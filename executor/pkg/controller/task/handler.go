...
func (t Handler) ResolvePlugin(ctx context.Context, ttype string, executionConfig v1.ExecutionConfig) (pluginCore.Plugin, error) {
...
func (t *Handler) ValidateOutput(ctx context.Context, nodeID v1alpha1.NodeID, i io.InputReader,
	r io.OutputReader, outputCommitter io.OutputWriter, executionConfig v1.ExecutionConfig,
...
func New(ctx context.Context, kubeClient pluginCore.KubeClient, kubeClientset kubernetes.Interface, client catalog.Client,
