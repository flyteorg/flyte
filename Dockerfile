...
RUN go get github.com/flyteorg/flyteidl@databricks
RUN go get github.com/flyteorg/flyteplugins@databricks
RUN go get github.com/flyteorg/flytepropeller@databricks
RUN go mod download
