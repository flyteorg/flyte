...
func (p *Plugin) Create(ctx context.Context, taskCtx webapi.TaskExecutionContextReader) (webapi.ResourceMeta,
	...
	taskCategory := plugins.TaskCategory{Name: taskTemplate.GetType(), Version: taskTemplate.GetTaskTypeVersion()}
...
func (p *Plugin) Get(ctx context.Context, taskCtx webapi.GetContext) (latest webapi.Resource, err error) {
	...
	request := &plugins.GetTaskRequest{
...
func (p *Plugin) getFinalConnector(taskCategory *plugins.TaskCategory, cfg *Config, domain string) (*Connector, error) {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
func buildTaskExecutionMetadata(taskExecutionMetadata core.TaskExecutionMetadata) plugins.TaskExecutionMetadata {
	taskExecutionID := taskExecutionMetadata.GetTaskExecutionID().GetID()

	return plugins.TaskExecutionMetadata{
