...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "logs.config.flyin-enabled"), defaultConfig.LogConfig.Config.IsFlyinEnabled, "Enable Log-links to flyin logs")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "logs.config.flyin-template-uri"), defaultConfig.LogConfig.Config.FlyinTemplateURI, "Template Uri to use when building flyin log links")
	return cmdFlags
}
