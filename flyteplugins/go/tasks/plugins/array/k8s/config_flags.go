...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "logs.config.dynamic-log-links-enabled"), defaultConfig.LogConfig.Config.IsDynamicLogLinksEnabled, "Enable dynamic log links")
	cmdFlags.StringToString(fmt.Sprintf("%v%v", prefix, "logs.config.dynamic-log-links"), defaultConfig.LogConfig.Config.DynamicLogLinks, "Map of dynamic log links")
	return cmdFlags
}
