...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "logs.mixed.flyin-enabled"), defaultConfig.LogConfig.Mixed.IsFlyinEnabled, "Enable Log-links to flyin logs")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "logs.mixed.flyin-template-uri"), defaultConfig.LogConfig.Mixed.FlyinTemplateURI, "Template Uri to use when building flyin log links")
	...
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "logs.user.flyin-enabled"), defaultConfig.LogConfig.User.IsFlyinEnabled, "Enable Log-links to flyin logs")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "logs.user.flyin-template-uri"), defaultConfig.LogConfig.User.FlyinTemplateURI, "Template Uri to use when building flyin log links")
	...
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "logs.system.flyin-enabled"), defaultConfig.LogConfig.System.IsFlyinEnabled, "Enable Log-links to flyin logs")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "logs.system.flyin-template-uri"), defaultConfig.LogConfig.System.FlyinTemplateURI, "Template Uri to use when building flyin log links")
	...
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "logs.all-user.flyin-enabled"), defaultConfig.LogConfig.AllUser.IsFlyinEnabled, "Enable Log-links to flyin logs")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "logs.all-user.flyin-template-uri"), defaultConfig.LogConfig.AllUser.FlyinTemplateURI, "Template Uri to use when building flyin log links")
	return cmdFlags
}
