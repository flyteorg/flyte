...
// application that carries a driver or executor pod template, and the value the plugin
// declares: a floor the feature is known to need, rather than a guess at what the image ships.
