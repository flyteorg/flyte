...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "batchScheduler.scheduler"), defaultConfig.BatchScheduler.Scheduler, " Specify batch scheduler to")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "batchScheduler.default.Kueue.Priority"), defaultConfig.BatchScheduler.Default.KueueConfig.PriorityClassName, " Kueue Prioty class")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "batchScheduler.default.Kueue.Queue"), defaultConfig.BatchScheduler.Default.KueueConfig.Queue, " Specify batch scheduler to")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "batchScheduler.default.Yunikorn.parameters"), defaultConfig.BatchScheduler.Default.YunikornConfig.Parameters, " Specify gangscheduling policy")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "batchScheduler.default.Yunikorn.queue"), defaultConfig.BatchScheduler.Default.YunikornConfig.Queue, " Specify leaf queue to submit to")
