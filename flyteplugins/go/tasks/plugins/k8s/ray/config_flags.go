...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "kubeRayCrdVersion"), defaultConfig.KubeRayCrdVersion, "Version of the Ray CRD to use when creating RayClusters or RayJobs.")
	return cmdFlags
}
