...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_remoteFileOutputPaths.deckFilename", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("remoteFileOutputPaths.deckFilename", testValue)
			if vString, err := cmdFlags.GetString("remoteFileOutputPaths.deckFilename"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.RemoteFileOutputPathsConfig.DeckFilename)
