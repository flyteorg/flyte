...
import (
	flyteidl2core "github.com/flyteorg/flyte/v2/gen/go/flyteidl2/core"
...
func (_c *TaskOverrides_GetConfig_Call) Return(_a0 map[string]string) *TaskOverrides_GetConfig_Call {
	_c.Call.Return(_a0)
	return _c
}
...
// GetConfigMap provides a mock function with no fields
...
func (_c *TaskOverrides_GetConfigMap_Call) Return(_a0 *v1.ConfigMap) *TaskOverrides_GetConfigMap_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *TaskOverrides) GetExtendedResources() *flyteidl2core.ExtendedResources {
	ret := _m.Called()
	...
	var r0 *flyteidl2core.ExtendedResources
	if rf, ok := ret.Get(0).(func() *flyteidl2core.ExtendedResources); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*flyteidl2core.ExtendedResources)
		}
	}
...
func (_c *TaskOverrides_GetExtendedResources_Call) Return(_a0 *flyteidl2core.ExtendedResources) *TaskOverrides_GetExtendedResources_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *TaskOverrides_GetExtendedResources_Call) RunAndReturn(run func() *flyteidl2core.ExtendedResources) *TaskOverrides_GetExtendedResources_Call {
	_c.Call.Return(run)
	return _c
}

// GetPodTemplate provides a mock function with no fields
func (_m *TaskOverrides) GetPodTemplate() *flyteidl2core.K8SPod {
	ret := _m.Called()
	...
	var r0 *flyteidl2core.K8SPod
	if rf, ok := ret.Get(0).(func() *flyteidl2core.K8SPod); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*flyteidl2core.K8SPod)
		}
	}
...
func (_c *TaskOverrides_GetPodTemplate_Call) Return(_a0 *flyteidl2core.K8SPod) *TaskOverrides_GetPodTemplate_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *TaskOverrides_GetPodTemplate_Call) RunAndReturn(run func() *flyteidl2core.K8SPod) *TaskOverrides_GetPodTemplate_Call {
	_c.Call.Return(run)
	return _c
}
