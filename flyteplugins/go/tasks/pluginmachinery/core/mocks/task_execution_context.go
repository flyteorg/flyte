...
func (_m TaskExecutionContext_GetExecutionEnv) Return(_a0 *structpb.Struct) *TaskExecutionContext_GetExecutionEnv {
	return &TaskExecutionContext_GetExecutionEnv{Call: _m.Call.Return(_a0)}
}

func (_m *TaskExecutionContext) OnGetExecutionEnv(_a0 string) *TaskExecutionContext_GetExecutionEnv {
...
func (_m *TaskExecutionContext) GetExecutionEnv(_a0 string) *structpb.Struct {
	ret := _m.Called(_a0)
