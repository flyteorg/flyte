...
// IncludeEnqueueLabels provides a mock function with no fields
...
func (_c *SetupContext_IncludeEnqueueLabels_Call) Return(_a0 []string) *SetupContext_IncludeEnqueueLabels_Call {
	_c.Call.Return(_a0)
	return _c
}
