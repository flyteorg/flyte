...
func (_m *TaskReader) Read(ctx context.Context) (*flyteidl2core.TaskTemplate, error) {
	ret := _m.Called(ctx)
	...
	var r0 *flyteidl2core.TaskTemplate
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*flyteidl2core.TaskTemplate, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *flyteidl2core.TaskTemplate); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*flyteidl2core.TaskTemplate)
		}
	}
...
func (_c *TaskReader_Read_Call) Return(_a0 *flyteidl2core.TaskTemplate, _a1 error) *TaskReader_Read_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TaskReader_Read_Call) RunAndReturn(run func(context.Context) (*flyteidl2core.TaskTemplate, error)) *TaskReader_Read_Call {
	_c.Call.Return(run)
	return _c
}
