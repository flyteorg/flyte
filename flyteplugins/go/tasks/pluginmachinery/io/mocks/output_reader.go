...
type OutputReader_GetDeckPath struct {
	*mock.Call
}

func (_m OutputReader_GetDeckPath) Return(_a0 *storage.DataReference) *OutputReader_GetDeckPath {
	return &OutputReader_GetDeckPath{Call: _m.Call.Return(_a0)}
}

func (_m *OutputReader) OnGetDeckPath() *OutputReader_GetDeckPath {
	c := _m.On("GetDeckPath")
	return &OutputReader_GetDeckPath{Call: c}
}

func (_m *OutputReader) OnGetDeckPathMatch(matchers ...interface{}) *OutputReader_GetDeckPath {
	c := _m.On("GetDeckPath", matchers...)
	return &OutputReader_GetDeckPath{Call: c}
}

// GetDeckPath provides a mock function with given fields:
func (_m *OutputReader) GetDeckPath() *storage.DataReference {
	ret := _m.Called()
