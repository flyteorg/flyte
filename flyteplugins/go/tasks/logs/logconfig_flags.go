...
func (cfg LogConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "dynamic-log-links-enabled"), DefaultConfig.IsDynamicLogLinksEnabled, "Enable dynamic log links")
	cmdFlags.StringToString(fmt.Sprintf("%v%v", prefix, "dynamic-log-links"), DefaultConfig.DynamicLogLinks, "Map of dynamic log links")
	return cmdFlags
}
