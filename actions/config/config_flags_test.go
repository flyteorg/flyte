...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_watchWorkers", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("watchWorkers", testValue)
			if vInt, err := cmdFlags.GetInt("watchWorkers"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vInt), &actual.WatchWorkers)
	...
	t.Run("Test_recordFilterSize", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("recordFilterSize", testValue)
			if vInt, err := cmdFlags.GetInt("recordFilterSize"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vInt), &actual.RecordFilterSize)
