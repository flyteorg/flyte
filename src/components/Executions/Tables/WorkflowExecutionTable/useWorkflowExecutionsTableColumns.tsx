...
export function useWorkflowExecutionsTableColumns(
  ...
  return React.useMemo(() => {
    const arr: WorkflowExecutionColumnDefinition[] = [
      {
        cellRenderer: ({ execution }) =>
          getExecutionIdCell(execution, commonStyles.textWrapped, props.showWorkflowName),
    ...
    return arr;
  }, [styles, commonStyles, props.showWorkflowName, isLaunchPlanEnabled, props.onArchiveClick]);
}
