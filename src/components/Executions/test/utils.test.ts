...
import { Execution, NodeExecution, TaskExecution } from 'models';
...
const getMockWorkflowExecution = () =>
    createMockWorkflowExecutionsListResponse(1).executions[0];
const getMockNodeExecution = () => createMockNodeExecutions(1).executions[0];
const getMockTaskExecution = () =>
    createMockTaskExecutionsListResponse(1).taskExecutions[0];
