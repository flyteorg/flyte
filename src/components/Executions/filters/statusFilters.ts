 ...
 */
export const workflowExecutionStatusFilters: FilterMap<
    WorkflowExecutionStatusFilterKey,
    string
> = {
    queued: {
        label: 'Scheduled',
...
/** A set of WorkflowExecution status/phase filters to be consumed by a MultiFilterState.
 */
export const nodeExecutionStatusFilters: FilterMap<
    NodeExecutionStatusFilterKey,
    string
> = {
    queued: {
        label: 'Scheduled',
