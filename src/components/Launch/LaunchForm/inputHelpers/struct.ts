...
export function protobufValueToPrimitive(value: Protobuf.IValue): PrimitiveType | PrimitiveType[] {
...
function protobufStructToObject(struct: Protobuf.IStruct): Dictionary<any> {
  ...
  return Object.entries(struct.fields).reduce<Dictionary<any>>((out, [key, value]) => {
