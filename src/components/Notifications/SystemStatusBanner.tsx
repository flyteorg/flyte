...
const WarningIcon = () => <Warning data-testid="warning-icon" htmlColor={warningIconColor} />;
...
export const RenderSystemStatusBanner: React.FC<{
  ...
  return (
    <div className={styles.container}>
      <Paper role="banner" className={styles.statusPaper} elevation={1} square={true}>
        ...
        <div className={styles.statusClose}>
          <ButtonBase aria-label="Close" className={styles.closeButton} onClick={onClose}>
