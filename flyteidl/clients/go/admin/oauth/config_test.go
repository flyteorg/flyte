...
func TestGenerateClientConfig(t *testing.T) {
	...
	mockAuthClient.On("GetPublicClientConfig", ctx, mock.Anything).Return(flyteClientResp, nil)
	mockAuthClient.On("GetOAuth2Metadata", ctx, mock.Anything).Return(oauthMetaDataResp, nil)
