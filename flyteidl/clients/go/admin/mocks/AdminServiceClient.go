...
func (_m *AdminServiceClient) OnGetProject(ctx context.Context, in *admin.ProjectRequest, opts ...grpc.CallOption) *AdminServiceClient_GetProject {
...
func (_m *AdminServiceClient) GetProject(ctx context.Context, in *admin.ProjectRequest, opts ...grpc.CallOption) (*admin.Project, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if rf, ok := ret.Get(0).(func(context.Context, *admin.ProjectRequest, ...grpc.CallOption) *admin.Project); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *admin.ProjectRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
