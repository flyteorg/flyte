...
func (_m AgentServiceClient_CreateTask) Return(_a0 *service.TaskCreateResponse, _a1 error) *AgentServiceClient_CreateTask {
	return &AgentServiceClient_CreateTask{Call: _m.Call.Return(_a0, _a1)}
}

func (_m *AgentServiceClient) OnCreateTask(ctx context.Context, in *service.TaskCreateRequest, opts ...grpc.CallOption) *AgentServiceClient_CreateTask {
...
func (_m *AgentServiceClient) CreateTask(ctx context.Context, in *service.TaskCreateRequest, opts ...grpc.CallOption) (*service.TaskCreateResponse, error) {
...
func (_m AgentServiceClient_DeleteTask) Return(_a0 *service.TaskDeleteResponse, _a1 error) *AgentServiceClient_DeleteTask {
	return &AgentServiceClient_DeleteTask{Call: _m.Call.Return(_a0, _a1)}
}

func (_m *AgentServiceClient) OnDeleteTask(ctx context.Context, in *service.TaskDeleteRequest, opts ...grpc.CallOption) *AgentServiceClient_DeleteTask {
...
func (_m *AgentServiceClient) DeleteTask(ctx context.Context, in *service.TaskDeleteRequest, opts ...grpc.CallOption) (*service.TaskDeleteResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m AgentServiceClient_GetTask) Return(_a0 *service.TaskGetResponse, _a1 error) *AgentServiceClient_GetTask {
	return &AgentServiceClient_GetTask{Call: _m.Call.Return(_a0, _a1)}
}

func (_m *AgentServiceClient) OnGetTask(ctx context.Context, in *service.TaskGetRequest, opts ...grpc.CallOption) *AgentServiceClient_GetTask {
...
func (_m *AgentServiceClient) GetTask(ctx context.Context, in *service.TaskGetRequest, opts ...grpc.CallOption) (*service.TaskGetResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
