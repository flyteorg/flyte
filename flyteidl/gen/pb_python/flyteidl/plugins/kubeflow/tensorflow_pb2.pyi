...
class DistributedTensorflowTrainingTask(_message.Message):
    __slots__ = ["worker_replicas", "ps_replicas", "chief_replicas", "evaluator_replicas", "run_policy"]
