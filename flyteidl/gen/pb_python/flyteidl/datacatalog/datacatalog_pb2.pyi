...
class DatasetID(_message.Message):
    __slots__ = ["project", "name", "domain", "version", "UUID", "partition", "org"]
    ...
    partition: str
    org: str
    def __init__(self, project: _Optional[str] = ..., name: _Optional[str] = ..., domain: _Optional[str] = ..., version: _Optional[str] = ..., UUID: _Optional[str] = ..., partition: _Optional[str] = ..., org: _Optional[str] = ...) -> None: ...
