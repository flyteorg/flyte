...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TASKEXECUTIONGETDATARESPONSE.fields_by_name['full_inputs']._options = None
  _TASKEXECUTIONGETDATARESPONSE.fields_by_name['full_inputs']._serialized_options = b'\030\001'
  _TASKEXECUTIONGETDATARESPONSE.fields_by_name['full_outputs']._options = None
  _TASKEXECUTIONGETDATARESPONSE.fields_by_name['full_outputs']._serialized_options = b'\030\001'
