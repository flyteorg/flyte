...
class CreateLaunchPlanFromNodeRequest(_message.Message):
    __slots__ = ["launch_plan_id", "sub_node_ids", "org"]
    ...
    org: str
    def __init__(self, launch_plan_id: _Optional[_Union[_identifier_pb2.Identifier, _Mapping]] = ..., sub_node_ids: _Optional[_Iterable[_Union[SubNodeIdAsList, _Mapping]]] = ..., org: _Optional[str] = ...) -> None: ...

class CreateLaunchPlanFromNodeResponse(_message.Message):
    __slots__ = ["launch_plan"]
    LAUNCH_PLAN_FIELD_NUMBER: _ClassVar[int]
    launch_plan: _launch_plan_pb2.LaunchPlan
    def __init__(self, launch_plan: _Optional[_Union[_launch_plan_pb2.LaunchPlan, _Mapping]] = ...) -> None: ...
