...
class ExecutionTerminateRequest(_message.Message):
    ...
    cause: str
    force: bool
    def __init__(self, id: _Optional[_Union[_identifier_pb2.WorkflowExecutionIdentifier, _Mapping]] = ..., cause: _Optional[str] = ..., force: bool = ...) -> None: ...
