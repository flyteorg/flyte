...
class WorkflowExecutionConfig(_message.Message):
    __slots__ = ["max_parallelism", "security_context", "raw_output_data_config", "labels", "annotations", "interruptible", "overwrite_cache", "envs", "execution_envs"]
