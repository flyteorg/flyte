...
class Literal(_message.Message):
    __slots__ = ["scalar", "collection", "map", "hash", "metadata", "test"]
    ...
    test: str
    def __init__(self, scalar: _Optional[_Union[Scalar, _Mapping]] = ..., collection: _Optional[_Union[LiteralCollection, _Mapping]] = ..., map: _Optional[_Union[LiteralMap, _Mapping]] = ..., hash: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ..., test: _Optional[str] = ...) -> None: ...
