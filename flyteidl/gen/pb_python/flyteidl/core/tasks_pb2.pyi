...
class TaskMetadata(_message.Message):
    __slots__ = ["discoverable", "runtime", "timeout", "retries", "discovery_version", "deprecated_error_message", "interruptible", "cache_serializable", "tags", "pod_template_name", "cache_ignore_input_vars", "is_eager", "generates_deck", "metadata", "mode"]
    class ExecutionMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
        DEFAULT: _ClassVar[TaskMetadata.ExecutionMode]
        DYNAMIC: _ClassVar[TaskMetadata.ExecutionMode]
    DEFAULT: TaskMetadata.ExecutionMode
    DYNAMIC: TaskMetadata.ExecutionMode
