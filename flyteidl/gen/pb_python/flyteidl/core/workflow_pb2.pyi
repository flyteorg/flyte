...
class TaskNodeOverrides(_message.Message):
    __slots__ = ["resources", "resource_metadata"]
    RESOURCES_FIELD_NUMBER: _ClassVar[int]
    RESOURCE_METADATA_FIELD_NUMBER: _ClassVar[int]
    resources: _tasks_pb2.Resources
    resource_metadata: _tasks_pb2.ResourceMetadata
    def __init__(self, resources: _Optional[_Union[_tasks_pb2.Resources, _Mapping]] = ..., resource_metadata: _Optional[_Union[_tasks_pb2.ResourceMetadata, _Mapping]] = ...) -> None: ...
