...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ASYNCAGENTSERVICE.methods_by_name['GetTask']._serialized_options = b'\202\323\344\223\002I\022G/api/v1/agent/task/{task_type.name}/{task_type.version}/{resource_meta}'
  _ASYNCAGENTSERVICE.methods_by_name['DeleteTask']._options = None
  _ASYNCAGENTSERVICE.methods_by_name['DeleteTask']._serialized_options = b'\202\323\344\223\002T*R/api/v1/agent/task_executions/{task_type.name}/{task_type.version}/{resource_meta}'
  _ASYNCAGENTSERVICE.methods_by_name['GetTaskMetrics']._options = None
  _ASYNCAGENTSERVICE.methods_by_name['GetTaskMetrics']._serialized_options = b'\202\323\344\223\002Q\022O/api/v1/agent/task/metrics/{task_type.name}/{task_type.version}/{resource_meta}'
  _ASYNCAGENTSERVICE.methods_by_name['GetTaskLogs']._options = None
  _ASYNCAGENTSERVICE.methods_by_name['GetTaskLogs']._serialized_options = b'\202\323\344\223\002N\022L/api/v1/agent/task/logs/{task_type.name}/{task_type.version}/{resource_meta}'
  _AGENTMETADATASERVICE.methods_by_name['GetAgent']._options = None
  _AGENTMETADATASERVICE.methods_by_name['GetAgent']._serialized_options = b'\202\323\344\223\0024\0222/api/v1/agent/{task_type.name}/{task_type.version}'
  ...
  _globals['_ASYNCAGENTSERVICE']._serialized_end=1108
  _globals['_AGENTMETADATASERVICE']._serialized_start=1111
  _globals['_AGENTMETADATASERVICE']._serialized_end=1382
