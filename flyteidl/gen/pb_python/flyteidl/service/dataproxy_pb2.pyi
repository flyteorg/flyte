...
class CreateDownloadLocationRequest(_message.Message):
    __slots__ = ["native_url", "expires_in", "headers"]
    ...
    def __init__(self, native_url: _Optional[str] = ..., expires_in: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., headers: _Optional[_Mapping[str, str]] = ...) -> None: ...
