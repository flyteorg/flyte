...
class AdminServiceApi(object):
    ...
    def get_workflow_node_executions(self, execution_id_project, execution_id_domain, execution_id_name, **kwargs):  # noqa: E501
        """Fetches a :ref:`ref_flyteidl.admin.WorkflowNodeExecutionsGetResponse`.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workflow_node_executions(execution_id_project, execution_id_domain, execution_id_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str execution_id_project: Name of the project the resource belongs to. (required)
        :param str execution_id_domain: Name of the domain the resource belongs to. A domain can be considered as a subset within a specific project. (required)
        :param str execution_id_name: User or system provided value for the resource. (required)
        :param str workflow_name: Name of workflow that was executed. Should be sent together with workflow_version. +optional.
        :param str workflow_version: Version of workflow that was executed. Should be sent together with workflow_name. +optional.
        :param str dynamic_node_id: Id of dynamic node containing workflow closure containing requested parent node. If not sent, top-level workflow closure is fetched. +optional.
        :param str parent_node_id: Node id of parent node if we want to fetch a subworkflow generated by node. +optional.
        :return: AdminWorkflowNodeExecutionsGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_workflow_node_executions_with_http_info(execution_id_project, execution_id_domain, execution_id_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_workflow_node_executions_with_http_info(execution_id_project, execution_id_domain, execution_id_name, **kwargs)  # noqa: E501
            return data

    def get_workflow_node_executions_with_http_info(self, execution_id_project, execution_id_domain, execution_id_name, **kwargs):  # noqa: E501
        """Fetches a :ref:`ref_flyteidl.admin.WorkflowNodeExecutionsGetResponse`.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workflow_node_executions_with_http_info(execution_id_project, execution_id_domain, execution_id_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['execution_id_project', 'execution_id_domain', 'execution_id_name', 'workflow_name', 'workflow_version', 'dynamic_node_id', 'parent_node_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_workflow_node_executions" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'execution_id_project' is set
        if ('execution_id_project' not in params or
                params['execution_id_project'] is None):
            raise ValueError("Missing the required parameter `execution_id_project` when calling `get_workflow_node_executions`")  # noqa: E501
        # verify the required parameter 'execution_id_domain' is set
        if ('execution_id_domain' not in params or
                params['execution_id_domain'] is None):
            raise ValueError("Missing the required parameter `execution_id_domain` when calling `get_workflow_node_executions`")  # noqa: E501
        # verify the required parameter 'execution_id_name' is set
        if ('execution_id_name' not in params or
                params['execution_id_name'] is None):
            raise ValueError("Missing the required parameter `execution_id_name` when calling `get_workflow_node_executions`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'execution_id_project' in params:
            path_params['execution_id.project'] = params['execution_id_project']  # noqa: E501
        if 'execution_id_domain' in params:
            path_params['execution_id.domain'] = params['execution_id_domain']  # noqa: E501
        if 'execution_id_name' in params:
            path_params['execution_id.name'] = params['execution_id_name']  # noqa: E501

        query_params = []
        if 'workflow_name' in params:
            query_params.append(('workflow_name', params['workflow_name']))  # noqa: E501
        if 'workflow_version' in params:
            query_params.append(('workflow_version', params['workflow_version']))  # noqa: E501
        if 'dynamic_node_id' in params:
            query_params.append(('dynamic_node_id', params['dynamic_node_id']))  # noqa: E501
        if 'parent_node_id' in params:
            query_params.append(('parent_node_id', params['parent_node_id']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/workflow_node_executions/{execution_id.project}/{execution_id.domain}/{execution_id.name}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AdminWorkflowNodeExecutionsGetResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
