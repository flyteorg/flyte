...
class AdminServiceApi(object):
    ...
    def get_launch_plan(self, id_project, id_domain, id_name, id_version, **kwargs):  # noqa: E501
        ...
        :param str id_resource_type: Identifies the specific type of resource that this identifer corresponds to.
        :return: AdminLaunchPlan
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_node_executions_for_task(self, task_execution_id_node_execution_id_execution_id_project, task_execution_id_node_execution_id_execution_id_domain, task_execution_id_node_execution_id_execution_id_name, task_execution_id_node_execution_id_node_id, task_execution_id_task_id_project, task_execution_id_task_id_domain, task_execution_id_task_id_name, task_execution_id_task_id_version, task_execution_id_retry_attempt, **kwargs):  # noqa: E501
        ...
        :param str task_execution_id_task_id_resource_type: Identifies the specific type of resource that this identifer corresponds to.
        :param int limit: Indicates the number of resources to be returned.
        :param str token: In the case of multiple pages of results, the, server-provided token can be used to fetch the next page in a query. +optional.
        :param str filters: Indicates a list of filters passed as string. More info on constructing filters : <Link> +optional.
        :param str sort_by_key: Indicates an attribute to sort the response values. TODO(katrogan): Add string validation here. This should never be empty.
    ...
    def update_workflow(self, id_project, id_domain, id_name, id_version, body, **kwargs):  # noqa: E501
        """update_workflow  # noqa: E501

        Update the state of an existing workflow definition.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_workflow(id_project, id_domain, id_name, id_version, body, async_req=True)
        >>> result = thread.get()
        ...
        :param str id_name: User provided value for the resource. (required)
        :param str id_version: Specific version of the resource. (required)
        :param AdminWorkflowUpdateRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_workflow_with_http_info(id_project, id_domain, id_name, id_version, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_workflow_with_http_info(id_project, id_domain, id_name, id_version, body, **kwargs)  # noqa: E501
            return data

    def update_workflow_with_http_info(self, id_project, id_domain, id_name, id_version, body, **kwargs):  # noqa: E501
        """update_workflow  # noqa: E501

        Update the state of an existing workflow definition.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_workflow_with_http_info(id_project, id_domain, id_name, id_version, body, async_req=True)
        >>> result = thread.get()
        ...
        if ('id_project' not in params or
                params['id_project'] is None):
            raise ValueError("Missing the required parameter `id_project` when calling `update_workflow`")  # noqa: E501
        # verify the required parameter 'id_domain' is set
        if ('id_domain' not in params or
                params['id_domain'] is None):
            raise ValueError("Missing the required parameter `id_domain` when calling `update_workflow`")  # noqa: E501
        # verify the required parameter 'id_name' is set
        if ('id_name' not in params or
                params['id_name'] is None):
            raise ValueError("Missing the required parameter `id_name` when calling `update_workflow`")  # noqa: E501
        # verify the required parameter 'id_version' is set
        if ('id_version' not in params or
                params['id_version'] is None):
            raise ValueError("Missing the required parameter `id_version` when calling `update_workflow`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
        ...
        return self.api_client.call_api(
            '/api/v1/workflows/{id.project}/{id.domain}/{id.name}/{id.version}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='AdminWorkflowUpdateResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
