...
class CoreOutputData(object):
    ...
    def __init__(self, outputs=None):  # noqa: E501
        """CoreOutputData - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CoreOutputData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoreOutputData):
            return False
