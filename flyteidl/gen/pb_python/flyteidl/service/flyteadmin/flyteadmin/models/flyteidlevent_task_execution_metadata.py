...
class FlyteidleventTaskExecutionMetadata(object):
    ...
    def __init__(self, generated_name=None, external_resources=None, resource_pool_info=None, plugin_identifier=None, instance_class=None, _configuration=None):  # noqa: E501
