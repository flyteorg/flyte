...
class CoreResourceMetadata(object):
    ...
    def __init__(self, gpu_accelerator=None):  # noqa: E501
        """CoreResourceMetadata - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CoreResourceMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoreResourceMetadata):
            return False
