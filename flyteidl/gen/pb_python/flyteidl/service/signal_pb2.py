...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SIGNALSERVICE.methods_by_name['ListSignals']._serialized_options = b'\222AI\032GFetch existing signal definitions matching the input signal id filters.\202\323\344\223\002\376\001Z\216\001\022\213\001/api/v1/org/signals/{workflow_execution_id.org}/{workflow_execution_id.project}/{workflow_execution_id.domain}/{workflow_execution_id.name}\022k/api/v1/signals/{workflow_execution_id.project}/{workflow_execution_id.domain}/{workflow_execution_id.name}'
  _SIGNALSERVICE.methods_by_name['SetSignal']._options = None
  _SIGNALSERVICE.methods_by_name['SetSignal']._serialized_options = b'\222A\300\001\032\023Set a signal value.JB\n\003400\022;\n9Returned for bad request that may have failed validation.Je\n\003409\022^\n\\Returned for a request that references an identical entity that has already been registered.\202\323\344\223\002D:\001*Z.:\001*\")/api/v1/org/signals/{id.execution_id.org}\"\017/api/v1/signals'
