...
func (*NodeExecutionGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_1b18c314e12f4636, []int{0}
}
...
func (*NodeExecutionListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_1b18c314e12f4636, []int{1}
}
...
func (*NodeExecutionForTaskListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_1b18c314e12f4636, []int{2}
}
...
func (*NodeExecution) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_1b18c314e12f4636, []int{3}
}
...
func (*NodeExecutionList) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_1b18c314e12f4636, []int{4}
}
...
func (*NodeExecutionClosure) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_1b18c314e12f4636, []int{5}
}
...
func _NodeExecutionClosure_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("NodeExecutionClosure.TargetMetadata has unexpected type %T", x)
	}
	return nil
}
...
func _NodeExecutionClosure_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 8: // target_metadata.workflow_node_metadata
		...
		err := b.DecodeMessage(msg)
		m.TargetMetadata = &NodeExecutionClosure_WorkflowNodeMetadata{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*WorkflowNodeMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_1b18c314e12f4636, []int{6}
}
...
func (*NodeExecutionGetDataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_1b18c314e12f4636, []int{7}
}
...
func (*NodeExecutionGetDataResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_execution_1b18c314e12f4636, []int{8}
}
...
func init() {
	proto.RegisterFile("flyteidl/admin/node_execution.proto", fileDescriptor_node_execution_1b18c314e12f4636)
}

var fileDescriptor_node_execution_1b18c314e12f4636 = []byte{
