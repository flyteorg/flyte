...
func (ExecutionMetadata_ExecutionMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4e2785d91b3809ec, []int{9, 0}
}
...
type ExecutionMetadata struct {
	...
	Interruptible        bool     `protobuf:"varint,7,opt,name=interruptible,proto3" json:"interruptible,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ExecutionMetadata) GetInterruptible() bool {
	if m != nil {
...
var fileDescriptor_4e2785d91b3809ec = []byte{
	...
	,
}
