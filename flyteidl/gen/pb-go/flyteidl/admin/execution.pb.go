...
var file_flyteidl_admin_execution_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x63, 0x65, 0x22, 0x95, 0x05, 0x0a, 0x11, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69,
	...
	,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x2a, 0x3e, 0x0a, 0x0e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f,
	0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x14, 0x0a, 0x10, 0x45, 0x58, 0x45, 0x43, 0x55, 0x54,
	0x49, 0x4f, 0x4e, 0x5f, 0x41, 0x43, 0x54, 0x49, 0x56, 0x45, 0x10, 0x00, 0x12, 0x16, 0x0a, 0x12,
	0x45, 0x58, 0x45, 0x43, 0x55, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x41, 0x52, 0x43, 0x48, 0x49, 0x56,
	0x45, 0x44, 0x10, 0x01, 0x42, 0xba, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x79,
	0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x42, 0x0e, 0x45, 0x78, 0x65,
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3b, 0x67,
...
var file_flyteidl_admin_execution_proto_goTypes = []interface{}{
	...
	(*ExecutionClusterLabel)(nil),               // 49: flyteidl.admin.ExecutionClusterLabel
	(*core.ExecutionEnvAssignment)(nil),         // 50: flyteidl.core.ExecutionEnvAssignment
	(*TaskResourceAttributes)(nil),              // 51: flyteidl.admin.TaskResourceAttributes
	(*UrlBlob)(nil),                             // 52: flyteidl.admin.UrlBlob
	(*core.Span)(nil),                           // 53: flyteidl.core.Span
}
var file_flyteidl_admin_execution_proto_depIdxs = []int32{
	...
	36, // 32: flyteidl.admin.NotificationList.notifications:type_name -> flyteidl.admin.Notification
	37, // 33: flyteidl.admin.ExecutionSpec.launch_plan:type_name -> flyteidl.core.Identifier
	30, // 34: flyteidl.admin.ExecutionSpec.inputs:type_name -> flyteidl.core.LiteralMap
	...
	40, // 37: flyteidl.admin.ExecutionSpec.labels:type_name -> flyteidl.admin.Labels
	41, // 38: flyteidl.admin.ExecutionSpec.annotations:type_name -> flyteidl.admin.Annotations
	42, // 39: flyteidl.admin.ExecutionSpec.security_context:type_name -> flyteidl.core.SecurityContext
	43, // 40: flyteidl.admin.ExecutionSpec.auth_role:type_name -> flyteidl.admin.AuthRole
	44, // 41: flyteidl.admin.ExecutionSpec.quality_of_service:type_name -> flyteidl.core.QualityOfService
	45, // 42: flyteidl.admin.ExecutionSpec.raw_output_data_config:type_name -> flyteidl.admin.RawOutputDataConfig
	46, // 43: flyteidl.admin.ExecutionSpec.cluster_assignment:type_name -> flyteidl.admin.ClusterAssignment
	47, // 44: flyteidl.admin.ExecutionSpec.interruptible:type_name -> google.protobuf.BoolValue
	48, // 45: flyteidl.admin.ExecutionSpec.envs:type_name -> flyteidl.admin.Envs
	49, // 46: flyteidl.admin.ExecutionSpec.execution_cluster_label:type_name -> flyteidl.admin.ExecutionClusterLabel
	50, // 47: flyteidl.admin.ExecutionSpec.execution_env_assignments:type_name -> flyteidl.core.ExecutionEnvAssignment
	51, // 48: flyteidl.admin.ExecutionSpec.task_resource_attributes:type_name -> flyteidl.admin.TaskResourceAttributes
	31, // 49: flyteidl.admin.ExecutionTerminateRequest.id:type_name -> flyteidl.core.WorkflowExecutionIdentifier
	31, // 50: flyteidl.admin.WorkflowExecutionGetDataRequest.id:type_name -> flyteidl.core.WorkflowExecutionIdentifier
	52, // 51: flyteidl.admin.WorkflowExecutionGetDataResponse.outputs:type_name -> flyteidl.admin.UrlBlob
	52, // 52: flyteidl.admin.WorkflowExecutionGetDataResponse.inputs:type_name -> flyteidl.admin.UrlBlob
	30, // 53: flyteidl.admin.WorkflowExecutionGetDataResponse.full_inputs:type_name -> flyteidl.core.LiteralMap
	30, // 54: flyteidl.admin.WorkflowExecutionGetDataResponse.full_outputs:type_name -> flyteidl.core.LiteralMap
	31, // 55: flyteidl.admin.ExecutionUpdateRequest.id:type_name -> flyteidl.core.WorkflowExecutionIdentifier
	...
	34, // 58: flyteidl.admin.ExecutionStateChangeDetails.occurred_at:type_name -> google.protobuf.Timestamp
	31, // 59: flyteidl.admin.WorkflowExecutionGetMetricsRequest.id:type_name -> flyteidl.core.WorkflowExecutionIdentifier
	53, // 60: flyteidl.admin.WorkflowExecutionGetMetricsResponse.span:type_name -> flyteidl.core.Span
	33, // 61: flyteidl.admin.ExecutionCountsByPhase.phase:type_name -> flyteidl.core.WorkflowExecution.Phase
