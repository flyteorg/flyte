...
type LaunchPlanSpec struct {
	...
	ExecutionEnvs        []*core.ExecutionEnvironmentAssignment `protobuf:"bytes,22,rep,name=execution_envs,json=executionEnvs,proto3" json:"execution_envs,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                               `json:"-"`
	XXX_unrecognized     []byte                                 `json:"-"`
	XXX_sizecache        int32                                  `json:"-"`
}
...
func (m *LaunchPlanSpec) GetExecutionEnvs() []*core.ExecutionEnvironmentAssignment {
	if m != nil {
...
var fileDescriptor_368a863574f5e699 = []byte{
	...
	,
}
