...
type SubNodeList struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// List of sub node IDs to include in the execution
	SubNodeIds []*SubNodeIdAsList `protobuf:"bytes,1,rep,name=sub_node_ids,json=subNodeIds,proto3" json:"sub_node_ids,omitempty"`
}

func (x *SubNodeList) Reset() {
	*x = SubNodeList{}
	if protoimpl.UnsafeEnabled {
...
func (x *SubNodeList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubNodeList) ProtoMessage() {}

func (x *SubNodeList) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl_admin_launch_plan_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubNodeList.ProtoReflect.Descriptor instead.
func (*SubNodeList) Descriptor() ([]byte, []int) {
	return file_flyteidl_admin_launch_plan_proto_rawDescGZIP(), []int{14}
}

func (x *SubNodeList) GetSubNodeIds() []*SubNodeIdAsList {
	if x != nil {
		return x.SubNodeIds
	}
	return nil
...
type CreateLaunchPlanFromNodeRequest struct {
	...
	// +required
	//
	// Types that are assignable to SubNodes:
	//
	//	*CreateLaunchPlanFromNodeRequest_SubNodeIds
	//	*CreateLaunchPlanFromNodeRequest_SubNodeSpec
	SubNodes isCreateLaunchPlanFromNodeRequest_SubNodes `protobuf_oneof:"sub_nodes"`
	// Indicates security context for permissions triggered with this launch plan
...
func (x *CreateLaunchPlanFromNodeRequest) Reset() {
	*x = CreateLaunchPlanFromNodeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl_admin_launch_plan_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateLaunchPlanFromNodeRequest) Descriptor() ([]byte, []int) {
	return file_flyteidl_admin_launch_plan_proto_rawDescGZIP(), []int{15}
}
...
func (m *CreateLaunchPlanFromNodeRequest) GetSubNodes() isCreateLaunchPlanFromNodeRequest_SubNodes {
	if m != nil {
		return m.SubNodes
	}
	return nil
...
func (x *CreateLaunchPlanFromNodeRequest) GetSubNodeIds() *SubNodeList {
	if x, ok := x.GetSubNodes().(*CreateLaunchPlanFromNodeRequest_SubNodeIds); ok {
		return x.SubNodeIds
	}
	return nil
}

func (x *CreateLaunchPlanFromNodeRequest) GetSubNodeSpec() *core.Node {
	if x, ok := x.GetSubNodes().(*CreateLaunchPlanFromNodeRequest_SubNodeSpec); ok {
		return x.SubNodeSpec
	}
	return nil
}

func (x *CreateLaunchPlanFromNodeRequest) GetSecurityContext() *core.SecurityContext {
	if x != nil {
		return x.SecurityContext
	}
	return nil
...
func (x *CreateLaunchPlanFromNodeRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type isCreateLaunchPlanFromNodeRequest_SubNodes interface {
	isCreateLaunchPlanFromNodeRequest_SubNodes()
}

type CreateLaunchPlanFromNodeRequest_SubNodeIds struct {
	// List of sub node IDs to include in the execution. Utilized for re-running a node(s) within a workflow.
	SubNodeIds *SubNodeList `protobuf:"bytes,2,opt,name=sub_node_ids,json=subNodeIds,proto3,oneof"`
}

type CreateLaunchPlanFromNodeRequest_SubNodeSpec struct {
	// Node spec to create a workflow from
	SubNodeSpec *core.Node `protobuf:"bytes,3,opt,name=sub_node_spec,json=subNodeSpec,proto3,oneof"`
}

func (*CreateLaunchPlanFromNodeRequest_SubNodeIds) isCreateLaunchPlanFromNodeRequest_SubNodes() {}

func (*CreateLaunchPlanFromNodeRequest_SubNodeSpec) isCreateLaunchPlanFromNodeRequest_SubNodes() {}
...
func (x *CreateLaunchPlanFromNodeResponse) Reset() {
	*x = CreateLaunchPlanFromNodeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl_admin_launch_plan_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateLaunchPlanFromNodeResponse) Descriptor() ([]byte, []int) {
	return file_flyteidl_admin_launch_plan_proto_rawDescGZIP(), []int{16}
}
...
var file_flyteidl_admin_launch_plan_proto_rawDesc = []byte{
	...
	0xc4, 0x09, 0x0a, 0x0e, 0x4c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x50, 0x6c, 0x61, 0x6e, 0x53, 0x70,
	...
	0x79, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x12, 0x4d, 0x0a, 0x12, 0x71, 0x75, 0x61, 0x6c,
	0x69, 0x74, 0x79, 0x5f, 0x6f, 0x66, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x18, 0x10,
	...
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x58, 0x0a, 0x16, 0x72, 0x61, 0x77, 0x5f, 0x6f,
	0x75, 0x74, 0x70, 0x75, 0x74, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69,
	0x64, 0x6c, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x52, 0x61, 0x77, 0x4f, 0x75, 0x74, 0x70,
	0x75, 0x74, 0x44, 0x61, 0x74, 0x61, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x13, 0x72, 0x61,
	...
	0x6c, 0x69, 0x73, 0x6d, 0x18, 0x12, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x6d, 0x61, 0x78, 0x50,
	0x61, 0x72, 0x61, 0x6c, 0x6c, 0x65, 0x6c, 0x69, 0x73, 0x6d, 0x12, 0x40, 0x0a, 0x0d, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x72, 0x75, 0x70, 0x74, 0x69, 0x62, 0x6c, 0x65, 0x18, 0x13, 0x20, 0x01, 0x28,
	...
	0x14, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x6f, 0x76, 0x65, 0x72, 0x77, 0x72, 0x69, 0x74, 0x65,
	0x43, 0x61, 0x63, 0x68, 0x65, 0x12, 0x28, 0x0a, 0x04, 0x65, 0x6e, 0x76, 0x73, 0x18, 0x15, 0x20,
	...
	,
	...
	,
	...
	0x69, 0x6f, 0x72, 0x22, 0xcd, 0x02, 0x0a, 0x11, 0x4c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x50, 0x6c,
	0x61, 0x6e, 0x43, 0x6c, 0x6f, 0x73, 0x75, 0x72, 0x65, 0x12, 0x35, 0x0a, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65,
	0x69, 0x64, 0x6c, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x4c, 0x61, 0x75, 0x6e, 0x63, 0x68,
	0x50, 0x6c, 0x61, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65,
	0x12, 0x44, 0x0a, 0x0f, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x69, 0x6e, 0x70,
	...
	0x74, 0x65, 0x72, 0x4d, 0x61, 0x70, 0x52, 0x0e, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64,
	0x49, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x12, 0x45, 0x0a, 0x10, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74,
	0x65, 0x64, 0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1a, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e, 0x63, 0x6f, 0x72, 0x65,
	0x2e, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x4d, 0x61, 0x70, 0x52, 0x0f, 0x65, 0x78,
	0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x12, 0x39, 0x0a,
	...
	0x64, 0x41, 0x74, 0x22, 0xd1, 0x01, 0x0a, 0x12, 0x4c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x50, 0x6c,
	0x61, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x34, 0x0a, 0x08, 0x73, 0x63,
	0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x66,
	0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x53, 0x63,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x12, 0x41, 0x0a, 0x11, 0x6c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x5f, 0x63,
	0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x14, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x10, 0x6c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x43, 0x6f, 0x6e,
	0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x7b, 0x0a, 0x17, 0x4c, 0x61, 0x75, 0x6e, 0x63,
	...
	,
	...
	0x6d, 0x61, 0x69, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x03, 0x20,
	...
	0x12, 0x2d, 0x0a, 0x07, 0x73, 0x6f, 0x72, 0x74, 0x5f, 0x62, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	0x45, 0x48, 0x41, 0x56, 0x49, 0x4f, 0x52, 0x5f, 0x53, 0x4b, 0x49, 0x50, 0x10, 0x01, 0x42, 0xbb,
	0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e,
	0x61, 0x64, 0x6d, 0x69, 0x6e, 0x42, 0x0f, 0x4c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x50, 0x6c, 0x61,
...
var file_flyteidl_admin_launch_plan_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_flyteidl_admin_launch_plan_proto_goTypes = []interface{}{
	...
	(*SubNodeIdAsList)(nil),                  // 15: flyteidl.admin.SubNodeIdAsList
	(*SubNodeList)(nil),                      // 16: flyteidl.admin.SubNodeList
	(*CreateLaunchPlanFromNodeRequest)(nil),  // 17: flyteidl.admin.CreateLaunchPlanFromNodeRequest
	(*CreateLaunchPlanFromNodeResponse)(nil), // 18: flyteidl.admin.CreateLaunchPlanFromNodeResponse
	(*core.Identifier)(nil),                  // 19: flyteidl.core.Identifier
	(*core.ParameterMap)(nil),                // 20: flyteidl.core.ParameterMap
	(*core.LiteralMap)(nil),                  // 21: flyteidl.core.LiteralMap
	(*Labels)(nil),                           // 22: flyteidl.admin.Labels
	(*Annotations)(nil),                      // 23: flyteidl.admin.Annotations
	(*AuthRole)(nil),                         // 24: flyteidl.admin.AuthRole
	(*core.SecurityContext)(nil),             // 25: flyteidl.core.SecurityContext
	(*core.QualityOfService)(nil),            // 26: flyteidl.core.QualityOfService
	(*RawOutputDataConfig)(nil),              // 27: flyteidl.admin.RawOutputDataConfig
	(*wrapperspb.BoolValue)(nil),             // 28: google.protobuf.BoolValue
	(*Envs)(nil),                             // 29: flyteidl.admin.Envs
	(*core.ExecutionEnvAssignment)(nil),      // 30: flyteidl.core.ExecutionEnvAssignment
	(*ClusterAssignment)(nil),                // 31: flyteidl.admin.ClusterAssignment
	(*core.VariableMap)(nil),                 // 32: flyteidl.core.VariableMap
	(*timestamppb.Timestamp)(nil),            // 33: google.protobuf.Timestamp
	(*Schedule)(nil),                         // 34: flyteidl.admin.Schedule
	(*Notification)(nil),                     // 35: flyteidl.admin.Notification
	(*anypb.Any)(nil),                        // 36: google.protobuf.Any
	(*NamedEntityIdentifier)(nil),            // 37: flyteidl.admin.NamedEntityIdentifier
	(*Sort)(nil),                             // 38: flyteidl.admin.Sort
	(*core.Node)(nil),                        // 39: flyteidl.core.Node
}
var file_flyteidl_admin_launch_plan_proto_depIdxs = []int32{
	19, // 0: flyteidl.admin.LaunchPlanCreateRequest.id:type_name -> flyteidl.core.Identifier
	7,  // 1: flyteidl.admin.LaunchPlanCreateRequest.spec:type_name -> flyteidl.admin.LaunchPlanSpec
	19, // 2: flyteidl.admin.LaunchPlan.id:type_name -> flyteidl.core.Identifier
	...
	19, // 6: flyteidl.admin.LaunchPlanSpec.workflow_id:type_name -> flyteidl.core.Identifier
	10, // 7: flyteidl.admin.LaunchPlanSpec.entity_metadata:type_name -> flyteidl.admin.LaunchPlanMetadata
	20, // 8: flyteidl.admin.LaunchPlanSpec.default_inputs:type_name -> flyteidl.core.ParameterMap
	21, // 9: flyteidl.admin.LaunchPlanSpec.fixed_inputs:type_name -> flyteidl.core.LiteralMap
	22, // 10: flyteidl.admin.LaunchPlanSpec.labels:type_name -> flyteidl.admin.Labels
	23, // 11: flyteidl.admin.LaunchPlanSpec.annotations:type_name -> flyteidl.admin.Annotations
	6,  // 12: flyteidl.admin.LaunchPlanSpec.auth:type_name -> flyteidl.admin.Auth
	24, // 13: flyteidl.admin.LaunchPlanSpec.auth_role:type_name -> flyteidl.admin.AuthRole
	25, // 14: flyteidl.admin.LaunchPlanSpec.security_context:type_name -> flyteidl.core.SecurityContext
	26, // 15: flyteidl.admin.LaunchPlanSpec.quality_of_service:type_name -> flyteidl.core.QualityOfService
	27, // 16: flyteidl.admin.LaunchPlanSpec.raw_output_data_config:type_name -> flyteidl.admin.RawOutputDataConfig
	28, // 17: flyteidl.admin.LaunchPlanSpec.interruptible:type_name -> google.protobuf.BoolValue
	29, // 18: flyteidl.admin.LaunchPlanSpec.envs:type_name -> flyteidl.admin.Envs
	30, // 19: flyteidl.admin.LaunchPlanSpec.execution_env_assignments:type_name -> flyteidl.core.ExecutionEnvAssignment
	31, // 20: flyteidl.admin.LaunchPlanSpec.cluster_assignment:type_name -> flyteidl.admin.ClusterAssignment
	8,  // 21: flyteidl.admin.LaunchPlanSpec.concurrency_policy:type_name -> flyteidl.admin.ConcurrencyPolicy
	1,  // 22: flyteidl.admin.ConcurrencyPolicy.behavior:type_name -> flyteidl.admin.ConcurrencyLimitBehavior
	0,  // 23: flyteidl.admin.LaunchPlanClosure.state:type_name -> flyteidl.admin.LaunchPlanState
	20, // 24: flyteidl.admin.LaunchPlanClosure.expected_inputs:type_name -> flyteidl.core.ParameterMap
	32, // 25: flyteidl.admin.LaunchPlanClosure.expected_outputs:type_name -> flyteidl.core.VariableMap
	33, // 26: flyteidl.admin.LaunchPlanClosure.created_at:type_name -> google.protobuf.Timestamp
	33, // 27: flyteidl.admin.LaunchPlanClosure.updated_at:type_name -> google.protobuf.Timestamp
	34, // 28: flyteidl.admin.LaunchPlanMetadata.schedule:type_name -> flyteidl.admin.Schedule
	35, // 29: flyteidl.admin.LaunchPlanMetadata.notifications:type_name -> flyteidl.admin.Notification
	36, // 30: flyteidl.admin.LaunchPlanMetadata.launch_conditions:type_name -> google.protobuf.Any
	19, // 31: flyteidl.admin.LaunchPlanUpdateRequest.id:type_name -> flyteidl.core.Identifier
	0,  // 32: flyteidl.admin.LaunchPlanUpdateRequest.state:type_name -> flyteidl.admin.LaunchPlanState
	37, // 33: flyteidl.admin.ActiveLaunchPlanRequest.id:type_name -> flyteidl.admin.NamedEntityIdentifier
	38, // 34: flyteidl.admin.ActiveLaunchPlanListRequest.sort_by:type_name -> flyteidl.admin.Sort
	15, // 35: flyteidl.admin.SubNodeList.sub_node_ids:type_name -> flyteidl.admin.SubNodeIdAsList
	19, // 36: flyteidl.admin.CreateLaunchPlanFromNodeRequest.launch_plan_id:type_name -> flyteidl.core.Identifier
	16, // 37: flyteidl.admin.CreateLaunchPlanFromNodeRequest.sub_node_ids:type_name -> flyteidl.admin.SubNodeList
	39, // 38: flyteidl.admin.CreateLaunchPlanFromNodeRequest.sub_node_spec:type_name -> flyteidl.core.Node
	25, // 39: flyteidl.admin.CreateLaunchPlanFromNodeRequest.security_context:type_name -> flyteidl.core.SecurityContext
	4,  // 40: flyteidl.admin.CreateLaunchPlanFromNodeResponse.launch_plan:type_name -> flyteidl.admin.LaunchPlan
...
func file_flyteidl_admin_launch_plan_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_flyteidl_admin_launch_plan_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl_admin_launch_plan_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
	...
	file_flyteidl_admin_launch_plan_proto_msgTypes[15].OneofWrappers = []interface{}{
		(*CreateLaunchPlanFromNodeRequest_SubNodeIds)(nil),
		(*CreateLaunchPlanFromNodeRequest_SubNodeSpec)(nil),
	}
	type x struct{}
