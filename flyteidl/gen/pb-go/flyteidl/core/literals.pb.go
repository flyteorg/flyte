...
func (x *InputData) GetInputs() *LiteralMap {
	if x != nil {
		return x.Inputs
	}
	return nil
...
func (x *OutputData) GetOutputs() *LiteralMap {
	if x != nil {
		return x.Outputs
	}
	return nil
...
var file_flyteidl_core_literals_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x3e, 0x0a, 0x09, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x44,
	0x61, 0x74, 0x61, 0x12, 0x31, 0x0a, 0x06, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x18, 0x01, 0x20,
	...
	0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x22, 0x41, 0x0a, 0x0a, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74,
	0x44, 0x61, 0x74, 0x61, 0x12, 0x33, 0x0a, 0x07, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x18,
	...
	0x52, 0x07, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x22, 0x4f, 0x0a, 0x15, 0x42, 0x69, 0x6e,
	...
	0x72, 0x67, 0x65, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0xae, 0x02, 0x0a, 0x0b, 0x42, 0x69, 0x6e,
...
var file_flyteidl_core_literals_proto_goTypes = []interface{}{
	...
	(*InputData)(nil),                 // 13: flyteidl.core.InputData
	(*OutputData)(nil),                // 14: flyteidl.core.OutputData
...
var file_flyteidl_core_literals_proto_depIdxs = []int32{
	...
	22, // 21: flyteidl.core.Literal.metadata:type_name -> flyteidl.core.Literal.MetadataEntry
	10, // 22: flyteidl.core.LiteralCollection.literals:type_name -> flyteidl.core.Literal
	23, // 23: flyteidl.core.LiteralMap.literals:type_name -> flyteidl.core.LiteralMap.LiteralsEntry
	12, // 24: flyteidl.core.InputData.inputs:type_name -> flyteidl.core.LiteralMap
	12, // 25: flyteidl.core.OutputData.outputs:type_name -> flyteidl.core.LiteralMap
	...
	15, // 30: flyteidl.core.BindingData.collection:type_name -> flyteidl.core.BindingDataCollection
	33, // 31: flyteidl.core.BindingData.promise:type_name -> flyteidl.core.OutputReference
	16, // 32: flyteidl.core.BindingData.map:type_name -> flyteidl.core.BindingDataMap
	17, // 33: flyteidl.core.BindingData.union:type_name -> flyteidl.core.UnionInfo
	18, // 34: flyteidl.core.Binding.binding:type_name -> flyteidl.core.BindingData
	10, // 35: flyteidl.core.LiteralMap.LiteralsEntry.value:type_name -> flyteidl.core.Literal
	18, // 36: flyteidl.core.BindingDataMap.BindingsEntry.value:type_name -> flyteidl.core.BindingData
