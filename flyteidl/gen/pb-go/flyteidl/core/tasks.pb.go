...
var file_flyteidl_core_tasks_proto_rawDesc = []byte{
	...
	0x5f, 0x53, 0x44, 0x4b, 0x10, 0x01, 0x22, 0xdf, 0x06, 0x0a, 0x0c, 0x54, 0x61, 0x73, 0x6b, 0x4d,
	...
	0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x36, 0x0a, 0x09, 0x63, 0x61,
	0x63, 0x68, 0x65, 0x5f, 0x74, 0x74, 0x6c, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x08, 0x63, 0x61, 0x63, 0x68, 0x65, 0x54,
	0x74, 0x6c, 0x1a, 0x37, 0x0a, 0x09, 0x54, 0x61, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
...
var file_flyteidl_core_tasks_proto_depIdxs = []int32{
	...
	26, // 11: flyteidl.core.TaskMetadata.cache_ttl:type_name -> google.protobuf.Duration
	29, // 12: flyteidl.core.TaskTemplate.id:type_name -> flyteidl.core.Identifier
	12, // 13: flyteidl.core.TaskTemplate.metadata:type_name -> flyteidl.core.TaskMetadata
	30, // 14: flyteidl.core.TaskTemplate.interface:type_name -> flyteidl.core.TypedInterface
	31, // 15: flyteidl.core.TaskTemplate.custom:type_name -> google.protobuf.Struct
	15, // 16: flyteidl.core.TaskTemplate.container:type_name -> flyteidl.core.Container
	18, // 17: flyteidl.core.TaskTemplate.k8s_pod:type_name -> flyteidl.core.K8sPod
	20, // 18: flyteidl.core.TaskTemplate.sql:type_name -> flyteidl.core.Sql
	32, // 19: flyteidl.core.TaskTemplate.security_context:type_name -> flyteidl.core.SecurityContext
	10, // 20: flyteidl.core.TaskTemplate.extended_resources:type_name -> flyteidl.core.ExtendedResources
	23, // 21: flyteidl.core.TaskTemplate.config:type_name -> flyteidl.core.TaskTemplate.ConfigEntry
	7,  // 22: flyteidl.core.Container.resources:type_name -> flyteidl.core.Resources
	33, // 23: flyteidl.core.Container.env:type_name -> flyteidl.core.KeyValuePair
	33, // 24: flyteidl.core.Container.config:type_name -> flyteidl.core.KeyValuePair
	14, // 25: flyteidl.core.Container.ports:type_name -> flyteidl.core.ContainerPort
	17, // 26: flyteidl.core.Container.data_config:type_name -> flyteidl.core.DataLoadingConfig
	2,  // 27: flyteidl.core.Container.architecture:type_name -> flyteidl.core.Container.Architecture
	3,  // 28: flyteidl.core.IOStrategy.download_mode:type_name -> flyteidl.core.IOStrategy.DownloadMode
	4,  // 29: flyteidl.core.IOStrategy.upload_mode:type_name -> flyteidl.core.IOStrategy.UploadMode
	5,  // 30: flyteidl.core.DataLoadingConfig.format:type_name -> flyteidl.core.DataLoadingConfig.LiteralMapFormat
	16, // 31: flyteidl.core.DataLoadingConfig.io_strategy:type_name -> flyteidl.core.IOStrategy
	19, // 32: flyteidl.core.K8sPod.metadata:type_name -> flyteidl.core.K8sObjectMetadata
	31, // 33: flyteidl.core.K8sPod.pod_spec:type_name -> google.protobuf.Struct
	17, // 34: flyteidl.core.K8sPod.data_config:type_name -> flyteidl.core.DataLoadingConfig
	24, // 35: flyteidl.core.K8sObjectMetadata.labels:type_name -> flyteidl.core.K8sObjectMetadata.LabelsEntry
	25, // 36: flyteidl.core.K8sObjectMetadata.annotations:type_name -> flyteidl.core.K8sObjectMetadata.AnnotationsEntry
	6,  // 37: flyteidl.core.Sql.dialect:type_name -> flyteidl.core.Sql.Dialect
