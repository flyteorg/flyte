...
var file_flyteidl_core_workflow_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x48, 0x00, 0x52, 0x0f, 0x6d, 0x69, 0x6e, 0x53, 0x75, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x42, 0x12, 0x0a, 0x10, 0x73, 0x75, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x5f, 0x63, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x61, 0x22, 0xce, 0x01,
	0x0a, 0x0c, 0x4e, 0x6f, 0x64, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x12,
	0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x12, 0x33, 0x0a, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x26, 0x0a, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x72, 0x75, 0x70, 0x74, 0x69, 0x62, 0x6c, 0x65,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x72,
	0x75, 0x70, 0x74, 0x69, 0x62, 0x6c, 0x65, 0x42, 0x15, 0x0a, 0x13, 0x69, 0x6e, 0x74, 0x65, 0x72,
	0x72, 0x75, 0x70, 0x74, 0x69, 0x62, 0x6c, 0x65, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x2f,
	...
	0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x22, 0xc5, 0x01, 0x0a, 0x11, 0x54, 0x61, 0x73, 0x6b,
...
var file_flyteidl_core_workflow_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_flyteidl_core_workflow_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_flyteidl_core_workflow_proto_goTypes = []interface{}{
	(WorkflowMetadata_OnFailurePolicy)(0), // 0: flyteidl.core.WorkflowMetadata.OnFailurePolicy
	(*IfBlock)(nil),                       // 1: flyteidl.core.IfBlock
	(*IfElseBlock)(nil),                   // 2: flyteidl.core.IfElseBlock
	...
	(*WorkflowTemplate)(nil),              // 16: flyteidl.core.WorkflowTemplate
	(*TaskNodeOverrides)(nil),             // 17: flyteidl.core.TaskNodeOverrides
	nil,                                   // 18: flyteidl.core.WorkflowMetadata.TagsEntry
	(*BooleanExpression)(nil),             // 19: flyteidl.core.BooleanExpression
	(*Error)(nil),                         // 20: flyteidl.core.Error
	(*Identifier)(nil),                    // 21: flyteidl.core.Identifier
	(*LiteralType)(nil),                   // 22: flyteidl.core.LiteralType
	(*durationpb.Duration)(nil),           // 23: google.protobuf.Duration
	(*RetryStrategy)(nil),                 // 24: flyteidl.core.RetryStrategy
	(*Binding)(nil),                       // 25: flyteidl.core.Binding
	(*QualityOfService)(nil),              // 26: flyteidl.core.QualityOfService
	(*TypedInterface)(nil),                // 27: flyteidl.core.TypedInterface
	(*Resources)(nil),                     // 28: flyteidl.core.Resources
	(*ExtendedResources)(nil),             // 29: flyteidl.core.ExtendedResources
}
var file_flyteidl_core_workflow_proto_depIdxs = []int32{
	19, // 0: flyteidl.core.IfBlock.condition:type_name -> flyteidl.core.BooleanExpression
	13, // 1: flyteidl.core.IfBlock.then_node:type_name -> flyteidl.core.Node
	1,  // 2: flyteidl.core.IfElseBlock.case:type_name -> flyteidl.core.IfBlock
	1,  // 3: flyteidl.core.IfElseBlock.other:type_name -> flyteidl.core.IfBlock
	13, // 4: flyteidl.core.IfElseBlock.else_node:type_name -> flyteidl.core.Node
	20, // 5: flyteidl.core.IfElseBlock.error:type_name -> flyteidl.core.Error
	2,  // 6: flyteidl.core.BranchNode.if_else:type_name -> flyteidl.core.IfElseBlock
	21, // 7: flyteidl.core.TaskNode.reference_id:type_name -> flyteidl.core.Identifier
	17, // 8: flyteidl.core.TaskNode.overrides:type_name -> flyteidl.core.TaskNodeOverrides
	21, // 9: flyteidl.core.WorkflowNode.launchplan_ref:type_name -> flyteidl.core.Identifier
	21, // 10: flyteidl.core.WorkflowNode.sub_workflow_ref:type_name -> flyteidl.core.Identifier
	22, // 11: flyteidl.core.SignalCondition.type:type_name -> flyteidl.core.LiteralType
	23, // 12: flyteidl.core.SleepCondition.duration:type_name -> google.protobuf.Duration
	6,  // 13: flyteidl.core.GateNode.approve:type_name -> flyteidl.core.ApproveCondition
	7,  // 14: flyteidl.core.GateNode.signal:type_name -> flyteidl.core.SignalCondition
	8,  // 15: flyteidl.core.GateNode.sleep:type_name -> flyteidl.core.SleepCondition
	13, // 16: flyteidl.core.ArrayNode.node:type_name -> flyteidl.core.Node
	23, // 17: flyteidl.core.NodeMetadata.timeout:type_name -> google.protobuf.Duration
	24, // 18: flyteidl.core.NodeMetadata.retries:type_name -> flyteidl.core.RetryStrategy
	11, // 19: flyteidl.core.Node.metadata:type_name -> flyteidl.core.NodeMetadata
	25, // 20: flyteidl.core.Node.inputs:type_name -> flyteidl.core.Binding
	12, // 21: flyteidl.core.Node.output_aliases:type_name -> flyteidl.core.Alias
	4,  // 22: flyteidl.core.Node.task_node:type_name -> flyteidl.core.TaskNode
	5,  // 23: flyteidl.core.Node.workflow_node:type_name -> flyteidl.core.WorkflowNode
	3,  // 24: flyteidl.core.Node.branch_node:type_name -> flyteidl.core.BranchNode
	9,  // 25: flyteidl.core.Node.gate_node:type_name -> flyteidl.core.GateNode
	10, // 26: flyteidl.core.Node.array_node:type_name -> flyteidl.core.ArrayNode
	26, // 27: flyteidl.core.WorkflowMetadata.quality_of_service:type_name -> flyteidl.core.QualityOfService
	0,  // 28: flyteidl.core.WorkflowMetadata.on_failure:type_name -> flyteidl.core.WorkflowMetadata.OnFailurePolicy
	18, // 29: flyteidl.core.WorkflowMetadata.tags:type_name -> flyteidl.core.WorkflowMetadata.TagsEntry
	21, // 30: flyteidl.core.WorkflowTemplate.id:type_name -> flyteidl.core.Identifier
	14, // 31: flyteidl.core.WorkflowTemplate.metadata:type_name -> flyteidl.core.WorkflowMetadata
	27, // 32: flyteidl.core.WorkflowTemplate.interface:type_name -> flyteidl.core.TypedInterface
	13, // 33: flyteidl.core.WorkflowTemplate.nodes:type_name -> flyteidl.core.Node
	25, // 34: flyteidl.core.WorkflowTemplate.outputs:type_name -> flyteidl.core.Binding
	13, // 35: flyteidl.core.WorkflowTemplate.failure_node:type_name -> flyteidl.core.Node
	15, // 36: flyteidl.core.WorkflowTemplate.metadata_defaults:type_name -> flyteidl.core.WorkflowMetadataDefaults
	28, // 37: flyteidl.core.TaskNodeOverrides.resources:type_name -> flyteidl.core.Resources
	29, // 38: flyteidl.core.TaskNodeOverrides.extended_resources:type_name -> flyteidl.core.ExtendedResources
