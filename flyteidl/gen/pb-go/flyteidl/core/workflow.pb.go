...
var file_flyteidl_core_workflow_proto_rawDesc = []byte{
	...
	0xc5, 0x01, 0x0a, 0x11, 0x54, 0x61, 0x73, 0x6b, 0x4e, 0x6f, 0x64, 0x65, 0x4f, 0x76, 0x65, 0x72,
	...
	0x65, 0x72, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x22, 0xba, 0x01, 0x0a, 0x12, 0x4c, 0x61, 0x75, 0x6e,
	0x63, 0x68, 0x50, 0x6c, 0x61, 0x6e, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x29,
	...
	0x69, 0x66, 0x69, 0x65, 0x72, 0x52, 0x02, 0x69, 0x64, 0x12, 0x3b, 0x0a, 0x09, 0x69, 0x6e, 0x74,
	...
	0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x12, 0x3c, 0x0a, 0x0c, 0x66, 0x69, 0x78, 0x65, 0x64, 0x5f,
	...
	0x70, 0x75, 0x74, 0x73, 0x42, 0xb3, 0x01, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x79,
	0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x42, 0x0d, 0x57, 0x6f, 0x72, 0x6b,
	0x66, 0x6c, 0x6f, 0x77, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3a, 0x67, 0x69, 0x74,
...
var file_flyteidl_core_workflow_proto_goTypes = []interface{}{
	...
	(*Binding)(nil),                       // 29: flyteidl.core.Binding
	(*QualityOfService)(nil),              // 30: flyteidl.core.QualityOfService
	(*TypedInterface)(nil),                // 31: flyteidl.core.TypedInterface
	(*Resources)(nil),                     // 32: flyteidl.core.Resources
	(*ExtendedResources)(nil),             // 33: flyteidl.core.ExtendedResources
	(*LiteralMap)(nil),                    // 34: flyteidl.core.LiteralMap
}
var file_flyteidl_core_workflow_proto_depIdxs = []int32{
	...
	29, // 23: flyteidl.core.Node.inputs:type_name -> flyteidl.core.Binding
	...
	30, // 30: flyteidl.core.WorkflowMetadata.quality_of_service:type_name -> flyteidl.core.QualityOfService
	...
	24, // 33: flyteidl.core.WorkflowTemplate.id:type_name -> flyteidl.core.Identifier
	16, // 34: flyteidl.core.WorkflowTemplate.metadata:type_name -> flyteidl.core.WorkflowMetadata
	31, // 35: flyteidl.core.WorkflowTemplate.interface:type_name -> flyteidl.core.TypedInterface
	15, // 36: flyteidl.core.WorkflowTemplate.nodes:type_name -> flyteidl.core.Node
	29, // 37: flyteidl.core.WorkflowTemplate.outputs:type_name -> flyteidl.core.Binding
	...
	32, // 40: flyteidl.core.TaskNodeOverrides.resources:type_name -> flyteidl.core.Resources
	33, // 41: flyteidl.core.TaskNodeOverrides.extended_resources:type_name -> flyteidl.core.ExtendedResources
	24, // 42: flyteidl.core.LaunchPlanTemplate.id:type_name -> flyteidl.core.Identifier
	31, // 43: flyteidl.core.LaunchPlanTemplate.interface:type_name -> flyteidl.core.TypedInterface
	34, // 44: flyteidl.core.LaunchPlanTemplate.fixed_inputs:type_name -> flyteidl.core.LiteralMap
