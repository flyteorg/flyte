...
var file_flyteidl_cacheservice_cacheservice_proto_rawDesc = []byte{
	...
	,
...
var file_flyteidl_cacheservice_cacheservice_proto_depIdxs = []int32{
	...
	19, // 8: flyteidl.cacheservice.OverwriteOutput.max_age:type_name -> google.protobuf.Duration
	2,  // 9: flyteidl.cacheservice.PutCacheRequest.output:type_name -> flyteidl.cacheservice.CachedOutput
	5,  // 10: flyteidl.cacheservice.PutCacheRequest.overwrite:type_name -> flyteidl.cacheservice.OverwriteOutput
	19, // 11: flyteidl.cacheservice.Reservation.heartbeat_interval:type_name -> google.protobuf.Duration
	17, // 12: flyteidl.cacheservice.Reservation.expires_at:type_name -> google.protobuf.Timestamp
	19, // 13: flyteidl.cacheservice.GetOrExtendReservationRequest.heartbeat_interval:type_name -> google.protobuf.Duration
	10, // 14: flyteidl.cacheservice.GetOrExtendReservationResponse.reservation:type_name -> flyteidl.cacheservice.Reservation
	3,  // 15: flyteidl.cacheservice.CacheService.Get:input_type -> flyteidl.cacheservice.GetCacheRequest
	6,  // 16: flyteidl.cacheservice.CacheService.Put:input_type -> flyteidl.cacheservice.PutCacheRequest
	8,  // 17: flyteidl.cacheservice.CacheService.Delete:input_type -> flyteidl.cacheservice.DeleteCacheRequest
	11, // 18: flyteidl.cacheservice.CacheService.GetOrExtendReservation:input_type -> flyteidl.cacheservice.GetOrExtendReservationRequest
	13, // 19: flyteidl.cacheservice.CacheService.ReleaseReservation:input_type -> flyteidl.cacheservice.ReleaseReservationRequest
	4,  // 20: flyteidl.cacheservice.CacheService.Get:output_type -> flyteidl.cacheservice.GetCacheResponse
	7,  // 21: flyteidl.cacheservice.CacheService.Put:output_type -> flyteidl.cacheservice.PutCacheResponse
	9,  // 22: flyteidl.cacheservice.CacheService.Delete:output_type -> flyteidl.cacheservice.DeleteCacheResponse
	12, // 23: flyteidl.cacheservice.CacheService.GetOrExtendReservation:output_type -> flyteidl.cacheservice.GetOrExtendReservationResponse
	14, // 24: flyteidl.cacheservice.CacheService.ReleaseReservation:output_type -> flyteidl.cacheservice.ReleaseReservationResponse
