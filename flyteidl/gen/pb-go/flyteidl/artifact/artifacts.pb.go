...
type ArtifactSource struct {
	...
	TaskExecution *core.TaskExecutionIdentifier `protobuf:"bytes,1,opt,name=task_execution,json=taskExecution,proto3" json:"task_execution,omitempty"`
	// Workflow outputs will have this.
	NodeExecution *core.NodeExecutionIdentifier `protobuf:"bytes,2,opt,name=node_execution,json=nodeExecution,proto3" json:"node_execution,omitempty"`
...
func (m *ArtifactSource) GetTaskExecution() *core.TaskExecutionIdentifier {
	if m != nil {
...
func (m *ArtifactSource) GetNodeExecution() *core.NodeExecutionIdentifier {
	if m != nil {
		return m.NodeExecution
	}
	return nil
}
...
type SearchOptions struct {
	...
	FetchSpecs           bool     `protobuf:"varint,3,opt,name=fetch_specs,json=fetchSpecs,proto3" json:"fetch_specs,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SearchOptions) GetFetchSpecs() bool {
	if m != nil {
		return m.FetchSpecs
	}
	return false
...
var fileDescriptor_804518da5936dedb = []byte{
	...
	,
}
