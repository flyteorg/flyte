...
func (m *DatasetID) GetPartition() string {
	if m != nil {
		return m.Partition
	}
	return ""
...
type DatasetPropertyFilter struct {
	...
	//	*DatasetPropertyFilter_Partition
...
type DatasetPropertyFilter_Partition struct {
	Partition string `protobuf:"bytes,5,opt,name=partition,proto3,oneof"`
}
...
func (*DatasetPropertyFilter_Partition) isDatasetPropertyFilter_Property() {}
...
func (m *DatasetPropertyFilter) GetPartition() string {
	if x, ok := m.GetProperty().(*DatasetPropertyFilter_Partition); ok {
		return x.Partition
	}
	return ""
}
...
func (*DatasetPropertyFilter) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*DatasetPropertyFilter_Partition)(nil),
	}
}
...
var fileDescriptor_275951237ff4368a = []byte{
	...
	,
}
