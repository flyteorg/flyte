...
type Card_CardType int32

const (
	Card_UNKNOWN Card_CardType = 0
	Card_MODEL   Card_CardType = 1
	Card_DATASET Card_CardType = 2
)

// Enum value maps for Card_CardType.
var (
	Card_CardType_name = map[int32]string{
		0: "UNKNOWN",
		1: "MODEL",
		2: "DATASET",
	}
	Card_CardType_value = map[string]int32{
		"UNKNOWN": 0,
		"MODEL":   1,
		"DATASET": 2,
	}
...
func (x Card_CardType) Enum() *Card_CardType {
	p := new(Card_CardType)
	*p = x
	return p
}

func (x Card_CardType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Card_CardType) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl_artifacts_artifacts_proto_enumTypes[0].Descriptor()
}

func (Card_CardType) Type() protoreflect.EnumType {
	return &file_flyteidl_artifacts_artifacts_proto_enumTypes[0]
}

func (x Card_CardType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Card_CardType.Descriptor instead.
func (Card_CardType) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl_artifacts_artifacts_proto_rawDescGZIP(), []int{4, 0}
}

type Card_TextType int32

const (
	Card_MARKDOWN Card_TextType = 0
)

// Enum value maps for Card_TextType.
var (
	Card_TextType_name = map[int32]string{
		0: "MARKDOWN",
	}
	Card_TextType_value = map[string]int32{
		"MARKDOWN": 0,
	}
)

func (x Card_TextType) Enum() *Card_TextType {
	p := new(Card_TextType)
	*p = x
	return p
}

func (x Card_TextType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Card_TextType) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl_artifacts_artifacts_proto_enumTypes[1].Descriptor()
}

func (Card_TextType) Type() protoreflect.EnumType {
	return &file_flyteidl_artifacts_artifacts_proto_enumTypes[1]
}

func (x Card_TextType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Card_TextType.Descriptor instead.
func (Card_TextType) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl_artifacts_artifacts_proto_rawDescGZIP(), []int{4, 1}
}
...
func (FindByWorkflowExecRequest_Direction) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl_artifacts_artifacts_proto_enumTypes[2].Descriptor()
}

func (FindByWorkflowExecRequest_Direction) Type() protoreflect.EnumType {
	return &file_flyteidl_artifacts_artifacts_proto_enumTypes[2]
}
...
func (FindByWorkflowExecRequest_Direction) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl_artifacts_artifacts_proto_rawDescGZIP(), []int{13, 0}
}
...
type Card struct {
	...
	Type     Card_CardType `protobuf:"varint,2,opt,name=type,proto3,enum=flyteidl.artifact.Card_CardType" json:"type,omitempty"`
	Body     string        `protobuf:"bytes,3,opt,name=body,proto3" json:"body,omitempty"`
	TextType Card_TextType `protobuf:"varint,4,opt,name=text_type,json=textType,proto3,enum=flyteidl.artifact.Card_TextType" json:"text_type,omitempty"`
}
...
func (x *Card) GetType() Card_CardType {
	if x != nil {
		return x.Type
	}
	return Card_UNKNOWN
...
func (x *Card) GetTextType() Card_TextType {
	if x != nil {
		return x.TextType
	}
...
type SearchArtifactsRequest struct {
	...
	Granularity        core.Granularity       `protobuf:"varint,9,opt,name=granularity,proto3,enum=flyteidl.core.Granularity" json:"granularity,omitempty"`
}
...
func (x *SearchArtifactsRequest) GetGranularity() core.Granularity {
	if x != nil {
...
func (x *ListUsageResponse) Reset() {
	*x = ListUsageResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListUsageResponse) Descriptor() ([]byte, []int) {
	return file_flyteidl_artifacts_artifacts_proto_rawDescGZIP(), []int{32}
}
...
func (x *GetCardRequest) Reset() {
	*x = GetCardRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetCardRequest) Descriptor() ([]byte, []int) {
	return file_flyteidl_artifacts_artifacts_proto_rawDescGZIP(), []int{33}
}

func (x *GetCardRequest) GetArtifactId() *core.ArtifactID {
	if x != nil {
		return x.ArtifactId
	}
	return nil
...
func (x *GetCardResponse) Reset() {
	*x = GetCardResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetCardResponse) Descriptor() ([]byte, []int) {
	return file_flyteidl_artifacts_artifacts_proto_rawDescGZIP(), []int{34}
}
...
type GetTriggeringArtifactsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetTriggeringArtifactsRequest) Reset() {
	*x = GetTriggeringArtifactsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[35]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetTriggeringArtifactsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTriggeringArtifactsRequest) ProtoMessage() {}

func (x *GetTriggeringArtifactsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[35]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTriggeringArtifactsRequest.ProtoReflect.Descriptor instead.
func (*GetTriggeringArtifactsRequest) Descriptor() ([]byte, []int) {
	return file_flyteidl_artifacts_artifacts_proto_rawDescGZIP(), []int{35}
}

func (x *GetTriggeringArtifactsRequest) GetExecutions() []*core.WorkflowExecutionIdentifier {
	if x != nil {
		return x.Executions
	}
	return nil
...
type GetTriggeringArtifactsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Artifacts map[string]*core.ArtifactID `protobuf:"bytes,1,rep,name=artifacts,proto3" json:"artifacts,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *GetTriggeringArtifactsResponse) Reset() {
	*x = GetTriggeringArtifactsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[36]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetTriggeringArtifactsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTriggeringArtifactsResponse) ProtoMessage() {}

func (x *GetTriggeringArtifactsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTriggeringArtifactsResponse.ProtoReflect.Descriptor instead.
func (*GetTriggeringArtifactsResponse) Descriptor() ([]byte, []int) {
	return file_flyteidl_artifacts_artifacts_proto_rawDescGZIP(), []int{36}
}

func (x *GetTriggeringArtifactsResponse) GetArtifacts() map[string]*core.ArtifactID {
	if x != nil {
		return x.Artifacts
	}
	return nil
...
type GetTriggeredExecutionsByArtifactRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetTriggeredExecutionsByArtifactRequest) Reset() {
	*x = GetTriggeredExecutionsByArtifactRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[37]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetTriggeredExecutionsByArtifactRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTriggeredExecutionsByArtifactRequest) ProtoMessage() {}

func (x *GetTriggeredExecutionsByArtifactRequest) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[37]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTriggeredExecutionsByArtifactRequest.ProtoReflect.Descriptor instead.
func (*GetTriggeredExecutionsByArtifactRequest) Descriptor() ([]byte, []int) {
	return file_flyteidl_artifacts_artifacts_proto_rawDescGZIP(), []int{37}
}

func (x *GetTriggeredExecutionsByArtifactRequest) GetArtifactId() *core.ArtifactID {
	if x != nil {
		return x.ArtifactId
	}
	return nil
...
type GetTriggeredExecutionsByArtifactResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetTriggeredExecutionsByArtifactResponse) Reset() {
	*x = GetTriggeredExecutionsByArtifactResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[38]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetTriggeredExecutionsByArtifactResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTriggeredExecutionsByArtifactResponse) ProtoMessage() {}

func (x *GetTriggeredExecutionsByArtifactResponse) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl_artifacts_artifacts_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTriggeredExecutionsByArtifactResponse.ProtoReflect.Descriptor instead.
func (*GetTriggeredExecutionsByArtifactResponse) Descriptor() ([]byte, []int) {
	return file_flyteidl_artifacts_artifacts_proto_rawDescGZIP(), []int{38}
}

func (x *GetTriggeredExecutionsByArtifactResponse) GetExecutions() []*core.WorkflowExecutionIdentifier {
	if x != nil {
		return x.Executions
	}
	return nil
...
var file_flyteidl_artifacts_artifacts_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x22, 0xec, 0x01, 0x0a, 0x04, 0x43, 0x61, 0x72,
	0x64, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72, 0x69, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	0x75, 0x72, 0x69, 0x12, 0x34, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x20, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e, 0x61, 0x72, 0x74,
	0x69, 0x66, 0x61, 0x63, 0x74, 0x2e, 0x43, 0x61, 0x72, 0x64, 0x2e, 0x43, 0x61, 0x72, 0x64, 0x54,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x3c, 0x0a, 0x0d, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6d, 0x65, 0x74, 0x61,
	...
	,
	...
	0x72, 0x4d, 0x61, 0x70, 0x52, 0x0d, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x49, 0x6e, 0x70,
	0x75, 0x74, 0x73, 0x22, 0x51, 0x0a, 0x16, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x72, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x3a, 0x0a, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65,
	0x69, 0x64, 0x6c, 0x2e, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x2e, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x07, 0x6f, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x07, 0x20, 0x01,
	...
	0x3c, 0x0a, 0x0b, 0x67, 0x72, 0x61, 0x6e, 0x75, 0x6c, 0x61, 0x72, 0x69, 0x74, 0x79, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e,
	0x63, 0x6f, 0x72, 0x65, 0x2e, 0x47, 0x72, 0x61, 0x6e, 0x75, 0x6c, 0x61, 0x72, 0x69, 0x74, 0x79,
	0x52, 0x0b, 0x67, 0x72, 0x61, 0x6e, 0x75, 0x6c, 0x61, 0x72, 0x69, 0x74, 0x79, 0x22, 0x6a, 0x0a,
	0x17, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x09, 0x61, 0x72, 0x74, 0x69,
	0x66, 0x61, 0x63, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x66, 0x6c,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xdc, 0x01, 0x0a, 0x19, 0x46, 0x69,
	0x6e, 0x64, 0x42, 0x79, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x45, 0x78, 0x65, 0x63,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x43, 0x0a, 0x07, 0x65, 0x78, 0x65, 0x63, 0x5f,
	...
	,
	...
	0x6f, 0x76, 0x65, 0x72, 0x77, 0x72, 0x69, 0x74, 0x65, 0x22, 0x10, 0x0a, 0x0e, 0x41, 0x64, 0x64,
	0x54, 0x61, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x52, 0x0a, 0x16, 0x41,
	0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x38, 0x0a, 0x0a, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72,
	...
	0x66, 0x69, 0x65, 0x72, 0x52, 0x09, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x49, 0x64, 0x22,
	0x19, 0x0a, 0x17, 0x41, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x54, 0x72, 0x69, 0x67, 0x67,
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x62, 0x0a, 0x14, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x4a, 0x0a, 0x13, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x5f, 0x6c, 0x61,
	...
	0x2e, 0x4c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x50, 0x6c, 0x61, 0x6e, 0x52, 0x11, 0x74, 0x72, 0x69,
	0x67, 0x67, 0x65, 0x72, 0x4c, 0x61, 0x75, 0x6e, 0x63, 0x68, 0x50, 0x6c, 0x61, 0x6e, 0x22, 0x17,
	0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x54, 0x0a, 0x18, 0x44, 0x65, 0x61, 0x63, 0x74,
	0x69, 0x76, 0x61, 0x74, 0x65, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x38, 0x0a, 0x0a, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x5f, 0x69,
	...
	,
	...
	0x64, 0x12, 0x34, 0x0a, 0x07, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	0x74, 0x49, 0x44, 0x52, 0x0a, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x49, 0x64, 0x22,
	0x3e, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x43, 0x61, 0x72, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x2b, 0x0a, 0x04, 0x63, 0x61, 0x72, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x17, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e, 0x61, 0x72, 0x74, 0x69,
	0x66, 0x61, 0x63, 0x74, 0x2e, 0x43, 0x61, 0x72, 0x64, 0x52, 0x04, 0x63, 0x61, 0x72, 0x64, 0x22,
	0x6b, 0x0a, 0x1d, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x69, 0x6e, 0x67,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e,
	...
	,
	...
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0x9f, 0x12, 0x0a, 0x10, 0x41, 0x72, 0x74, 0x69,
	...
	,
	...
	,
	...
	,
	...
	0x2d, 0x67, 0x6f, 0x2f, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2f, 0x61, 0x72, 0x74,
	0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0xa2, 0x02, 0x03, 0x46, 0x41, 0x58, 0xaa, 0x02, 0x11, 0x46,
	0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74,
	0xca, 0x02, 0x11, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x5c, 0x41, 0x72, 0x74, 0x69,
	0x66, 0x61, 0x63, 0x74, 0xe2, 0x02, 0x1d, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x5c,
...
var file_flyteidl_artifacts_artifacts_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_flyteidl_artifacts_artifacts_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_flyteidl_artifacts_artifacts_proto_goTypes = []interface{}{
	(Card_CardType)(0),                               // 0: flyteidl.artifact.Card.CardType
	(Card_TextType)(0),                               // 1: flyteidl.artifact.Card.TextType
	(FindByWorkflowExecRequest_Direction)(0),         // 2: flyteidl.artifact.FindByWorkflowExecRequest.Direction
	(*Artifact)(nil),                                 // 3: flyteidl.artifact.Artifact
	(*ArtifactMetadata)(nil),                         // 4: flyteidl.artifact.ArtifactMetadata
	(*CreateArtifactRequest)(nil),                    // 5: flyteidl.artifact.CreateArtifactRequest
	(*ArtifactSource)(nil),                           // 6: flyteidl.artifact.ArtifactSource
	(*Card)(nil),                                     // 7: flyteidl.artifact.Card
	(*ArtifactSpec)(nil),                             // 8: flyteidl.artifact.ArtifactSpec
	(*Trigger)(nil),                                  // 9: flyteidl.artifact.Trigger
	(*CreateArtifactResponse)(nil),                   // 10: flyteidl.artifact.CreateArtifactResponse
	(*GetArtifactRequest)(nil),                       // 11: flyteidl.artifact.GetArtifactRequest
	(*GetArtifactResponse)(nil),                      // 12: flyteidl.artifact.GetArtifactResponse
	(*SearchOptions)(nil),                            // 13: flyteidl.artifact.SearchOptions
	(*SearchArtifactsRequest)(nil),                   // 14: flyteidl.artifact.SearchArtifactsRequest
	(*SearchArtifactsResponse)(nil),                  // 15: flyteidl.artifact.SearchArtifactsResponse
	(*FindByWorkflowExecRequest)(nil),                // 16: flyteidl.artifact.FindByWorkflowExecRequest
	(*AddTagRequest)(nil),                            // 17: flyteidl.artifact.AddTagRequest
	(*AddTagResponse)(nil),                           // 18: flyteidl.artifact.AddTagResponse
	(*ActivateTriggerRequest)(nil),                   // 19: flyteidl.artifact.ActivateTriggerRequest
	(*ActivateTriggerResponse)(nil),                  // 20: flyteidl.artifact.ActivateTriggerResponse
	(*CreateTriggerRequest)(nil),                     // 21: flyteidl.artifact.CreateTriggerRequest
	(*CreateTriggerResponse)(nil),                    // 22: flyteidl.artifact.CreateTriggerResponse
	(*DeactivateTriggerRequest)(nil),                 // 23: flyteidl.artifact.DeactivateTriggerRequest
	(*DeactivateTriggerResponse)(nil),                // 24: flyteidl.artifact.DeactivateTriggerResponse
	(*DeactivateAllTriggersRequest)(nil),             // 25: flyteidl.artifact.DeactivateAllTriggersRequest
	(*DeactivateAllTriggersResponse)(nil),            // 26: flyteidl.artifact.DeactivateAllTriggersResponse
	(*ArtifactProducer)(nil),                         // 27: flyteidl.artifact.ArtifactProducer
	(*RegisterProducerRequest)(nil),                  // 28: flyteidl.artifact.RegisterProducerRequest
	(*ArtifactConsumer)(nil),                         // 29: flyteidl.artifact.ArtifactConsumer
	(*RegisterConsumerRequest)(nil),                  // 30: flyteidl.artifact.RegisterConsumerRequest
	(*RegisterResponse)(nil),                         // 31: flyteidl.artifact.RegisterResponse
	(*ExecutionInputsRequest)(nil),                   // 32: flyteidl.artifact.ExecutionInputsRequest
	(*ExecutionInputsResponse)(nil),                  // 33: flyteidl.artifact.ExecutionInputsResponse
	(*ListUsageRequest)(nil),                         // 34: flyteidl.artifact.ListUsageRequest
	(*ListUsageResponse)(nil),                        // 35: flyteidl.artifact.ListUsageResponse
	(*GetCardRequest)(nil),                           // 36: flyteidl.artifact.GetCardRequest
	(*GetCardResponse)(nil),                          // 37: flyteidl.artifact.GetCardResponse
	(*GetTriggeringArtifactsRequest)(nil),            // 38: flyteidl.artifact.GetTriggeringArtifactsRequest
	(*GetTriggeringArtifactsResponse)(nil),           // 39: flyteidl.artifact.GetTriggeringArtifactsResponse
	(*GetTriggeredExecutionsByArtifactRequest)(nil),  // 40: flyteidl.artifact.GetTriggeredExecutionsByArtifactRequest
	(*GetTriggeredExecutionsByArtifactResponse)(nil), // 41: flyteidl.artifact.GetTriggeredExecutionsByArtifactResponse
	nil,                                      // 42: flyteidl.artifact.CreateArtifactRequest.PartitionsEntry
	nil,                                      // 43: flyteidl.artifact.GetTriggeringArtifactsResponse.ArtifactsEntry
	(*core.ArtifactID)(nil),                  // 44: flyteidl.core.ArtifactID
	(*timestamppb.Timestamp)(nil),            // 45: google.protobuf.Timestamp
	(*core.ArtifactKey)(nil),                 // 46: flyteidl.core.ArtifactKey
	(*core.WorkflowExecutionIdentifier)(nil), // 47: flyteidl.core.WorkflowExecutionIdentifier
	(*core.Identifier)(nil),                  // 48: flyteidl.core.Identifier
	(*core.Literal)(nil),                     // 49: flyteidl.core.Literal
	(*core.LiteralType)(nil),                 // 50: flyteidl.core.LiteralType
	(*structpb.Struct)(nil),                  // 51: google.protobuf.Struct
	(*core.ParameterMap)(nil),                // 52: flyteidl.core.ParameterMap
	(*core.ArtifactQuery)(nil),               // 53: flyteidl.core.ArtifactQuery
	(*core.Partitions)(nil),                  // 54: flyteidl.core.Partitions
	(core.Granularity)(0),                    // 55: flyteidl.core.Granularity
	(*admin.LaunchPlan)(nil),                 // 56: flyteidl.admin.LaunchPlan
	(*core.VariableMap)(nil),                 // 57: flyteidl.core.VariableMap
}
var file_flyteidl_artifacts_artifacts_proto_depIdxs = []int32{
	44, // 0: flyteidl.artifact.Artifact.artifact_id:type_name -> flyteidl.core.ArtifactID
	8,  // 1: flyteidl.artifact.Artifact.spec:type_name -> flyteidl.artifact.ArtifactSpec
	6,  // 2: flyteidl.artifact.Artifact.source:type_name -> flyteidl.artifact.ArtifactSource
	4,  // 3: flyteidl.artifact.Artifact.metadata:type_name -> flyteidl.artifact.ArtifactMetadata
	45, // 4: flyteidl.artifact.ArtifactMetadata.created_at:type_name -> google.protobuf.Timestamp
	46, // 5: flyteidl.artifact.CreateArtifactRequest.artifact_key:type_name -> flyteidl.core.ArtifactKey
	8,  // 6: flyteidl.artifact.CreateArtifactRequest.spec:type_name -> flyteidl.artifact.ArtifactSpec
	42, // 7: flyteidl.artifact.CreateArtifactRequest.partitions:type_name -> flyteidl.artifact.CreateArtifactRequest.PartitionsEntry
	45, // 8: flyteidl.artifact.CreateArtifactRequest.time_partition_value:type_name -> google.protobuf.Timestamp
	6,  // 9: flyteidl.artifact.CreateArtifactRequest.source:type_name -> flyteidl.artifact.ArtifactSource
	47, // 10: flyteidl.artifact.ArtifactSource.workflow_execution:type_name -> flyteidl.core.WorkflowExecutionIdentifier
	48, // 11: flyteidl.artifact.ArtifactSource.task_id:type_name -> flyteidl.core.Identifier
	0,  // 12: flyteidl.artifact.Card.type:type_name -> flyteidl.artifact.Card.CardType
	1,  // 13: flyteidl.artifact.Card.text_type:type_name -> flyteidl.artifact.Card.TextType
	49, // 14: flyteidl.artifact.ArtifactSpec.value:type_name -> flyteidl.core.Literal
	50, // 15: flyteidl.artifact.ArtifactSpec.type:type_name -> flyteidl.core.LiteralType
	51, // 16: flyteidl.artifact.ArtifactSpec.user_metadata:type_name -> google.protobuf.Struct
	7,  // 17: flyteidl.artifact.ArtifactSpec.card:type_name -> flyteidl.artifact.Card
	44, // 18: flyteidl.artifact.Trigger.trigger:type_name -> flyteidl.core.ArtifactID
	52, // 19: flyteidl.artifact.Trigger.trigger_inputs:type_name -> flyteidl.core.ParameterMap
	3,  // 20: flyteidl.artifact.CreateArtifactResponse.artifact:type_name -> flyteidl.artifact.Artifact
	53, // 21: flyteidl.artifact.GetArtifactRequest.query:type_name -> flyteidl.core.ArtifactQuery
	3,  // 22: flyteidl.artifact.GetArtifactResponse.artifact:type_name -> flyteidl.artifact.Artifact
	46, // 23: flyteidl.artifact.SearchArtifactsRequest.artifact_key:type_name -> flyteidl.core.ArtifactKey
	54, // 24: flyteidl.artifact.SearchArtifactsRequest.partitions:type_name -> flyteidl.core.Partitions
	45, // 25: flyteidl.artifact.SearchArtifactsRequest.time_partition_value:type_name -> google.protobuf.Timestamp
	13, // 26: flyteidl.artifact.SearchArtifactsRequest.options:type_name -> flyteidl.artifact.SearchOptions
	55, // 27: flyteidl.artifact.SearchArtifactsRequest.granularity:type_name -> flyteidl.core.Granularity
	3,  // 28: flyteidl.artifact.SearchArtifactsResponse.artifacts:type_name -> flyteidl.artifact.Artifact
	47, // 29: flyteidl.artifact.FindByWorkflowExecRequest.exec_id:type_name -> flyteidl.core.WorkflowExecutionIdentifier
	2,  // 30: flyteidl.artifact.FindByWorkflowExecRequest.direction:type_name -> flyteidl.artifact.FindByWorkflowExecRequest.Direction
	44, // 31: flyteidl.artifact.AddTagRequest.artifact_id:type_name -> flyteidl.core.ArtifactID
	48, // 32: flyteidl.artifact.ActivateTriggerRequest.trigger_id:type_name -> flyteidl.core.Identifier
	56, // 33: flyteidl.artifact.CreateTriggerRequest.trigger_launch_plan:type_name -> flyteidl.admin.LaunchPlan
	48, // 34: flyteidl.artifact.DeactivateTriggerRequest.trigger_id:type_name -> flyteidl.core.Identifier
	48, // 35: flyteidl.artifact.ArtifactProducer.entity_id:type_name -> flyteidl.core.Identifier
	57, // 36: flyteidl.artifact.ArtifactProducer.outputs:type_name -> flyteidl.core.VariableMap
	27, // 37: flyteidl.artifact.RegisterProducerRequest.producers:type_name -> flyteidl.artifact.ArtifactProducer
	48, // 38: flyteidl.artifact.ArtifactConsumer.entity_id:type_name -> flyteidl.core.Identifier
	52, // 39: flyteidl.artifact.ArtifactConsumer.inputs:type_name -> flyteidl.core.ParameterMap
	29, // 40: flyteidl.artifact.RegisterConsumerRequest.consumers:type_name -> flyteidl.artifact.ArtifactConsumer
	47, // 41: flyteidl.artifact.ExecutionInputsRequest.execution_id:type_name -> flyteidl.core.WorkflowExecutionIdentifier
	44, // 42: flyteidl.artifact.ExecutionInputsRequest.inputs:type_name -> flyteidl.core.ArtifactID
	44, // 43: flyteidl.artifact.ListUsageRequest.artifact_id:type_name -> flyteidl.core.ArtifactID
	47, // 44: flyteidl.artifact.ListUsageResponse.executions:type_name -> flyteidl.core.WorkflowExecutionIdentifier
	44, // 45: flyteidl.artifact.GetCardRequest.artifact_id:type_name -> flyteidl.core.ArtifactID
	7,  // 46: flyteidl.artifact.GetCardResponse.card:type_name -> flyteidl.artifact.Card
	47, // 47: flyteidl.artifact.GetTriggeringArtifactsRequest.executions:type_name -> flyteidl.core.WorkflowExecutionIdentifier
	43, // 48: flyteidl.artifact.GetTriggeringArtifactsResponse.artifacts:type_name -> flyteidl.artifact.GetTriggeringArtifactsResponse.ArtifactsEntry
	44, // 49: flyteidl.artifact.GetTriggeredExecutionsByArtifactRequest.artifact_id:type_name -> flyteidl.core.ArtifactID
	47, // 50: flyteidl.artifact.GetTriggeredExecutionsByArtifactResponse.executions:type_name -> flyteidl.core.WorkflowExecutionIdentifier
	44, // 51: flyteidl.artifact.GetTriggeringArtifactsResponse.ArtifactsEntry.value:type_name -> flyteidl.core.ArtifactID
	5,  // 52: flyteidl.artifact.ArtifactRegistry.CreateArtifact:input_type -> flyteidl.artifact.CreateArtifactRequest
	11, // 53: flyteidl.artifact.ArtifactRegistry.GetArtifact:input_type -> flyteidl.artifact.GetArtifactRequest
	14, // 54: flyteidl.artifact.ArtifactRegistry.SearchArtifacts:input_type -> flyteidl.artifact.SearchArtifactsRequest
	21, // 55: flyteidl.artifact.ArtifactRegistry.CreateTrigger:input_type -> flyteidl.artifact.CreateTriggerRequest
	19, // 56: flyteidl.artifact.ArtifactRegistry.ActivateTrigger:input_type -> flyteidl.artifact.ActivateTriggerRequest
	23, // 57: flyteidl.artifact.ArtifactRegistry.DeactivateTrigger:input_type -> flyteidl.artifact.DeactivateTriggerRequest
	25, // 58: flyteidl.artifact.ArtifactRegistry.DeactivateAllTriggers:input_type -> flyteidl.artifact.DeactivateAllTriggersRequest
	36, // 59: flyteidl.artifact.ArtifactRegistry.GetCard:input_type -> flyteidl.artifact.GetCardRequest
	17, // 60: flyteidl.artifact.ArtifactRegistry.AddTag:input_type -> flyteidl.artifact.AddTagRequest
	28, // 61: flyteidl.artifact.ArtifactRegistry.RegisterProducer:input_type -> flyteidl.artifact.RegisterProducerRequest
	30, // 62: flyteidl.artifact.ArtifactRegistry.RegisterConsumer:input_type -> flyteidl.artifact.RegisterConsumerRequest
	32, // 63: flyteidl.artifact.ArtifactRegistry.SetExecutionInputs:input_type -> flyteidl.artifact.ExecutionInputsRequest
	16, // 64: flyteidl.artifact.ArtifactRegistry.FindByWorkflowExec:input_type -> flyteidl.artifact.FindByWorkflowExecRequest
	34, // 65: flyteidl.artifact.ArtifactRegistry.ListUsage:input_type -> flyteidl.artifact.ListUsageRequest
	38, // 66: flyteidl.artifact.ArtifactRegistry.GetTriggeringArtifacts:input_type -> flyteidl.artifact.GetTriggeringArtifactsRequest
	40, // 67: flyteidl.artifact.ArtifactRegistry.GetTriggeredExecutionsByArtifact:input_type -> flyteidl.artifact.GetTriggeredExecutionsByArtifactRequest
	10, // 68: flyteidl.artifact.ArtifactRegistry.CreateArtifact:output_type -> flyteidl.artifact.CreateArtifactResponse
	12, // 69: flyteidl.artifact.ArtifactRegistry.GetArtifact:output_type -> flyteidl.artifact.GetArtifactResponse
	15, // 70: flyteidl.artifact.ArtifactRegistry.SearchArtifacts:output_type -> flyteidl.artifact.SearchArtifactsResponse
	22, // 71: flyteidl.artifact.ArtifactRegistry.CreateTrigger:output_type -> flyteidl.artifact.CreateTriggerResponse
	20, // 72: flyteidl.artifact.ArtifactRegistry.ActivateTrigger:output_type -> flyteidl.artifact.ActivateTriggerResponse
	24, // 73: flyteidl.artifact.ArtifactRegistry.DeactivateTrigger:output_type -> flyteidl.artifact.DeactivateTriggerResponse
	26, // 74: flyteidl.artifact.ArtifactRegistry.DeactivateAllTriggers:output_type -> flyteidl.artifact.DeactivateAllTriggersResponse
	37, // 75: flyteidl.artifact.ArtifactRegistry.GetCard:output_type -> flyteidl.artifact.GetCardResponse
	18, // 76: flyteidl.artifact.ArtifactRegistry.AddTag:output_type -> flyteidl.artifact.AddTagResponse
	31, // 77: flyteidl.artifact.ArtifactRegistry.RegisterProducer:output_type -> flyteidl.artifact.RegisterResponse
	31, // 78: flyteidl.artifact.ArtifactRegistry.RegisterConsumer:output_type -> flyteidl.artifact.RegisterResponse
	33, // 79: flyteidl.artifact.ArtifactRegistry.SetExecutionInputs:output_type -> flyteidl.artifact.ExecutionInputsResponse
	15, // 80: flyteidl.artifact.ArtifactRegistry.FindByWorkflowExec:output_type -> flyteidl.artifact.SearchArtifactsResponse
	35, // 81: flyteidl.artifact.ArtifactRegistry.ListUsage:output_type -> flyteidl.artifact.ListUsageResponse
	39, // 82: flyteidl.artifact.ArtifactRegistry.GetTriggeringArtifacts:output_type -> flyteidl.artifact.GetTriggeringArtifactsResponse
	41, // 83: flyteidl.artifact.ArtifactRegistry.GetTriggeredExecutionsByArtifact:output_type -> flyteidl.artifact.GetTriggeredExecutionsByArtifactResponse
...
func file_flyteidl_artifacts_artifacts_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_flyteidl_artifacts_artifacts_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl_artifacts_artifacts_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl_artifacts_artifacts_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl_artifacts_artifacts_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTriggeringArtifactsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_flyteidl_artifacts_artifacts_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTriggeringArtifactsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_flyteidl_artifacts_artifacts_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTriggeredExecutionsByArtifactRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_flyteidl_artifacts_artifacts_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTriggeredExecutionsByArtifactResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
