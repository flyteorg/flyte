...
var fileDescriptor_f7d1dfd1fb77d2ef = []byte{
	...
	0x39, 0xa9, 0xb8, 0x1c, 0x89, 0x90, 0xc3, 0xe9, 0x48, 0x64, 0x25, 0x30, 0x63, 0x8d, 0x62, 0xb9,
	0x04, 0x82, 0xd1, 0xc3, 0xc3, 0x93, 0x8b, 0xcd, 0x25, 0x1f, 0x6c, 0x8d, 0x2c, 0x86, 0x19, 0xf9,
	0xc8, 0x56, 0xc8, 0xe1, 0x92, 0x86, 0x19, 0xef, 0x64, 0x1f, 0x65, 0x9b, 0x9e, 0x59, 0x92, 0x51,
	0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x0f, 0x56, 0x9d, 0x5f, 0x94, 0x0e, 0x61, 0xe8, 0xc3, 0x23,
	0x2a, 0x3d, 0x35, 0x4f, 0xbf, 0x20, 0x49, 0x37, 0x3d, 0x5f, 0x1f, 0x3d, 0xae, 0x93, 0xd8, 0xc0,
	0x11, 0x67, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xc7, 0x0e, 0x26, 0x76, 0x06, 0x02, 0x00, 0x00,
}
...
func (c *syncAgentServiceClient) DoTask(ctx context.Context, in *admin.DoTaskRequest, opts ...grpc.CallOption) (*admin.DoTaskResponse, error) {
	out := new(admin.DoTaskResponse)
	err := c.cc.Invoke(ctx, "/flyteidl.service.SyncAgentService/DoTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedSyncAgentServiceServer) DoTask(ctx context.Context, req *admin.DoTaskRequest) (*admin.DoTaskResponse, error) {
...
func _SyncAgentService_DoTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(admin.DoTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SyncAgentServiceServer).DoTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flyteidl.service.SyncAgentService/DoTask",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncAgentServiceServer).DoTask(ctx, req.(*admin.DoTaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SyncAgentService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DoTask",
			Handler:    _SyncAgentService_DoTask_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "flyteidl/service/agent.proto",
