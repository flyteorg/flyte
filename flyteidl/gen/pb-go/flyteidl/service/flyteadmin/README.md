...
*AdminServiceApi* | [**UpdateProject4**](docs/AdminServiceApi.md#updateproject4) | **Put** /api/v1/projects/org/{identifier.org}/{identifier.id} | Updates an existing :ref:&#x60;ref_flyteidl.admin.Project&#x60; flyteidl.admin.Project should be passed but the domains property should be empty; it will be ignored in the handler as domains cannot be updated via this API.
