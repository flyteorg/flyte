...
type JobObjectMeta struct {
	...
	Annotations *admin.Annotations `protobuf:"bytes,1,opt,name=annotations,proto3" json:"annotations,omitempty"`
	Labels      *admin.Labels      `protobuf:"bytes,2,opt,name=labels,proto3" json:"labels,omitempty"`
}

func (x *JobObjectMeta) Reset() {
	*x = JobObjectMeta{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl_plugins_common_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *JobObjectMeta) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JobObjectMeta) ProtoMessage() {}

func (x *JobObjectMeta) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl_plugins_common_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JobObjectMeta.ProtoReflect.Descriptor instead.
func (*JobObjectMeta) Descriptor() ([]byte, []int) {
	return file_flyteidl_plugins_common_proto_rawDescGZIP(), []int{1}
}

func (x *JobObjectMeta) GetAnnotations() *admin.Annotations {
	if x != nil {
...
func (x *JobObjectMeta) GetLabels() *admin.Labels {
	if x != nil {
		return x.Labels
	}
	return nil
...
var file_flyteidl_plugins_common_proto_rawDesc = []byte{
	...
	0x73, 0x1a, 0x1b, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2f, 0x61, 0x64, 0x6d, 0x69,
	...
	0x73, 0x6b, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc5, 0x01, 0x0a, 0x11, 0x43, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x53, 0x70, 0x65, 0x63, 0x12,
	...
	0x65, 0x12, 0x36, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x03,
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x46, 0x0a, 0x0e, 0x72, 0x65, 0x73,
	0x74, 0x61, 0x72, 0x74, 0x5f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1f, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e, 0x70, 0x6c, 0x75,
	...
	0x79, 0x22, 0x7e, 0x0a, 0x0d, 0x4a, 0x6f, 0x62, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x4d, 0x65,
	0x74, 0x61, 0x12, 0x3d, 0x0a, 0x0b, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x73, 0x12, 0x2e, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x73, 0x2a, 0x63, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x50, 0x6f, 0x6c, 0x69,
	0x63, 0x79, 0x12, 0x18, 0x0a, 0x14, 0x52, 0x45, 0x53, 0x54, 0x41, 0x52, 0x54, 0x5f, 0x50, 0x4f,
	0x4c, 0x49, 0x43, 0x59, 0x5f, 0x4e, 0x45, 0x56, 0x45, 0x52, 0x10, 0x00, 0x12, 0x1d, 0x0a, 0x19,
	0x52, 0x45, 0x53, 0x54, 0x41, 0x52, 0x54, 0x5f, 0x50, 0x4f, 0x4c, 0x49, 0x43, 0x59, 0x5f, 0x4f,
	0x4e, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x01, 0x12, 0x19, 0x0a, 0x15, 0x52,
	0x45, 0x53, 0x54, 0x41, 0x52, 0x54, 0x5f, 0x50, 0x4f, 0x4c, 0x49, 0x43, 0x59, 0x5f, 0x41, 0x4c,
	0x57, 0x41, 0x59, 0x53, 0x10, 0x02, 0x42, 0xc3, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x66,
...
var file_flyteidl_plugins_common_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_flyteidl_plugins_common_proto_goTypes = []interface{}{
	...
	(*JobObjectMeta)(nil),     // 2: flyteidl.plugins.JobObjectMeta
	(*core.Resources)(nil),    // 3: flyteidl.core.Resources
	(*admin.Annotations)(nil), // 4: flyteidl.admin.Annotations
	(*admin.Labels)(nil),      // 5: flyteidl.admin.Labels
}
var file_flyteidl_plugins_common_proto_depIdxs = []int32{
	3, // 0: flyteidl.plugins.CommonReplicaSpec.resources:type_name -> flyteidl.core.Resources
	0, // 1: flyteidl.plugins.CommonReplicaSpec.restart_policy:type_name -> flyteidl.plugins.RestartPolicy
	4, // 2: flyteidl.plugins.JobObjectMeta.annotations:type_name -> flyteidl.admin.Annotations
	5, // 3: flyteidl.plugins.JobObjectMeta.labels:type_name -> flyteidl.admin.Labels
...
func file_flyteidl_plugins_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_flyteidl_plugins_common_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobObjectMeta); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
