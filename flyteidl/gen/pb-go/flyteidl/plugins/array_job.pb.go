...
func (*ArrayJob) Descriptor() ([]byte, []int) {
	return fileDescriptor_array_job_fcc8f6dac22adac2, []int{0}
}
...
func init() {
	proto.RegisterFile("flyteidl/plugins/array_job.proto", fileDescriptor_array_job_fcc8f6dac22adac2)
}

var fileDescriptor_array_job_fcc8f6dac22adac2 = []byte{
