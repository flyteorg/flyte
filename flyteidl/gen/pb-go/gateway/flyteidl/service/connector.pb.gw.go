...
func request_SyncConnectorService_ExecuteTaskSync_0(ctx context.Context, marshaler runtime.Marshaler, client extService.SyncConnectorServiceClient, req *http.Request, pathParams map[string]string) (extService.SyncConnectorService_ExecuteTaskSyncClient, runtime.ServerMetadata, error) {
...
// RegisterSyncConnectorServiceHandlerServer registers the http handlers for service SyncConnectorService to "mux".
// UnaryRPC     :call SyncConnectorServiceServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterSyncConnectorServiceHandlerFromEndpoint instead.
func RegisterSyncConnectorServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extService.SyncConnectorServiceServer) error {

	mux.Handle("POST", pattern_SyncConnectorService_ExecuteTaskSync_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterAsyncConnectorServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extService.AsyncConnectorServiceServer) error {
	...
	mux.Handle("POST", pattern_AsyncConnectorService_CreateTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl.service.AsyncConnectorService/CreateTask", runtime.WithHTTPPathPattern("/api/v1/connector/task"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AsyncConnectorService_GetTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl.service.AsyncConnectorService/GetTask", runtime.WithHTTPPathPattern("/api/v1/connector/task/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_AsyncConnectorService_DeleteTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl.service.AsyncConnectorService/DeleteTask", runtime.WithHTTPPathPattern("/api/v1/connector/task_executions/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AsyncConnectorService_GetTaskMetrics_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl.service.AsyncConnectorService/GetTaskMetrics", runtime.WithHTTPPathPattern("/api/v1/connector/task/metrics/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterConnectorMetadataServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extService.ConnectorMetadataServiceServer) error {
	...
	mux.Handle("GET", pattern_ConnectorMetadataService_GetConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl.service.ConnectorMetadataService/GetConnector", runtime.WithHTTPPathPattern("/api/v1/connector/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorMetadataService_ListConnectors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl.service.ConnectorMetadataService/ListConnectors", runtime.WithHTTPPathPattern("/api/v1/connectors"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
// RegisterSyncConnectorServiceHandlerFromEndpoint is same as RegisterSyncConnectorServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterSyncConnectorServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterSyncConnectorServiceHandler(ctx, mux, conn)
}

// RegisterSyncConnectorServiceHandler registers the http handlers for service SyncConnectorService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterSyncConnectorServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterSyncConnectorServiceHandlerClient(ctx, mux, extService.NewSyncConnectorServiceClient(conn))
}

// RegisterSyncConnectorServiceHandlerClient registers the http handlers for service SyncConnectorService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "extService.SyncConnectorServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "extService.SyncConnectorServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "extService.SyncConnectorServiceClient" to call the correct interceptors.
func RegisterSyncConnectorServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extService.SyncConnectorServiceClient) error {
	...
	mux.Handle("POST", pattern_SyncConnectorService_ExecuteTaskSync_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl.service.SyncConnectorService/ExecuteTaskSync", runtime.WithHTTPPathPattern("/api/v1/connector/task/stream"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SyncConnectorService_ExecuteTaskSync_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_SyncConnectorService_ExecuteTaskSync_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_SyncConnectorService_ExecuteTaskSync_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"api", "v1", "connector", "task", "stream"}, ""))
)

var (
	forward_SyncConnectorService_ExecuteTaskSync_0 = runtime.ForwardResponseStream
)
...
func RegisterAsyncConnectorServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extService.AsyncConnectorServiceClient) error {
	...
	mux.Handle("POST", pattern_AsyncConnectorService_CreateTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl.service.AsyncConnectorService/CreateTask", runtime.WithHTTPPathPattern("/api/v1/connector/task"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AsyncConnectorService_GetTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl.service.AsyncConnectorService/GetTask", runtime.WithHTTPPathPattern("/api/v1/connector/task/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_AsyncConnectorService_DeleteTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl.service.AsyncConnectorService/DeleteTask", runtime.WithHTTPPathPattern("/api/v1/connector/task_executions/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AsyncConnectorService_GetTaskMetrics_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl.service.AsyncConnectorService/GetTaskMetrics", runtime.WithHTTPPathPattern("/api/v1/connector/task/metrics/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AsyncConnectorService_GetTaskLogs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl.service.AsyncConnectorService/GetTaskLogs", runtime.WithHTTPPathPattern("/api/v1/connector/task/logs/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterConnectorMetadataServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extService.ConnectorMetadataServiceClient) error {
	...
	mux.Handle("GET", pattern_ConnectorMetadataService_GetConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl.service.ConnectorMetadataService/GetConnector", runtime.WithHTTPPathPattern("/api/v1/connector/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorMetadataService_ListConnectors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl.service.ConnectorMetadataService/ListConnectors", runtime.WithHTTPPathPattern("/api/v1/connectors"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
