...
pub struct WorkflowExecutionConfig {
    ...
    pub execution_env_assignments: ::prost::alloc::vec::Vec<
        super::core::ExecutionEnvAssignment,
    >,
}
...
pub struct LaunchPlanMetadata {
    ...
    #[prost(message, optional, tag = "3")]
    pub launch_conditions: ::core::option::Option<super::super::google::protobuf::Any>,
}
