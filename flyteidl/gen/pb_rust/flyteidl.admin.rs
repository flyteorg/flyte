...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ClusterResourceAttributesWithSource {
    #[prost(enumeration="AttributesSource", tag="1")]
    pub source: i32,
    #[prost(message, optional, tag="2")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ExecutionQueueAttributesWithSource {
    #[prost(enumeration="AttributesSource", tag="1")]
    pub source: i32,
    #[prost(message, optional, tag="2")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ExecutionClusterLabelWithSource {
    #[prost(enumeration="AttributesSource", tag="1")]
    pub source: i32,
    #[prost(message, optional, tag="2")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PluginOverridesWithSource {
    #[prost(enumeration="AttributesSource", tag="1")]
    pub source: i32,
    #[prost(message, optional, tag="2")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct WorkflowExecutionConfigWithSource {
    #[prost(enumeration="AttributesSource", tag="1")]
    pub source: i32,
    #[prost(message, optional, tag="2")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ClusterAssignmentWithSource {
    #[prost(enumeration="AttributesSource", tag="1")]
    pub source: i32,
    #[prost(message, optional, tag="2")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ExternalResourceAttributesWithSource {
    #[prost(enumeration="AttributesSource", tag="1")]
    pub source: i32,
    #[prost(message, optional, tag="2")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ConfigurationWithSource {
    #[prost(message, optional, tag="1")]
    pub task_resource_attributes: ::core::option::Option<TaskResourceAttributesWithSource>,
    #[prost(message, optional, tag="2")]
    pub cluster_resource_attributes: ::core::option::Option<ClusterResourceAttributesWithSource>,
    #[prost(message, optional, tag="3")]
    pub execution_queue_attributes: ::core::option::Option<ExecutionQueueAttributesWithSource>,
    #[prost(message, optional, tag="4")]
    pub execution_cluster_label: ::core::option::Option<ExecutionClusterLabelWithSource>,
    #[prost(message, optional, tag="5")]
    pub quality_of_service: ::core::option::Option<QualityOfServiceWithSource>,
    #[prost(message, optional, tag="6")]
    pub plugin_overrides: ::core::option::Option<PluginOverridesWithSource>,
    #[prost(message, optional, tag="7")]
    pub workflow_execution_config: ::core::option::Option<WorkflowExecutionConfigWithSource>,
    #[prost(message, optional, tag="8")]
    pub cluster_assignment: ::core::option::Option<ClusterAssignmentWithSource>,
    #[prost(message, optional, tag="9")]
    pub external_resource_attributes: ::core::option::Option<ExternalResourceAttributesWithSource>,
}
...
pub struct ConfigurationGetResponse {
    ...
    /// Configuration with source information.
    #[prost(message, optional, tag="3")]
    pub configuration: ::core::option::Option<ConfigurationWithSource>,
}
