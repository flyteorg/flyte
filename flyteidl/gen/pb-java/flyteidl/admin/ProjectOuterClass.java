...
public final class ProjectOuterClass {
  ...
  public interface ProjectRequestOrBuilder extends
      // @@protoc_insertion_point(interface_extends:flyteidl.admin.ProjectRequest)
      com.google.protobuf.MessageOrBuilder {
   ...
   * </pre>
   *
   * Protobuf type {@code flyteidl.admin.ProjectRequest}
   */
  public  static final class ProjectRequest extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:flyteidl.admin.ProjectRequest)
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return flyteidl.admin.ProjectOuterClass.internal_static_flyteidl_admin_ProjectRequest_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return flyteidl.admin.ProjectOuterClass.internal_static_flyteidl_admin_ProjectRequest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              flyteidl.admin.ProjectOuterClass.ProjectRequest.class, flyteidl.admin.ProjectOuterClass.ProjectRequest.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof flyteidl.admin.ProjectOuterClass.ProjectRequest)) {
        return super.equals(obj);
      }
      flyteidl.admin.ProjectOuterClass.ProjectRequest other = (flyteidl.admin.ProjectOuterClass.ProjectRequest) obj;
    ...
    public static flyteidl.admin.ProjectOuterClass.ProjectRequest parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static flyteidl.admin.ProjectOuterClass.ProjectRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static flyteidl.admin.ProjectOuterClass.ProjectRequest parseFrom(
    ...
    public static flyteidl.admin.ProjectOuterClass.ProjectRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static flyteidl.admin.ProjectOuterClass.ProjectRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static flyteidl.admin.ProjectOuterClass.ProjectRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(flyteidl.admin.ProjectOuterClass.ProjectRequest prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:flyteidl.admin.ProjectRequest)
        flyteidl.admin.ProjectOuterClass.ProjectRequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return flyteidl.admin.ProjectOuterClass.internal_static_flyteidl_admin_ProjectRequest_descriptor;
      }
      ...
      // Construct using flyteidl.admin.ProjectOuterClass.ProjectRequest.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public flyteidl.admin.ProjectOuterClass.ProjectRequest getDefaultInstanceForType() {
        return flyteidl.admin.ProjectOuterClass.ProjectRequest.getDefaultInstance();
      }

      @java.lang.Override
      public flyteidl.admin.ProjectOuterClass.ProjectRequest build() {
        flyteidl.admin.ProjectOuterClass.ProjectRequest result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public flyteidl.admin.ProjectOuterClass.ProjectRequest buildPartial() {
        flyteidl.admin.ProjectOuterClass.ProjectRequest result = new flyteidl.admin.ProjectOuterClass.ProjectRequest(this);
        if (projectBuilder_ == null) {
          result.project_ = project_;
        } else {
          result.project_ = projectBuilder_.build();
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof flyteidl.admin.ProjectOuterClass.ProjectRequest) {
          return mergeFrom((flyteidl.admin.ProjectOuterClass.ProjectRequest)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(flyteidl.admin.ProjectOuterClass.ProjectRequest other) {
        if (other == flyteidl.admin.ProjectOuterClass.ProjectRequest.getDefaultInstance()) return this;
        if (other.hasProject()) {
          mergeProject(other.getProject());
        }
        this.mergeUnknownFields(other.unknownFields);
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        flyteidl.admin.ProjectOuterClass.ProjectRequest parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (flyteidl.admin.ProjectOuterClass.ProjectRequest) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      // @@protoc_insertion_point(builder_scope:flyteidl.admin.ProjectRequest)
    }

    // @@protoc_insertion_point(class_scope:flyteidl.admin.ProjectRequest)
    private static final flyteidl.admin.ProjectOuterClass.ProjectRequest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new flyteidl.admin.ProjectOuterClass.ProjectRequest();
    }

    public static flyteidl.admin.ProjectOuterClass.ProjectRequest getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_flyteidl_admin_ProjectRequest_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_flyteidl_admin_ProjectRequest_fieldAccessorTable;
  ...
  static {
    ...
    internal_static_flyteidl_admin_ProjectRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_flyteidl_admin_ProjectRequest_descriptor,
        new java.lang.String[] { "Project", });
    flyteidl.admin.Common.getDescriptor();
