...
#ifndef PROTOBUF_flyteidl_2fplugins_2fwaitable_2eproto__INCLUDED
#define PROTOBUF_flyteidl_2fplugins_2fwaitable_2eproto__INCLUDED
...
class Waitable : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.plugins.Waitable) */ {
 public:
  Waitable();
  virtual ~Waitable();
  ...
  inline Waitable* New() const PROTOBUF_FINAL { return New(NULL); }

  Waitable* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_flyteidl_2fplugins_2fwaitable_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fplugins_2fwaitable_2eproto::InitDefaultsWaitableImpl();
};
// ===================================================================
...
inline bool Waitable::has_wf_exec_id() const {
  return this != internal_default_instance() && wf_exec_id_ != NULL;
}
...
inline ::flyteidl::core::WorkflowExecutionIdentifier* Waitable::mutable_wf_exec_id() {
  ...
  if (wf_exec_id_ == NULL) {
    wf_exec_id_ = new ::flyteidl::core::WorkflowExecutionIdentifier;
  }
...
#endif  // PROTOBUF_flyteidl_2fplugins_2fwaitable_2eproto__INCLUDED
