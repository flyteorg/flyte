...
const char descriptor_table_protodef_flyteidl_2fservice_2fadmin_2eproto[] =
  ...
  "api/v1/tasks:\001*Z\037\"\032/api/v1/org/tasks/{id"
  ...
  "/org/tasks/{id.org}/{id.project}/{id.dom"
  ...
  "ds/{project}/{domain}Z,\022*/api/v1/org/tas"
  "ks/{org}/{project}/{domain}\022\250\002\n\tListTask"
  ...
  "1/workflows:\001*Z#\"\036/api/v1/org/workflows/"
  ...
  "ion}ZP\022N/api/v1/org/workflows/{id.org}/{"
  ...
  "{domain}Z0\022./api/v1/org/workflows/{org}/"
  ...
  "d.name}ZC\022A/api/v1/org/workflows/{id.org"
  "}/{id.project}/{id.domain}/{id.name}Z,\022*"
  "/api/v1/workflows/{id.project}/{id.domai"
  "n}Z9\0227/api/v1/org/workflows/{id.org}/{id"
  ...
  "\"!/api/v1/org/launch_plans/{id.org}:\001*\022\362"
  ...
  "\022Q/api/v1/org/launch_plans/{id.org}/{id."
  ...
  "/{id.name}ZM\022K/api/v1/org/active_launch_"
  "plans/{id.org}/{id.project}/{id.domain}/"
  ...
  "{domain}Z:\0228/api/v1/org/active_launch_pl"
  "ans/{org}/{project}/{domain}\022\334\001\n\021ListLau"
  ...
  "api/v1/org/launch_plan_ids/{org}/{projec"
  ...
  "d.name}ZF\022D/api/v1/org/launch_plans/{id."
  "org}/{id.project}/{id.domain}/{id.name}Z"
  "/\022-/api/v1/launch_plans/{id.project}/{id"
  ".domain}Z<\022:/api/v1/org/launch_plans/{id"
  ...
  "}/{id.version}:\001*ZS\032Q/api/v1/org/launch_"
  "plans/{id.org}/{id.project}/{id.domain}/"
  "{id.name}/{id.version}\022\244\001\n\017CreateExecuti"
  "on\022&.flyteidl.admin.ExecutionCreateReque"
  "st\032\'.flyteidl.admin.ExecutionCreateRespo"
  "nse\"@\202\323\344\223\002:\"\022/api/v1/executions:\001*Z!\"\034/a"
  "pi/v1/org/executions/{org}:\001*\022\275\001\n\021Relaun"
  ...
  "ns/relaunch:\001*Z-\"(/api/v1/org/executions"
  ...
  ":\001*Z,\"\'/api/v1/org/executions/{id.org}/r"
  ...
  "e}ZD\022B/api/v1/org/executions/{id.org}/{i"
  ...
  "*ZG\032B/api/v1/org/executions/{id.org}/{id"
  ...
  "t}/{id.domain}/{id.name}ZI\022G/api/v1/org/"
  "data/executions/{id.org}/{id.project}/{i"
  ...
  ":\0228/api/v1/org/executions/{id.org}/{id.p"
  ...
  "B/api/v1/org/executions/{id.org}/{id.pro"
  ...
  "e_id}Z\213\001\022\210\001/api/v1/org/node_executions/{"
  ...
  "kflowZ\234\001\022\231\001/api/v1/org/node_executions/{"
  "id.execution_id.org}/{id.execution_id.pr"
  "oject}/{id.execution_id.domain}/{id.exec"
  ...
  "i/v1/org/node_executions/{workflow_execu"
  ...
  "d.retry_attempt}Z\347\003\022\344\003/api/v1/org/childr"
  "en/{task_execution_id.node_execution_id."
  ...
  "v1/org/data/node_executions/{id.executio"
  ...
  "\323\344\223\002>\"\020/api/v1/projects:\001*Z\'\"\"/api/v1/or"
  "g/projects/{project.org}:\001*\022\227\001\n\rUpdatePr"
  "oject\022\027.flyteidl.admin.Project\032%.flyteid"
  "l.admin.ProjectUpdateResponse\"F\202\323\344\223\002@\032\025/"
  "api/v1/projects/{id}:\001*Z$\032\037/api/v1/org/p"
  "rojects/{org}/{id}:\001*\022\204\001\n\014ListProjects\022\""
  ".flyteidl.admin.ProjectListRequest\032\030.fly"
  "teidl.admin.Projects\"6\202\323\344\223\0020\022\020/api/v1/pr"
  "ojectsZ\034\022\032/api/v1/org/projects/{org}\022\325\001\n"
  ...
  "/v1/org/events/{event.execution_id.org}/"
  ...
  "/v1/org/events/{event.id.execution_id.or"
  ...
  "v1/org/events/{event.parent_node_executi"
  ...
  "/{id.retry_attempt}Z\310\002\022\305\002/api/v1/org/tas"
  ...
  "api/v1/org/task_executions/{node_executi"
  ...
  "rsion}/{id.retry_attempt}Z\315\002\022\312\002/api/v1/o"
  "rg/data/task_executions/{id.node_executi"
  ...
  "i/v1/org/project_domain_attributes/{attr"
  ...
  "t}/{domain}Z@\022>/api/v1/org/project_domai"
  "n_attributes/{org}/{project}/{domain}\022\223\002"
  ...
  "in}:\001*ZC*>/api/v1/org/project_domain_att"
  "ributes/{org}/{project}/{domain}:\001*\022\212\002\n\027"
  ...
  "attributes.project}:\001*ZP\032K/api/v1/org/pr"
  "oject_domain_attributes/{attributes.org}"
  ...
  "oject_attributes/{project}Z7\0225/api/v1/or"
  "g/project_domain_attributes/{org}/{proje"
  ...
  "utes/{project}:\001*Z:*5/api/v1/org/project"
  "_domain_attributes/{org}/{project}:\001*\022\334\002"
  ...
  "1/org/workflow_attributes/{attributes.or"
  ...
  "main}/{workflow}ZE\022C/api/v1/org/workflow"
  "_attributes/{org}/{project}/{domain}/{wo"
  ...
  "low}:\001*ZH*C/api/v1/org/workflow_attribut"
  "es/{org}/{project}/{domain}/{workflow}:\001"
  ...
  "utesZ(\022&/api/v1/org/matchable_attributes"
  ...
  "}/{domain}ZE\022C/api/v1/org/named_entities"
  ...
  "in}/{id.name}ZX\022V/api/v1/org/named_entit"
  "ies/{id.org}/{resource_type}/{id.project"
  ...
  "main}/{id.name}:\001*Z[\032V/api/v1/org/named_"
  "entities/{id.org}/{resource_type}/{id.pr"
  ...
  "{id.name}/{id.version}Zn\022l/api/v1/org/de"
  "scription_entities/{id.org}/{id.resource"
  ...
  ".domain}/{id.name}Z^\022\\/api/v1/org/descri"
  "ption_entities/{id.org}/{resource_type}/"
  "{id.project}/{id.domain}/{id.name}ZG\022E/a"
  "pi/v1/description_entities/{resource_typ"
  "e}/{id.project}/{id.domain}ZT\022R/api/v1/o"
  "rg/description_entities/{id.org}/{resour"
  ...
  "api/v1/org/metrics/executions/{id.org}/{"
