...
AdminService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_UpdateWorkflow_(AdminService_method_names[8], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  ...
  , rpcmethod_GetExecutionData_(AdminService_method_names[19], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListExecutions_(AdminService_method_names[20], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_TerminateExecution_(AdminService_method_names[21], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetNodeExecution_(AdminService_method_names[22], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListNodeExecutions_(AdminService_method_names[23], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListNodeExecutionsForTask_(AdminService_method_names[24], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetNodeExecutionData_(AdminService_method_names[25], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RegisterProject_(AdminService_method_names[26], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListProjects_(AdminService_method_names[27], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CreateWorkflowEvent_(AdminService_method_names[28], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CreateNodeEvent_(AdminService_method_names[29], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CreateTaskEvent_(AdminService_method_names[30], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetTaskExecution_(AdminService_method_names[31], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListTaskExecutions_(AdminService_method_names[32], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetTaskExecutionData_(AdminService_method_names[33], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateProjectDomainAttributes_(AdminService_method_names[34], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetProjectDomainAttributes_(AdminService_method_names[35], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteProjectDomainAttributes_(AdminService_method_names[36], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateWorkflowAttributes_(AdminService_method_names[37], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetWorkflowAttributes_(AdminService_method_names[38], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteWorkflowAttributes_(AdminService_method_names[39], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListMatchableAttributes_(AdminService_method_names[40], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListNamedEntities_(AdminService_method_names[41], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetNamedEntity_(AdminService_method_names[42], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateNamedEntity_(AdminService_method_names[43], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status AdminService::Stub::UpdateWorkflow(::grpc::ClientContext* context, const ::flyteidl::admin::WorkflowUpdateRequest& request, ::flyteidl::admin::WorkflowUpdateResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_UpdateWorkflow_, context, request, response);
}

void AdminService::Stub::experimental_async::UpdateWorkflow(::grpc::ClientContext* context, const ::flyteidl::admin::WorkflowUpdateRequest* request, ::flyteidl::admin::WorkflowUpdateResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_UpdateWorkflow_, context, request, response, std::move(f));
}

void AdminService::Stub::experimental_async::UpdateWorkflow(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::WorkflowUpdateResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_UpdateWorkflow_, context, request, response, std::move(f));
}

void AdminService::Stub::experimental_async::UpdateWorkflow(::grpc::ClientContext* context, const ::flyteidl::admin::WorkflowUpdateRequest* request, ::flyteidl::admin::WorkflowUpdateResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_UpdateWorkflow_, context, request, response, reactor);
}

void AdminService::Stub::experimental_async::UpdateWorkflow(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::WorkflowUpdateResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_UpdateWorkflow_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::admin::WorkflowUpdateResponse>* AdminService::Stub::AsyncUpdateWorkflowRaw(::grpc::ClientContext* context, const ::flyteidl::admin::WorkflowUpdateRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::admin::WorkflowUpdateResponse>::Create(channel_.get(), cq, rpcmethod_UpdateWorkflow_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::admin::WorkflowUpdateResponse>* AdminService::Stub::PrepareAsyncUpdateWorkflowRaw(::grpc::ClientContext* context, const ::flyteidl::admin::WorkflowUpdateRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::admin::WorkflowUpdateResponse>::Create(channel_.get(), cq, rpcmethod_UpdateWorkflow_, context, request, false);
}
...
AdminService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< AdminService::Service, ::flyteidl::admin::WorkflowUpdateRequest, ::flyteidl::admin::WorkflowUpdateResponse>(
          std::mem_fn(&AdminService::Service::UpdateWorkflow), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status AdminService::Service::UpdateWorkflow(::grpc::ServerContext* context, const ::flyteidl::admin::WorkflowUpdateRequest* request, ::flyteidl::admin::WorkflowUpdateResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
