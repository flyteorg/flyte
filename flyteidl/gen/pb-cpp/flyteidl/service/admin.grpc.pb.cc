...
AdminService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_GetWorkflowNodeExecutions_(AdminService_method_names[24], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status AdminService::Stub::GetWorkflowNodeExecutions(::grpc::ClientContext* context, const ::flyteidl::admin::WorkflowNodeExecutionsGetRequest& request, ::flyteidl::admin::WorkflowNodeExecutionsGetResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetWorkflowNodeExecutions_, context, request, response);
}

void AdminService::Stub::experimental_async::GetWorkflowNodeExecutions(::grpc::ClientContext* context, const ::flyteidl::admin::WorkflowNodeExecutionsGetRequest* request, ::flyteidl::admin::WorkflowNodeExecutionsGetResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetWorkflowNodeExecutions_, context, request, response, std::move(f));
}

void AdminService::Stub::experimental_async::GetWorkflowNodeExecutions(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::WorkflowNodeExecutionsGetResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetWorkflowNodeExecutions_, context, request, response, std::move(f));
}

void AdminService::Stub::experimental_async::GetWorkflowNodeExecutions(::grpc::ClientContext* context, const ::flyteidl::admin::WorkflowNodeExecutionsGetRequest* request, ::flyteidl::admin::WorkflowNodeExecutionsGetResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_GetWorkflowNodeExecutions_, context, request, response, reactor);
}

void AdminService::Stub::experimental_async::GetWorkflowNodeExecutions(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::WorkflowNodeExecutionsGetResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_GetWorkflowNodeExecutions_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::admin::WorkflowNodeExecutionsGetResponse>* AdminService::Stub::AsyncGetWorkflowNodeExecutionsRaw(::grpc::ClientContext* context, const ::flyteidl::admin::WorkflowNodeExecutionsGetRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::admin::WorkflowNodeExecutionsGetResponse>::Create(channel_.get(), cq, rpcmethod_GetWorkflowNodeExecutions_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::admin::WorkflowNodeExecutionsGetResponse>* AdminService::Stub::PrepareAsyncGetWorkflowNodeExecutionsRaw(::grpc::ClientContext* context, const ::flyteidl::admin::WorkflowNodeExecutionsGetRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::admin::WorkflowNodeExecutionsGetResponse>::Create(channel_.get(), cq, rpcmethod_GetWorkflowNodeExecutions_, context, request, false);
}
...
AdminService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< AdminService::Service, ::flyteidl::admin::WorkflowNodeExecutionsGetRequest, ::flyteidl::admin::WorkflowNodeExecutionsGetResponse>(
          std::mem_fn(&AdminService::Service::GetWorkflowNodeExecutions), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status AdminService::Service::GetWorkflowNodeExecutions(::grpc::ServerContext* context, const ::flyteidl::admin::WorkflowNodeExecutionsGetRequest* request, ::flyteidl::admin::WorkflowNodeExecutionsGetResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
