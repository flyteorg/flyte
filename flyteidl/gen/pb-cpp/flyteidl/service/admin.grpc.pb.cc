...
AdminService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_UpdateTaskExecution_(AdminService_method_names[36], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status AdminService::Stub::UpdateTaskExecution(::grpc::ClientContext* context, const ::flyteidl::admin::TaskExecutionUpdateRequest& request, ::flyteidl::admin::TaskExecutionUpdateResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_UpdateTaskExecution_, context, request, response);
}

void AdminService::Stub::experimental_async::UpdateTaskExecution(::grpc::ClientContext* context, const ::flyteidl::admin::TaskExecutionUpdateRequest* request, ::flyteidl::admin::TaskExecutionUpdateResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_UpdateTaskExecution_, context, request, response, std::move(f));
}

void AdminService::Stub::experimental_async::UpdateTaskExecution(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::TaskExecutionUpdateResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_UpdateTaskExecution_, context, request, response, std::move(f));
}

void AdminService::Stub::experimental_async::UpdateTaskExecution(::grpc::ClientContext* context, const ::flyteidl::admin::TaskExecutionUpdateRequest* request, ::flyteidl::admin::TaskExecutionUpdateResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_UpdateTaskExecution_, context, request, response, reactor);
}

void AdminService::Stub::experimental_async::UpdateTaskExecution(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::flyteidl::admin::TaskExecutionUpdateResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_UpdateTaskExecution_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::admin::TaskExecutionUpdateResponse>* AdminService::Stub::AsyncUpdateTaskExecutionRaw(::grpc::ClientContext* context, const ::flyteidl::admin::TaskExecutionUpdateRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::admin::TaskExecutionUpdateResponse>::Create(channel_.get(), cq, rpcmethod_UpdateTaskExecution_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::flyteidl::admin::TaskExecutionUpdateResponse>* AdminService::Stub::PrepareAsyncUpdateTaskExecutionRaw(::grpc::ClientContext* context, const ::flyteidl::admin::TaskExecutionUpdateRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::flyteidl::admin::TaskExecutionUpdateResponse>::Create(channel_.get(), cq, rpcmethod_UpdateTaskExecution_, context, request, false);
}
...
AdminService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< AdminService::Service, ::flyteidl::admin::TaskExecutionUpdateRequest, ::flyteidl::admin::TaskExecutionUpdateResponse>(
          std::mem_fn(&AdminService::Service::UpdateTaskExecution), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status AdminService::Service::UpdateTaskExecution(::grpc::ServerContext* context, const ::flyteidl::admin::TaskExecutionUpdateRequest* request, ::flyteidl::admin::TaskExecutionUpdateResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
