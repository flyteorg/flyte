...
class CacheService final {
 public:
  ...
  typedef WithAsyncMethod_EvictTaskExecutionCache<Service > AsyncService;
  template <class BaseClass>
  ...
  typedef ExperimentalWithCallbackMethod_EvictTaskExecutionCache<Service > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_EvictTaskExecutionCache<Service > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_EvictTaskExecutionCache<Service > StreamedService;
};
