...
extern PROTOBUF_INTERNAL_EXPORT_flyteidl_2fadmin_2ftask_5fexecution_2eproto ::google::protobuf::internal::SCCInfo<9> scc_info_TaskExecutionClosure_flyteidl_2fadmin_2ftask_5fexecution_2eproto;
...
const ::google::protobuf::uint32 TableStruct_flyteidl_2fadmin_2ftask_5fexecution_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(::flyteidl::admin::TaskExecutionClosureDefaultTypeInternal, full_outputs_),
  ...
  PROTOBUF_FIELD_OFFSET(::flyteidl::admin::TaskExecutionGetDataResponse, input_data_),
  PROTOBUF_FIELD_OFFSET(::flyteidl::admin::TaskExecutionGetDataResponse, output_data_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 54, -1, sizeof(::flyteidl::admin::Reason)},
  { 61, -1, sizeof(::flyteidl::admin::TaskExecutionGetDataRequest)},
  { 67, -1, sizeof(::flyteidl::admin::TaskExecutionGetDataResponse)},
};
...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fadmin_2ftask_5fexecution_2eproto = {
  ...
  "flyteidl/admin/task_execution.proto", &assign_descriptors_table_flyteidl_2fadmin_2ftask_5fexecution_2eproto, 2115,
};
...
void TaskExecutionClosure::InitAsDefaultInstance() {
  ...
  ::flyteidl::admin::_TaskExecutionClosure_default_instance_.full_outputs_ = const_cast< ::flyteidl::core::OutputData*>(
...
class TaskExecutionClosure::HasBitSetters {
 public:
  ...
  static const ::flyteidl::core::OutputData& full_outputs(const TaskExecutionClosure* msg);
...
TaskExecutionClosure::HasBitSetters::full_outputs(const TaskExecutionClosure* msg) {
...
void TaskExecutionClosure::set_allocated_full_outputs(::flyteidl::core::OutputData* full_outputs) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  clear_output_result();
  if (full_outputs) {
    ::google::protobuf::Arena* submessage_arena = nullptr;
  ...
  // @@protoc_insertion_point(field_set_allocated:flyteidl.admin.TaskExecutionClosure.full_outputs)
}
void TaskExecutionClosure::clear_full_outputs() {
  if (has_full_outputs()) {
...
const int TaskExecutionClosure::kFullOutputsFieldNumber;
...
void TaskExecutionClosure::SerializeWithCachedSizes(
  ...
  if (has_full_outputs()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      19, HasBitSetters::full_outputs(this), output);
  }
...
::google::protobuf::uint8* TaskExecutionClosure::InternalSerializeWithCachedSizesToArray(
  ...
  if (has_full_outputs()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        19, HasBitSetters::full_outputs(this), target);
  }
...
void TaskExecutionGetDataResponse::InitAsDefaultInstance() {
  ...
  ::flyteidl::admin::_TaskExecutionGetDataResponse_default_instance_._instance.get_mutable()->full_outputs_ = const_cast< ::flyteidl::core::LiteralMap*>(
      ::flyteidl::core::LiteralMap::internal_default_instance());
  ::flyteidl::admin::_TaskExecutionGetDataResponse_default_instance_._instance.get_mutable()->input_data_ = const_cast< ::flyteidl::core::InputData*>(
      ::flyteidl::core::InputData::internal_default_instance());
  ::flyteidl::admin::_TaskExecutionGetDataResponse_default_instance_._instance.get_mutable()->output_data_ = const_cast< ::flyteidl::core::OutputData*>(
      ::flyteidl::core::OutputData::internal_default_instance());
...
class TaskExecutionGetDataResponse::HasBitSetters {
 public:
  ...
  static const ::flyteidl::core::InputData& input_data(const TaskExecutionGetDataResponse* msg);
  static const ::flyteidl::core::OutputData& output_data(const TaskExecutionGetDataResponse* msg);
...
TaskExecutionGetDataResponse::HasBitSetters::input_data(const TaskExecutionGetDataResponse* msg) {
  return *msg->input_data_;
}
const ::flyteidl::core::OutputData&
TaskExecutionGetDataResponse::HasBitSetters::output_data(const TaskExecutionGetDataResponse* msg) {
...
void TaskExecutionGetDataResponse::clear_input_data() {
  if (GetArenaNoVirtual() == nullptr && input_data_ != nullptr) {
    delete input_data_;
  }
  input_data_ = nullptr;
}
void TaskExecutionGetDataResponse::clear_output_data() {
...
const int TaskExecutionGetDataResponse::kInputDataFieldNumber;
const int TaskExecutionGetDataResponse::kOutputDataFieldNumber;
...
void TaskExecutionGetDataResponse::SharedCtor() {
  ...
  ::memset(&inputs_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&inputs_)) + sizeof(output_data_));
}
