...
extern PROTOBUF_INTERNAL_EXPORT_flyteidl_2fadmin_2fmatchable_5fresource_2eproto ::google::protobuf::internal::SCCInfo<7> scc_info_WorkflowExecutionConfig_flyteidl_2fadmin_2fmatchable_5fresource_2eproto;
...
extern PROTOBUF_INTERNAL_EXPORT_flyteidl_2fcore_2fexecution_5fenvs_2eproto ::google::protobuf::internal::SCCInfo<2> scc_info_ExecutionEnvironmentAssignment_flyteidl_2fcore_2fexecution_5fenvs_2eproto;
...
::google::protobuf::internal::SCCInfo<7> scc_info_WorkflowExecutionConfig_flyteidl_2fadmin_2fmatchable_5fresource_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 7, InitDefaultsWorkflowExecutionConfig_flyteidl_2fadmin_2fmatchable_5fresource_2eproto}, {
...
const ::google::protobuf::uint32 TableStruct_flyteidl_2fadmin_2fmatchable_5fresource_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::flyteidl::admin::WorkflowExecutionConfig, execution_envs_),
  ~0u,  // no _has_bits_
...
static const ::google::protobuf::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 72, -1, sizeof(::flyteidl::admin::MatchingAttributes)},
  { 86, -1, sizeof(::flyteidl::admin::MatchableAttributesConfiguration)},
...
const char descriptor_table_protodef_flyteidl_2fadmin_2fmatchable_5fresource_2eproto[] =
  ...
  "flyteidl/core/execution_envs.proto\032\034flyt"
  "eidl/core/security.proto\032\036google/protobu"
  "f/wrappers.proto\"h\n\020TaskResourceSpec\022\013\n\003"
  "cpu\030\001 \001(\t\022\013\n\003gpu\030\002 \001(\t\022\016\n\006memory\030\003 \001(\t\022\017"
  "\n\007storage\030\004 \001(\t\022\031\n\021ephemeral_storage\030\005 \001"
  "(\t\"~\n\026TaskResourceAttributes\0222\n\010defaults"
  "\030\001 \001(\0132 .flyteidl.admin.TaskResourceSpec"
  "\0220\n\006limits\030\002 \001(\0132 .flyteidl.admin.TaskRe"
  "sourceSpec\"\235\001\n\031ClusterResourceAttributes"
  "\022M\n\nattributes\030\001 \003(\01329.flyteidl.admin.Cl"
  "usterResourceAttributes.AttributesEntry\032"
  ...
  "_plugin_behavior\030\004 \001(\01624.flyteidl.admin."
  "PluginOverride.MissingPluginBehavior\"2\n\025"
  "MissingPluginBehavior\022\010\n\004FAIL\020\000\022\017\n\013USE_D"
  "EFAULT\020\001\"D\n\017PluginOverrides\0221\n\toverrides"
  "\030\001 \003(\0132\036.flyteidl.admin.PluginOverride\"\302"
  "\003\n\027WorkflowExecutionConfig\022\027\n\017max_parall"
  "elism\030\001 \001(\005\0228\n\020security_context\030\002 \001(\0132\036."
  "flyteidl.core.SecurityContext\022C\n\026raw_out"
  "put_data_config\030\003 \001(\0132#.flyteidl.admin.R"
  "awOutputDataConfig\022&\n\006labels\030\004 \001(\0132\026.fly"
  "teidl.admin.Labels\0220\n\013annotations\030\005 \001(\0132"
  "\033.flyteidl.admin.Annotations\0221\n\rinterrup"
  "tible\030\006 \001(\0132\032.google.protobuf.BoolValue\022"
  "\027\n\017overwrite_cache\030\007 \001(\010\022\"\n\004envs\030\010 \001(\0132\024"
  ".flyteidl.admin.Envs\022E\n\016execution_envs\030\t"
  " \003(\0132-.flyteidl.core.ExecutionEnvironmen"
  "tAssignment\"\341\004\n\022MatchingAttributes\022J\n\030ta"
  "sk_resource_attributes\030\001 \001(\0132&.flyteidl."
  "admin.TaskResourceAttributesH\000\022P\n\033cluste"
  "r_resource_attributes\030\002 \001(\0132).flyteidl.a"
  "dmin.ClusterResourceAttributesH\000\022N\n\032exec"
  "ution_queue_attributes\030\003 \001(\0132(.flyteidl."
  "admin.ExecutionQueueAttributesH\000\022H\n\027exec"
  "ution_cluster_label\030\004 \001(\0132%.flyteidl.adm"
  "in.ExecutionClusterLabelH\000\022=\n\022quality_of"
  "_service\030\005 \001(\0132\037.flyteidl.core.QualityOf"
  "ServiceH\000\022;\n\020plugin_overrides\030\006 \001(\0132\037.fl"
  "yteidl.admin.PluginOverridesH\000\022L\n\031workfl"
  "ow_execution_config\030\007 \001(\0132\'.flyteidl.adm"
  "in.WorkflowExecutionConfigH\000\022\?\n\022cluster_"
  "assignment\030\010 \001(\0132!.flyteidl.admin.Cluste"
  "rAssignmentH\000B\010\n\006target\"\242\001\n MatchableAtt"
  "ributesConfiguration\0226\n\nattributes\030\001 \001(\013"
  "2\".flyteidl.admin.MatchingAttributes\022\016\n\006"
  "domain\030\002 \001(\t\022\017\n\007project\030\003 \001(\t\022\020\n\010workflo"
  "w\030\004 \001(\t\022\023\n\013launch_plan\030\005 \001(\t\"Z\n\036ListMatc"
  "hableAttributesRequest\0228\n\rresource_type\030"
  "\001 \001(\0162!.flyteidl.admin.MatchableResource"
  "\"k\n\037ListMatchableAttributesResponse\022H\n\016c"
  "onfigurations\030\001 \003(\01320.flyteidl.admin.Mat"
  "chableAttributesConfiguration*\340\001\n\021Matcha"
  ...
  "TER_ASSIGNMENT\020\007B=Z;github.com/flyteorg/"
...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fadmin_2fmatchable_5fresource_2eproto = {
  ...
  "flyteidl/admin/matchable_resource.proto", &assign_descriptors_table_flyteidl_2fadmin_2fmatchable_5fresource_2eproto, 2727,
};
...
void AddDescriptors_flyteidl_2fadmin_2fmatchable_5fresource_2eproto() {
  static constexpr ::google::protobuf::internal::InitFunc deps[6] =
  {
    ...
    ::AddDescriptors_flyteidl_2fcore_2fexecution_5fenvs_2eproto,
    ::AddDescriptors_flyteidl_2fcore_2fsecurity_2eproto,
    ::AddDescriptors_google_2fprotobuf_2fwrappers_2eproto,
  };
 ::google::protobuf::internal::AddDescriptors(&descriptor_table_flyteidl_2fadmin_2fmatchable_5fresource_2eproto, deps, 6);
}
...
void WorkflowExecutionConfig::clear_execution_envs() {
  execution_envs_.Clear();
}
#if !defined(_MSC_VER) || _MSC_VER >= 1900
...
const int WorkflowExecutionConfig::kExecutionEnvsFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
WorkflowExecutionConfig::WorkflowExecutionConfig(const WorkflowExecutionConfig& from)
  : ::google::protobuf::Message(),
      _internal_metadata_(nullptr),
      execution_envs_(from.execution_envs_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
...
const char* WorkflowExecutionConfig::_InternalParse(const char* begin, const char* end, void* object,
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      // repeated .flyteidl.core.ExecutionEnvironmentAssignment execution_envs = 9;
      case 9: {
        if (static_cast<::google::protobuf::uint8>(tag) != 74) goto handle_unusual;
        do {
          ptr = ::google::protobuf::io::ReadSize(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          parser_till_end = ::flyteidl::core::ExecutionEnvironmentAssignment::_InternalParse;
          object = msg->add_execution_envs();
          if (size > end - ptr) goto len_delim_till_end;
          ptr += size;
          GOOGLE_PROTOBUF_PARSER_ASSERT(ctx->ParseExactRange(
              {parser_till_end, object}, ptr - size, ptr));
...
void WorkflowExecutionConfig::SerializeWithCachedSizes(
  ...
  // repeated .flyteidl.core.ExecutionEnvironmentAssignment execution_envs = 9;
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->execution_envs_size()); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      9,
      this->execution_envs(static_cast<int>(i)),
      output);
  }
...
::google::protobuf::uint8* WorkflowExecutionConfig::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        9, this->execution_envs(static_cast<int>(i)), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:flyteidl.admin.WorkflowExecutionConfig)
  ...
  // repeated .flyteidl.core.ExecutionEnvironmentAssignment execution_envs = 9;
  {
    unsigned int count = static_cast<unsigned int>(this->execution_envs_size());
    total_size += 1UL * count;
    for (unsigned int i = 0; i < count; i++) {
      total_size +=
        ::google::protobuf::internal::WireFormatLite::MessageSize(
...
// @@protoc_insertion_point(class_specific_merge_from_start:flyteidl.admin.WorkflowExecutionConfig)
  ...
  execution_envs_.MergeFrom(from.execution_envs_);
  if (from.has_security_context()) {
...
void WorkflowExecutionConfig::InternalSwap(WorkflowExecutionConfig* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  CastToBase(&execution_envs_)->InternalSwap(CastToBase(&other->execution_envs_));
