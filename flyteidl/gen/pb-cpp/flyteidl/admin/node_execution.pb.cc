...
extern PROTOBUF_INTERNAL_EXPORT_flyteidl_2fadmin_2fnode_5fexecution_2eproto ::google::protobuf::internal::SCCInfo<7> scc_info_NodeExecutionClosure_flyteidl_2fadmin_2fnode_5fexecution_2eproto;
...
::google::protobuf::internal::SCCInfo<7> scc_info_NodeExecutionClosure_flyteidl_2fadmin_2fnode_5fexecution_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 7, InitDefaultsNodeExecutionClosure_flyteidl_2fadmin_2fnode_5fexecution_2eproto}, {
...
const ::google::protobuf::uint32 TableStruct_flyteidl_2fadmin_2fnode_5fexecution_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(::flyteidl::admin::NodeExecutionClosureDefaultTypeInternal, full_outputs_),
  ...
  PROTOBUF_FIELD_OFFSET(::flyteidl::admin::NodeExecutionGetDataResponse, input_data_),
  PROTOBUF_FIELD_OFFSET(::flyteidl::admin::NodeExecutionGetDataResponse, output_data_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 46, -1, sizeof(::flyteidl::admin::NodeExecutionList)},
  { 53, -1, sizeof(::flyteidl::admin::NodeExecutionClosure)},
  { 73, -1, sizeof(::flyteidl::admin::WorkflowNodeMetadata)},
  { 79, -1, sizeof(::flyteidl::admin::TaskNodeMetadata)},
  { 87, -1, sizeof(::flyteidl::admin::DynamicWorkflowNodeMetadata)},
  { 95, -1, sizeof(::flyteidl::admin::NodeExecutionGetDataRequest)},
  { 101, -1, sizeof(::flyteidl::admin::NodeExecutionGetDataResponse)},
  { 114, -1, sizeof(::flyteidl::admin::GetDynamicNodeWorkflowRequest)},
  { 120, -1, sizeof(::flyteidl::admin::DynamicNodeWorkflowResponse)},
};
...
::google::protobuf::internal::DescriptorTable descriptor_table_flyteidl_2fadmin_2fnode_5fexecution_2eproto = {
  ...
  "flyteidl/admin/node_execution.proto", &assign_descriptors_table_flyteidl_2fadmin_2fnode_5fexecution_2eproto, 3061,
};
...
void NodeExecutionClosure::InitAsDefaultInstance() {
  ...
  ::flyteidl::admin::_NodeExecutionClosure_default_instance_.full_outputs_ = const_cast< ::flyteidl::core::OutputData*>(
...
class NodeExecutionClosure::HasBitSetters {
 public:
  ...
  static const ::flyteidl::core::OutputData& full_outputs(const NodeExecutionClosure* msg);
...
NodeExecutionClosure::HasBitSetters::full_outputs(const NodeExecutionClosure* msg) {
  return *msg->output_result_.full_outputs_;
}
...
void NodeExecutionClosure::set_allocated_full_outputs(::flyteidl::core::OutputData* full_outputs) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  clear_output_result();
  if (full_outputs) {
    ::google::protobuf::Arena* submessage_arena = nullptr;
    ...
    output_result_.full_outputs_ = full_outputs;
  }
  // @@protoc_insertion_point(field_set_allocated:flyteidl.admin.NodeExecutionClosure.full_outputs)
}
void NodeExecutionClosure::clear_full_outputs() {
  if (has_full_outputs()) {
    delete output_result_.full_outputs_;
    clear_has_output_result();
  }
}
...
const int NodeExecutionClosure::kFullOutputsFieldNumber;
...
NodeExecutionClosure::NodeExecutionClosure(const NodeExecutionClosure& from)
  ...
  switch (from.output_result_case()) {
    ...
    case kFullOutputs: {
      mutable_full_outputs()->::flyteidl::core::OutputData::MergeFrom(from.full_outputs());
      break;
    }
...
const char* NodeExecutionClosure::_InternalParse(const char* begin, const char* end, void* object,
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      // .flyteidl.core.OutputData full_outputs = 13;
      case 13: {
...
void NodeExecutionClosure::SerializeWithCachedSizes(
  ...
  if (has_full_outputs()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      13, HasBitSetters::full_outputs(this), output);
  }
...
::google::protobuf::uint8* NodeExecutionClosure::InternalSerializeWithCachedSizesToArray(
  ...
  if (has_full_outputs()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        13, HasBitSetters::full_outputs(this), target);
  }
...
void NodeExecutionGetDataResponse::InitAsDefaultInstance() {
  ...
  ::flyteidl::admin::_NodeExecutionGetDataResponse_default_instance_._instance.get_mutable()->full_outputs_ = const_cast< ::flyteidl::core::LiteralMap*>(
      ::flyteidl::core::LiteralMap::internal_default_instance());
  ::flyteidl::admin::_NodeExecutionGetDataResponse_default_instance_._instance.get_mutable()->input_data_ = const_cast< ::flyteidl::core::InputData*>(
      ::flyteidl::core::InputData::internal_default_instance());
  ::flyteidl::admin::_NodeExecutionGetDataResponse_default_instance_._instance.get_mutable()->output_data_ = const_cast< ::flyteidl::core::OutputData*>(
      ::flyteidl::core::OutputData::internal_default_instance());
...
class NodeExecutionGetDataResponse::HasBitSetters {
 public:
  ...
  static const ::flyteidl::core::InputData& input_data(const NodeExecutionGetDataResponse* msg);
  static const ::flyteidl::core::OutputData& output_data(const NodeExecutionGetDataResponse* msg);
...
NodeExecutionGetDataResponse::HasBitSetters::input_data(const NodeExecutionGetDataResponse* msg) {
  return *msg->input_data_;
}
const ::flyteidl::core::OutputData&
NodeExecutionGetDataResponse::HasBitSetters::output_data(const NodeExecutionGetDataResponse* msg) {
...
void NodeExecutionGetDataResponse::clear_input_data() {
  if (GetArenaNoVirtual() == nullptr && input_data_ != nullptr) {
    delete input_data_;
  }
  input_data_ = nullptr;
}
void NodeExecutionGetDataResponse::clear_output_data() {
...
const int NodeExecutionGetDataResponse::kInputDataFieldNumber;
const int NodeExecutionGetDataResponse::kOutputDataFieldNumber;
...
NodeExecutionGetDataResponse::NodeExecutionGetDataResponse(const NodeExecutionGetDataResponse& from)
  ...
  if (from.has_input_data()) {
    input_data_ = new ::flyteidl::core::InputData(*from.input_data_);
  } else {
    input_data_ = nullptr;
  }
  if (from.has_output_data()) {
    output_data_ = new ::flyteidl::core::OutputData(*from.output_data_);
  } else {
    output_data_ = nullptr;
  }
...
const char* NodeExecutionGetDataResponse::_InternalParse(const char* begin, const char* end, void* object,
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      // .flyteidl.core.InputData input_data = 5;
      case 5: {
        if (static_cast<::google::protobuf::uint8>(tag) != 42) goto handle_unusual;
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
      ...
      // .flyteidl.core.OutputData output_data = 6;
      case 6: {
        if (static_cast<::google::protobuf::uint8>(tag) != 50) goto handle_unusual;
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
...
void NodeExecutionGetDataResponse::SerializeWithCachedSizes(
  ...
  if (this->has_input_data()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, HasBitSetters::input_data(this), output);
  }

  // .flyteidl.core.OutputData output_data = 6;
  if (this->has_output_data()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      6, HasBitSetters::output_data(this), output);
  }
...
::google::protobuf::uint8* NodeExecutionGetDataResponse::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_input_data()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        5, HasBitSetters::input_data(this), target);
  }
  ...
  if (this->has_output_data()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        6, HasBitSetters::output_data(this), target);
  }
