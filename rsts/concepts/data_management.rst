...
Flytekit has a pluggable data persistence layer as explained in :std:ref:`extend data persistence layer <https://docs.flyte.org/projects/flytekit/en/latest/data.extend.html#data-persistence-layer>`. This is driven by PROTOCOL.
