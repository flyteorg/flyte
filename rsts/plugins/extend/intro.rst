...
Case 1: I dont want to use my special Type - e.g. my own DataFrame format
==========================================================================
...
Flytekit allows users to model these types in python, so that they are useful in the users code, but are converted natively to a Flyte generic representation. As an example,
