...
Talk about what a sandbox deployment is and how it relates to flytectl demo start.
...
_This section should be moved/removed depending on how easy/hard it is to do._
(Jeev had concerns around the ease of this because the address for S3 needs to be the same? from within the cluster as outside of it.)
