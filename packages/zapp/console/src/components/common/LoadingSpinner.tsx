...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ size = 'large' }) => {
  ...
  return shouldRender ? (
    <div className={classnames(styles.container, size)} data-testid="loading-spinner">
...
export const SmallLoadingSpinner: React.FC = () => <LoadingSpinner size="small" />;
/** `LoadingSpinner` with a pre-bound size of `medium` */
export const MediumLoadingSpinner: React.FC = () => <LoadingSpinner size="medium" />;
/** `LoadingSpinner` with a pre-bound size of `large` */
export const LargeLoadingSpinner: React.FC = () => <LoadingSpinner size="large" />;
