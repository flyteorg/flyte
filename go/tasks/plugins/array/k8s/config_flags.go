...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "remoteClusterConfig.name"), defaultConfig.RemoteClusterConfig.Name, "")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "remoteClusterConfig.endpoint"), defaultConfig.RemoteClusterConfig.Endpoint, "")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "remoteClusterConfig.auth.type"), defaultConfig.RemoteClusterConfig.Auth.Type, "")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "remoteClusterConfig.auth.tokenPath"), defaultConfig.RemoteClusterConfig.Auth.TokenPath, "")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "remoteClusterConfig.auth.certPath"), defaultConfig.RemoteClusterConfig.Auth.CertPath, "")
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "remoteClusterConfig.enabled"), defaultConfig.RemoteClusterConfig.Enabled, "")
