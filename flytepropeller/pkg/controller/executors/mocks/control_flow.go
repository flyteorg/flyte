...
func (_m *ControlFlow) VisitedNodes() executors.VisitedNodes {
	ret := _m.Called()
...
// ControlFlow_VisitedNodes_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'VisitedNodes'
type ControlFlow_VisitedNodes_Call struct {
	*mock.Call
}

// VisitedNodes is a helper method to define mock.On call
func (_e *ControlFlow_Expecter) VisitedNodes() *ControlFlow_VisitedNodes_Call {
	return &ControlFlow_VisitedNodes_Call{Call: _e.mock.On("VisitedNodes")}
}

func (_c *ControlFlow_VisitedNodes_Call) Run(run func()) *ControlFlow_VisitedNodes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ControlFlow_VisitedNodes_Call) Return(_a0 executors.VisitedNodes) *ControlFlow_VisitedNodes_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ControlFlow_VisitedNodes_Call) RunAndReturn(run func() executors.VisitedNodes) *ControlFlow_VisitedNodes_Call {
	_c.Call.Return(run)
	return _c
}
