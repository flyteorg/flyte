...
func (_m *ExecutionContext) FindLaunchPlan(id v1alpha1.Identifier) v1alpha1.ExecutableLaunchPlan {
	...
	if len(ret) == 0 {
		panic("no return value specified for FindLaunchPlan")
	}
...
// ExecutionContext_FindLaunchPlan_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindLaunchPlan'
type ExecutionContext_FindLaunchPlan_Call struct {
	*mock.Call
}

// FindLaunchPlan is a helper method to define mock.On call
//   - id v1alpha1.Identifier
func (_e *ExecutionContext_Expecter) FindLaunchPlan(id interface{}) *ExecutionContext_FindLaunchPlan_Call {
	return &ExecutionContext_FindLaunchPlan_Call{Call: _e.mock.On("FindLaunchPlan", id)}
}

func (_c *ExecutionContext_FindLaunchPlan_Call) Run(run func(id v1alpha1.Identifier)) *ExecutionContext_FindLaunchPlan_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(v1alpha1.Identifier))
	})
	return _c
}

func (_c *ExecutionContext_FindLaunchPlan_Call) Return(_a0 v1alpha1.ExecutableLaunchPlan) *ExecutionContext_FindLaunchPlan_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ExecutionContext_FindLaunchPlan_Call) RunAndReturn(run func(v1alpha1.Identifier) v1alpha1.ExecutableLaunchPlan) *ExecutionContext_FindLaunchPlan_Call {
	_c.Call.Return(run)
	return _c
}
