...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "insecure"), defaultConfig.Insecure, " Use insecure (plaintext) grpc connection")
	cmdFlags.Bool(fmt.Sprintf("%v%v", prefix, "insecure-skip-verify"), defaultConfig.InsecureSkipVerify, " Use TLS but skip server certificate verification (for self-signed certs)")
