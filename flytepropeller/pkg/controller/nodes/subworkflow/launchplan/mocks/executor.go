...
func (_m *Executor) OnGetStatus(ctx context.Context, executionID *core.WorkflowExecutionIdentifier, launchPlan v1alpha1.ExecutableLaunchPlan) *Executor_GetStatus {
	c_call := _m.On("GetStatus", ctx, executionID, launchPlan)
...
// GetStatus provides a mock function with given fields: ctx, executionID, launchPlan
func (_m *Executor) GetStatus(ctx context.Context, executionID *core.WorkflowExecutionIdentifier, launchPlan v1alpha1.ExecutableLaunchPlan) (*admin.ExecutionClosure, *core.LiteralMap, error) {
	ret := _m.Called(ctx, executionID, launchPlan)

	var r0 *admin.ExecutionClosure
	if rf, ok := ret.Get(0).(func(context.Context, *core.WorkflowExecutionIdentifier, v1alpha1.ExecutableLaunchPlan) *admin.ExecutionClosure); ok {
		r0 = rf(ctx, executionID, launchPlan)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *core.WorkflowExecutionIdentifier, v1alpha1.ExecutableLaunchPlan) *core.LiteralMap); ok {
		r1 = rf(ctx, executionID, launchPlan)
	} else {
		if ret.Get(1) != nil {
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(context.Context, *core.WorkflowExecutionIdentifier, v1alpha1.ExecutableLaunchPlan) error); ok {
		r2 = rf(ctx, executionID, launchPlan)
	} else {
		r2 = ret.Error(2)
	}
...
func (_m *Executor) OnLaunch(ctx context.Context, launchCtx launchplan.LaunchContext, executionID *core.WorkflowExecutionIdentifier, launchPlan v1alpha1.ExecutableLaunchPlan, inputs *core.LiteralMap) *Executor_Launch {
	c_call := _m.On("Launch", ctx, launchCtx, executionID, launchPlan, inputs)
...
// Launch provides a mock function with given fields: ctx, launchCtx, executionID, launchPlan, inputs
func (_m *Executor) Launch(ctx context.Context, launchCtx launchplan.LaunchContext, executionID *core.WorkflowExecutionIdentifier, launchPlan v1alpha1.ExecutableLaunchPlan, inputs *core.LiteralMap) error {
	ret := _m.Called(ctx, launchCtx, executionID, launchPlan, inputs)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, launchplan.LaunchContext, *core.WorkflowExecutionIdentifier, v1alpha1.ExecutableLaunchPlan, *core.LiteralMap) error); ok {
		r0 = rf(ctx, launchCtx, executionID, launchPlan, inputs)
	} else {
		r0 = ret.Error(0)
	}
