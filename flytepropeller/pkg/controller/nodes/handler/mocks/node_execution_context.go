...
import (
	events "github.com/lyft/flyteidl/clients/go/events"
...
func (_m NodeExecutionContext_Workflow) Return(_a0 v1alpha1.ExecutableWorkflow) *NodeExecutionContext_Workflow {
	return &NodeExecutionContext_Workflow{Call: _m.Call.Return(_a0)}
}

func (_m *NodeExecutionContext) OnWorkflow() *NodeExecutionContext_Workflow {
	c := _m.On("Workflow")
	return &NodeExecutionContext_Workflow{Call: c}
}

func (_m *NodeExecutionContext) OnWorkflowMatch(matchers ...interface{}) *NodeExecutionContext_Workflow {
	c := _m.On("Workflow", matchers...)
	return &NodeExecutionContext_Workflow{Call: c}
}
