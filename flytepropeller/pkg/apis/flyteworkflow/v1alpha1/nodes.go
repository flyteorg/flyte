...
func (in *TypedInterface) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	if err := marshaler.Marshal(&buf, in.TypedInterface); err != nil {
		return nil, err
	}
...
func (in *TypedInterface) UnmarshalJSON(b []byte) error {
	in.TypedInterface = &core.TypedInterface{}
	return jsonpb.Unmarshal(bytes.NewReader(b), in.TypedInterface)
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TypedInterface) DeepCopyInto(out *TypedInterface) {
	*out = *in
	// We do not manipulate the object, so its ok
	// Once we figure out the autogenerate story we can replace this
}
...
type NodeSpec struct {
	...
	// Cacheable indicates that this nodes output data should be cached.
	// +optional
	Cacheable *bool `json:"cacheable,omitempty"`
	// CacheVersion defines the version of this nodes data in the cache.
	// +optional
...
func (in *NodeSpec) IsCacheable() *bool {
	return in.Cacheable
}

func (in *NodeSpec) GetCacheVersion() *string {
	return in.CacheVersion
}

func (in *NodeSpec) IsCacheSerializable() *bool {
