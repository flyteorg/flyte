...
type ExecutableSubWorkflow_GetIdentifier struct {
	*mock.Call
}

func (_m ExecutableSubWorkflow_GetIdentifier) Return(_a0 *core.Identifier) *ExecutableSubWorkflow_GetIdentifier {
	return &ExecutableSubWorkflow_GetIdentifier{Call: _m.Call.Return(_a0)}
}

func (_m *ExecutableSubWorkflow) OnGetIdentifier() *ExecutableSubWorkflow_GetIdentifier {
	c_call := _m.On("GetIdentifier")
	return &ExecutableSubWorkflow_GetIdentifier{Call: c_call}
}

func (_m *ExecutableSubWorkflow) OnGetIdentifierMatch(matchers ...interface{}) *ExecutableSubWorkflow_GetIdentifier {
	c_call := _m.On("GetIdentifier", matchers...)
	return &ExecutableSubWorkflow_GetIdentifier{Call: c_call}
}

// GetIdentifier provides a mock function with given fields:
func (_m *ExecutableSubWorkflow) GetIdentifier() *core.Identifier {
	ret := _m.Called()
...
type ExecutableSubWorkflow_GetInterface struct {
	*mock.Call
}

func (_m ExecutableSubWorkflow_GetInterface) Return(_a0 *core.TypedInterface) *ExecutableSubWorkflow_GetInterface {
	return &ExecutableSubWorkflow_GetInterface{Call: _m.Call.Return(_a0)}
}

func (_m *ExecutableSubWorkflow) OnGetInterface() *ExecutableSubWorkflow_GetInterface {
	c_call := _m.On("GetInterface")
	return &ExecutableSubWorkflow_GetInterface{Call: c_call}
}

func (_m *ExecutableSubWorkflow) OnGetInterfaceMatch(matchers ...interface{}) *ExecutableSubWorkflow_GetInterface {
	c_call := _m.On("GetInterface", matchers...)
	return &ExecutableSubWorkflow_GetInterface{Call: c_call}
}

// GetInterface provides a mock function with given fields:
func (_m *ExecutableSubWorkflow) GetInterface() *core.TypedInterface {
	ret := _m.Called()
