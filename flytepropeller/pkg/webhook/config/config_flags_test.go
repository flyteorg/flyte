...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_embeddedSecretManagerConfig.awsConfig.maxRetries", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("embeddedSecretManagerConfig.awsConfig.maxRetries", testValue)
			if vInt, err := cmdFlags.GetInt("embeddedSecretManagerConfig.awsConfig.maxRetries"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vInt), &actual.EmbeddedSecretManagerConfig.AWSConfig.MaxRetries)
