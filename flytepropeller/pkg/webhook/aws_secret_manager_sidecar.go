...
type AWSSecretManagerSidecarInjector struct {
...
func (i AWSSecretManagerSidecarInjector) Type() config.SecretManagerType {
	return config.SecretManagerTypeAWS
}

func (i AWSSecretManagerSidecarInjector) Inject(ctx context.Context, secret *core.Secret, p *corev1.Pod) (newP *corev1.Pod, injected bool, err error) {
...
// NewAWSSecretManagerSidecarInjector creates a SecretInjector that's able to mount secrets from AWS Secret Manager using sidecar.
func NewAWSSecretManagerSidecarInjector(cfg config.AWSSecretManagerConfig) AWSSecretManagerSidecarInjector {
	return AWSSecretManagerSidecarInjector{
		cfg: cfg,
	}
}
