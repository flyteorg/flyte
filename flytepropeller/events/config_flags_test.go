...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_filter-size", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("filter-size", testValue)
			if vInt, err := cmdFlags.GetInt("filter-size"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vInt), &actual.FilterSize)
