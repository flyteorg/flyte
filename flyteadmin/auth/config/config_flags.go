...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "appAuth.externalAuthServer.retryDelayMilliseconds"), DefaultConfig.AppAuth.ExternalAuthServer.RetryDelayMilliseconds.String(), " Optional,  Duration in milliseconds to wait between retries")
