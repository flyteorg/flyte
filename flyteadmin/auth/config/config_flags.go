...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.StringSlice(fmt.Sprintf("%v%v", prefix, "appAuth.subjectClaimNames"), DefaultConfig.AppAuth.SubjectClaimNames, "Ordered list of JWT claim names to try for subject identity resolution from access tokens. When empty the standard sub claim is used.")
