...
func TestCreateLaunchPlan(t *testing.T) {
	...
	repository.LaunchPlanRepo().(*repositoryMocks.MockLaunchPlanRepo).SetCreateCallback(
		func(input models.LaunchPlan) error {
			assert.Equal(t, []byte{0x3f, 0x79, 0x8b, 0x7c, 0xff, 0x94, 0xc2, 0xa2, 0x73, 0x11, 0xca, 0x7c, 0x11, 0xbc,
				0x93, 0xe6, 0x98, 0x25, 0x24, 0xd8, 0xa8, 0xc1, 0xad, 0xdb, 0xd5, 0x5d, 0x13, 0xd6, 0x77, 0xf6, 0x32, 0x97}, input.Digest)
			createCalled = true
			return nil
		})
