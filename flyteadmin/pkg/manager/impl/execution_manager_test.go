...
func TestCreateExecution_ConcurrencyPolicy(t *testing.T) {
	...
	var mockPublisher notificationMocks.MockPublisher
	var mockUrlData dataMocks.MockRemoteURL
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockPluginRegistry.RegisterDefault(plugins.PluginIDPreExecutionValidation, noopPreExecutionValidationPlugin)
			...
			executionManager := NewExecutionManager(
				...
				&mockPublisher,
				&mockUrlData,
				&managerMocks.MockWorkflowManager{},
				&managerMocks.MockLaunchPlanManager{},
				&managerMocks.NamedEntityManager{},
				nil,
				nil,
