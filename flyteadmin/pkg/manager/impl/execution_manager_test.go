...
func TestCreateExecution(t *testing.T) {
	...
	execManager := NewExecutionManager(repository, r, mockConfig, getMockStorageForExecTest(context.Background()), mockScope.NewTestScope(), mockScope.NewTestScope(), &mockPublisher, nil, nil, &mockPublisher, nil, &eventWriterMocks.WorkflowExecutionEventWriter{})
...
func TestCreateExecutionFromWorkflowNode(t *testing.T) {
	...
	execManager := NewExecutionManager(repository, r, getMockExecutionsConfigProvider(), getMockStorageForExecTest(context.Background()), mockScope.NewTestScope(), mockScope.NewTestScope(), &mockPublisher, nil, nil, nil, nil, &eventWriterMocks.WorkflowExecutionEventWriter{})
	request := testutils.GetExecutionRequest()
	request.Spec.Metadata = &admin.ExecutionMetadata{
...
func TestCreateExecution_TaggedQueue(t *testing.T) {
	...
	r := plugins.NewRegistry()
	r.RegisterDefault(plugins.PluginIDWorkflowExecutor, &mockExecutor)
	execManager := NewExecutionManager(repository, r, configProvider, getMockStorageForExecTest(context.Background()), mockScope.NewTestScope(), mockScope.NewTestScope(), &mockPublisher, nil, nil, nil, nil, &eventWriterMocks.WorkflowExecutionEventWriter{})
...
func TestCreateExecutionVerifyDbModel(t *testing.T) {
	...
	r := plugins.NewRegistry()
	r.RegisterDefault(plugins.PluginIDWorkflowExecutor, &mockExecutor)
	execManager := NewExecutionManager(repository, r, getMockExecutionsConfigProvider(), storageClient, mockScope.NewTestScope(), mockScope.NewTestScope(), &mockPublisher, nil, nil, nil, nil, &eventWriterMocks.WorkflowExecutionEventWriter{})
...
func TestCreateExecution_CustomNamespaceMappingConfig(t *testing.T) {
	...
	execManager := NewExecutionManager(repository, r, mockExecutionsConfigProvider, storageClient, mockScope.NewTestScope(), mockScope.NewTestScope(), &mockPublisher, nil, nil, nil, nil, &eventWriterMocks.WorkflowExecutionEventWriter{})
...
func TestRecoverExecution_GetExistingInputsFailure(t *testing.T) {
	...
	r := plugins.NewRegistry()
	r.RegisterDefault(plugins.PluginIDWorkflowExecutor, &defaultTestExecutor)
	execManager := NewExecutionManager(repository, r, getMockExecutionsConfigProvider(), mockStorage, mockScope.NewTestScope(), mockScope.NewTestScope(), &mockPublisher, nil, nil, nil, nil, &eventWriterMocks.WorkflowExecutionEventWriter{})
	startTime := time.Now()
	startTimeProto, _ := ptypes.TimestampProto(startTime)
	existingClosure := admin.ExecutionClosure{
		Phase:     core.WorkflowExecution_SUCCEEDED,
...
func TestCreateWorkflowEvent(t *testing.T) {
	...
	r := plugins.NewRegistry()
	r.RegisterDefault(plugins.PluginIDWorkflowExecutor, &defaultTestExecutor)
	execManager := NewExecutionManager(repository, r, getMockExecutionsConfigProvider(), getMockStorageForExecTest(context.Background()), mockScope.NewTestScope(), mockScope.NewTestScope(), &mockPublisher, nil, nil, &mockPublisher, &mockPublisher, mockDbEventWriter)
...
func TestListExecutions_MissingParameters(t *testing.T) {
	r := plugins.NewRegistry()
	r.RegisterDefault(plugins.PluginIDWorkflowExecutor, &defaultTestExecutor)
	execManager := NewExecutionManager(repositoryMocks.NewMockRepository(), r, getMockExecutionsConfigProvider(), getMockStorageForExecTest(context.Background()), mockScope.NewTestScope(), mockScope.NewTestScope(), &mockPublisher, nil, nil, nil, nil, &eventWriterMocks.WorkflowExecutionEventWriter{})
...
func TestAddPluginOverrides(t *testing.T) {
	...
	r := plugins.NewRegistry()
	r.RegisterDefault(plugins.PluginIDWorkflowExecutor, &defaultTestExecutor)
	execManager := NewExecutionManager(db, r, getMockExecutionsConfigProvider(), getMockStorageForExecTest(context.Background()), mockScope.NewTestScope(), mockScope.NewTestScope(), &mockPublisher, nil, nil, nil, nil, &eventWriterMocks.WorkflowExecutionEventWriter{})
...
func TestCreateSingleTaskExecution(t *testing.T) {
	...
	r := plugins.NewRegistry()
	r.RegisterDefault(plugins.PluginIDWorkflowExecutor, &mockExecutor)
	execManager := NewExecutionManager(repository, r, getMockExecutionsConfigProvider(), mockStorage, mockScope.NewTestScope(), mockScope.NewTestScope(), &mockPublisher, workflowManager, namedEntityManager, nil, nil, &eventWriterMocks.WorkflowExecutionEventWriter{})
