...
type NodeExecutionRepoInterface interface {
	...
	Create(ctx context.Context, id *core.NodeExecutionIdentifier, execution *models.NodeExecution) error
	// Update an existing node execution in the database store with all non-empty fields in the input.
	Update(ctx context.Context, id *core.NodeExecutionIdentifier, execution *models.NodeExecution) error
	// Get returns a matching execution if it exists.
	Get(ctx context.Context, id *core.NodeExecutionIdentifier) (models.NodeExecution, error)
	...
	GetWithChildren(ctx context.Context, id *core.NodeExecutionIdentifier) (models.NodeExecution, error)
	...
	Exists(ctx context.Context, id *core.NodeExecutionIdentifier) (bool, error)
