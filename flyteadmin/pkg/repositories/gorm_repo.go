...
type GormRepo struct {
	...
	configurationDocumentRepo    interfaces.ConfigurationDocumentRepoInterface
...
func (r *GormRepo) ConfigurationDocumentRepo() interfaces.ConfigurationDocumentRepoInterface {
	return r.configurationDocumentRepo
}
...
func NewGormRepo(db *gorm.DB, errorTransformer errors.ErrorTransformer, scope promutils.Scope) interfaces.Repository {
	return &GormRepo{
		...
		configurationDocumentRepo:    gormimpl.NewConfigurationRepo(db, errorTransformer, scope.NewSubScope("configuration")),
