...
func TestCreateTaskExecution(t *testing.T) {
	...
	err := taskExecutionRepo.Create(context.Background(), &core.TaskExecutionIdentifier{}, testTaskExecution)
...
func TestUpdateTaskExecution(t *testing.T) {
	...
	err := taskExecutionRepo.Update(context.Background(), &core.TaskExecutionIdentifier{}, testTaskExecution)
	assert.NoError(t, err)
