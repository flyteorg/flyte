...
func (cfg ServerConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.Int(fmt.Sprintf("%v%v", prefix, "watchService.maxPageSize"), defaultServerConfig.WatchService.MaxPageSize, "")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "watchService.pollInterval"), defaultServerConfig.WatchService.PollInterval.String(), "")
	cmdFlags.Int(fmt.Sprintf("%v%v", prefix, "watchService.maxActiveClusterConnections"), defaultServerConfig.WatchService.MaxActiveClusterConnections, "")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "watchService.nonTerminalStatusUpdatesInterval"), defaultServerConfig.WatchService.NonTerminalStatusUpdatesInterval.String(), "")
	return cmdFlags
}
