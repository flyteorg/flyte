...
func (cfg ServerConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "serviceHttpEndpoint"), defaultServerConfig.ServiceHTTPEndpoint.String(), "Defines the http endpoint the service is accessible at.")
	return cmdFlags
}
