...
type executionEndpointMetrics struct {
	...
	count        util.RequestMetrics
	runningCount util.RequestMetrics
}
...
func InitMetrics(adminScope promutils.Scope) AdminMetrics {
	return AdminMetrics{
		...
		executionEndpointMetrics: executionEndpointMetrics{
			...
			count:        util.NewRequestMetrics(adminScope, "count_execution"),
		...
		orgAttributesEndpointMetrics: attributeEndpointMetrics{
			scope:  adminScope,
			update: util.NewRequestMetrics(adminScope, "update_org_attrs"),
			get:    util.NewRequestMetrics(adminScope, "get_org_attrs"),
			delete: util.NewRequestMetrics(adminScope, "delete_org_attrs"),
		},
		projectAttributesEndpointMetrics: attributeEndpointMetrics{
			scope:  adminScope,
