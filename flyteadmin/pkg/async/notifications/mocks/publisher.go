...
func (_m *Publisher) Publish(ctx context.Context, notificationType string, msg protoreflect.ProtoMessage) error {
...
func (_c *Publisher_Publish_Call) Run(run func(ctx context.Context, notificationType string, msg protoreflect.ProtoMessage)) *Publisher_Publish_Call {
...
func (_c *Publisher_Publish_Call) RunAndReturn(run func(context.Context, string, protoreflect.ProtoMessage) error) *Publisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
