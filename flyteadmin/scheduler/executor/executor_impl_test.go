...
func TestExecutor(t *testing.T) {
	...
	active := true
	mockAdminClient.On("CreateExecution", mock.Anything, mock.Anything).Return(&admin.ExecutionCreateResponse{}, nil)
...
func TestExecutorAlreadyExists(t *testing.T) {
	...
	mockAdminClient.On("CreateExecution", mock.Anything, mock.Anything).Return(nil,
