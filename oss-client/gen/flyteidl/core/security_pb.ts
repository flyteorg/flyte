...
/**
 * Describes the file flyteidl/core/security.proto.
 */
export const file_flyteidl_core_security: GenFile = /*@__PURE__*/
  fileDesc("");
 ...
 */
export type Secret = Message<"flyteidl.core.Secret"> & {
  /**
...
/**
 * Describes the enum flyteidl.core.Secret.MountType.
 */
export const Secret_MountTypeSchema: GenEnum<Secret_MountType> = /*@__PURE__*/
  enumDesc(file_flyteidl_core_security, 0, 0);

/**
 * @generated from message flyteidl.core.Connection
 */
export type Connection = Message<"flyteidl.core.Connection"> & {
  /**
 ...
 */
export type OAuth2Client = Message<"flyteidl.core.OAuth2Client"> & {
  /**
 ...
 */
export type Identity = Message<"flyteidl.core.Identity"> & {
  /**
 ...
 */
export type OAuth2TokenRequest = Message<"flyteidl.core.OAuth2TokenRequest"> & {
  /**
...
/**
 * Describes the message flyteidl.core.OAuth2TokenRequest.
...
export const OAuth2TokenRequestSchema: GenMessage<OAuth2TokenRequest> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_security, 4);
...
/**
 * Describes the enum flyteidl.core.OAuth2TokenRequest.Type.
 */
export const OAuth2TokenRequest_TypeSchema: GenEnum<OAuth2TokenRequest_Type> = /*@__PURE__*/
  enumDesc(file_flyteidl_core_security, 4, 0);
 ...
 */
export type SecurityContext = Message<"flyteidl.core.SecurityContext"> & {
  /**
...
/**
 * Describes the message flyteidl.core.SecurityContext.
...
export const SecurityContextSchema: GenMessage<SecurityContext> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_security, 5);
