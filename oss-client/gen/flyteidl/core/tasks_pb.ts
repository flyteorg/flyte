...
/**
 * Describes the file flyteidl/core/tasks.proto.
 */
export const file_flyteidl_core_tasks: GenFile = /*@__PURE__*/
  fileDesc("", [file_flyteidl_core_execution, file_flyteidl_core_identifier, file_flyteidl_core_interface, file_flyteidl_core_literals, file_flyteidl_core_security, file_google_protobuf_duration, file_google_protobuf_struct, file_google_protobuf_wrappers]);
 ...
 */
export type Resources = Message<"flyteidl.core.Resources"> & {
  /**
 ...
 */
export type Resources_ResourceEntry = Message<"flyteidl.core.Resources.ResourceEntry"> & {
  /**
   * Resource name.
   *
...
/**
 * Describes the message flyteidl.core.Resources.ResourceEntry.
...
export const Resources_ResourceEntrySchema: GenMessage<Resources_ResourceEntry> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_tasks, 0, 0);
...
/**
 * Describes the enum flyteidl.core.Resources.ResourceName.
 */
export const Resources_ResourceNameSchema: GenEnum<Resources_ResourceName> = /*@__PURE__*/
  enumDesc(file_flyteidl_core_tasks, 0, 0);
 ...
 */
export type GPUAccelerator = Message<"flyteidl.core.GPUAccelerator"> & {
  /**
...
/**
 * Describes the message flyteidl.core.GPUAccelerator.
...
export const GPUAcceleratorSchema: GenMessage<GPUAccelerator> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_tasks, 1);
...
/**
 * Describes the enum flyteidl.core.GPUAccelerator.DeviceClass.
 */
export const GPUAccelerator_DeviceClassSchema: GenEnum<GPUAccelerator_DeviceClass> = /*@__PURE__*/
  enumDesc(file_flyteidl_core_tasks, 1, 0);
 ...
 */
export type SharedMemory = Message<"flyteidl.core.SharedMemory"> & {
  /**
 ...
 */
export type ExtendedResources = Message<"flyteidl.core.ExtendedResources"> & {
  /**
...
/**
 * Describes the message flyteidl.core.ExtendedResources.
...
export const ExtendedResourcesSchema: GenMessage<ExtendedResources> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_tasks, 3);
 ...
 */
export type RuntimeMetadata = Message<"flyteidl.core.RuntimeMetadata"> & {
  /**
   * Type of runtime.
   *
...
/**
 * Describes the message flyteidl.core.RuntimeMetadata.
...
export const RuntimeMetadataSchema: GenMessage<RuntimeMetadata> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_tasks, 4);
...
/**
 * Describes the enum flyteidl.core.RuntimeMetadata.RuntimeType.
 */
export const RuntimeMetadata_RuntimeTypeSchema: GenEnum<RuntimeMetadata_RuntimeType> = /*@__PURE__*/
  enumDesc(file_flyteidl_core_tasks, 4, 0);
 ...
 */
export type TaskMetadata = Message<"flyteidl.core.TaskMetadata"> & {
  /**
 ...
 */
export type TaskTemplate = Message<"flyteidl.core.TaskTemplate"> & {
  /**
 ...
 */
export type ContainerPort = Message<"flyteidl.core.ContainerPort"> & {
  /**
...
/**
 * Describes the enum flyteidl.core.Container.Architecture.
 */
export const Container_ArchitectureSchema: GenEnum<Container_Architecture> = /*@__PURE__*/
  enumDesc(file_flyteidl_core_tasks, 8, 0);
 ...
 */
export type IOStrategy = Message<"flyteidl.core.IOStrategy"> & {
  /**
...
/**
 * Describes the enum flyteidl.core.IOStrategy.DownloadMode.
 */
export const IOStrategy_DownloadModeSchema: GenEnum<IOStrategy_DownloadMode> = /*@__PURE__*/
  enumDesc(file_flyteidl_core_tasks, 9, 0);
...
/**
 * Describes the enum flyteidl.core.IOStrategy.UploadMode.
 */
export const IOStrategy_UploadModeSchema: GenEnum<IOStrategy_UploadMode> = /*@__PURE__*/
  enumDesc(file_flyteidl_core_tasks, 9, 1);
 ...
 */
export type DataLoadingConfig = Message<"flyteidl.core.DataLoadingConfig"> & {
  /**
...
/**
 * Describes the message flyteidl.core.DataLoadingConfig.
...
export const DataLoadingConfigSchema: GenMessage<DataLoadingConfig> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_tasks, 10);
...
/**
 * Describes the enum flyteidl.core.DataLoadingConfig.LiteralMapFormat.
 */
export const DataLoadingConfig_LiteralMapFormatSchema: GenEnum<DataLoadingConfig_LiteralMapFormat> = /*@__PURE__*/
  enumDesc(file_flyteidl_core_tasks, 10, 0);
 ...
 */
export type K8sPod = Message<"flyteidl.core.K8sPod"> & {
  /**
 ...
 */
export type K8sObjectMetadata = Message<"flyteidl.core.K8sObjectMetadata"> & {
  /**
...
/**
 * Describes the message flyteidl.core.K8sObjectMetadata.
...
export const K8sObjectMetadataSchema: GenMessage<K8sObjectMetadata> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_tasks, 12);
 ...
 */
export type Sql = Message<"flyteidl.core.Sql"> & {
  /**
...
/**
 * Describes the enum flyteidl.core.Sql.Dialect.
 */
export const Sql_DialectSchema: GenEnum<Sql_Dialect> = /*@__PURE__*/
  enumDesc(file_flyteidl_core_tasks, 13, 0);
