...
import { file_flyteidl_core_artifact_id } from "./artifact_id_pb.ts";
import type { Message } from "@bufbuild/protobuf";

/**
 * Describes the file flyteidl/core/interface.proto.
 */
export const file_flyteidl_core_interface: GenFile = /*@__PURE__*/
  fileDesc("", [file_flyteidl_core_types, file_flyteidl_core_literals, file_flyteidl_core_artifact_id]);
...
export const VariableSchema: GenMessage<Variable> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_interface, 0);
...
export const VariableMapSchema: GenMessage<VariableMap> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_interface, 1);
...
export const TypedInterfaceSchema: GenMessage<TypedInterface> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_interface, 2);
...
export const ParameterSchema: GenMessage<Parameter> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_interface, 3);
...
export const ParameterMapSchema: GenMessage<ParameterMap> = /*@__PURE__*/
  messageDesc(file_flyteidl_core_interface, 4);
