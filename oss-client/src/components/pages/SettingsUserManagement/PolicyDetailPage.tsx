...
export function SettingsPolicyDetailPage({
  ...
  const backUrl = returnTo
    ? `/settings/user-management?tab=policies&returnTo=${encodeURIComponent(returnTo)}`
    : '/settings/user-management?tab=policies'
...
export default SettingsPolicyDetailPage
