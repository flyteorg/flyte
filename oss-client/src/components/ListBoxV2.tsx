    ...
    <Headless.Listbox {...props} multiple={false}>
      ...
      >
        <Headless.ListboxSelectedOption
          ...
          className={clsx([
            ...
            // Background color
            noBackground ? null : 'bg-transparent dark:bg-white/5',
            // Invalid state
      ...
      <Headless.ListboxOptions
        ...
        className={clsx(
          // Anchor positioning
          '-translate-y-7.5',
          //'[--anchor-offset:-0.5em] [--anchor-padding:--spacing(4)] sm:[--anchor-offset:-0.75rem]',
          // Base styles
        ...
        return (
          <div
            className={clsx(
              ...
              // Focus
              'outline-hidden data-focus:bg-zinc-900/5 dark:data-focus:bg-white/5',
              // Forced colors mode
              'forced-color-adjust-none forced-colors:text-[CanvasText] forced-colors:data-focus:bg-[Highlight] forced-colors:data-focus:text-[HighlightText]',
              // Disabled
