...
func Setup(ctx context.Context, sc *app.SetupContext) error {
	...
	runsSvc := service.NewRunService(repo, actionsClient, dataProxyClient, projectClient, cfg.StoragePrefix, sc.DataStore, abortReconciler, cfg.TrustForwardedIdentityHeaders, cfg.IdentityHeaders)
