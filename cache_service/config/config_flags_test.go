...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_heartbeatGracePeriodMultiplier", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("heartbeatGracePeriodMultiplier", testValue)
			if vInt, err := cmdFlags.GetInt("heartbeatGracePeriodMultiplier"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vInt), &actual.HeartbeatGracePeriodMultiplier)
	...
	t.Run("Test_maxReservationHeartbeat", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := defaultConfig.MaxReservationHeartbeat.String()

			cmdFlags.Set("maxReservationHeartbeat", testValue)
			if vString, err := cmdFlags.GetString("maxReservationHeartbeat"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.MaxReservationHeartbeat)
