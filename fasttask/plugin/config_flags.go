...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "image"), defaultConfig.Image, "Fasttask image to wrap the task execution with.")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "init-container-cpu"), defaultConfig.InitContainerCPU.String(), "The default cpu request / limit for the init container used to inject the fasttask worker binary.")
