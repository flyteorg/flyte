...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "env-scale-down-interval"), defaultConfig.EnvScaleDownInterval.String(), "Frequency that environments are scaled down in case of TTL expirations.")
	...
	cmdFlags.Int(fmt.Sprintf("%v%v", prefix, "scaling-buffer-size"), defaultConfig.ScalingBufferSize, "The size of the scaling buffers (up & down) for each environment.")
