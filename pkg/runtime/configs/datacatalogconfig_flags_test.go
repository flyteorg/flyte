...
func TestDataCatalogConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_storage-prefix", func(t *testing.T) {
		t.Run("DefaultValue", func(t *testing.T) {
			...
			if vStringSlice, err := cmdFlags.GetStringSlice("storage-prefix"); err == nil {
				assert.Equal(t, []string{}, vStringSlice)
			} else {
		...
		t.Run("Override", func(t *testing.T) {
			cmdFlags.Set("storage-prefix", "1,1")
			if vStringSlice, err := cmdFlags.GetStringSlice("storage-prefix"); err == nil {
				testDecodeSlice_DataCatalogConfig(t, strings.Join(vStringSlice, ","), &actual.StoragePrefix)
