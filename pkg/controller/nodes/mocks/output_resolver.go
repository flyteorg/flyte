...
func (_m *OutputResolver) OnExtractOutput(ctx context.Context, w v1alpha1.ExecutableWorkflow, n v1alpha1.ExecutableNode, bindToVar string) *OutputResolver_ExtractOutput {
