...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_secrets-prefix", func(t *testing.T) {
		t.Run("DefaultValue", func(t *testing.T) {
			...
			if vString, err := cmdFlags.GetString("secrets-prefix"); err == nil {
				assert.Equal(t, string(defaultConfig.SecretFilePrefix), vString)
			} else {
		...
		t.Run("Override", func(t *testing.T) {
			...
			cmdFlags.Set("secrets-prefix", testValue)
			if vString, err := cmdFlags.GetString("secrets-prefix"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.SecretFilePrefix)
	...
	t.Run("Test_env-prefix", func(t *testing.T) {
		t.Run("DefaultValue", func(t *testing.T) {
			// Test that default value is set properly
			if vString, err := cmdFlags.GetString("env-prefix"); err == nil {
				assert.Equal(t, string(defaultConfig.EnvironmentPrefix), vString)
			} else {
				assert.FailNow(t, err.Error())
			}
		})
		...
		t.Run("Override", func(t *testing.T) {
			...
			cmdFlags.Set("env-prefix", testValue)
			if vString, err := cmdFlags.GetString("env-prefix"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.EnvironmentPrefix)
