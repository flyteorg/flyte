...
var testPublisher pubsubtest.TestPublisher
var mockPublisher pubsub.Publisher = &testPublisher
var currentPublisher = NewPublisher(mockPublisher, promutils.NewTestScope())
var testEmail = admin.EmailMessage{
