...
func TestFetchAllVerOfLP(t *testing.T) {
	...
	adminClient.On("ListLaunchPlans", mock.Anything, mock.Anything).Return(launchPlanListResponse, nil)
...
func TestFetchLPVersion(t *testing.T) {
	getLaunchPlanFetcherSetup()
	adminClient.On("GetLaunchPlan", mock.Anything, mock.Anything).Return(launchPlan1, nil)
...
func TestFetchAllVerOfLPError(t *testing.T) {
	getLaunchPlanFetcherSetup()
	adminClient.On("ListLaunchPlans", mock.Anything, mock.Anything).Return(nil, fmt.Errorf("failed"))
	_, err := adminFetcherExt.FetchAllVerOfLP(ctx, "lpName", "project", "domain", lpFilters)
...
func TestFetchAllVerOfLPFilterError(t *testing.T) {
	...
	adminClient.On("ListLaunchPlans", mock.Anything, mock.Anything).Return(nil, fmt.Errorf("Please add a valid field selector"))
	_, err := adminFetcherExt.FetchAllVerOfLP(ctx, "lpName", "project", "domain", lpFilters)
