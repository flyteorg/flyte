...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_maxRecords", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("maxRecords", testValue)
			if vInt, err := cmdFlags.GetInt("maxRecords"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vInt), &actual.MaxRecords)
	...
	t.Run("Test_batchSize", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("batchSize", testValue)
			if vInt, err := cmdFlags.GetInt("batchSize"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vInt), &actual.BatchSize)
