...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.BoolVar(&DefaultConfig.DisableConnector, fmt.Sprintf("%v%v", prefix, "disable-connector"), DefaultConfig.DisableConnector, "Optional. Disable the connector service.")
