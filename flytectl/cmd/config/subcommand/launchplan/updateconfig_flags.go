...
func (cfg UpdateConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.BoolVar(&UConfig.Archive, fmt.Sprintf("%v%v", prefix, "archive"), UConfig.Archive, "archive the launch plan version and hide it from list queries (disabling any schedule).")
