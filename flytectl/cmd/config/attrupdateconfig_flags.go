...
func (cfg AttrUpdateConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.StringSliceVar(&DefaultUpdateConfig.AttrFile, fmt.Sprintf("%v%v", prefix, "attrFile"), DefaultUpdateConfig.AttrFile, "attribute file names to be used for updating attribute for the resource type.")
