...
require (
	...
	github.com/flyteorg/flyte/flyteplugins v1.9.14 // indirect
	...
	github.com/unionai/fasttask/plugin v0.0.0-00010101000000-000000000000 // indirect
...
replace (
	...
	github.com/unionai/fasttask/plugin => ../fasttask/plugin
