...
require (
	...
	github.com/flyteorg/flyteadmin v1.1.100
	github.com/flyteorg/flytepropeller v1.1.90
...
require (
	...
	github.com/flyteorg/flyteidl v1.5.7 // indirect
	github.com/flyteorg/flyteplugins v1.0.63 // indirect
