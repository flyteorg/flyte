...
require (
	github.com/flyteorg/datacatalog v1.0.50
	github.com/flyteorg/flyteadmin v1.1.115
	github.com/flyteorg/flytepropeller v1.1.110
	github.com/flyteorg/flytestdlib v1.0.21
