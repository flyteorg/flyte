...
| flyte.flyteadmin.image.tag | string | `"v0.6.112"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v0.16.32"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v0.6.112"` | Docker image tag |
