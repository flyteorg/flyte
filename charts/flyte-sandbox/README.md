...
| flyte-binary.clusterResourceTemplates.inlineConfigMap | string | `"{{ template \"flyte-sandbox.clusterResourceTemplates.inlineConfigMap\" . }}"` |  |
...
| flyte-binary.configuration.inlineConfigMap | string | `"{{ template \"flyte-sandbox.configuration.inlineConfigMap\" . }}"` |  |
