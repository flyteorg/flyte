...
| flyteadmin.image.tag | string | `"v1.1.16"` |  |
...
| flyteconsole.image.tag | string | `"v1.1.0"` |  |
...
| flytepropeller.image.tag | string | `"v1.1.7"` |  |
...
| flytescheduler.image.tag | string | `"v1.1.16"` | Docker image tag |
