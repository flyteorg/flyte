...
| datacatalog.image.tag | string | `"v1.0.41"` | Docker image tag |
...
| flyteadmin.image.tag | string | `"v1.1.70"` |  |
...
| flytepropeller.image.tag | string | `"v1.1.62"` |  |
...
| flytescheduler.image.tag | string | `"v1.1.70"` | Docker image tag |
