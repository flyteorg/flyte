...
| configmap.task_resource_defaults | object | `{"task_resources":{"defaults":{"cpu":"100m","memory":"500Mi","storage":"500Mi"}}}` | Task default resources configuration Refer to the full [structure](https://pkg.go.dev/github.com/lyft/flyteadmin@v0.3.37/pkg/runtime/interfaces#TaskResourceConfiguration). |
| configmap.task_resource_defaults.task_resources | object | `{"defaults":{"cpu":"100m","memory":"500Mi","storage":"500Mi"}}` | Task default resources parameters |
...
| flyteadmin.image.tag | string | `"v1.1.50"` |  |
...
| flyteconsole.image.tag | string | `"v1.3.4"` |  |
...
| flytepropeller.image.tag | string | `"v1.1.43"` |  |
...
| flytescheduler.image.tag | string | `"v1.1.50"` | Docker image tag |
