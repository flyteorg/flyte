...
| flyteadmin.image.tag | string | `"v0.6.144"` |  |
...
| flyteconsole.image.tag | string | `"v0.51.1"` |  |
...
| flytepropeller.image.tag | string | `"v0.16.44"` |  |
...
| flytescheduler.image.tag | string | `"v0.6.144"` | Docker image tag |
