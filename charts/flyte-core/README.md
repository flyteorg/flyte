...
| datacatalog.image.tag | string | `"v1.0.50"` | Docker image tag |
...
| flyteadmin.image.tag | string | `"v1.1.115"` |  |
...
| flyteconsole.image.tag | string | `"v1.9.0"` |  |
...
| flytepropeller.image.tag | string | `"v1.1.110"` |  |
...
| flytescheduler.image.tag | string | `"v1.1.115"` | Docker image tag |
