...
| flyteadmin.image.tag | string | `"v1.1.28"` |  |
...
| flyteconsole.image.tag | string | `"v1.1.3"` |  |
...
| flytepropeller.image.tag | string | `"v1.1.14"` |  |
...
| flytescheduler.image.tag | string | `"v1.1.28"` | Docker image tag |
