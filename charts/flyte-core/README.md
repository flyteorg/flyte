...
| datacatalog.image.tag | string | `"v1.0.35"` | Docker image tag |
...
| flyteadmin.image.tag | string | `"v1.1.54"` |  |
...
| flytepropeller.image.tag | string | `"v1.1.47"` |  |
...
| flytescheduler.image.tag | string | `"v1.1.54"` | Docker image tag |
