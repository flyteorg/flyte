...
| flyteadmin.image.tag | string | `"v1.1.37"` |  |
...
| flyteconsole.image.tag | string | `"v1.2.7"` |  |
...
| flytepropeller.image.tag | string | `"v1.1.30"` |  |
...
| flytescheduler.image.tag | string | `"v1.1.37"` | Docker image tag |
