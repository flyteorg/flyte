...
| flyte.flyteadmin.image.tag | string | `"v1.1.88.1"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.88.1"` | Docker image tag |
