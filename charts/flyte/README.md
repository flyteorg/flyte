...
| flyte.flyteconsole.image.tag | string | `"v1.1.0"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.7"` | Docker image tag |
