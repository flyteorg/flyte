...
| flyte.flyteadmin.image.tag | string | `"v1.1.78"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.4.8"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.78"` | Docker image tag |
