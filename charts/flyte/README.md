...
| flyte.datacatalog.image.tag | string | `"v1.0.0"` | Docker image tag |
...
| flyte.flyteadmin.image.tag | string | `"v1.0.0"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.0.0"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.0.0"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.0.0"` | Docker image tag |
