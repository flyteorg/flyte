...
| flyte.flyteadmin.image.tag | string | `"v1.1.62"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.54"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.62"` | Docker image tag |
