...
| flyte.flyteadmin.image.tag | string | `"v1.1.104"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.8.2"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.104"` | Docker image tag |
