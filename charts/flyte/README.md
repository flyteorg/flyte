...
| flyte.common.flyteNamespaceTemplate.enabled | bool | `false` |  |
| flyte.common.ingress.albSSLRedirect | bool | `false` |  |
| flyte.common.ingress.annotations."nginx.ingress.kubernetes.io/app-root" | string | `"/console"` |  |
| flyte.common.ingress.enabled | bool | `true` |  |
| flyte.common.ingress.host | string | `""` |  |
| flyte.common.ingress.separateGrpcIngress | bool | `false` |  |
| flyte.common.ingress.separateGrpcIngressAnnotations."nginx.ingress.kubernetes.io/backend-protocol" | string | `"GRPC"` |  |
| flyte.common.ingress.tls.enabled | bool | `false` |  |
| flyte.common.ingress.webpackHMR | bool | `true` |  |
...
| flyte.configmap.remoteData.remoteData.region | string | `"us-east-1"` |  |
| flyte.configmap.remoteData.remoteData.scheme | string | `"local"` |  |
| flyte.configmap.remoteData.remoteData.signedUrls.durationMinutes | int | `3` |  |
...
| flyte.db.admin.database.dbname | string | `"flyteadmin"` |  |
| flyte.db.admin.database.host | string | `"postgres"` |  |
| flyte.db.admin.database.port | int | `5432` |  |
| flyte.db.admin.database.username | string | `"postgres"` |  |
| flyte.db.datacatalog.database.dbname | string | `"datacatalog"` |  |
| flyte.db.datacatalog.database.host | string | `"postgres"` |  |
| flyte.db.datacatalog.database.port | int | `5432` |  |
| flyte.db.datacatalog.database.username | string | `"postgres"` |  |
| flyte.flyteadmin.additionalVolumeMounts | list | `[]` |  |
| flyte.flyteadmin.additionalVolumes | list | `[]` |  |
...
| flyte.flyteadmin.image.tag | string | `"v0.6.75"` | Docker image tag |
...
| flyte.flyteadmin.secrets | object | `{}` |  |
...
| flyte.flyteconsole.ga.tracking_id | string | `"G-0QW4DJWJ20"` |  |
...
| flyte.flyteconsole.image.tag | string | `"v0.38.0"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v0.16.13"` | Docker image tag |
| flyte.flytepropeller.manager | bool | `false` |  |
...
| flyte.flytescheduler.image.tag | string | `"v0.6.75"` | Docker image tag |
...
| flyte.flytescheduler.secrets | object | `{}` |  |
...
| flyte.storage.custom | object | `{}` | GCP project ID. Required for storage type gcs. projectId: -- GCP service account key for GSA with bucket access. Leave empty if you use workload identity. serviceAccountKey: "" -- Settings for storage type custom. See https://github:com/graymeta/stow for supported storage providers/settings. |
...
| flyte.workflow_scheduler.enabled | bool | `true` |  |
