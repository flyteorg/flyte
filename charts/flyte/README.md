...
| flyte.flyteadmin.image.tag | string | `"v1.1.37"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.2.7"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.30"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.37"` | Docker image tag |
