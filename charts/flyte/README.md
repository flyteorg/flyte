...
| flyte.flyteadmin.image.tag | string | `"v1.1.82"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.5.2"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.70"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.82"` | Docker image tag |
