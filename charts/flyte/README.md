...
| flyte.configmap.enabled_plugins.tasks | object | `{"task-plugins":{"default-for-task-types":[{"container":"container"},{"sidecar":"sidecar"},{"container_array":"k8s-array"},{"bigquery_query_job_task":"agent-service"}],"enabled-plugins":["container","sidecar","k8s-array","agent-service"]}}` | Tasks specific configuration [structure](https://pkg.go.dev/github.com/flyteorg/flytepropeller/pkg/controller/nodes/task/config#GetConfig) |
| flyte.configmap.enabled_plugins.tasks.task-plugins | object | `{"default-for-task-types":[{"container":"container"},{"sidecar":"sidecar"},{"container_array":"k8s-array"},{"bigquery_query_job_task":"agent-service"}],"enabled-plugins":["container","sidecar","k8s-array","agent-service"]}` | Plugins configuration, [structure](https://pkg.go.dev/github.com/flyteorg/flytepropeller/pkg/controller/nodes/task/config#TaskPluginConfig) |
