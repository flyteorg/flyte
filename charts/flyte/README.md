...
| flyte.flyteadmin.image.tag | string | `"v1.1.92"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.88"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.92"` | Docker image tag |
