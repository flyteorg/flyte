...
| flyte.flyteadmin.image.tag | string | `"v0.6.147"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v0.52.1"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v0.6.147"` | Docker image tag |
