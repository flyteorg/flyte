...
| flyte.flyteadmin.image.tag | string | `"v1.1.44"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.3.4"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.40"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.44"` | Docker image tag |
