...
| flyte.datacatalog.image.tag | string | `"v1.0.51"` | Docker image tag |
...
| flyte.flyteadmin.image.tag | string | `"v1.1.118"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.9.2"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.116"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.118"` | Docker image tag |
