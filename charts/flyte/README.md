...
| flyteadmin.image.tag | string | `"v0.6.53"` | Docker image tag |
...
| flyteconsole.image.tag | string | `"v0.30.0"` | Docker image tag |
...
| flytepropeller.image.tag | string | `"v0.15.17"` | Docker image tag |
