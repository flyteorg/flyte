...
| flyte.datacatalog.image.tag | string | `"v1.0.35"` | Docker image tag |
...
| flyte.flyteadmin.image.tag | string | `"v1.1.54"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.47"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.54"` | Docker image tag |
