...
| flyte.flyteadmin.image.tag | string | `"v0.6.145"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v0.51.3"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v0.16.46"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v0.6.145"` | Docker image tag |
