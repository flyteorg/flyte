...
| flyte.flyteadmin.image.tag | string | `"v1.1.84"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.84"` | Docker image tag |
