...
| flyte.flyteadmin.image.tag | string | `"v0.6.69"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v0.34.0"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v0.16.4"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v0.6.69"` | Docker image tag |
