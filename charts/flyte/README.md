...
| flyte.flyteadmin.image.tag | string | `"v1.1.16"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.1.1"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.8"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.16"` | Docker image tag |
