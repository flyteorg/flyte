...
| flyte.flyteadmin.image.tag | string | `"v1.1.100"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.100"` | Docker image tag |
