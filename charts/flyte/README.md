...
| flyte.flyteadmin.image.tag | string | `"v1.1.72"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.64"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.72"` | Docker image tag |
