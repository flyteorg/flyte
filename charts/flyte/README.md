...
| flyte.flyteadmin.image.tag | string | `"v1.1.28"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.1.3"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.28"` | Docker image tag |
