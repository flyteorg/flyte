...
| flyte.flytepropeller.image.tag | string | `"v1.1.14"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.29"` | Docker image tag |
