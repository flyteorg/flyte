...
| flyte.configmap.copilot | object | `{"plugins":{"k8s":{"co-pilot":{"image":"cr.flyte.org/flyteorg/flytecopilot:v0.0.32","name":"flyte-copilot-","start-timeout":"30s"}}}}` | Copilot configuration |
| flyte.configmap.copilot.plugins.k8s.co-pilot | object | `{"image":"cr.flyte.org/flyteorg/flytecopilot:v0.0.32","name":"flyte-copilot-","start-timeout":"30s"}` | Structure documented [here](https://pkg.go.dev/github.com/lyft/flyteplugins@v0.5.28/go/tasks/pluginmachinery/flytek8s/config#FlyteCoPilotConfig) |
...
| flyte.datacatalog.image.tag | string | `"v1.0.48"` | Docker image tag |
...
| flyte.flyteadmin.image.tag | string | `"v1.1.110"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.8.7"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.106"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.110"` | Docker image tag |
