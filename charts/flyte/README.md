...
| flyte.flyteadmin.image.tag | string | `"v0.6.144"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v0.51.1"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v0.16.44"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v0.6.144"` | Docker image tag |
