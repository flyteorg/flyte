...
| flyte.configmap.copilot | object | `{"plugins":{"k8s":{"co-pilot":{"image":"cr.flyte.org/flyteorg/flytecopilot:v1.13.0-rc0","name":"flyte-copilot-","start-timeout":"30s"}}}}` | Copilot configuration |
| flyte.configmap.copilot.plugins.k8s.co-pilot | object | `{"image":"cr.flyte.org/flyteorg/flytecopilot:v1.13.0-rc0","name":"flyte-copilot-","start-timeout":"30s"}` | Structure documented [here](https://pkg.go.dev/github.com/lyft/flyteplugins@v0.5.28/go/tasks/pluginmachinery/flytek8s/config#FlyteCoPilotConfig) |
...
| flyte.datacatalog.image.tag | string | `"v1.13.0-rc0"` | Docker image tag |
...
| flyte.flyteadmin.image.tag | string | `"v1.13.0-rc0"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.15.1"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.13.0-rc0"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.13.0-rc0"` | Docker image tag |
