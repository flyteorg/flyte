...
| flyte.flyteadmin.image.tag | string | `"v1.1.90"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.6.2"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.87"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.90"` | Docker image tag |
