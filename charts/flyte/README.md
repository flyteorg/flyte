...
| flyte.cluster_resource_manager.podAnnotations | object | `{}` | Annotations for cluster resource controller pods |
...
| flyte.datacatalog.image.tag | string | `"v0.3.34"` | Docker image tag |
...
| flyte.flyteadmin.image.tag | string | `"v0.6.148"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v0.54.1"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v0.16.47"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v0.6.148"` | Docker image tag |
