...
| flyte.external_plugin_service.image.repository | string | `"ghcr.io/flyteorg/external-plugin-service"` | Docker image for external-plugin-service deployment |
| flyte.external_plugin_service.image.tag | string | `"1.6.0"` | Docker image tag |
...
| flyte.external_plugin_service.tolerations | list | `[]` | tolerations for external-plugin-service deployment |
