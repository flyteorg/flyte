...
| flyte.flyteadmin.image.tag | string | `"v1.1.50"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.43"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.50"` | Docker image tag |
