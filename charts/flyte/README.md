...
| flyte.flyteadmin.image.tag | string | `"v1.1.33"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.2.4"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.26"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.33"` | Docker image tag |
