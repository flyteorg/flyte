...
| flyte.datacatalog.image.tag | string | `"v0.3.22"` | Docker image tag |
...
| flyte.flyteadmin.image.tag | string | `"v0.6.92"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v0.41.0"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v0.16.19"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v0.6.92"` | Docker image tag |
