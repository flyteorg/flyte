...
| flyte.datacatalog.image.tag | string | `"v1.0.1"` | Docker image tag |
...
| flyte.flyteadmin.image.tag | string | `"v1.1.29-hotfix"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.1.6"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.15"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.30"` | Docker image tag |
