...
| flyte.flyteadmin.image.tag | string | `"v1.1.75"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.67"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.75"` | Docker image tag |
