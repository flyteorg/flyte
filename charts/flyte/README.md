...
| flyte.datacatalog.image.tag | string | `"v0.3.23"` | Docker image tag |
...
| flyte.flyteadmin.image.tag | string | `"v0.6.104"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v0.43.0"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v0.16.29"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v0.6.104"` | Docker image tag |
