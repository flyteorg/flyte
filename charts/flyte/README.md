...
| flyte.flyteadmin.image.tag | string | `"v1.1.105"` | Docker image tag |
...
| flyte.flyteconsole.image.tag | string | `"v1.8.4"` | Docker image tag |
...
| flyte.flytepropeller.image.tag | string | `"v1.1.95"` | Docker image tag |
...
| flyte.flytescheduler.image.tag | string | `"v1.1.105"` | Docker image tag |
