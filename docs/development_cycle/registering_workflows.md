...
- Followed the {doc}`Creating a Flyte project <../getting_started/creating_a_flyte_project>`
...
that we created in {doc}`Creating a Flyte project <../getting_started/creating_a_flyte_project>`,
...
## Registering workflows (copied from Union docs)
