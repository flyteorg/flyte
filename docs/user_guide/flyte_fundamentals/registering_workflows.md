...
- Followed the {doc}`Creating a Flyte project </user_guide/first_workflow/creating_a_flyte_project>`
...
that we created in {doc}`Creating a Flyte project </user_guide/first_workflow/creating_a_flyte_project>`,
