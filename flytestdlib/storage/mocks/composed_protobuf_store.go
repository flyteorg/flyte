...
func (_m *ComposedProtobufStore) ReadProtobuf(ctx context.Context, reference storage.DataReference, msg proto.Message) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, storage.DataReference, proto.Message) error); ok {
...
func (_c *ComposedProtobufStore_ReadProtobuf_Call) Run(run func(ctx context.Context, reference storage.DataReference, msg proto.Message)) *ComposedProtobufStore_ReadProtobuf_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(storage.DataReference), args[2].(proto.Message))
	})
	return _c
}
...
func (_c *ComposedProtobufStore_ReadProtobuf_Call) RunAndReturn(run func(context.Context, storage.DataReference, proto.Message) error) *ComposedProtobufStore_ReadProtobuf_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ComposedProtobufStore) WriteProtobuf(ctx context.Context, reference storage.DataReference, opts storage.Options, msg proto.Message) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, storage.DataReference, storage.Options, proto.Message) error); ok {
...
func (_c *ComposedProtobufStore_WriteProtobuf_Call) Run(run func(ctx context.Context, reference storage.DataReference, opts storage.Options, msg proto.Message)) *ComposedProtobufStore_WriteProtobuf_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(storage.DataReference), args[2].(storage.Options), args[3].(proto.Message))
	})
	return _c
}
...
func (_c *ComposedProtobufStore_WriteProtobuf_Call) RunAndReturn(run func(context.Context, storage.DataReference, storage.Options, proto.Message) error) *ComposedProtobufStore_WriteProtobuf_Call {
	_c.Call.Return(run)
	return _c
}
