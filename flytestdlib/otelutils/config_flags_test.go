...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_type", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			if vString, err := cmdFlags.GetString("type"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.ExporterType)
	...
	t.Run("Test_file.filename", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("file.filename", testValue)
			if vString, err := cmdFlags.GetString("file.filename"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.FileConfig.Filename)
	...
	t.Run("Test_jaeger.endpoint", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			cmdFlags.Set("jaeger.endpoint", testValue)
			if vString, err := cmdFlags.GetString("jaeger.endpoint"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vString), &actual.JaegerConfig.Endpoint)
