...
func (_m *AutoRefresh) DeleteDelayed(id cache.ItemID) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(cache.ItemID) error); ok {
		r0 = rf(id)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *AutoRefresh) Get(id cache.ItemID) (cache.Item, error) {
	...
	var r0 cache.Item
	var r1 error
	if rf, ok := ret.Get(0).(func(cache.ItemID) (cache.Item, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(cache.ItemID) cache.Item); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(cache.ItemID) error); ok {
		r1 = rf(id)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *AutoRefresh) GetOrCreate(id cache.ItemID, item cache.Item) (cache.Item, error) {
	...
	var r0 cache.Item
	var r1 error
	if rf, ok := ret.Get(0).(func(cache.ItemID, cache.Item) (cache.Item, error)); ok {
		return rf(id, item)
	}
	if rf, ok := ret.Get(0).(func(cache.ItemID, cache.Item) cache.Item); ok {
		r0 = rf(id, item)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(cache.Item)
	...
	if rf, ok := ret.Get(1).(func(cache.ItemID, cache.Item) error); ok {
		r1 = rf(id, item)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *AutoRefresh_GetOrCreate_Call) Run(run func(id cache.ItemID, item cache.Item)) *AutoRefresh_GetOrCreate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(cache.ItemID), args[1].(cache.Item))
	})
	return _c
}
