...
func TestMetricsScope(t *testing.T) {
	...
	t.Run("Counter", func(t *testing.T) {
		...
		assert.Equal(t, `Desc{fqName: "test:xc", help: "some x", unit: "", constLabels: {}, variableLabels: {}}`, m.Desc().String())
	...
	t.Run("Histogram", func(t *testing.T) {
		...
		assert.Equal(t, `Desc{fqName: "test:xh", help: "some x", unit: "", constLabels: {}, variableLabels: {}}`, m.Desc().String())
	...
	t.Run("Summary", func(t *testing.T) {
		...
		assert.Equal(t, `Desc{fqName: "test:xs", help: "some x", unit: "", constLabels: {}, variableLabels: {}}`, m.Desc().String())
		mco, err := s.NewSummaryWithOptions("xsco", description, SummaryOptions{Objectives: map[float64]float64{0.5: 0.05, 1.0: 0.0}})
		assert.Nil(t, err)
		assert.Equal(t, `Desc{fqName: "test:xsco", help: "some x", unit: "", constLabels: {}, variableLabels: {}}`, mco.Desc().String())
	...
	t.Run("Gauge", func(t *testing.T) {
		...
		assert.Equal(t, `Desc{fqName: "test:xg", help: "some x", unit: "", constLabels: {}, variableLabels: {}}`, m.Desc().String())
	...
	t.Run("Timer", func(t *testing.T) {
		...
		assert.True(t, ok)
		assert.Equal(t, `Desc{fqName: "test:xt_s", help: "some x", unit: "", constLabels: {}, variableLabels: {}}`, asDesc.Desc().String())
		assert.Panics(t, func() {
