...
func TestTestType_SetFlags(t *testing.T) {
	...
	t.Run("Test_storage.defaultHttpClient.idleConnTimeout", func(t *testing.T) {
		...
		t.Run("Override", func(t *testing.T) {
			...
			if v := cmdFlags.Lookup("storage.defaultHttpClient.idleConnTimeout"); v != nil {
				testDecodeJson_TestType(t, fmt.Sprintf("%v", v.Value.String()), &actual.StorageConfig.DefaultHTTPClient.IdleConnTimeout)
