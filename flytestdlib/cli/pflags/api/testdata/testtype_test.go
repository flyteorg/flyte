...
func TestTestType_SetFlags(t *testing.T) {
	...
	t.Run("Test_storage.defaultHttpClient.maxIdleConns", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("storage.defaultHttpClient.maxIdleConns", testValue)
			if vInt, err := cmdFlags.GetInt("storage.defaultHttpClient.maxIdleConns"); err == nil {
				testDecodeJson_TestType(t, fmt.Sprintf("%v", vInt), &actual.StorageConfig.DefaultHTTPClient.MaxIdleConns)
	...
	t.Run("Test_storage.defaultHttpClient.maxIdleConnsPerHost", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("storage.defaultHttpClient.maxIdleConnsPerHost", testValue)
			if vInt, err := cmdFlags.GetInt("storage.defaultHttpClient.maxIdleConnsPerHost"); err == nil {
				testDecodeJson_TestType(t, fmt.Sprintf("%v", vInt), &actual.StorageConfig.DefaultHTTPClient.MaxIdleConnsPerHost)
	...
	t.Run("Test_storage.defaultHttpClient.maxConnsPerHost", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("storage.defaultHttpClient.maxConnsPerHost", testValue)
			if vInt, err := cmdFlags.GetInt("storage.defaultHttpClient.maxConnsPerHost"); err == nil {
				testDecodeJson_TestType(t, fmt.Sprintf("%v", vInt), &actual.StorageConfig.DefaultHTTPClient.MaxConnsPerHost)
	...
	t.Run("Test_storage.defaultHttpClient.idleConnTimeout", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := DefaultTestType.StorageConfig.DefaultHTTPClient.IdleConnTimeout.String()

			cmdFlags.Set("storage.defaultHttpClient.idleConnTimeout", testValue)
			if vString, err := cmdFlags.GetString("storage.defaultHttpClient.idleConnTimeout"); err == nil {
				testDecodeJson_TestType(t, fmt.Sprintf("%v", vString), &actual.StorageConfig.DefaultHTTPClient.IdleConnTimeout)
