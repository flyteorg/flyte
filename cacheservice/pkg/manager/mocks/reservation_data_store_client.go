...
func (_m *ReservationDataStoreClient) OnCreate(ctx context.Context, reservation *models.Reservation, now time.Time) *ReservationDataStoreClient_Create {
...
func (_m *ReservationDataStoreClient) Create(ctx context.Context, reservation *models.Reservation, now time.Time) error {
