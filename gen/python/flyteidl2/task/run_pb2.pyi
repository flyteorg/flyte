...
class RunSpec(_message.Message):
    __slots__ = ["labels", "annotations", "envs", "interruptible", "overwrite_cache", "queue", "raw_data_storage", "security_context", "cache_config", "notification_rule_name", "notification_rules"]
