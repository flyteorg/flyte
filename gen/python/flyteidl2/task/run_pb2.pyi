...
class RunSpec(_message.Message):
    __slots__ = ["labels", "annotations", "envs", "interruptible", "overwrite_cache", "queue", "raw_data_storage", "security_context", "cache_config", "notification_rule_name", "notification_rules", "run_start_time", "max_action_concurrency", "run_base_dir", "related_to", "cluster_pool", "task_spec_source", "relation", "recover", "default_settings"]
    ...
    DEFAULT_SETTINGS_FIELD_NUMBER: _ClassVar[int]
    labels: Labels
...
class TaskResourceDefaults(_message.Message):
    __slots__ = ["requests", "max", "default_gpu_accelerator"]
    REQUESTS_FIELD_NUMBER: _ClassVar[int]
    MAX_FIELD_NUMBER: _ClassVar[int]
    DEFAULT_GPU_ACCELERATOR_FIELD_NUMBER: _ClassVar[int]
    ...
    default_gpu_accelerator: _tasks_pb2.GPUAccelerator
    def __init__(self, requests: _Optional[_Iterable[_Union[_tasks_pb2.Resources.ResourceEntry, _Mapping]]] = ..., max: _Optional[_Iterable[_Union[_tasks_pb2.Resources.ResourceEntry, _Mapping]]] = ..., default_gpu_accelerator: _Optional[_Union[_tasks_pb2.GPUAccelerator, _Mapping]] = ...) -> None: ...
