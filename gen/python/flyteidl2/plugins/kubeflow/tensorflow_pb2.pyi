...
from flyteidl2.plugins import common_pb2 as _common_pb2
from flyteidl2.plugins.kubeflow import common_pb2 as _common_pb2_1
...
class DistributedTensorflowTrainingTask(_message.Message):
    ...
    run_policy: _common_pb2_1.RunPolicy
...
class DistributedTensorflowTrainingReplicaSpec(_message.Message):
    ...
    common: _common_pb2.CommonReplicaSpec
    def __init__(self, replicas: _Optional[int] = ..., image: _Optional[str] = ..., resources: _Optional[_Union[_tasks_pb2.Resources, _Mapping]] = ..., restart_policy: _Optional[_Union[_common_pb2.RestartPolicy, str]] = ..., common: _Optional[_Union[_common_pb2.CommonReplicaSpec, _Mapping]] = ...) -> None: ...
