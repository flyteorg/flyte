...
class LogContext(_message.Message):
    __slots__ = ["pods", "primary_pod_name", "connector", "pod_name_prefix", "pod_name_prefixes"]
    ...
    def __init__(self, pods: _Optional[_Iterable[_Union[PodLogContext, _Mapping]]] = ..., primary_pod_name: _Optional[str] = ..., connector: _Optional[_Union[ConnectorLogContext, _Mapping]] = ..., pod_name_prefix: _Optional[str] = ..., pod_name_prefixes: _Optional[_Iterable[str]] = ...) -> None: ...
