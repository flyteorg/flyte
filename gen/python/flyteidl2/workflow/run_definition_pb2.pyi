...
class ActionMetadata(_message.Message):
    __slots__ = ["parent", "group", "executed_by", "task", "trace", "condition", "action_type", "trigger_id", "environment_name", "function_name", "trigger_name", "trigger_type", "source", "relation", "recovered_from"]
