...
class TracedRunServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamLogs = channel.stream_stream(
                ...
                request_serializer=flyteidl2_dot_workflow_dot_traced__run__service__pb2.StreamLogsRequest.SerializeToString,
                response_deserializer=flyteidl2_dot_workflow_dot_traced__run__service__pb2.StreamLogsResponse.FromString,
                )
        self.TailLogs = channel.unary_stream(
                '/flyteidl2.workflow.TracedRunService/TailLogs',
                request_serializer=flyteidl2_dot_workflow_dot_traced__run__service__pb2.TailTracedLogsRequest.SerializeToString,
                response_deserializer=flyteidl2_dot_workflow_dot_traced__run__service__pb2.TailTracedLogsResponse.FromString,
                )
...
def add_TracedRunServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamLogs': grpc.stream_stream_rpc_method_handler(
                    servicer.StreamLogs,
                    request_deserializer=flyteidl2_dot_workflow_dot_traced__run__service__pb2.StreamLogsRequest.FromString,
                    response_serializer=flyteidl2_dot_workflow_dot_traced__run__service__pb2.StreamLogsResponse.SerializeToString,
            ),
            'TailLogs': grpc.unary_stream_rpc_method_handler(
                    servicer.TailLogs,
                    request_deserializer=flyteidl2_dot_workflow_dot_traced__run__service__pb2.TailTracedLogsRequest.FromString,
                    response_serializer=flyteidl2_dot_workflow_dot_traced__run__service__pb2.TailTracedLogsResponse.SerializeToString,
            ),
    }
...
class TracedRunService(object):
    ...
    def StreamLogs(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/flyteidl2.workflow.TracedRunService/StreamLogs',
            flyteidl2_dot_workflow_dot_traced__run__service__pb2.StreamLogsRequest.SerializeToString,
            flyteidl2_dot_workflow_dot_traced__run__service__pb2.StreamLogsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def TailLogs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/flyteidl2.workflow.TracedRunService/TailLogs',
            flyteidl2_dot_workflow_dot_traced__run__service__pb2.TailTracedLogsRequest.SerializeToString,
            flyteidl2_dot_workflow_dot_traced__run__service__pb2.TailTracedLogsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
