...
class TailTracedLogsRequest(_message.Message):
...
class TailTracedLogsResponse(_message.Message):
    __slots__ = ["lines", "source", "truncated"]
    class Source(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
        SOURCE_UNSPECIFIED: _ClassVar[TailTracedLogsResponse.Source]
        SOURCE_LIVE: _ClassVar[TailTracedLogsResponse.Source]
        SOURCE_PERSISTED: _ClassVar[TailTracedLogsResponse.Source]
    SOURCE_UNSPECIFIED: TailTracedLogsResponse.Source
    SOURCE_LIVE: TailTracedLogsResponse.Source
    SOURCE_PERSISTED: TailTracedLogsResponse.Source
    LINES_FIELD_NUMBER: _ClassVar[int]
    SOURCE_FIELD_NUMBER: _ClassVar[int]
    TRUNCATED_FIELD_NUMBER: _ClassVar[int]
    lines: _containers.RepeatedCompositeFieldContainer[_payload_pb2.LogLine]
    source: TailTracedLogsResponse.Source
    truncated: bool
    def __init__(self, lines: _Optional[_Iterable[_Union[_payload_pb2.LogLine, _Mapping]]] = ..., source: _Optional[_Union[TailTracedLogsResponse.Source, str]] = ..., truncated: bool = ...) -> None: ...
