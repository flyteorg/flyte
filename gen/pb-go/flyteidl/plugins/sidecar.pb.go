...
func (*SidecarJob) Descriptor() ([]byte, []int) {
	return fileDescriptor_sidecar_8bf5a276219a51d4, []int{0}
}
...
func (dst *SidecarJob) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SidecarJob.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("flyteidl/plugins/sidecar.proto", fileDescriptor_sidecar_8bf5a276219a51d4)
}

var fileDescriptor_sidecar_8bf5a276219a51d4 = []byte{
