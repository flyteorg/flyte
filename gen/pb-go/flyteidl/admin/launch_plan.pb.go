...
func (LaunchPlanState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{0}
}
...
func (*LaunchPlanCreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{1}
}
...
func (*LaunchPlan) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{2}
}
...
func (*LaunchPlanList) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{3}
}
...
func (*Auth) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{4}
}
...
func (*LaunchPlanSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{5}
}
...
func (*LaunchPlanClosure) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{6}
}
...
func (*LaunchPlanMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{7}
}
...
func (*LaunchPlanUpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{8}
}
...
func (*LaunchPlanUpdateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{9}
}
...
func (*ActiveLaunchPlanRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{10}
}
...
func (*ActiveLaunchPlanListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_launch_plan_db3993efa31ba4ad, []int{11}
}
...
func (dst *ActiveLaunchPlanListRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ActiveLaunchPlanListRequest.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("flyteidl/admin/launch_plan.proto", fileDescriptor_launch_plan_db3993efa31ba4ad)
}

var fileDescriptor_launch_plan_db3993efa31ba4ad = []byte{
