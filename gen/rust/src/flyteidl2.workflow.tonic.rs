...
/// Generated client implementations.
pub mod internal_run_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct InternalRunServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl InternalRunServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> InternalRunServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::BoxBody>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> InternalRunServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + Send + Sync,
        {
            InternalRunServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn record_action(
            &mut self,
            request: impl tonic::IntoRequest<super::RecordActionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RecordActionResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn record_action_stream(
            &mut self,
            request: impl tonic::IntoStreamingRequest<
                Message = super::RecordActionStreamRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::RecordActionStreamResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn update_action_status(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateActionStatusRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateActionStatusResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn update_action_status_stream(
            &mut self,
            request: impl tonic::IntoStreamingRequest<
                Message = super::UpdateActionStatusStreamRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<
                tonic::codec::Streaming<super::UpdateActionStatusStreamResponse>,
            >,
            tonic::Status,
        > {
            self.inner
        ...
        pub async fn record_action_events(
            &mut self,
            request: impl tonic::IntoRequest<super::RecordActionEventsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RecordActionEventsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn record_action_event_stream(
            &mut self,
            request: impl tonic::IntoStreamingRequest<
                Message = super::RecordActionEventStreamRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<
                tonic::codec::Streaming<super::RecordActionEventStreamResponse>,
            >,
            tonic::Status,
        > {
            self.inner
...
/// Generated server implementations.
pub mod internal_run_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with InternalRunServiceServer.
    #[async_trait]
    pub trait InternalRunService: Send + Sync + 'static {
        async fn record_action(
            &self,
            request: tonic::Request<super::RecordActionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RecordActionResponse>,
            tonic::Status,
        >;
        /// Server streaming response type for the RecordActionStream method.
        type RecordActionStreamStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::RecordActionStreamResponse,
                    tonic::Status,
                >,
            >
            + Send
            + 'static;
        async fn record_action_stream(
            &self,
            request: tonic::Request<tonic::Streaming<super::RecordActionStreamRequest>>,
        ) -> std::result::Result<
            tonic::Response<Self::RecordActionStreamStream>,
            tonic::Status,
        >;
        async fn update_action_status(
            &self,
            request: tonic::Request<super::UpdateActionStatusRequest>,
        ) -> std::result::Result<
            tonic::Response<super::UpdateActionStatusResponse>,
            tonic::Status,
        >;
        /// Server streaming response type for the UpdateActionStatusStream method.
        type UpdateActionStatusStreamStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::UpdateActionStatusStreamResponse,
                    tonic::Status,
                >,
            >
            + Send
            + 'static;
        async fn update_action_status_stream(
            &self,
            request: tonic::Request<
                tonic::Streaming<super::UpdateActionStatusStreamRequest>,
            >,
        ) -> std::result::Result<
            tonic::Response<Self::UpdateActionStatusStreamStream>,
            tonic::Status,
        >;
        async fn record_action_events(
            &self,
            request: tonic::Request<super::RecordActionEventsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RecordActionEventsResponse>,
            tonic::Status,
        >;
        /// Server streaming response type for the RecordActionEventStream method.
        type RecordActionEventStreamStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::RecordActionEventStreamResponse,
                    tonic::Status,
                >,
            >
            + Send
            + 'static;
        async fn record_action_event_stream(
            &self,
            request: tonic::Request<
                tonic::Streaming<super::RecordActionEventStreamRequest>,
            >,
        ) -> std::result::Result<
            tonic::Response<Self::RecordActionEventStreamStream>,
            tonic::Status,
        >;
    }
    #[derive(Debug)]
    pub struct InternalRunServiceServer<T: InternalRunService> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: InternalRunService> InternalRunServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for InternalRunServiceServer<T>
    where
        T: InternalRunService,
        B: Body + Send + 'static,
        B::Error: Into<StdError> + Send + 'static,
    {
        type Response = http::Response<tonic::body::BoxBody>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/flyteidl2.workflow.InternalRunService/RecordAction" => {
                    #[allow(non_camel_case_types)]
                    struct RecordActionSvc<T: InternalRunService>(pub Arc<T>);
                    impl<
                        T: InternalRunService,
                    > tonic::server::UnaryService<super::RecordActionRequest>
                    for RecordActionSvc<T> {
                        type Response = super::RecordActionResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InternalRunService>::record_action(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RecordActionSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/flyteidl2.workflow.InternalRunService/RecordActionStream" => {
                    #[allow(non_camel_case_types)]
                    struct RecordActionStreamSvc<T: InternalRunService>(pub Arc<T>);
                    impl<
                        T: InternalRunService,
                    > tonic::server::StreamingService<super::RecordActionStreamRequest>
                    for RecordActionStreamSvc<T> {
                        type Response = super::RecordActionStreamResponse;
                        type ResponseStream = T::RecordActionStreamStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                tonic::Streaming<super::RecordActionStreamRequest>,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InternalRunService>::record_action_stream(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RecordActionStreamSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/flyteidl2.workflow.InternalRunService/UpdateActionStatus" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateActionStatusSvc<T: InternalRunService>(pub Arc<T>);
                    impl<
                        T: InternalRunService,
                    > tonic::server::UnaryService<super::UpdateActionStatusRequest>
                    for UpdateActionStatusSvc<T> {
                        type Response = super::UpdateActionStatusResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InternalRunService>::update_action_status(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateActionStatusSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/flyteidl2.workflow.InternalRunService/UpdateActionStatusStream" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateActionStatusStreamSvc<T: InternalRunService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: InternalRunService,
                    > tonic::server::StreamingService<
                        super::UpdateActionStatusStreamRequest,
                    > for UpdateActionStatusStreamSvc<T> {
                        type Response = super::UpdateActionStatusStreamResponse;
                        type ResponseStream = T::UpdateActionStatusStreamStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InternalRunService>::update_action_status_stream(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UpdateActionStatusStreamSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/flyteidl2.workflow.InternalRunService/RecordActionEvents" => {
                    #[allow(non_camel_case_types)]
                    struct RecordActionEventsSvc<T: InternalRunService>(pub Arc<T>);
                    impl<
                        T: InternalRunService,
                    > tonic::server::UnaryService<super::RecordActionEventsRequest>
                    for RecordActionEventsSvc<T> {
                        type Response = super::RecordActionEventsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InternalRunService>::record_action_events(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RecordActionEventsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/flyteidl2.workflow.InternalRunService/RecordActionEventStream" => {
                    #[allow(non_camel_case_types)]
                    struct RecordActionEventStreamSvc<T: InternalRunService>(pub Arc<T>);
                    impl<
                        T: InternalRunService,
                    > tonic::server::StreamingService<
                        super::RecordActionEventStreamRequest,
                    > for RecordActionEventStreamSvc<T> {
                        type Response = super::RecordActionEventStreamResponse;
                        type ResponseStream = T::RecordActionEventStreamStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InternalRunService>::record_action_event_stream(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RecordActionEventStreamSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T: InternalRunService> Clone for InternalRunServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: InternalRunService> tonic::server::NamedService
    for InternalRunServiceServer<T> {
        const NAME: &'static str = "flyteidl2.workflow.InternalRunService";
    }
}
/// Generated client implementations.
pub mod run_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn signal_event(
            &mut self,
            request: impl tonic::IntoRequest<super::SignalEventRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SignalEventResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.workflow.RunService", "SignalEvent"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod run_service_server {
    ...
    pub trait RunService: Send + Sync + 'static {
        ...
        async fn signal_event(
            &self,
            request: tonic::Request<super::SignalEventRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SignalEventResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/flyteidl2.workflow.RunService/SignalEvent" => {
                    #[allow(non_camel_case_types)]
                    struct SignalEventSvc<T: RunService>(pub Arc<T>);
                    impl<
                        T: RunService,
                    > tonic::server::UnaryService<super::SignalEventRequest>
                    for SignalEventSvc<T> {
                        type Response = super::SignalEventResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RunService>::signal_event(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SignalEventSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/flyteidl2.workflow.RunService/GetActionLogContext" => {
                    #[allow(non_camel_case_types)]
                    struct GetActionLogContextSvc<T: RunService>(pub Arc<T>);
                    impl<
                        T: RunService,
                    > tonic::server::UnaryService<super::GetActionLogContextRequest>
                    for GetActionLogContextSvc<T> {
                        type Response = super::GetActionLogContextResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RunService>::get_action_log_context(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetActionLogContextSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
...
/// Generated client implementations.
pub mod local_run_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct LocalRunServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl LocalRunServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> LocalRunServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::BoxBody>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> LocalRunServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + Send + Sync,
        {
            LocalRunServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn create_run(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateLocalRunRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateRunResponse>,
            tonic::Status,
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.workflow.LocalRunService", "CreateRun"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn report_actions(
            &mut self,
            request: impl tonic::IntoRequest<super::ReportLocalActionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReportLocalActionsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "flyteidl2.workflow.LocalRunService",
                        "ReportActions",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.workflow.LocalRunService", "ListRuns"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn watch_runs(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.workflow.LocalRunService", "WatchRuns"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
        pub async fn list_actions(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.workflow.LocalRunService", "ListActions"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn watch_actions(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.workflow.LocalRunService", "WatchActions"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
        pub async fn abort_run(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.workflow.LocalRunService", "AbortRun"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
/// Generated server implementations.
pub mod local_run_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with LocalRunServiceServer.
    #[async_trait]
    pub trait LocalRunService: Send + Sync + 'static {
        async fn create_run(
            &self,
            request: tonic::Request<super::CreateLocalRunRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateRunResponse>,
            tonic::Status,
        >;
        async fn report_actions(
            &self,
            request: tonic::Request<super::ReportLocalActionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReportLocalActionsResponse>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct LocalRunServiceServer<T: LocalRunService> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: LocalRunService> LocalRunServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for LocalRunServiceServer<T>
    where
        T: LocalRunService,
        B: Body + Send + 'static,
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/flyteidl2.workflow.LocalRunService/CreateRun" => {
                    #[allow(non_camel_case_types)]
                    struct CreateRunSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::UnaryService<super::CreateLocalRunRequest>
                    for CreateRunSvc<T> {
                        type Response = super::CreateRunResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::create_run(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.workflow.LocalRunService/ReportActions" => {
                    #[allow(non_camel_case_types)]
                    struct ReportActionsSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::UnaryService<super::ReportLocalActionsRequest>
                    for ReportActionsSvc<T> {
                        type Response = super::ReportLocalActionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::report_actions(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/flyteidl2.workflow.LocalRunService/GetRunDetails" => {
                    #[allow(non_camel_case_types)]
                    struct GetRunDetailsSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::UnaryService<super::GetRunDetailsRequest>
                    for GetRunDetailsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::get_run_details(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/flyteidl2.workflow.LocalRunService/WatchRunDetails" => {
                    #[allow(non_camel_case_types)]
                    struct WatchRunDetailsSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::ServerStreamingService<
                        super::WatchRunDetailsRequest,
                    > for WatchRunDetailsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::watch_run_details(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/flyteidl2.workflow.LocalRunService/GetActionDetails" => {
                    #[allow(non_camel_case_types)]
                    struct GetActionDetailsSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::UnaryService<super::GetActionDetailsRequest>
                    for GetActionDetailsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::get_action_details(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/flyteidl2.workflow.LocalRunService/WatchActionDetails" => {
                    #[allow(non_camel_case_types)]
                    struct WatchActionDetailsSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::ServerStreamingService<
                        super::WatchActionDetailsRequest,
                    > for WatchActionDetailsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::watch_action_details(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/flyteidl2.workflow.LocalRunService/ListRuns" => {
                    #[allow(non_camel_case_types)]
                    struct ListRunsSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::UnaryService<super::ListRunsRequest>
                    for ListRunsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::list_runs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.workflow.LocalRunService/WatchRuns" => {
                    #[allow(non_camel_case_types)]
                    struct WatchRunsSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::ServerStreamingService<super::WatchRunsRequest>
                    for WatchRunsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::watch_runs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.workflow.LocalRunService/ListActions" => {
                    #[allow(non_camel_case_types)]
                    struct ListActionsSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::UnaryService<super::ListActionsRequest>
                    for ListActionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::list_actions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.workflow.LocalRunService/WatchActions" => {
                    #[allow(non_camel_case_types)]
                    struct WatchActionsSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::ServerStreamingService<super::WatchActionsRequest>
                    for WatchActionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::watch_actions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.workflow.LocalRunService/AbortRun" => {
                    #[allow(non_camel_case_types)]
                    struct AbortRunSvc<T: LocalRunService>(pub Arc<T>);
                    impl<
                        T: LocalRunService,
                    > tonic::server::UnaryService<super::AbortRunRequest>
                    for AbortRunSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocalRunService>::abort_run(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: LocalRunService> Clone for LocalRunServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: LocalRunService> tonic::server::NamedService for LocalRunServiceServer<T> {
        const NAME: &'static str = "flyteidl2.workflow.LocalRunService";
    }
}
/// Generated client implementations.
