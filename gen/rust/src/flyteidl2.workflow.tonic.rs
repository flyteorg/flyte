...
pub mod node_execution_service_server {
    ...
    for NodeExecutionServiceServer<T> {
        const NAME: &'static str = "flyteidl2.workflow.NodeExecutionService";
    }
}
/// Generated client implementations.
...
pub mod task_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.workflow.TaskService", "DeployTask"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.workflow.TaskService", "GetTaskDetails"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.workflow.TaskService", "ListTasks"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod task_service_server {
    ...
    impl<T: TaskService> tonic::server::NamedService for TaskServiceServer<T> {
        const NAME: &'static str = "flyteidl2.workflow.TaskService";
    }
}
