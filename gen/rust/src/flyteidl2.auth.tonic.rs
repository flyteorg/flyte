...
*/
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/flyteidl2.auth.IdentityService/UserInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.auth.IdentityService", "UserInfo"));
...
*/
    ...
    impl<T: IdentityService> tonic::server::NamedService for IdentityServiceServer<T> {
        const NAME: &'static str = "flyteidl2.auth.IdentityService";
    }
}
