...
*/
        pub async fn get_o_auth2_metadata(
            &mut self,
            request: impl tonic::IntoRequest<super::GetOAuth2MetadataRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetOAuth2MetadataResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
*/
        pub async fn get_public_client_config(
            &mut self,
            request: impl tonic::IntoRequest<super::GetPublicClientConfigRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetPublicClientConfigResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
*/
        async fn get_o_auth2_metadata(
            &self,
            request: tonic::Request<super::GetOAuth2MetadataRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetOAuth2MetadataResponse>,
            tonic::Status,
        >;
...
*/
        async fn get_public_client_config(
            &self,
            request: tonic::Request<super::GetPublicClientConfigRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetPublicClientConfigResponse>,
            tonic::Status,
        >;
...
*/
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/flyteidl2.auth.AuthMetadataService/GetOAuth2Metadata" => {
                    ...
                    impl<
                        T: AuthMetadataService,
                    > tonic::server::UnaryService<super::GetOAuth2MetadataRequest>
                    for GetOAuth2MetadataSvc<T> {
                        type Response = super::GetOAuth2MetadataResponse;
                ...
                "/flyteidl2.auth.AuthMetadataService/GetPublicClientConfig" => {
                    ...
                    impl<
                        T: AuthMetadataService,
                    > tonic::server::UnaryService<super::GetPublicClientConfigRequest>
                    for GetPublicClientConfigSvc<T> {
                        type Response = super::GetPublicClientConfigResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
    ...
    for AuthMetadataServiceServer<T> {
        const NAME: &'static str = "flyteidl2.auth.AuthMetadataService";
    }
}
/// Generated client implementations.
