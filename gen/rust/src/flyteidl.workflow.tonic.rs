...
pub mod node_execution_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct NodeExecutionServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl NodeExecutionServiceClient<tonic::transport::Channel> {
    ...
    impl<T> NodeExecutionServiceClient<T>
    where
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> NodeExecutionServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            NodeExecutionServiceClient::new(InterceptedService::new(inner, interceptor))
        }
...
pub mod node_execution_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with NodeExecutionServiceServer.
    #[async_trait]
    pub trait NodeExecutionService: Send + Sync + 'static {}
    #[derive(Debug)]
    pub struct NodeExecutionServiceServer<T: NodeExecutionService> {
        inner: Arc<T>,
    ...
    impl<T: NodeExecutionService> NodeExecutionServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    for NodeExecutionServiceServer<T>
    where
        T: NodeExecutionService,
        B: Body + Send + 'static,
    ...
    impl<T: NodeExecutionService> Clone for NodeExecutionServiceServer<T> {
        fn clone(&self) -> Self {
    ...
    impl<T: NodeExecutionService> tonic::server::NamedService
    for NodeExecutionServiceServer<T> {
        const NAME: &'static str = "flyteidl.workflow.NodeExecutionService";
    }
}
/// Generated client implementations.
pub mod queue_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl.workflow.QueueService", "EnqueueAction"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl.workflow.QueueService", "AbortQueuedRun"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod queue_service_server {
    ...
    impl<T: QueueService> tonic::server::NamedService for QueueServiceServer<T> {
        const NAME: &'static str = "flyteidl.workflow.QueueService";
    }
}
/// Generated client implementations.
pub mod run_logs_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.RunLogsService", "TailLogs"));
...
pub mod run_logs_service_server {
    ...
    impl<T: RunLogsService> tonic::server::NamedService for RunLogsServiceServer<T> {
        const NAME: &'static str = "flyteidl.workflow.RunLogsService";
    }
}
/// Generated client implementations.
pub mod run_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.RunService", "CreateRun"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.RunService", "AbortRun"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl.workflow.RunService", "GetRunDetails"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl.workflow.RunService", "WatchRunDetails"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl.workflow.RunService", "GetActionDetails"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl.workflow.RunService", "WatchActionDetails"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl.workflow.RunService", "GetActionData"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.RunService", "ListRuns"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.RunService", "WatchRuns"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.RunService", "ListActions"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.RunService", "WatchActions"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl.workflow.RunService", "WatchClusterEvents"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
    }
...
pub mod run_service_server {
    ...
    impl<T: RunService> tonic::server::NamedService for RunServiceServer<T> {
        const NAME: &'static str = "flyteidl.workflow.RunService";
    }
}
/// Generated client implementations.
pub mod state_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.StateService", "Put"));
        ...
        > {
            ...
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.StateService", "Get"));
            self.inner.streaming(req, path, codec).await
        }
        pub async fn watch(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.StateService", "Watch"));
            self.inner.server_streaming(req, path, codec).await
        }
    }
}
...
pub mod state_service_server {
    ...
    impl<T: StateService> tonic::server::NamedService for StateServiceServer<T> {
        const NAME: &'static str = "flyteidl.workflow.StateService";
    }
}
/// Generated client implementations.
pub mod task_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.TaskService", "DeployTask"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_task_details(
            &mut self,
            request: impl tonic::IntoRequest<super::GetTaskDetailsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetTaskDetailsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl.workflow.TaskService", "GetTaskDetails"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl.workflow.TaskService", "ListTasks"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod task_service_server {
    ...
    pub trait TaskService: Send + Sync + 'static {
        ...
        async fn get_task_details(
            &self,
            request: tonic::Request<super::GetTaskDetailsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetTaskDetailsResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/flyteidl.workflow.TaskService/DeployTask" => {
                    #[allow(non_camel_case_types)]
                    struct DeployTaskSvc<T: TaskService>(pub Arc<T>);
                    impl<
                        T: TaskService,
                    ...
                    for DeployTaskSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TaskService>::deploy_task(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl.workflow.TaskService/GetTaskDetails" => {
                    #[allow(non_camel_case_types)]
                    struct GetTaskDetailsSvc<T: TaskService>(pub Arc<T>);
                    impl<
                        T: TaskService,
                    > tonic::server::UnaryService<super::GetTaskDetailsRequest>
                    for GetTaskDetailsSvc<T> {
                        type Response = super::GetTaskDetailsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TaskService>::get_task_details(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetTaskDetailsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T: TaskService> tonic::server::NamedService for TaskServiceServer<T> {
        const NAME: &'static str = "flyteidl.workflow.TaskService";
    }
}
