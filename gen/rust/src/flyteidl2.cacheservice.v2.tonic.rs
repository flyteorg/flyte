...
pub mod cache_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get(
            ...
            tonic::Response<super::super::GetCacheResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/flyteidl2.cacheservice.v2.CacheService/Get",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.cacheservice.v2.CacheService", "Get"),
                );
        ...
        pub async fn put(
            ...
            tonic::Response<super::super::PutCacheResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/flyteidl2.cacheservice.v2.CacheService/Put",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.cacheservice.v2.CacheService", "Put"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
            ...
            tonic::Response<super::super::DeleteCacheResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/flyteidl2.cacheservice.v2.CacheService/Delete",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.cacheservice.v2.CacheService", "Delete"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_or_extend_reservation(
            ...
            tonic::Response<super::super::GetOrExtendReservationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/flyteidl2.cacheservice.v2.CacheService/GetOrExtendReservation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn release_reservation(
            ...
            tonic::Response<super::super::ReleaseReservationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/flyteidl2.cacheservice.v2.CacheService/ReleaseReservation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod cache_service_server {
            ...
            match req.uri().path() {
                "/flyteidl2.cacheservice.v2.CacheService/Get" => {
                    ...
                    > tonic::server::UnaryService<super::GetCacheRequest> for GetSvc<T> {
                        type Response = super::super::GetCacheResponse;
                ...
                "/flyteidl2.cacheservice.v2.CacheService/Put" => {
                    ...
                    > tonic::server::UnaryService<super::PutCacheRequest> for PutSvc<T> {
                        type Response = super::super::PutCacheResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/flyteidl2.cacheservice.v2.CacheService/Delete" => {
                    ...
                    for DeleteSvc<T> {
                        type Response = super::super::DeleteCacheResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/flyteidl2.cacheservice.v2.CacheService/GetOrExtendReservation" => {
                    ...
                    for GetOrExtendReservationSvc<T> {
                        type Response = super::super::GetOrExtendReservationResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/flyteidl2.cacheservice.v2.CacheService/ReleaseReservation" => {
                    ...
                    for ReleaseReservationSvc<T> {
                        type Response = super::super::ReleaseReservationResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
    ...
    impl<T: CacheService> tonic::server::NamedService for CacheServiceServer<T> {
        const NAME: &'static str = "flyteidl2.cacheservice.v2.CacheService";
    }
}
