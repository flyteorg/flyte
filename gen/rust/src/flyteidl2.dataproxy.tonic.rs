...
pub mod data_proxy_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn upload_metadata(
            &mut self,
            request: impl tonic::IntoRequest<super::UploadMetadataRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateUploadLocationResponse>,
            tonic::Status,
        > {
        ...
        pub async fn get_local_action_data(
            &mut self,
            request: impl tonic::IntoRequest<super::GetActionDataRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetActionDataResponse>,
        ...
        pub async fn create_local_download_link(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateLocalDownloadLinkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateDownloadLinkResponse>,
            tonic::Status,
        > {
...
pub mod data_proxy_service_server {
    ...
    pub trait DataProxyService: Send + Sync + 'static {
        ...
        async fn upload_metadata(
            &self,
            request: tonic::Request<super::UploadMetadataRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateUploadLocationResponse>,
            tonic::Status,
        >;
        async fn get_local_action_data(
            &self,
            request: tonic::Request<super::GetActionDataRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetActionDataResponse>,
            tonic::Status,
        >;
        async fn create_local_download_link(
            &self,
            request: tonic::Request<super::CreateLocalDownloadLinkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateDownloadLinkResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/flyteidl2.dataproxy.DataProxyService/UploadMetadata" => {
                    #[allow(non_camel_case_types)]
                    struct UploadMetadataSvc<T: DataProxyService>(pub Arc<T>);
                    impl<
                        T: DataProxyService,
                    > tonic::server::UnaryService<super::UploadMetadataRequest>
                    for UploadMetadataSvc<T> {
                        type Response = super::CreateUploadLocationResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataProxyService>::upload_metadata(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = UploadMetadataSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/flyteidl2.dataproxy.DataProxyService/GetLocalActionData" => {
                    #[allow(non_camel_case_types)]
                    struct GetLocalActionDataSvc<T: DataProxyService>(pub Arc<T>);
                    impl<
                        T: DataProxyService,
                    > tonic::server::UnaryService<super::GetActionDataRequest>
                    for GetLocalActionDataSvc<T> {
                        type Response = super::GetActionDataResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataProxyService>::get_local_action_data(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetLocalActionDataSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/flyteidl2.dataproxy.DataProxyService/CreateLocalDownloadLink" => {
                    #[allow(non_camel_case_types)]
                    struct CreateLocalDownloadLinkSvc<T: DataProxyService>(pub Arc<T>);
                    impl<
                        T: DataProxyService,
                    > tonic::server::UnaryService<super::CreateLocalDownloadLinkRequest>
                    for CreateLocalDownloadLinkSvc<T> {
                        type Response = super::CreateDownloadLinkResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                super::CreateLocalDownloadLinkRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DataProxyService>::create_local_download_link(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateLocalDownloadLinkSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
