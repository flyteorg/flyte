...
pub mod app_logs_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct AppLogsServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl AppLogsServiceClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> AppLogsServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            AppLogsServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.app.AppLogsService", "TailLogs"));
            self.inner.server_streaming(req, path, codec).await
        }
    }
}
/// Generated server implementations.
pub mod app_logs_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with AppLogsServiceServer.
    #[async_trait]
    pub trait AppLogsService: Send + Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct AppLogsServiceServer<T: AppLogsService> {
        inner: Arc<T>,
    ...
    impl<T: AppLogsService> AppLogsServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for AppLogsServiceServer<T>
    where
        T: AppLogsService,
        B: Body + Send + 'static,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/flyteidl2.app.AppLogsService/TailLogs" => {
                    ...
                    struct TailLogsSvc<T: AppLogsService>(pub Arc<T>);
                    impl<
                        T: AppLogsService,
                    ...
                    for TailLogsSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AppLogsService>::tail_logs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: AppLogsService> Clone for AppLogsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: AppLogsService> tonic::server::NamedService for AppLogsServiceServer<T> {
        const NAME: &'static str = "flyteidl2.app.AppLogsService";
    }
}
/// Generated client implementations.
...
*/
        pub async fn create(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.app.AppService", "Create"));
...
*/
        pub async fn get(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.app.AppService", "Get"));
            self.inner.unary(req, path, codec).await
        }
...
*/
        pub async fn update(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.app.AppService", "Update"));
            self.inner.unary(req, path, codec).await
        }
...
*/
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.app.AppService", "UpdateStatus"));
            self.inner.unary(req, path, codec).await
        }
...
*/
        pub async fn delete(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.app.AppService", "Delete"));
            self.inner.unary(req, path, codec).await
        }
...
*/
        pub async fn list(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.app.AppService", "List"));
            self.inner.unary(req, path, codec).await
        }
...
*/
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.app.AppService", "Watch"));
            self.inner.server_streaming(req, path, codec).await
        }
        /** Lease leases apps.
*/
        pub async fn lease(
            ...
            tonic::Response<tonic::codec::Streaming<super::LeaseResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
*/
        ...
        /// Server streaming response type for the Lease method.
        type LeaseStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::LeaseResponse, tonic::Status>,
            >
            + Send
            + 'static;
        /** Lease leases apps.
...
*/
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/flyteidl2.app.AppService/Create" => {
                    #[allow(non_camel_case_types)]
                    struct CreateSvc<T: AppService>(pub Arc<T>);
                    impl<T: AppService> tonic::server::UnaryService<super::CreateRequest>
                    for CreateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AppService>::create(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.app.AppService/Get" => {
                    #[allow(non_camel_case_types)]
                    struct GetSvc<T: AppService>(pub Arc<T>);
                    impl<T: AppService> tonic::server::UnaryService<super::GetRequest>
                    for GetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AppService>::get(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.app.AppService/Update" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateSvc<T: AppService>(pub Arc<T>);
                    impl<T: AppService> tonic::server::UnaryService<super::UpdateRequest>
                    for UpdateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AppService>::update(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.app.AppService/UpdateStatus" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateStatusSvc<T: AppService>(pub Arc<T>);
                    impl<
                        T: AppService,
                    ...
                    for UpdateStatusSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AppService>::update_status(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.app.AppService/Delete" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteSvc<T: AppService>(pub Arc<T>);
                    impl<T: AppService> tonic::server::UnaryService<super::DeleteRequest>
                    for DeleteSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AppService>::delete(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.app.AppService/List" => {
                    #[allow(non_camel_case_types)]
                    struct ListSvc<T: AppService>(pub Arc<T>);
                    impl<T: AppService> tonic::server::UnaryService<super::ListRequest>
                    for ListSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AppService>::list(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.app.AppService/Watch" => {
                    #[allow(non_camel_case_types)]
                    struct WatchSvc<T: AppService>(pub Arc<T>);
                    impl<
                        T: AppService,
                    ...
                    for WatchSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AppService>::watch(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/flyteidl2.app.AppService/Lease" => {
                    #[allow(non_camel_case_types)]
                    struct LeaseSvc<T: AppService>(pub Arc<T>);
                    impl<
                        T: AppService,
                    > tonic::server::ServerStreamingService<super::LeaseRequest>
                    for LeaseSvc<T> {
                        type Response = super::LeaseResponse;
                        type ResponseStream = T::LeaseStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AppService>::lease(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: AppService> tonic::server::NamedService for AppServiceServer<T> {
        const NAME: &'static str = "flyteidl2.app.AppService";
    }
}
