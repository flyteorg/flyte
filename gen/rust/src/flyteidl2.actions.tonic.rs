...
pub mod actions_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn watch_for_updates(
            ...
            tonic::Response<tonic::codec::Streaming<super::WatchForUpdatesResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod actions_service_server {
    ...
    pub trait ActionsService: Send + Sync + 'static {
        ...
        async fn watch_for_updates(
            &self,
            request: tonic::Request<super::WatchForUpdatesRequest>,
        ) -> std::result::Result<
            ...
            match req.uri().path() {
                ...
                "/flyteidl2.actions.ActionsService/WatchForUpdates" => {
                    ...
                    > tonic::server::ServerStreamingService<
                        super::WatchForUpdatesRequest,
                    > for WatchForUpdatesSvc<T> {
                        type Response = super::WatchForUpdatesResponse;
