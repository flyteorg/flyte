...
pub mod secret_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.secret.SecretService", "CreateSecret"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.secret.SecretService", "UpdateSecret"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("flyteidl2.secret.SecretService", "GetSecret"));
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.secret.SecretService", "DeleteSecret"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.secret.SecretService", "ListSecrets"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod secret_service_server {
    ...
    impl<T: SecretService> tonic::server::NamedService for SecretServiceServer<T> {
        const NAME: &'static str = "flyteidl2.secret.SecretService";
    }
}
