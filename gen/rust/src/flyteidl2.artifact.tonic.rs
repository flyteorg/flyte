...
pub mod artifact_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("flyteidl2.artifact.ArtifactService", "GetArtifact"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn list_artifact_names(
            &mut self,
            request: impl tonic::IntoRequest<super::ListArtifactNamesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListArtifactNamesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn list_artifact_metadata_keys(
            &mut self,
            request: impl tonic::IntoRequest<super::ListArtifactMetadataKeysRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListArtifactMetadataKeysResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/flyteidl2.artifact.ArtifactService/ListArtifactMetadataKeys",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod artifact_service_server {
    ...
    pub trait ArtifactService: Send + Sync + 'static {
        ...
        async fn list_artifacts(
            ...
            tonic::Status,
        >;
        async fn list_artifact_names(
            &self,
            request: tonic::Request<super::ListArtifactNamesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListArtifactNamesResponse>,
            tonic::Status,
        >;
        async fn list_artifact_metadata_keys(
            &self,
            request: tonic::Request<super::ListArtifactMetadataKeysRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListArtifactMetadataKeysResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/flyteidl2.artifact.ArtifactService/ListArtifactNames" => {
                    #[allow(non_camel_case_types)]
                    struct ListArtifactNamesSvc<T: ArtifactService>(pub Arc<T>);
                    impl<
                        T: ArtifactService,
                    > tonic::server::UnaryService<super::ListArtifactNamesRequest>
                    for ListArtifactNamesSvc<T> {
                        type Response = super::ListArtifactNamesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ArtifactService>::list_artifact_names(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListArtifactNamesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/flyteidl2.artifact.ArtifactService/ListArtifactMetadataKeys" => {
                    #[allow(non_camel_case_types)]
                    struct ListArtifactMetadataKeysSvc<T: ArtifactService>(pub Arc<T>);
                    impl<
                        T: ArtifactService,
                    > tonic::server::UnaryService<super::ListArtifactMetadataKeysRequest>
                    for ListArtifactMetadataKeysSvc<T> {
                        type Response = super::ListArtifactMetadataKeysResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::ListArtifactMetadataKeysRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ArtifactService>::list_artifact_metadata_keys(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListArtifactMetadataKeysSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/flyteidl2.artifact.ArtifactService/DeleteArtifact" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteArtifactSvc<T: ArtifactService>(pub Arc<T>);
                    impl<
                        T: ArtifactService,
                    > tonic::server::UnaryService<super::DeleteArtifactRequest>
                    for DeleteArtifactSvc<T> {
                        type Response = super::DeleteArtifactResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ArtifactService>::delete_artifact(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T: ArtifactService> tonic::server::NamedService for ArtifactServiceServer<T> {
        const NAME: &'static str = "flyteidl2.artifact.ArtifactService";
    }
}
