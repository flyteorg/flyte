...
#ifndef PROTOBUF_flyteidl_2fcore_2fcondition_2eproto__INCLUDED
#define PROTOBUF_flyteidl_2fcore_2fcondition_2eproto__INCLUDED
...
inline void InitDefaults() {
  InitDefaultsComparisonExpression();
  InitDefaultsOperand();
  InitDefaultsBooleanExpression();
}
}  // namespace protobuf_flyteidl_2fcore_2fcondition_2eproto
namespace flyteidl {
namespace core {
...
enum ComparisonExpression_Operator {
  ...
  ComparisonExpression_Operator_ComparisonExpression_Operator_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ComparisonExpression_Operator_ComparisonExpression_Operator_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
enum ConjunctionExpression_LogicalOperator {
  ...
  ConjunctionExpression_LogicalOperator_ConjunctionExpression_LogicalOperator_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ConjunctionExpression_LogicalOperator_ConjunctionExpression_LogicalOperator_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
class ComparisonExpression : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.ComparisonExpression) */ {
 public:
  ...
  inline ComparisonExpression* New() const PROTOBUF_FINAL { return New(NULL); }

  ComparisonExpression* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_flyteidl_2fcore_2fcondition_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fcore_2fcondition_2eproto::InitDefaultsComparisonExpressionImpl();
};
// -------------------------------------------------------------------

class Operand : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.Operand) */ {
 public:
  Operand();
  virtual ~Operand();
  ...
  inline Operand* New() const PROTOBUF_FINAL { return New(NULL); }

  Operand* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_flyteidl_2fcore_2fcondition_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fcore_2fcondition_2eproto::InitDefaultsOperandImpl();
};
// -------------------------------------------------------------------

class BooleanExpression : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.BooleanExpression) */ {
 public:
  BooleanExpression();
  ...
  inline BooleanExpression* New() const PROTOBUF_FINAL { return New(NULL); }

  BooleanExpression* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_flyteidl_2fcore_2fcondition_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fcore_2fcondition_2eproto::InitDefaultsBooleanExpressionImpl();
};
// -------------------------------------------------------------------

class ConjunctionExpression : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.ConjunctionExpression) */ {
 public:
  ...
  inline ConjunctionExpression* New() const PROTOBUF_FINAL { return New(NULL); }

  ConjunctionExpression* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
inline bool ComparisonExpression::has_left_value() const {
  return this != internal_default_instance() && left_value_ != NULL;
}
...
inline const ::flyteidl::core::Operand& ComparisonExpression::left_value() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::flyteidl::core::Operand*>(
...
inline ::flyteidl::core::Operand* ComparisonExpression::mutable_left_value() {
  ...
  if (left_value_ == NULL) {
    left_value_ = new ::flyteidl::core::Operand;
  }
...
inline bool ComparisonExpression::has_right_value() const {
  return this != internal_default_instance() && right_value_ != NULL;
}
...
inline ::flyteidl::core::Operand* ComparisonExpression::mutable_right_value() {
  ...
  if (right_value_ == NULL) {
    right_value_ = new ::flyteidl::core::Operand;
  }
...
inline ::flyteidl::core::Primitive* Operand::mutable_primitive() {
  if (!has_primitive()) {
    clear_val();
    set_has_primitive();
    val_.primitive_ = new ::flyteidl::core::Primitive;
  }
...
inline void Operand::set_allocated_var(::std::string* var) {
  ...
  if (var != NULL) {
    set_has_var();
    val_.var_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
        var);
  }
...
inline ::flyteidl::core::ConjunctionExpression* BooleanExpression::mutable_conjunction() {
  if (!has_conjunction()) {
    clear_expr();
    set_has_conjunction();
    expr_.conjunction_ = new ::flyteidl::core::ConjunctionExpression;
  }
...
inline ::flyteidl::core::ComparisonExpression* BooleanExpression::mutable_comparison() {
  if (!has_comparison()) {
    clear_expr();
    set_has_comparison();
    expr_.comparison_ = new ::flyteidl::core::ComparisonExpression;
  }
...
inline bool ConjunctionExpression::has_left_expression() const {
  return this != internal_default_instance() && left_expression_ != NULL;
}
...
inline ::flyteidl::core::BooleanExpression* ConjunctionExpression::mutable_left_expression() {
  ...
  if (left_expression_ == NULL) {
    left_expression_ = new ::flyteidl::core::BooleanExpression;
  }
...
inline bool ConjunctionExpression::has_right_expression() const {
  return this != internal_default_instance() && right_expression_ != NULL;
}
...
inline ::flyteidl::core::BooleanExpression* ConjunctionExpression::mutable_right_expression() {
  ...
  if (right_expression_ == NULL) {
    right_expression_ = new ::flyteidl::core::BooleanExpression;
  }
...
template <> struct is_proto_enum< ::flyteidl::core::ComparisonExpression_Operator> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::flyteidl::core::ConjunctionExpression_LogicalOperator> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_flyteidl_2fcore_2fcondition_2eproto__INCLUDED
