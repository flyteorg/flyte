...
#ifndef PROTOBUF_flyteidl_2fcore_2ftasks_2eproto__INCLUDED
#define PROTOBUF_flyteidl_2fcore_2ftasks_2eproto__INCLUDED
...
inline void InitDefaults() {
  InitDefaultsResources_ResourceEntry();
  InitDefaultsResources();
  InitDefaultsRuntimeMetadata();
  InitDefaultsTaskMetadata();
  InitDefaultsTaskTemplate();
  InitDefaultsContainerPort();
...
enum Resources_ResourceName {
  ...
  Resources_ResourceName_Resources_ResourceName_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  Resources_ResourceName_Resources_ResourceName_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
enum RuntimeMetadata_RuntimeType {
  ...
  RuntimeMetadata_RuntimeType_RuntimeMetadata_RuntimeType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  RuntimeMetadata_RuntimeType_RuntimeMetadata_RuntimeType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
class Resources_ResourceEntry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.Resources.ResourceEntry) */ {
 public:
  ...
  inline Resources_ResourceEntry* New() const PROTOBUF_FINAL { return New(NULL); }

  Resources_ResourceEntry* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_flyteidl_2fcore_2ftasks_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fcore_2ftasks_2eproto::InitDefaultsResources_ResourceEntryImpl();
};
// -------------------------------------------------------------------

class Resources : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.Resources) */ {
 public:
  Resources();
  virtual ~Resources();
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_flyteidl_2fcore_2ftasks_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fcore_2ftasks_2eproto::InitDefaultsResourcesImpl();
};
// -------------------------------------------------------------------

class RuntimeMetadata : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.RuntimeMetadata) */ {
 public:
  RuntimeMetadata();
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_flyteidl_2fcore_2ftasks_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fcore_2ftasks_2eproto::InitDefaultsRuntimeMetadataImpl();
};
// -------------------------------------------------------------------

class TaskMetadata : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.TaskMetadata) */ {
 public:
  TaskMetadata();
  ...
  inline TaskMetadata* New() const PROTOBUF_FINAL { return New(NULL); }

  TaskMetadata* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_flyteidl_2fcore_2ftasks_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fcore_2ftasks_2eproto::InitDefaultsTaskMetadataImpl();
};
// -------------------------------------------------------------------

class TaskTemplate : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.TaskTemplate) */ {
 public:
  TaskTemplate();
  ...
  inline TaskTemplate* New() const PROTOBUF_FINAL { return New(NULL); }

  TaskTemplate* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_flyteidl_2fcore_2ftasks_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fcore_2ftasks_2eproto::InitDefaultsTaskTemplateImpl();
};
// -------------------------------------------------------------------

class ContainerPort : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.ContainerPort) */ {
 public:
  ContainerPort();
  ...
  inline ContainerPort* New() const PROTOBUF_FINAL { return New(NULL); }

  ContainerPort* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_flyteidl_2fcore_2ftasks_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fcore_2ftasks_2eproto::InitDefaultsContainerPortImpl();
};
// -------------------------------------------------------------------

class Container : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.core.Container) */ {
 public:
  Container();
  virtual ~Container();
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_flyteidl_2fcore_2ftasks_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fcore_2ftasks_2eproto::InitDefaultsContainerImpl();
};
// ===================================================================
...
inline const ::flyteidl::core::RuntimeMetadata& TaskMetadata::runtime() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::flyteidl::core::RuntimeMetadata*>(
...
inline ::flyteidl::core::RuntimeMetadata* TaskMetadata::mutable_runtime() {
  ...
  if (runtime_ == NULL) {
    runtime_ = new ::flyteidl::core::RuntimeMetadata;
  }
...
inline void TaskMetadata::set_allocated_deprecated_error_message(::std::string* deprecated_error_message) {
  if (deprecated_error_message != NULL) {
...
inline const ::flyteidl::core::TaskMetadata& TaskTemplate::metadata() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::flyteidl::core::TaskMetadata*>(
...
inline ::flyteidl::core::TaskMetadata* TaskTemplate::mutable_metadata() {
  ...
  if (metadata_ == NULL) {
    metadata_ = new ::flyteidl::core::TaskMetadata;
  }
...
inline ::google::protobuf::Struct* TaskTemplate::mutable_custom() {
  ...
  if (custom_ == NULL) {
    custom_ = new ::google::protobuf::Struct;
  }
...
inline ::flyteidl::core::Container* TaskTemplate::mutable_container() {
  if (!has_container()) {
    clear_target();
    set_has_container();
    target_.container_ = new ::flyteidl::core::Container;
  }
...
inline const ::flyteidl::core::Resources& Container::resources() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::flyteidl::core::Resources*>(
...
inline ::flyteidl::core::Resources* Container::mutable_resources() {
  ...
  if (resources_ == NULL) {
    resources_ = new ::flyteidl::core::Resources;
  }
...
template <> struct is_proto_enum< ::flyteidl::core::Resources_ResourceName> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::flyteidl::core::RuntimeMetadata_RuntimeType> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_flyteidl_2fcore_2ftasks_2eproto__INCLUDED
