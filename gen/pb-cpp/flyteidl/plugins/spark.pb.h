...
#ifndef PROTOBUF_flyteidl_2fplugins_2fspark_2eproto__INCLUDED
#define PROTOBUF_flyteidl_2fplugins_2fspark_2eproto__INCLUDED
...
inline void InitDefaults() {
  InitDefaultsSparkApplication();
  InitDefaultsSparkJob_SparkConfEntry_DoNotUse();
  InitDefaultsSparkJob_HadoopConfEntry_DoNotUse();
...
enum SparkApplication_Type {
  ...
  SparkApplication_Type_SparkApplication_Type_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  SparkApplication_Type_SparkApplication_Type_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
class SparkApplication : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.plugins.SparkApplication) */ {
 public:
  SparkApplication();
  ...
  inline SparkApplication* New() const PROTOBUF_FINAL { return New(NULL); }

  SparkApplication* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct ::protobuf_flyteidl_2fplugins_2fspark_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fplugins_2fspark_2eproto::InitDefaultsSparkApplicationImpl();
};
// -------------------------------------------------------------------
...
class SparkJob : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:flyteidl.plugins.SparkJob) */ {
 public:
  SparkJob();
  virtual ~SparkJob();
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_flyteidl_2fplugins_2fspark_2eproto::TableStruct;
  friend void ::protobuf_flyteidl_2fplugins_2fspark_2eproto::InitDefaultsSparkJobImpl();
};
// ===================================================================
...
template <> struct is_proto_enum< ::flyteidl::plugins::SparkApplication_Type> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_flyteidl_2fplugins_2fspark_2eproto__INCLUDED
