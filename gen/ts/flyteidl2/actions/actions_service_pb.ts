...
export type Action = Message<"flyteidl2.actions.Action"> & {
   ...
   *
   * @generated from field: flyteidl2.common.ActionIdentifier recovered_from = 10;
   */
