...
export type Action = Message<"flyteidl2.actions.Action"> & {
   ...
   *
   * @generated from field: optional flyteidl2.common.ActionIdentifier recovered_from = 10;
   */
