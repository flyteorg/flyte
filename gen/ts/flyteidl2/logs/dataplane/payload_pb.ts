...
export const file_flyteidl2_logs_dataplane_payload: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_flyteidl2_common_list, file_google_protobuf_timestamp]);
...
export type LoggingContext = Message<"flyteidl2.logs.dataplane.LoggingContext"> & {
  ...
  /**
   * +optional, can be empty when kubernetes_pod_labels is provided for label-based lookup
   *
  ...
  /**
   * +optional, can be empty to stream logs for all containers in the matched pod(s)
   *
  ...
  /**
   * Pod-name prefix used by log sources to narrow stream/pod searches. Set by the
   * executor (leaseworker copies LogContext.unique_id to this field) and propagated
   * by the cloud-side data proxy. Log sources match pods whose name starts with
   * `{pod_name_prefix}-`. Preferred over deriving the prefix from run/action/attempt
   * because plugins can override GeneratedNameMaxLength (e.g. Ray uses 47, default 50).
   * +optional
   *
   * @generated from field: string pod_name_prefix = 13;
   */
