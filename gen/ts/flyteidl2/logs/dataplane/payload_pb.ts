...
export const file_flyteidl2_logs_dataplane_payload: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_flyteidl2_common_list, file_google_protobuf_timestamp]);
...
export type LoggingContext = Message<"flyteidl2.logs.dataplane.LoggingContext"> & {
   ...
   *
   * @generated from field: string pod_name_prefix = 12 [deprecated = true];
   * @deprecated
   */
   ...
   *
   * @generated from field: repeated string pod_name_prefixes = 13;
   */
...
export type LogLine = Message<"flyteidl2.logs.dataplane.LogLine"> & {
   ...
   *
   * @generated from field: string short_pod_name = 4;
   */
  shortPodName: string;
};
...
export type LogLines = Message<"flyteidl2.logs.dataplane.LogLines"> & {
   ...
   *
   * @generated from field: flyteidl2.logs.dataplane.LogLineSource source = 5;
   */
 ...
 *
 * @generated from enum flyteidl2.logs.dataplane.LogLineSource
 */
export enum LogLineSource {
  /**
   * @generated from enum value: LOG_LINE_SOURCE_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,
   ...
   *
   * @generated from enum value: LOG_LINE_SOURCE_LIVE = 1;
   */
  LIVE = 1,
   ...
   *
   * @generated from enum value: LOG_LINE_SOURCE_PERSISTED = 2;
   */
  PERSISTED = 2,
}

/**
 * Describes the enum flyteidl2.logs.dataplane.LogLineSource.
 */
export const LogLineSourceSchema: GenEnum<LogLineSource> = /*@__PURE__*/
...
export const LogsSourceSchema: GenEnum<LogsSource> = /*@__PURE__*/
  enumDesc(file_flyteidl2_logs_dataplane_payload, 2);
