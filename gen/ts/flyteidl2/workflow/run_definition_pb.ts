...
=======
  ...
  /**
   * Runtime details resolved at execution time by the operator.
   *
   * @generated from field: flyteidl2.workflow.RuntimeDetails runtime_details = 7;
   */
 ...
 * Runtime details resolved at execution time by the operator.
 *
 * @generated from message flyteidl2.workflow.RuntimeDetails
 */
export type RuntimeDetails = Message<"flyteidl2.workflow.RuntimeDetails"> & {
  /**
   * GPU resource name (e.g. "nvidia.com/gpu").
   *
   * @generated from field: string gpu_resource_name = 1;
   */
  gpuResourceName: string;

  /**
   * The pod this action ran on.
   *
  ...
  /**
   * The cloud provider id for the underlying node this action ran on, if available.
   * e.g. i-0abc123... on AWS or the GCP instance id.
   *
  ...
  /**
   * The cluster this action ran on.
   *
   * @generated from field: string source_cluster = 4;
   */
  sourceCluster: string;

  /**
   * Which cloud provider this action ran on.
   *
   * @generated from field: flyteidl2.workflow.Cloud source_cloud = 5;
   */
  sourceCloud: Cloud;
};

/**
 * Describes the message flyteidl2.workflow.RuntimeDetails.
 * Use `create(RuntimeDetailsSchema)` to create a new message.
 */
export const RuntimeDetailsSchema: GenMessage<RuntimeDetails> = /*@__PURE__*/
