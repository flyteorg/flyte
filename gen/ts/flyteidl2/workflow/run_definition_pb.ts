...
import type { CacheMetadata } from "../common/cache_pb.ts";
import { file_flyteidl2_common_cache } from "../common/cache_pb.ts";
...
import type { GpuFault, LogContext, TaskLog } from "../core/execution_pb.ts";
...
export const file_flyteidl2_workflow_run_definition: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_flyteidl2_common_cache, file_flyteidl2_common_identifier, file_flyteidl2_common_identity, file_flyteidl2_common_phase, file_flyteidl2_common_run, file_flyteidl2_core_catalog, file_flyteidl2_core_execution, file_flyteidl2_core_literals, file_flyteidl2_core_types, file_flyteidl2_task_common, file_flyteidl2_task_run, file_flyteidl2_task_task_definition, file_google_protobuf_duration, file_google_protobuf_struct, file_google_protobuf_timestamp, file_google_protobuf_wrappers]);
...
export type ErrorInfo = Message<"flyteidl2.workflow.ErrorInfo"> & {
  ...
  /**
   * Short failure code from the plugin's ExecutionError, for example "OOMKilled",
   * "Interrupted" or "GpuFallenOffBus". Empty when the producer did not set one.
   *
  ...
  /**
   * Mirrors ExecutionError.gpu_fault: set when the failure was classified as caused
   * by or coincident with a GPU fault.
   *
   * @generated from field: flyteidl2.core.GpuFault gpu_fault = 4;
   */
  gpuFault?: GpuFault;
};
...
export type ActionAttempt = Message<"flyteidl2.workflow.ActionAttempt"> & {
   ...
   *
   * @generated from field: flyteidl2.common.CacheMetadata cache_metadata = 14;
   */
...
export type ClusterEvent = Message<"flyteidl2.workflow.ClusterEvent"> & {
  ...
  /**
   * type mirrors the Kubernetes event type when this entry originated from a Kubernetes object
   * event. TYPE_UNSPECIFIED for entries synthesized from phase transitions.
   *
   * @generated from field: flyteidl2.workflow.ClusterEvent.Type type = 3;
   */
  type: ClusterEvent_Type;

  /**
   * reason is the machine-readable, CamelCase reason of the source Kubernetes event, e.g.
   * "FailedMount", "Pulling", "BackOff". Empty when unknown.
   *
  ...
  /**
   * source_component identifies the component that emitted the source event, e.g. "kubelet" or
   * "default-scheduler". Empty when unknown.
   *
   * @generated from field: string source_component = 5;
   */
  sourceComponent: string;

  /**
   * count is the number of occurrences the cluster had observed for the source event when it was
   * recorded, when known (0 otherwise). Repeating events are recorded once, with their count.
   *
  ...
  /**
   * gpu_fault is set when this event reports a GPU fault (an NVIDIA Xid or an
   * NVSwitch SXid) that was attributed to this attempt. The message still
   * carries the human-readable form; this field carries the same fault as data
   * so that consumers can classify, filter, and render it without parsing the
   * message. Unset for every other kind of cluster event.
   *
   * @generated from field: flyteidl2.core.GpuFault gpu_fault = 7;
   */
  gpuFault?: GpuFault;
};
...
/**
 * Severity of the source Kubernetes event.
 *
 * @generated from enum flyteidl2.workflow.ClusterEvent.Type
 */
export enum ClusterEvent_Type {
  /**
...
/**
 * Describes the enum flyteidl2.workflow.ClusterEvent.Type.
 */
export const ClusterEvent_TypeSchema: GenEnum<ClusterEvent_Type> = /*@__PURE__*/
  enumDesc(file_flyteidl2_workflow_run_definition, 18, 0);
...
export type ActionEvent = Message<"flyteidl2.workflow.ActionEvent"> & {
   ...
   *
   * @generated from field: flyteidl2.common.CacheMetadata cache_metadata = 16;
   */
  cacheMetadata?: CacheMetadata;
};
...
export enum RunSource {
  ...
  /**
   * The run is orchestrated outside the platform — on a user's machine, in CI, inside an agent
   * framework — and its action tree is reported via TrackedRunService.
   *
   * @generated from enum value: RUN_SOURCE_TRACKED = 4;
   */
  TRACKED = 4,

  /**
   * @generated from enum value: RUN_SOURCE_ARTIFACT_TRIGGER = 5;
   */
  ARTIFACT_TRIGGER = 5,
}
