...
export enum RunSource {
   ...
   * framework — and its action tree is reported via TracedRunService.
   *
   * @generated from enum value: RUN_SOURCE_TRACED = 4;
   */
  TRACED = 4,
