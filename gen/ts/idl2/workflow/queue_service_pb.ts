...
export type TraceAction = Message<"flyteidl2.workflow.TraceAction"> & {
   ...
   *
   * @generated from field: flyteidl2.workflow.TraceSpec spec = 6;
   */
  spec?: TraceSpec;
};
