...
// @generated from file idl2/workflow/state_service.proto (package flyteidl2.workflow, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file idl2/workflow/state_service.proto.
 */
export const file_idl2_workflow_state_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_idl2_common_identifier, file_idl2_core_execution, file_google_rpc_status, file_validate_validate, file_idl2_workflow_run_definition]);
...
export const PutRequestSchema: GenMessage<PutRequest> = /*@__PURE__*/
  messageDesc(file_idl2_workflow_state_service, 0);
...
export const PutResponseSchema: GenMessage<PutResponse> = /*@__PURE__*/
  messageDesc(file_idl2_workflow_state_service, 1);
...
export const GetRequestSchema: GenMessage<GetRequest> = /*@__PURE__*/
  messageDesc(file_idl2_workflow_state_service, 2);
...
export const GetResponseSchema: GenMessage<GetResponse> = /*@__PURE__*/
  messageDesc(file_idl2_workflow_state_service, 3);
...
export const WatchRequestSchema: GenMessage<WatchRequest> = /*@__PURE__*/
  messageDesc(file_idl2_workflow_state_service, 4);
...
export const WatchResponseSchema: GenMessage<WatchResponse> = /*@__PURE__*/
  messageDesc(file_idl2_workflow_state_service, 5);
...
export const ControlMessageSchema: GenMessage<ControlMessage> = /*@__PURE__*/
  messageDesc(file_idl2_workflow_state_service, 6);
...
export const ActionUpdateSchema: GenMessage<ActionUpdate> = /*@__PURE__*/
  messageDesc(file_idl2_workflow_state_service, 7);
...
export const StateService: GenService<{
  ...
  serviceDesc(file_idl2_workflow_state_service, 0);
