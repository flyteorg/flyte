...
_WORKFLOWMETADATA_ONFAILUREPOLICY = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FAIL_AFTER_RUNNING_NODES_COMPLETE', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FAIL_AFTER_EXECUTABLE_NODES_COMPLETE', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
...
_WORKFLOWMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='queuing_budget', full_name='flyteidl.core.WorkflowMetadata.queuing_budget', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WORKFLOWMETADATA.fields_by_name['queuing_budget'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
