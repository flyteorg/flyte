...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=flyteidl_dot_admin_dot_version__pb2._VERSION,
    serialized_options=_b('\202\323\344\223\002\021\032\014/api/version:\001*\222AP\032NRetrieve the Version (including the Build  information) for FlyteAdmin service'),
  ),
])
