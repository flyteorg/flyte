...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0024\032//api/v1/project_attributes/{attributes.project}:\001*\222AE\032CUpdate the customized resource attributes associated with a project'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002&\022$/api/v1/project_attributes/{project}\222AG\032ERetrieve the customized resource attributes associated with a project'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002)*$/api/v1/project_attributes/{project}:\001*\222AE\032CDelete the customized resource attributes associated with a project'),
  ),
  _descriptor.MethodDescriptor(
