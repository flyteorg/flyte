...
_ADMINSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='UpdateWorkflow',
    full_name='flyteidl.service.AdminService.UpdateWorkflow',
    index=8,
    containing_service=None,
    input_type=flyteidl_dot_admin_dot_workflow__pb2._WORKFLOWUPDATEREQUEST,
    output_type=flyteidl_dot_admin_dot_workflow__pb2._WORKFLOWUPDATERESPONSE,
    serialized_options=_b('\202\323\344\223\002F\032A/api/v1/workflows/{id.project}/{id.domain}/{id.name}/{id.version}:\001*\222A6\0324Update the state of an existing workflow definition.'),
  ),
  _descriptor.MethodDescriptor(
