...
_LAUNCHPLANSPEC.fields_by_name['role'].has_options = True
_LAUNCHPLANSPEC.fields_by_name['role']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
