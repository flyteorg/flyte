...
_NODEEXECUTIONMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='interruptible', full_name='flyteidl.admin.NodeExecutionMetaData.interruptible', index=0,
