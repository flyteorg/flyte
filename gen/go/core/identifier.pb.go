...
func (ResourceType) Descriptor() protoreflect.EnumDescriptor {
	return file_core_identifier_proto_enumTypes[0].Descriptor()
}

func (ResourceType) Type() protoreflect.EnumType {
	return &file_core_identifier_proto_enumTypes[0]
}
...
func (ResourceType) EnumDescriptor() ([]byte, []int) {
	return file_core_identifier_proto_rawDescGZIP(), []int{0}
}
...
func (x *Identifier) Reset() {
	*x = Identifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_identifier_proto_msgTypes[0]
...
func (x *WorkflowExecutionIdentifier) Reset() {
	*x = WorkflowExecutionIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_identifier_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WorkflowExecutionIdentifier) Descriptor() ([]byte, []int) {
	return file_core_identifier_proto_rawDescGZIP(), []int{1}
}
...
func (x *NodeExecutionIdentifier) Reset() {
	*x = NodeExecutionIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_identifier_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NodeExecutionIdentifier) Descriptor() ([]byte, []int) {
	return file_core_identifier_proto_rawDescGZIP(), []int{2}
}
...
func (x *TaskExecutionIdentifier) Reset() {
	*x = TaskExecutionIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_identifier_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TaskExecutionIdentifier) Descriptor() ([]byte, []int) {
	return file_core_identifier_proto_rawDescGZIP(), []int{3}
}
...
func (x *SignalIdentifier) Reset() {
	*x = SignalIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_core_identifier_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SignalIdentifier) Descriptor() ([]byte, []int) {
	return file_core_identifier_proto_rawDescGZIP(), []int{4}
}
...
var file_core_identifier_proto_rawDesc = []byte{
	0x0a, 0x15, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65,
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64,
	0x6c, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x22, 0xc0, 0x01, 0x0a, 0x0a, 0x49, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x40, 0x0a, 0x0d, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	0x22, 0x81, 0x01, 0x0a, 0x17, 0x4e, 0x6f, 0x64, 0x65, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69,
	...
	0x6f, 0x64, 0x65, 0x49, 0x64, 0x12, 0x4d, 0x0a, 0x0c, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x66, 0x6c,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x22, 0xc6, 0x01, 0x0a, 0x17, 0x54, 0x61, 0x73, 0x6b, 0x45, 0x78, 0x65,
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72,
	0x12, 0x32, 0x0a, 0x07, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x73, 0x6b, 0x49, 0x64, 0x12, 0x52, 0x0a, 0x11, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x65, 0x78, 0x65,
	...
	0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x52, 0x0f, 0x6e, 0x6f, 0x64, 0x65, 0x45, 0x78, 0x65,
	...
	0x0c, 0x72, 0x65, 0x74, 0x72, 0x79, 0x41, 0x74, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x22, 0x7e, 0x0a,
	0x10, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65,
	0x72, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x12, 0x4d,
	...
	0x45, 0x54, 0x10, 0x04, 0x42, 0xa2, 0x01, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x79,
	0x74, 0x65, 0x69, 0x64, 0x6c, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x42, 0x0f, 0x49, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x48, 0x02, 0x50, 0x01, 0x5a,
	0x25, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x66, 0x6c, 0x79, 0x74,
...
var (
	file_core_identifier_proto_rawDescOnce sync.Once
	file_core_identifier_proto_rawDescData = file_core_identifier_proto_rawDesc
)

func file_core_identifier_proto_rawDescGZIP() []byte {
	file_core_identifier_proto_rawDescOnce.Do(func() {
		file_core_identifier_proto_rawDescData = protoimpl.X.CompressGZIP(file_core_identifier_proto_rawDescData)
	})
	return file_core_identifier_proto_rawDescData
}

var file_core_identifier_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_core_identifier_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_core_identifier_proto_goTypes = []interface{}{
...
var file_core_identifier_proto_depIdxs = []int32{
...
func init() { file_core_identifier_proto_init() }
func file_core_identifier_proto_init() {
	if File_core_identifier_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_core_identifier_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_identifier_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_identifier_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_identifier_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_core_identifier_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_core_identifier_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_core_identifier_proto_goTypes,
		DependencyIndexes: file_core_identifier_proto_depIdxs,
		EnumInfos:         file_core_identifier_proto_enumTypes,
		MessageInfos:      file_core_identifier_proto_msgTypes,
	}.Build()
	File_core_identifier_proto = out.File
	file_core_identifier_proto_rawDesc = nil
	file_core_identifier_proto_goTypes = nil
	file_core_identifier_proto_depIdxs = nil
}
