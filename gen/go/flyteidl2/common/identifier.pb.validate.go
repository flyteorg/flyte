...
// Validate checks the field values on QueueIdentifier with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *QueueIdentifier) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on QueueIdentifier with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// QueueIdentifierMultiError, or nil if none found.
func (m *QueueIdentifier) ValidateAll() error {
	return m.validate(true)
}

func (m *QueueIdentifier) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return QueueIdentifierMultiError(errors)
	}

	return nil
}

// QueueIdentifierMultiError is an error wrapping multiple validation errors
// returned by QueueIdentifier.ValidateAll() if the designated constraints
// aren't met.
type QueueIdentifierMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m QueueIdentifierMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m QueueIdentifierMultiError) AllErrors() []error { return m }

// QueueIdentifierValidationError is the validation error returned by
// QueueIdentifier.Validate if the designated constraints aren't met.
type QueueIdentifierValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e QueueIdentifierValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e QueueIdentifierValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e QueueIdentifierValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e QueueIdentifierValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e QueueIdentifierValidationError) ErrorName() string { return "QueueIdentifierValidationError" }

// Error satisfies the builtin error interface
func (e QueueIdentifierValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sQueueIdentifier.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = QueueIdentifierValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = QueueIdentifierValidationError{}
