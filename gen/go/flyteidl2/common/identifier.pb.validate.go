...
// Validate checks the field values on DomainIdentifier with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *DomainIdentifier) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on DomainIdentifier with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// DomainIdentifierMultiError, or nil if none found.
func (m *DomainIdentifier) ValidateAll() error {
	return m.validate(true)
}

func (m *DomainIdentifier) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return DomainIdentifierMultiError(errors)
	}

	return nil
}

// DomainIdentifierMultiError is an error wrapping multiple validation errors
// returned by DomainIdentifier.ValidateAll() if the designated constraints
// aren't met.
type DomainIdentifierMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m DomainIdentifierMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m DomainIdentifierMultiError) AllErrors() []error { return m }

// DomainIdentifierValidationError is the validation error returned by
// DomainIdentifier.Validate if the designated constraints aren't met.
type DomainIdentifierValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e DomainIdentifierValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e DomainIdentifierValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e DomainIdentifierValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e DomainIdentifierValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e DomainIdentifierValidationError) ErrorName() string { return "DomainIdentifierValidationError" }

// Error satisfies the builtin error interface
func (e DomainIdentifierValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sDomainIdentifier.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = DomainIdentifierValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = DomainIdentifierValidationError{}
