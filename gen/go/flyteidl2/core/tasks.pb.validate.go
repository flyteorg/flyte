...
func (m *Node) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetTaskNode()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, NodeValidationError{
					field:  "TaskNode",
	...
	} else if v, ok := interface{}(m.GetTaskNode()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return NodeValidationError{
				field:  "TaskNode",
				reason: "embedded message failed validation",
...
func (m *TaskNode) validate(all bool) error {
	...
	case *TaskNode_ReferenceId:
		...
		if all {
			switch v := interface{}(m.GetReferenceId()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, TaskNodeValidationError{
						field:  "ReferenceId",
		...
		} else if v, ok := interface{}(m.GetReferenceId()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return TaskNodeValidationError{
					field:  "ReferenceId",
					reason: "embedded message failed validation",
...
// ValidateAll checks the field values on TaskNodeOverrides with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// TaskNodeOverridesMultiError, or nil if none found.
func (m *TaskNodeOverrides) ValidateAll() error {
	return m.validate(true)
}

func (m *TaskNodeOverrides) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, TaskNodeOverridesValidationError{
					field:  "Resources",
					reason: "embedded message failed validation",
					cause:  err,
				})
	...
	if len(errors) > 0 {
		return TaskNodeOverridesMultiError(errors)
	}

	return nil
}

// TaskNodeOverridesMultiError is an error wrapping multiple validation errors
// returned by TaskNodeOverrides.ValidateAll() if the designated constraints
// aren't met.
type TaskNodeOverridesMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TaskNodeOverridesMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TaskNodeOverridesMultiError) AllErrors() []error { return m }
...
func (m *NodeMetadata) validate(all bool) error {
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, NodeMetadataValidationError{
					field:  "Timeout",
					reason: "embedded message failed validation",
					cause:  err,
				})
	...
	case *NodeMetadata_Interruptible:
		if v == nil {
			err := NodeMetadataValidationError{
				field:  "InterruptibleValue",
				reason: "oneof value cannot be a typed-nil",
			}
			if !all {
	...
	switch v := m.CacheableValue.(type) {
	case *NodeMetadata_Cacheable:
		if v == nil {
			err := NodeMetadataValidationError{
				field:  "CacheableValue",
				reason: "oneof value cannot be a typed-nil",
			}
			if !all {
				return err
	...
	switch v := m.CacheVersionValue.(type) {
	case *NodeMetadata_CacheVersion:
		if v == nil {
			err := NodeMetadataValidationError{
				field:  "CacheVersionValue",
				reason: "oneof value cannot be a typed-nil",
			}
			if !all {
				return err
	...
	switch v := m.CacheSerializableValue.(type) {
	case *NodeMetadata_CacheSerializable:
		if v == nil {
			err := NodeMetadataValidationError{
				field:  "CacheSerializableValue",
				reason: "oneof value cannot be a typed-nil",
			}
			if !all {
				return err
...
// ValidateAll checks the field values on DynamicJobSpec with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in DynamicJobSpecMultiError,
// or nil if none found.
func (m *DynamicJobSpec) ValidateAll() error {
	return m.validate(true)
}

func (m *DynamicJobSpec) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetNodes() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, DynamicJobSpecValidationError{
	...
	if len(errors) > 0 {
		return DynamicJobSpecMultiError(errors)
	}

	return nil
}

// DynamicJobSpecMultiError is an error wrapping multiple validation errors
// returned by DynamicJobSpec.ValidateAll() if the designated constraints
// aren't met.
type DynamicJobSpecMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m DynamicJobSpecMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m DynamicJobSpecMultiError) AllErrors() []error { return m }
