...
// Validate checks the field values on ReusePolicy with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *ReusePolicy) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ReusePolicy with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ReusePolicyMultiError, or
// nil if none found.
func (m *ReusePolicy) ValidateAll() error {
	return m.validate(true)
}

func (m *ReusePolicy) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ReusePolicyValidationError{
					field:  "IdleTtl",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return ReusePolicyValidationError{
				field:  "IdleTtl",
				reason: "embedded message failed validation",
				cause:  err,
			}
...
// ReusePolicyMultiError is an error wrapping multiple validation errors
// returned by ReusePolicy.ValidateAll() if the designated constraints aren't met.
type ReusePolicyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ReusePolicyMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ReusePolicyMultiError) AllErrors() []error { return m }

// ReusePolicyValidationError is the validation error returned by
// ReusePolicy.Validate if the designated constraints aren't met.
type ReusePolicyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ReusePolicyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ReusePolicyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ReusePolicyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ReusePolicyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ReusePolicyValidationError) ErrorName() string { return "ReusePolicyValidationError" }

// Error satisfies the builtin error interface
func (e ReusePolicyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = ReusePolicyValidationError{}
...
func (m *TaskTemplate) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetReusePolicy()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, TaskTemplateValidationError{
					field:  "ReusePolicy",
	...
	} else if v, ok := interface{}(m.GetReusePolicy()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return TaskTemplateValidationError{
				field:  "ReusePolicy",
				reason: "embedded message failed validation",
