...
type GpuFault_Kind int32

const (
	GpuFault_KIND_UNSPECIFIED GpuFault_Kind = 0
	// An Xid: a fault on a GPU.
	GpuFault_KIND_XID GpuFault_Kind = 1
	// An SXid: a fault on an NVSwitch, which affects every GPU attached to it.
	GpuFault_KIND_SXID GpuFault_Kind = 2
)

// Enum value maps for GpuFault_Kind.
var (
	GpuFault_Kind_name = map[int32]string{
		0: "KIND_UNSPECIFIED",
		1: "KIND_XID",
		2: "KIND_SXID",
	}
	GpuFault_Kind_value = map[string]int32{
		"KIND_UNSPECIFIED": 0,
		"KIND_XID":         1,
		"KIND_SXID":        2,
	}
...
func (x GpuFault_Kind) Enum() *GpuFault_Kind {
	p := new(GpuFault_Kind)
	*p = x
	return p
}

func (x GpuFault_Kind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GpuFault_Kind) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl2_core_execution_proto_enumTypes[4].Descriptor()
}

func (GpuFault_Kind) Type() protoreflect.EnumType {
	return &file_flyteidl2_core_execution_proto_enumTypes[4]
}

func (x GpuFault_Kind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GpuFault_Kind.Descriptor instead.
func (GpuFault_Kind) EnumDescriptor() ([]byte, []int) {
...
type GpuFault_Severity int32

const (
	GpuFault_SEVERITY_UNSPECIFIED GpuFault_Severity = 0
	GpuFault_SEVERITY_USER        GpuFault_Severity = 1
	GpuFault_SEVERITY_WARN        GpuFault_Severity = 2
	GpuFault_SEVERITY_CRITICAL    GpuFault_Severity = 3
)

// Enum value maps for GpuFault_Severity.
var (
	GpuFault_Severity_name = map[int32]string{
		0: "SEVERITY_UNSPECIFIED",
		1: "SEVERITY_USER",
		2: "SEVERITY_WARN",
		3: "SEVERITY_CRITICAL",
	}
	GpuFault_Severity_value = map[string]int32{
...
func (x GpuFault_Severity) Enum() *GpuFault_Severity {
	p := new(GpuFault_Severity)
	*p = x
	return p
}

func (x GpuFault_Severity) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GpuFault_Severity) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl2_core_execution_proto_enumTypes[5].Descriptor()
}

func (GpuFault_Severity) Type() protoreflect.EnumType {
	return &file_flyteidl2_core_execution_proto_enumTypes[5]
}

func (x GpuFault_Severity) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GpuFault_Severity.Descriptor instead.
func (GpuFault_Severity) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{4, 1}
}
...
func (ContainerError_Kind) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{5, 0}
}
...
func (TaskLog_MessageFormat) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{7, 0}
}
...
func (TaskLog_LinkType) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl2_core_execution_proto_enumTypes[8].Descriptor()
}

func (TaskLog_LinkType) Type() protoreflect.EnumType {
	return &file_flyteidl2_core_execution_proto_enumTypes[8]
}
...
func (TaskLog_LinkType) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{7, 1}
}
...
func (QualityOfService_Tier) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl2_core_execution_proto_enumTypes[9].Descriptor()
}

func (QualityOfService_Tier) Type() protoreflect.EnumType {
	return &file_flyteidl2_core_execution_proto_enumTypes[9]
}
...
func (QualityOfService_Tier) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{13, 0}
}
...
type ExecutionError struct {
	...
	// message.
	GpuFault *GpuFault `protobuf:"bytes,8,opt,name=gpu_fault,json=gpuFault,proto3" json:"gpu_fault,omitempty"`
}
...
func (x *ExecutionError) GetGpuFault() *GpuFault {
	if x != nil {
		return x.GpuFault
	}
	return nil
...
type GpuFault struct {
	...
	Kind GpuFault_Kind `protobuf:"varint,1,opt,name=kind,proto3,enum=flyteidl2.core.GpuFault_Kind" json:"kind,omitempty"`
	...
	Severity GpuFault_Severity `protobuf:"varint,4,opt,name=severity,proto3,enum=flyteidl2.core.GpuFault_Severity" json:"severity,omitempty"`
	...
	GpuIndex *uint32 `protobuf:"varint,6,opt,name=gpu_index,json=gpuIndex,proto3,oneof" json:"gpu_index,omitempty"`
...
func (x *GpuFault) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GpuFault) ProtoMessage() {}

func (x *GpuFault) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl2_core_execution_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GpuFault.ProtoReflect.Descriptor instead.
func (*GpuFault) Descriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{4}
}

func (x *GpuFault) GetKind() GpuFault_Kind {
	if x != nil {
		return x.Kind
	}
	return GpuFault_KIND_UNSPECIFIED
}

func (x *GpuFault) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *GpuFault) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GpuFault) GetSeverity() GpuFault_Severity {
	if x != nil {
		return x.Severity
	}
	return GpuFault_SEVERITY_UNSPECIFIED
}

func (x *GpuFault) GetGpuUuid() string {
	if x != nil {
		return x.GpuUuid
	}
	return ""
...
func (x *GpuFault) GetGpuIndex() uint32 {
...
func (x *GpuFault) GetPciBusId() string {
	if x != nil {
		return x.PciBusId
	}
	return ""
...
func (x *GpuFault) GetNode() string {
	if x != nil {
		return x.Node
	}
	return ""
...
func (x *GpuFault) GetProcess() string {
	if x != nil {
		return x.Process
	}
	return ""
...
func (x *LogContext) Reset() {
	*x = LogContext{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl2_core_execution_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LogContext) Descriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{8}
}
...
func (x *LogContext) GetPrimaryPodName() string {
	if x != nil {
		return x.PrimaryPodName
	}
	return ""
}

func (x *LogContext) GetConnector() *ConnectorLogContext {
	if x != nil {
		return x.Connector
	}
	return nil
...
// Deprecated: Marked as deprecated in flyteidl2/core/execution.proto.
func (x *LogContext) GetPodNamePrefix() string {
	if x != nil {
...
func (x *LogContext) GetPodNamePrefixes() []string {
	if x != nil {
		return x.PodNamePrefixes
	}
	return nil
}

// ConnectorLogContext describes how to reach a connector that owns an action's logs.
type ConnectorLogContext struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ConnectorLogContext) Reset() {
	*x = ConnectorLogContext{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl2_core_execution_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ConnectorLogContext) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConnectorLogContext) ProtoMessage() {}

func (x *ConnectorLogContext) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl2_core_execution_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConnectorLogContext.ProtoReflect.Descriptor instead.
func (*ConnectorLogContext) Descriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{9}
}

func (x *ConnectorLogContext) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *PodLogContext) Reset() {
	*x = PodLogContext{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl2_core_execution_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PodLogContext) Descriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{10}
}
...
func (x *ContainerContext) Reset() {
	*x = ContainerContext{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl2_core_execution_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ContainerContext) Descriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{11}
}
...
func (x *ContainerContext) GetProcess() *ContainerContext_ProcessContext {
	if x != nil {
		return x.Process
	}
	return nil
...
func (x *QualityOfServiceSpec) Reset() {
	*x = QualityOfServiceSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl2_core_execution_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QualityOfServiceSpec) Descriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{12}
}
...
func (x *QualityOfService) Reset() {
	*x = QualityOfService{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl2_core_execution_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QualityOfService) Descriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{13}
}
...
type QualityOfService_Tier_ struct {
	Tier QualityOfService_Tier `protobuf:"varint,1,opt,name=tier,proto3,enum=flyteidl2.core.QualityOfService_Tier,oneof"`
}
...
func (x *ContainerContext_ProcessContext) Reset() {
	*x = ContainerContext_ProcessContext{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl2_core_execution_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ContainerContext_ProcessContext) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ContainerContext_ProcessContext) ProtoMessage() {}

func (x *ContainerContext_ProcessContext) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl2_core_execution_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (*ContainerContext_ProcessContext) Descriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{11, 0}
}
...
func (x *ContainerContext_ProcessContext) GetContainerEndTime() *timestamppb.Timestamp {
	if x != nil {
		return x.ContainerEndTime
	}
	return nil
}

var File_flyteidl2_core_execution_proto protoreflect.FileDescriptor

var file_flyteidl2_core_execution_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xb3, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c,
	0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x42, 0x0e, 0x45, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x48, 0x02, 0x50, 0x01,
	...
	0x65, 0x69, 0x64, 0x6c, 0x32, 0x3a, 0x3a, 0x43, 0x6f, 0x72, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_flyteidl2_core_execution_proto_rawDescOnce sync.Once
	file_flyteidl2_core_execution_proto_rawDescData = file_flyteidl2_core_execution_proto_rawDesc
)

func file_flyteidl2_core_execution_proto_rawDescGZIP() []byte {
	file_flyteidl2_core_execution_proto_rawDescOnce.Do(func() {
		file_flyteidl2_core_execution_proto_rawDescData = protoimpl.X.CompressGZIP(file_flyteidl2_core_execution_proto_rawDescData)
	})
	return file_flyteidl2_core_execution_proto_rawDescData
}

var file_flyteidl2_core_execution_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
var file_flyteidl2_core_execution_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_flyteidl2_core_execution_proto_goTypes = []interface{}{
	(WorkflowExecution_Phase)(0),            // 0: flyteidl2.core.WorkflowExecution.Phase
	(NodeExecution_Phase)(0),                // 1: flyteidl2.core.NodeExecution.Phase
	(TaskExecution_Phase)(0),                // 2: flyteidl2.core.TaskExecution.Phase
	(ExecutionError_ErrorKind)(0),           // 3: flyteidl2.core.ExecutionError.ErrorKind
	(GpuFault_Kind)(0),                      // 4: flyteidl2.core.GpuFault.Kind
	(GpuFault_Severity)(0),                  // 5: flyteidl2.core.GpuFault.Severity
	(ContainerError_Kind)(0),                // 6: flyteidl2.core.ContainerError.Kind
	(TaskLog_MessageFormat)(0),              // 7: flyteidl2.core.TaskLog.MessageFormat
	(TaskLog_LinkType)(0),                   // 8: flyteidl2.core.TaskLog.LinkType
	(QualityOfService_Tier)(0),              // 9: flyteidl2.core.QualityOfService.Tier
	(*WorkflowExecution)(nil),               // 10: flyteidl2.core.WorkflowExecution
	(*NodeExecution)(nil),                   // 11: flyteidl2.core.NodeExecution
	(*TaskExecution)(nil),                   // 12: flyteidl2.core.TaskExecution
	(*ExecutionError)(nil),                  // 13: flyteidl2.core.ExecutionError
	(*GpuFault)(nil),                        // 14: flyteidl2.core.GpuFault
	(*ContainerError)(nil),                  // 15: flyteidl2.core.ContainerError
	(*ErrorDocument)(nil),                   // 16: flyteidl2.core.ErrorDocument
	(*TaskLog)(nil),                         // 17: flyteidl2.core.TaskLog
	(*LogContext)(nil),                      // 18: flyteidl2.core.LogContext
	(*ConnectorLogContext)(nil),             // 19: flyteidl2.core.ConnectorLogContext
	(*PodLogContext)(nil),                   // 20: flyteidl2.core.PodLogContext
	(*ContainerContext)(nil),                // 21: flyteidl2.core.ContainerContext
	(*QualityOfServiceSpec)(nil),            // 22: flyteidl2.core.QualityOfServiceSpec
	(*QualityOfService)(nil),                // 23: flyteidl2.core.QualityOfService
	(*ContainerContext_ProcessContext)(nil), // 24: flyteidl2.core.ContainerContext.ProcessContext
	(*timestamppb.Timestamp)(nil),           // 25: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),             // 26: google.protobuf.Duration
}
var file_flyteidl2_core_execution_proto_depIdxs = []int32{
	3,  // 0: flyteidl2.core.ExecutionError.kind:type_name -> flyteidl2.core.ExecutionError.ErrorKind
	25, // 1: flyteidl2.core.ExecutionError.timestamp:type_name -> google.protobuf.Timestamp
	6,  // 2: flyteidl2.core.ExecutionError.recoverability:type_name -> flyteidl2.core.ContainerError.Kind
	14, // 3: flyteidl2.core.ExecutionError.gpu_fault:type_name -> flyteidl2.core.GpuFault
	4,  // 4: flyteidl2.core.GpuFault.kind:type_name -> flyteidl2.core.GpuFault.Kind
	5,  // 5: flyteidl2.core.GpuFault.severity:type_name -> flyteidl2.core.GpuFault.Severity
	6,  // 6: flyteidl2.core.ContainerError.kind:type_name -> flyteidl2.core.ContainerError.Kind
	3,  // 7: flyteidl2.core.ContainerError.origin:type_name -> flyteidl2.core.ExecutionError.ErrorKind
	15, // 8: flyteidl2.core.ErrorDocument.error:type_name -> flyteidl2.core.ContainerError
	7,  // 9: flyteidl2.core.TaskLog.message_format:type_name -> flyteidl2.core.TaskLog.MessageFormat
	26, // 10: flyteidl2.core.TaskLog.ttl:type_name -> google.protobuf.Duration
	8,  // 11: flyteidl2.core.TaskLog.link_type:type_name -> flyteidl2.core.TaskLog.LinkType
	20, // 12: flyteidl2.core.LogContext.pods:type_name -> flyteidl2.core.PodLogContext
	19, // 13: flyteidl2.core.LogContext.connector:type_name -> flyteidl2.core.ConnectorLogContext
	21, // 14: flyteidl2.core.PodLogContext.containers:type_name -> flyteidl2.core.ContainerContext
	21, // 15: flyteidl2.core.PodLogContext.init_containers:type_name -> flyteidl2.core.ContainerContext
	24, // 16: flyteidl2.core.ContainerContext.process:type_name -> flyteidl2.core.ContainerContext.ProcessContext
	26, // 17: flyteidl2.core.QualityOfServiceSpec.queueing_budget:type_name -> google.protobuf.Duration
	9,  // 18: flyteidl2.core.QualityOfService.tier:type_name -> flyteidl2.core.QualityOfService.Tier
	22, // 19: flyteidl2.core.QualityOfService.spec:type_name -> flyteidl2.core.QualityOfServiceSpec
	25, // 20: flyteidl2.core.ContainerContext.ProcessContext.container_start_time:type_name -> google.protobuf.Timestamp
	25, // 21: flyteidl2.core.ContainerContext.ProcessContext.container_end_time:type_name -> google.protobuf.Timestamp
...
func init() { file_flyteidl2_core_execution_proto_init() }
func file_flyteidl2_core_execution_proto_init() {
	if File_flyteidl2_core_execution_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_flyteidl2_core_execution_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GpuFault); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_flyteidl2_core_execution_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConnectorLogContext); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_flyteidl2_core_execution_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PodLogContext); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_flyteidl2_core_execution_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_flyteidl2_core_execution_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ContainerContext_ProcessContext); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_flyteidl2_core_execution_proto_msgTypes[4].OneofWrappers = []interface{}{}
	file_flyteidl2_core_execution_proto_msgTypes[13].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_flyteidl2_core_execution_proto_rawDesc,
			NumEnums:      10,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_flyteidl2_core_execution_proto_goTypes,
		DependencyIndexes: file_flyteidl2_core_execution_proto_depIdxs,
		EnumInfos:         file_flyteidl2_core_execution_proto_enumTypes,
		MessageInfos:      file_flyteidl2_core_execution_proto_msgTypes,
	}.Build()
	File_flyteidl2_core_execution_proto = out.File
	file_flyteidl2_core_execution_proto_rawDesc = nil
	file_flyteidl2_core_execution_proto_goTypes = nil
	file_flyteidl2_core_execution_proto_depIdxs = nil
}
