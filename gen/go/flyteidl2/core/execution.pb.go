...
var file_flyteidl2_core_execution_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x48, 0x02, 0x50, 0x01, 0x5a, 0x32, 0x67, 0x69,
...
var file_flyteidl2_core_execution_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_flyteidl2_core_execution_proto_goTypes = []interface{}{
	...
	(*PodLogContext)(nil),                   // 16: flyteidl2.core.PodLogContext
	(*ContainerContext)(nil),                // 17: flyteidl2.core.ContainerContext
	(*QualityOfServiceSpec)(nil),            // 18: flyteidl2.core.QualityOfServiceSpec
	(*QualityOfService)(nil),                // 19: flyteidl2.core.QualityOfService
	(*ContainerContext_ProcessContext)(nil), // 20: flyteidl2.core.ContainerContext.ProcessContext
...
var file_flyteidl2_core_execution_proto_depIdxs = []int32{
	...
	21, // 1: flyteidl2.core.ExecutionError.timestamp:type_name -> google.protobuf.Timestamp
	...
	22, // 7: flyteidl2.core.TaskLog.ttl:type_name -> google.protobuf.Duration
	6,  // 8: flyteidl2.core.TaskLog.link_type:type_name -> flyteidl2.core.TaskLog.LinkType
	16, // 9: flyteidl2.core.LogContext.pods:type_name -> flyteidl2.core.PodLogContext
	17, // 10: flyteidl2.core.PodLogContext.containers:type_name -> flyteidl2.core.ContainerContext
	17, // 11: flyteidl2.core.PodLogContext.init_containers:type_name -> flyteidl2.core.ContainerContext
	20, // 12: flyteidl2.core.ContainerContext.process:type_name -> flyteidl2.core.ContainerContext.ProcessContext
	22, // 13: flyteidl2.core.QualityOfServiceSpec.queueing_budget:type_name -> google.protobuf.Duration
	7,  // 14: flyteidl2.core.QualityOfService.tier:type_name -> flyteidl2.core.QualityOfService.Tier
	18, // 15: flyteidl2.core.QualityOfService.spec:type_name -> flyteidl2.core.QualityOfServiceSpec
	21, // 16: flyteidl2.core.ContainerContext.ProcessContext.container_start_time:type_name -> google.protobuf.Timestamp
	21, // 17: flyteidl2.core.ContainerContext.ProcessContext.container_end_time:type_name -> google.protobuf.Timestamp
...
func file_flyteidl2_core_execution_proto_init() {
	...
	file_flyteidl2_core_execution_proto_msgTypes[11].OneofWrappers = []interface{}{
