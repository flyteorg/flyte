...
type ExecutionError_RetryBehavior int32

const (
	ExecutionError_NON_RETRYABLE ExecutionError_RetryBehavior = 0
	ExecutionError_RETRYABLE     ExecutionError_RetryBehavior = 1
)

// Enum value maps for ExecutionError_RetryBehavior.
var (
	ExecutionError_RetryBehavior_name = map[int32]string{
		0: "NON_RETRYABLE",
		1: "RETRYABLE",
	}
	ExecutionError_RetryBehavior_value = map[string]int32{
		"NON_RETRYABLE": 0,
		"RETRYABLE":     1,
	}
)

func (x ExecutionError_RetryBehavior) Enum() *ExecutionError_RetryBehavior {
	p := new(ExecutionError_RetryBehavior)
	*p = x
	return p
}

func (x ExecutionError_RetryBehavior) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ExecutionError_RetryBehavior) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl2_core_execution_proto_enumTypes[4].Descriptor()
}

func (ExecutionError_RetryBehavior) Type() protoreflect.EnumType {
	return &file_flyteidl2_core_execution_proto_enumTypes[4]
}

func (x ExecutionError_RetryBehavior) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ExecutionError_RetryBehavior.Descriptor instead.
func (ExecutionError_RetryBehavior) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{3, 1}
}
...
func (QualityOfService_Tier) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl2_core_execution_proto_rawDescGZIP(), []int{9, 0}
}
...
type ExecutionError struct {
	...
	RetryBehavior ExecutionError_RetryBehavior `protobuf:"varint,7,opt,name=retry_behavior,json=retryBehavior,proto3,enum=flyteidl2.core.ExecutionError_RetryBehavior" json:"retry_behavior,omitempty"`
}
...
func (x *ExecutionError) GetRetryBehavior() ExecutionError_RetryBehavior {
	if x != nil {
		return x.RetryBehavior
	}
	return ExecutionError_NON_RETRYABLE
}
...
var file_flyteidl2_core_execution_proto_rawDesc = []byte{
	...
	0x44, 0x10, 0x08, 0x22, 0xa3, 0x03, 0x0a, 0x0e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f,
	...
	0x72, 0x12, 0x53, 0x0a, 0x0e, 0x72, 0x65, 0x74, 0x72, 0x79, 0x5f, 0x62, 0x65, 0x68, 0x61, 0x76,
	0x69, 0x6f, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2c, 0x2e, 0x66, 0x6c, 0x79, 0x74,
	0x65, 0x69, 0x64, 0x6c, 0x32, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x45, 0x78, 0x65, 0x63, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x52, 0x65, 0x74, 0x72, 0x79, 0x42,
	0x65, 0x68, 0x61, 0x76, 0x69, 0x6f, 0x72, 0x52, 0x0d, 0x72, 0x65, 0x74, 0x72, 0x79, 0x42, 0x65,
	0x68, 0x61, 0x76, 0x69, 0x6f, 0x72, 0x22, 0x2e, 0x0a, 0x09, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x4b,
	...
	0x53, 0x54, 0x45, 0x4d, 0x10, 0x02, 0x22, 0x31, 0x0a, 0x0d, 0x52, 0x65, 0x74, 0x72, 0x79, 0x42,
	0x65, 0x68, 0x61, 0x76, 0x69, 0x6f, 0x72, 0x12, 0x11, 0x0a, 0x0d, 0x4e, 0x4f, 0x4e, 0x5f, 0x52,
	0x45, 0x54, 0x52, 0x59, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x52, 0x45,
	0x54, 0x52, 0x59, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x01, 0x22, 0xd5, 0x03, 0x0a, 0x07, 0x54, 0x61,
	...
	0x02, 0x22, 0x69, 0x0a, 0x0a, 0x4c, 0x6f, 0x67, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x12,
	...
	0x69, 0x6d, 0x61, 0x72, 0x79, 0x50, 0x6f, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x8b, 0x02, 0x0a,
	...
	0x64, 0x65, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xb3, 0x01, 0x0a, 0x12,
...
var file_flyteidl2_core_execution_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_flyteidl2_core_execution_proto_goTypes = []interface{}{
	...
	(ExecutionError_RetryBehavior)(0),       // 4: flyteidl2.core.ExecutionError.RetryBehavior
	...
	(*TaskLog)(nil),                         // 12: flyteidl2.core.TaskLog
	(*LogContext)(nil),                      // 13: flyteidl2.core.LogContext
	(*PodLogContext)(nil),                   // 14: flyteidl2.core.PodLogContext
	(*ContainerContext)(nil),                // 15: flyteidl2.core.ContainerContext
	(*QualityOfServiceSpec)(nil),            // 16: flyteidl2.core.QualityOfServiceSpec
	(*QualityOfService)(nil),                // 17: flyteidl2.core.QualityOfService
	(*ContainerContext_ProcessContext)(nil), // 18: flyteidl2.core.ContainerContext.ProcessContext
...
var file_flyteidl2_core_execution_proto_depIdxs = []int32{
	...
	19, // 1: flyteidl2.core.ExecutionError.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 2: flyteidl2.core.ExecutionError.retry_behavior:type_name -> flyteidl2.core.ExecutionError.RetryBehavior
	5,  // 3: flyteidl2.core.TaskLog.message_format:type_name -> flyteidl2.core.TaskLog.MessageFormat
	20, // 4: flyteidl2.core.TaskLog.ttl:type_name -> google.protobuf.Duration
	6,  // 5: flyteidl2.core.TaskLog.link_type:type_name -> flyteidl2.core.TaskLog.LinkType
	14, // 6: flyteidl2.core.LogContext.pods:type_name -> flyteidl2.core.PodLogContext
	15, // 7: flyteidl2.core.PodLogContext.containers:type_name -> flyteidl2.core.ContainerContext
	15, // 8: flyteidl2.core.PodLogContext.init_containers:type_name -> flyteidl2.core.ContainerContext
	18, // 9: flyteidl2.core.ContainerContext.process:type_name -> flyteidl2.core.ContainerContext.ProcessContext
	20, // 10: flyteidl2.core.QualityOfServiceSpec.queueing_budget:type_name -> google.protobuf.Duration
	7,  // 11: flyteidl2.core.QualityOfService.tier:type_name -> flyteidl2.core.QualityOfService.Tier
	16, // 12: flyteidl2.core.QualityOfService.spec:type_name -> flyteidl2.core.QualityOfServiceSpec
	19, // 13: flyteidl2.core.ContainerContext.ProcessContext.container_start_time:type_name -> google.protobuf.Timestamp
	19, // 14: flyteidl2.core.ContainerContext.ProcessContext.container_end_time:type_name -> google.protobuf.Timestamp
...
func file_flyteidl2_core_execution_proto_init() {
	...
	file_flyteidl2_core_execution_proto_msgTypes[9].OneofWrappers = []interface{}{
