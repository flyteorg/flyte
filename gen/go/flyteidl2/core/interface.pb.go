...
func (x *VariableEntry) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *VariableEntry) GetValue() *Variable {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *VariableMap) GetVariables() []*VariableEntry {
	if x != nil {
		return x.Variables
	}
	return nil
...
func (x *ParameterMap) Reset() {
	*x = ParameterMap{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl2_core_interface_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ParameterMap) Descriptor() ([]byte, []int) {
	return file_flyteidl2_core_interface_proto_rawDescGZIP(), []int{5}
}
...
var file_flyteidl2_core_interface_proto_goTypes = []interface{}{
	...
	(*VariableEntry)(nil),  // 1: flyteidl2.core.VariableEntry
	(*VariableMap)(nil),    // 2: flyteidl2.core.VariableMap
	(*TypedInterface)(nil), // 3: flyteidl2.core.TypedInterface
	(*Parameter)(nil),      // 4: flyteidl2.core.Parameter
	(*ParameterMap)(nil),   // 5: flyteidl2.core.ParameterMap
...
var file_flyteidl2_core_interface_proto_depIdxs = []int32{
	...
	0,  // 3: flyteidl2.core.VariableEntry.value:type_name -> flyteidl2.core.Variable
	1,  // 4: flyteidl2.core.VariableMap.variables:type_name -> flyteidl2.core.VariableEntry
	2,  // 5: flyteidl2.core.TypedInterface.inputs:type_name -> flyteidl2.core.VariableMap
	2,  // 6: flyteidl2.core.TypedInterface.outputs:type_name -> flyteidl2.core.VariableMap
	0,  // 7: flyteidl2.core.Parameter.var:type_name -> flyteidl2.core.Variable
	10, // 8: flyteidl2.core.Parameter.default:type_name -> flyteidl2.core.Literal
	11, // 9: flyteidl2.core.Parameter.artifact_query:type_name -> flyteidl2.core.ArtifactQuery
	8,  // 10: flyteidl2.core.Parameter.artifact_id:type_name -> flyteidl2.core.ArtifactID
	6,  // 11: flyteidl2.core.ParameterMap.parameters:type_name -> flyteidl2.core.ParameterMap.ParametersEntry
	4,  // 12: flyteidl2.core.ParameterMap.ParametersEntry.value:type_name -> flyteidl2.core.Parameter
...
func file_flyteidl2_core_interface_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_flyteidl2_core_interface_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_flyteidl2_core_interface_proto_msgTypes[4].OneofWrappers = []interface{}{
