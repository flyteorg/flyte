...
// JsonValuesToLiterals provides a mock function with given fields: ctx, in, opts
func (_m *TranslatorServiceClient) JsonValuesToLiterals(ctx context.Context, in *workflow.JsonValuesToLiteralsRequest, opts ...grpc.CallOption) (*workflow.JsonValuesToLiteralsResponse, error) {
	...
	var r0 *workflow.JsonValuesToLiteralsResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *workflow.JsonValuesToLiteralsRequest, ...grpc.CallOption) (*workflow.JsonValuesToLiteralsResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *workflow.JsonValuesToLiteralsRequest, ...grpc.CallOption) *workflow.JsonValuesToLiteralsResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*workflow.JsonValuesToLiteralsResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *workflow.JsonValuesToLiteralsRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - in *workflow.JsonValuesToLiteralsRequest
//   - opts ...grpc.CallOption
func (_e *TranslatorServiceClient_Expecter) JsonValuesToLiterals(ctx interface{}, in interface{}, opts ...interface{}) *TranslatorServiceClient_JsonValuesToLiterals_Call {
	return &TranslatorServiceClient_JsonValuesToLiterals_Call{Call: _e.mock.On("JsonValuesToLiterals",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *TranslatorServiceClient_JsonValuesToLiterals_Call) Run(run func(ctx context.Context, in *workflow.JsonValuesToLiteralsRequest, opts ...grpc.CallOption)) *TranslatorServiceClient_JsonValuesToLiterals_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(*workflow.JsonValuesToLiteralsRequest), variadicArgs...)
	})
	return _c
}

func (_c *TranslatorServiceClient_JsonValuesToLiterals_Call) Return(_a0 *workflow.JsonValuesToLiteralsResponse, _a1 error) *TranslatorServiceClient_JsonValuesToLiterals_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TranslatorServiceClient_JsonValuesToLiterals_Call) RunAndReturn(run func(context.Context, *workflow.JsonValuesToLiteralsRequest, ...grpc.CallOption) (*workflow.JsonValuesToLiteralsResponse, error)) *TranslatorServiceClient_JsonValuesToLiterals_Call {
	_c.Call.Return(run)
	return _c
}
