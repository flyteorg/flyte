...
//
// Source: flyteidl2/workflow/task_service.proto
...
var (
	taskServiceServiceDescriptor              = workflow.File_flyteidl2_workflow_task_service_proto.Services().ByName("TaskService")
