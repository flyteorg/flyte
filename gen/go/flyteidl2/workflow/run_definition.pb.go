...
var file_flyteidl2_workflow_run_definition_proto_depIdxs = []int32{
	...
	41, // 17: flyteidl2.workflow.ActionMetadata.executed_by:type_name -> flyteidl2.common.EnrichedIdentity
	10, // 18: flyteidl2.workflow.ActionMetadata.task:type_name -> flyteidl2.workflow.TaskActionMetadata
	11, // 19: flyteidl2.workflow.ActionMetadata.trace:type_name -> flyteidl2.workflow.TraceActionMetadata
	12, // 20: flyteidl2.workflow.ActionMetadata.condition:type_name -> flyteidl2.workflow.ConditionActionMetadata
	1,  // 21: flyteidl2.workflow.ActionMetadata.action_type:type_name -> flyteidl2.workflow.ActionType
	42, // 22: flyteidl2.workflow.ActionMetadata.trigger_id:type_name -> flyteidl2.common.TriggerIdentifier
	43, // 23: flyteidl2.workflow.ActionMetadata.trigger_type:type_name -> flyteidl2.task.TriggerAutomationSpec
	2,  // 24: flyteidl2.workflow.ActionMetadata.source:type_name -> flyteidl2.workflow.RunSource
	34, // 25: flyteidl2.workflow.ActionStatus.phase:type_name -> flyteidl2.common.ActionPhase
	35, // 26: flyteidl2.workflow.ActionStatus.start_time:type_name -> google.protobuf.Timestamp
	35, // 27: flyteidl2.workflow.ActionStatus.end_time:type_name -> google.protobuf.Timestamp
	44, // 28: flyteidl2.workflow.ActionStatus.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	45, // 29: flyteidl2.workflow.Action.id:type_name -> flyteidl2.common.ActionIdentifier
	13, // 30: flyteidl2.workflow.Action.metadata:type_name -> flyteidl2.workflow.ActionMetadata
	14, // 31: flyteidl2.workflow.Action.status:type_name -> flyteidl2.workflow.ActionStatus
	15, // 32: flyteidl2.workflow.EnrichedAction.action:type_name -> flyteidl2.workflow.Action
	26, // 33: flyteidl2.workflow.EnrichedAction.children_phase_counts:type_name -> flyteidl2.workflow.EnrichedAction.ChildrenPhaseCountsEntry
	3,  // 34: flyteidl2.workflow.ErrorInfo.kind:type_name -> flyteidl2.workflow.ErrorInfo.Kind
	41, // 35: flyteidl2.workflow.AbortInfo.aborted_by:type_name -> flyteidl2.common.EnrichedIdentity
	45, // 36: flyteidl2.workflow.ActionDetails.id:type_name -> flyteidl2.common.ActionIdentifier
	13, // 37: flyteidl2.workflow.ActionDetails.metadata:type_name -> flyteidl2.workflow.ActionMetadata
	14, // 38: flyteidl2.workflow.ActionDetails.status:type_name -> flyteidl2.workflow.ActionStatus
	17, // 39: flyteidl2.workflow.ActionDetails.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	18, // 40: flyteidl2.workflow.ActionDetails.abort_info:type_name -> flyteidl2.workflow.AbortInfo
	32, // 41: flyteidl2.workflow.ActionDetails.task:type_name -> flyteidl2.task.TaskSpec
	37, // 42: flyteidl2.workflow.ActionDetails.trace:type_name -> flyteidl2.task.TraceSpec
	20, // 43: flyteidl2.workflow.ActionDetails.attempts:type_name -> flyteidl2.workflow.ActionAttempt
	34, // 44: flyteidl2.workflow.ActionAttempt.phase:type_name -> flyteidl2.common.ActionPhase
	35, // 45: flyteidl2.workflow.ActionAttempt.start_time:type_name -> google.protobuf.Timestamp
	35, // 46: flyteidl2.workflow.ActionAttempt.end_time:type_name -> google.protobuf.Timestamp
	17, // 47: flyteidl2.workflow.ActionAttempt.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	46, // 48: flyteidl2.workflow.ActionAttempt.log_info:type_name -> flyteidl2.core.TaskLog
	36, // 49: flyteidl2.workflow.ActionAttempt.outputs:type_name -> flyteidl2.task.OutputReferences
	44, // 50: flyteidl2.workflow.ActionAttempt.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	21, // 51: flyteidl2.workflow.ActionAttempt.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	22, // 52: flyteidl2.workflow.ActionAttempt.phase_transitions:type_name -> flyteidl2.workflow.PhaseTransition
	47, // 53: flyteidl2.workflow.ActionAttempt.log_context:type_name -> flyteidl2.core.LogContext
	35, // 54: flyteidl2.workflow.ClusterEvent.occurred_at:type_name -> google.protobuf.Timestamp
	34, // 55: flyteidl2.workflow.PhaseTransition.phase:type_name -> flyteidl2.common.ActionPhase
	35, // 56: flyteidl2.workflow.PhaseTransition.start_time:type_name -> google.protobuf.Timestamp
	35, // 57: flyteidl2.workflow.PhaseTransition.end_time:type_name -> google.protobuf.Timestamp
	45, // 58: flyteidl2.workflow.ActionEvent.id:type_name -> flyteidl2.common.ActionIdentifier
	34, // 59: flyteidl2.workflow.ActionEvent.phase:type_name -> flyteidl2.common.ActionPhase
	35, // 60: flyteidl2.workflow.ActionEvent.start_time:type_name -> google.protobuf.Timestamp
	35, // 61: flyteidl2.workflow.ActionEvent.updated_time:type_name -> google.protobuf.Timestamp
	35, // 62: flyteidl2.workflow.ActionEvent.end_time:type_name -> google.protobuf.Timestamp
	17, // 63: flyteidl2.workflow.ActionEvent.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	46, // 64: flyteidl2.workflow.ActionEvent.log_info:type_name -> flyteidl2.core.TaskLog
	47, // 65: flyteidl2.workflow.ActionEvent.log_context:type_name -> flyteidl2.core.LogContext
	36, // 66: flyteidl2.workflow.ActionEvent.outputs:type_name -> flyteidl2.task.OutputReferences
	44, // 67: flyteidl2.workflow.ActionEvent.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	21, // 68: flyteidl2.workflow.ActionEvent.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	35, // 69: flyteidl2.workflow.ActionEvent.reported_time:type_name -> google.protobuf.Timestamp
	45, // 70: flyteidl2.workflow.ActionSpec.action_id:type_name -> flyteidl2.common.ActionIdentifier
	30, // 71: flyteidl2.workflow.ActionSpec.run_spec:type_name -> flyteidl2.task.RunSpec
	6,  // 72: flyteidl2.workflow.ActionSpec.task:type_name -> flyteidl2.workflow.TaskAction
	8,  // 73: flyteidl2.workflow.ActionSpec.condition:type_name -> flyteidl2.workflow.ConditionAction
	7,  // 74: flyteidl2.workflow.ActionSpec.trace:type_name -> flyteidl2.workflow.TraceAction
	35, // 75: flyteidl2.workflow.TaskGroup.latest_run_time:type_name -> google.protobuf.Timestamp
	27, // 76: flyteidl2.workflow.TaskGroup.recent_statuses:type_name -> flyteidl2.workflow.TaskGroup.RecentStatus
	39, // 77: flyteidl2.workflow.TaskGroup.average_duration:type_name -> google.protobuf.Duration
	35, // 78: flyteidl2.workflow.TaskGroup.latest_finished_time:type_name -> google.protobuf.Timestamp
	41, // 79: flyteidl2.workflow.TaskGroup.created_by:type_name -> flyteidl2.common.EnrichedIdentity
	28, // 80: flyteidl2.workflow.TaskGroup.error_counts:type_name -> flyteidl2.workflow.TaskGroup.ErrorCounts
	29, // 81: flyteidl2.workflow.TaskGroup.phase_counts:type_name -> flyteidl2.workflow.TaskGroup.PhaseCounts
	39, // 82: flyteidl2.workflow.TaskGroup.average_time_to_running:type_name -> google.protobuf.Duration
	34, // 83: flyteidl2.workflow.TaskGroup.RecentStatus.phase:type_name -> flyteidl2.common.ActionPhase
	34, // 84: flyteidl2.workflow.TaskGroup.PhaseCounts.phase:type_name -> flyteidl2.common.ActionPhase
