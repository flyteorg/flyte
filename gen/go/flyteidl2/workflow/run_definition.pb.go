...
var file_flyteidl2_workflow_run_definition_proto_rawDesc = []byte{
	...
	0x42, 0x79, 0x22, 0xb6, 0x04, 0x0a, 0x0d, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x74,
...
var file_flyteidl2_workflow_run_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_flyteidl2_workflow_run_definition_proto_goTypes = []interface{}{
	...
	nil,                                // 26: flyteidl2.workflow.Run.LabelsEntry
	nil,                                // 27: flyteidl2.workflow.EnrichedAction.ChildrenPhaseCountsEntry
	(*TaskGroup_RecentStatus)(nil),     // 28: flyteidl2.workflow.TaskGroup.RecentStatus
	(*TaskGroup_ErrorCounts)(nil),      // 29: flyteidl2.workflow.TaskGroup.ErrorCounts
	(*TaskGroup_PhaseCounts)(nil),      // 30: flyteidl2.workflow.TaskGroup.PhaseCounts
	(*task.RunSpec)(nil),               // 31: flyteidl2.task.RunSpec
	(*task.TaskIdentifier)(nil),        // 32: flyteidl2.task.TaskIdentifier
	(*task.TaskSpec)(nil),              // 33: flyteidl2.task.TaskSpec
	(*wrapperspb.StringValue)(nil),     // 34: google.protobuf.StringValue
	(common.ActionPhase)(0),            // 35: flyteidl2.common.ActionPhase
	(*timestamppb.Timestamp)(nil),      // 36: google.protobuf.Timestamp
	(*task.OutputReferences)(nil),      // 37: flyteidl2.task.OutputReferences
	(*task.TraceSpec)(nil),             // 38: flyteidl2.task.TraceSpec
	(*core.LiteralType)(nil),           // 39: flyteidl2.core.LiteralType
	(*durationpb.Duration)(nil),        // 40: google.protobuf.Duration
	(*structpb.Struct)(nil),            // 41: google.protobuf.Struct
	(*common.EnrichedIdentity)(nil),    // 42: flyteidl2.common.EnrichedIdentity
	(*common.TriggerIdentifier)(nil),   // 43: flyteidl2.common.TriggerIdentifier
	(*task.TriggerAutomationSpec)(nil), // 44: flyteidl2.task.TriggerAutomationSpec
	(core.CatalogCacheStatus)(0),       // 45: flyteidl2.core.CatalogCacheStatus
	(*common.ActionIdentifier)(nil),    // 46: flyteidl2.common.ActionIdentifier
	(*core.TaskLog)(nil),               // 47: flyteidl2.core.TaskLog
	(*core.LogContext)(nil),            // 48: flyteidl2.core.LogContext
}
var file_flyteidl2_workflow_run_definition_proto_depIdxs = []int32{
	...
	26, // 1: flyteidl2.workflow.Run.labels:type_name -> flyteidl2.workflow.Run.LabelsEntry
	31, // 2: flyteidl2.workflow.RunDetails.run_spec:type_name -> flyteidl2.task.RunSpec
	19, // 3: flyteidl2.workflow.RunDetails.action:type_name -> flyteidl2.workflow.ActionDetails
	32, // 4: flyteidl2.workflow.TaskAction.id:type_name -> flyteidl2.task.TaskIdentifier
	33, // 5: flyteidl2.workflow.TaskAction.spec:type_name -> flyteidl2.task.TaskSpec
	34, // 6: flyteidl2.workflow.TaskAction.cache_key:type_name -> google.protobuf.StringValue
	35, // 7: flyteidl2.workflow.TraceAction.phase:type_name -> flyteidl2.common.ActionPhase
	36, // 8: flyteidl2.workflow.TraceAction.start_time:type_name -> google.protobuf.Timestamp
	36, // 9: flyteidl2.workflow.TraceAction.end_time:type_name -> google.protobuf.Timestamp
	37, // 10: flyteidl2.workflow.TraceAction.outputs:type_name -> flyteidl2.task.OutputReferences
	38, // 11: flyteidl2.workflow.TraceAction.spec:type_name -> flyteidl2.task.TraceSpec
	39, // 12: flyteidl2.workflow.ConditionAction.type:type_name -> flyteidl2.core.LiteralType
	0,  // 13: flyteidl2.workflow.ConditionAction.prompt_type:type_name -> flyteidl2.workflow.ConditionPromptType
	40, // 14: flyteidl2.workflow.ConditionAction.timeout:type_name -> google.protobuf.Duration
	9,  // 15: flyteidl2.workflow.ConditionAction.webhook:type_name -> flyteidl2.workflow.ConditionWebhook
	41, // 16: flyteidl2.workflow.ConditionWebhook.payload:type_name -> google.protobuf.Struct
	32, // 17: flyteidl2.workflow.TaskActionMetadata.id:type_name -> flyteidl2.task.TaskIdentifier
	39, // 18: flyteidl2.workflow.ConditionActionMetadata.type:type_name -> flyteidl2.core.LiteralType
	42, // 19: flyteidl2.workflow.ActionMetadata.executed_by:type_name -> flyteidl2.common.EnrichedIdentity
	...
	43, // 24: flyteidl2.workflow.ActionMetadata.trigger_id:type_name -> flyteidl2.common.TriggerIdentifier
	44, // 25: flyteidl2.workflow.ActionMetadata.trigger_type:type_name -> flyteidl2.task.TriggerAutomationSpec
	2,  // 26: flyteidl2.workflow.ActionMetadata.source:type_name -> flyteidl2.workflow.RunSource
	35, // 27: flyteidl2.workflow.ActionStatus.phase:type_name -> flyteidl2.common.ActionPhase
	36, // 28: flyteidl2.workflow.ActionStatus.start_time:type_name -> google.protobuf.Timestamp
	36, // 29: flyteidl2.workflow.ActionStatus.end_time:type_name -> google.protobuf.Timestamp
	45, // 30: flyteidl2.workflow.ActionStatus.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	46, // 31: flyteidl2.workflow.Action.id:type_name -> flyteidl2.common.ActionIdentifier
	...
	27, // 35: flyteidl2.workflow.EnrichedAction.children_phase_counts:type_name -> flyteidl2.workflow.EnrichedAction.ChildrenPhaseCountsEntry
	3,  // 36: flyteidl2.workflow.ErrorInfo.kind:type_name -> flyteidl2.workflow.ErrorInfo.Kind
	42, // 37: flyteidl2.workflow.AbortInfo.aborted_by:type_name -> flyteidl2.common.EnrichedIdentity
	46, // 38: flyteidl2.workflow.ActionDetails.id:type_name -> flyteidl2.common.ActionIdentifier
	...
	33, // 43: flyteidl2.workflow.ActionDetails.task:type_name -> flyteidl2.task.TaskSpec
	38, // 44: flyteidl2.workflow.ActionDetails.trace:type_name -> flyteidl2.task.TraceSpec
	8,  // 45: flyteidl2.workflow.ActionDetails.condition:type_name -> flyteidl2.workflow.ConditionAction
	20, // 46: flyteidl2.workflow.ActionDetails.attempts:type_name -> flyteidl2.workflow.ActionAttempt
	35, // 47: flyteidl2.workflow.ActionAttempt.phase:type_name -> flyteidl2.common.ActionPhase
	36, // 48: flyteidl2.workflow.ActionAttempt.start_time:type_name -> google.protobuf.Timestamp
	36, // 49: flyteidl2.workflow.ActionAttempt.end_time:type_name -> google.protobuf.Timestamp
	17, // 50: flyteidl2.workflow.ActionAttempt.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	47, // 51: flyteidl2.workflow.ActionAttempt.log_info:type_name -> flyteidl2.core.TaskLog
	37, // 52: flyteidl2.workflow.ActionAttempt.outputs:type_name -> flyteidl2.task.OutputReferences
	45, // 53: flyteidl2.workflow.ActionAttempt.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	21, // 54: flyteidl2.workflow.ActionAttempt.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	22, // 55: flyteidl2.workflow.ActionAttempt.phase_transitions:type_name -> flyteidl2.workflow.PhaseTransition
	48, // 56: flyteidl2.workflow.ActionAttempt.log_context:type_name -> flyteidl2.core.LogContext
	36, // 57: flyteidl2.workflow.ClusterEvent.occurred_at:type_name -> google.protobuf.Timestamp
	35, // 58: flyteidl2.workflow.PhaseTransition.phase:type_name -> flyteidl2.common.ActionPhase
	36, // 59: flyteidl2.workflow.PhaseTransition.start_time:type_name -> google.protobuf.Timestamp
	36, // 60: flyteidl2.workflow.PhaseTransition.end_time:type_name -> google.protobuf.Timestamp
	46, // 61: flyteidl2.workflow.ActionEvent.id:type_name -> flyteidl2.common.ActionIdentifier
	35, // 62: flyteidl2.workflow.ActionEvent.phase:type_name -> flyteidl2.common.ActionPhase
	36, // 63: flyteidl2.workflow.ActionEvent.start_time:type_name -> google.protobuf.Timestamp
	36, // 64: flyteidl2.workflow.ActionEvent.updated_time:type_name -> google.protobuf.Timestamp
	36, // 65: flyteidl2.workflow.ActionEvent.end_time:type_name -> google.protobuf.Timestamp
	17, // 66: flyteidl2.workflow.ActionEvent.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	47, // 67: flyteidl2.workflow.ActionEvent.log_info:type_name -> flyteidl2.core.TaskLog
	48, // 68: flyteidl2.workflow.ActionEvent.log_context:type_name -> flyteidl2.core.LogContext
	37, // 69: flyteidl2.workflow.ActionEvent.outputs:type_name -> flyteidl2.task.OutputReferences
	45, // 70: flyteidl2.workflow.ActionEvent.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	21, // 71: flyteidl2.workflow.ActionEvent.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	36, // 72: flyteidl2.workflow.ActionEvent.reported_time:type_name -> google.protobuf.Timestamp
	46, // 73: flyteidl2.workflow.ActionSpec.action_id:type_name -> flyteidl2.common.ActionIdentifier
	31, // 74: flyteidl2.workflow.ActionSpec.run_spec:type_name -> flyteidl2.task.RunSpec
	6,  // 75: flyteidl2.workflow.ActionSpec.task:type_name -> flyteidl2.workflow.TaskAction
	8,  // 76: flyteidl2.workflow.ActionSpec.condition:type_name -> flyteidl2.workflow.ConditionAction
	7,  // 77: flyteidl2.workflow.ActionSpec.trace:type_name -> flyteidl2.workflow.TraceAction
	36, // 78: flyteidl2.workflow.TaskGroup.latest_run_time:type_name -> google.protobuf.Timestamp
	28, // 79: flyteidl2.workflow.TaskGroup.recent_statuses:type_name -> flyteidl2.workflow.TaskGroup.RecentStatus
	40, // 80: flyteidl2.workflow.TaskGroup.average_duration:type_name -> google.protobuf.Duration
	36, // 81: flyteidl2.workflow.TaskGroup.latest_finished_time:type_name -> google.protobuf.Timestamp
	42, // 82: flyteidl2.workflow.TaskGroup.created_by:type_name -> flyteidl2.common.EnrichedIdentity
	29, // 83: flyteidl2.workflow.TaskGroup.error_counts:type_name -> flyteidl2.workflow.TaskGroup.ErrorCounts
	30, // 84: flyteidl2.workflow.TaskGroup.phase_counts:type_name -> flyteidl2.workflow.TaskGroup.PhaseCounts
	40, // 85: flyteidl2.workflow.TaskGroup.average_time_to_running:type_name -> google.protobuf.Duration
	35, // 86: flyteidl2.workflow.TaskGroup.RecentStatus.phase:type_name -> flyteidl2.common.ActionPhase
	35, // 87: flyteidl2.workflow.TaskGroup.PhaseCounts.phase:type_name -> flyteidl2.common.ActionPhase
