...
var file_flyteidl2_workflow_run_definition_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xa1, 0x01, 0x0a, 0x17, 0x43, 0x6f, 0x6e, 0x64, 0x69,
	...
	0x48, 0x00, 0x52, 0x06, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x42, 0x0e, 0x0a, 0x05, 0x73, 0x63,
	0x6f, 0x70, 0x65, 0x12, 0x05, 0xba, 0x48, 0x02, 0x08, 0x01, 0x22, 0xdc, 0x03, 0x0a, 0x0e, 0x41,
	...
	0x64, 0x42, 0x06, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63, 0x22, 0xaf, 0x02, 0x0a, 0x0c, 0x41, 0x63,
	...
	0x4e, 0x10, 0x03, 0x42, 0xcf, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x79, 0x74,
...
var file_flyteidl2_workflow_run_definition_proto_goTypes = []interface{}{
	...
	(*core.Literal)(nil),             // 42: flyteidl2.core.Literal
}
var file_flyteidl2_workflow_run_definition_proto_depIdxs = []int32{
	...
	32, // 10: flyteidl2.workflow.TaskActionMetadata.id:type_name -> flyteidl2.task.TaskIdentifier
	...
	34, // 16: flyteidl2.workflow.ActionMetadata.trigger_id:type_name -> flyteidl2.common.TriggerIdentifier
	0,  // 17: flyteidl2.workflow.ActionStatus.phase:type_name -> flyteidl2.workflow.Phase
	35, // 18: flyteidl2.workflow.ActionStatus.start_time:type_name -> google.protobuf.Timestamp
	35, // 19: flyteidl2.workflow.ActionStatus.end_time:type_name -> google.protobuf.Timestamp
	36, // 20: flyteidl2.workflow.ActionStatus.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	37, // 21: flyteidl2.workflow.Action.id:type_name -> flyteidl2.common.ActionIdentifier
	12, // 22: flyteidl2.workflow.Action.metadata:type_name -> flyteidl2.workflow.ActionMetadata
	13, // 23: flyteidl2.workflow.Action.status:type_name -> flyteidl2.workflow.ActionStatus
	14, // 24: flyteidl2.workflow.EnrichedAction.action:type_name -> flyteidl2.workflow.Action
	29, // 25: flyteidl2.workflow.EnrichedAction.children_phase_counts:type_name -> flyteidl2.workflow.EnrichedAction.ChildrenPhaseCountsEntry
	2,  // 26: flyteidl2.workflow.ErrorInfo.kind:type_name -> flyteidl2.workflow.ErrorInfo.Kind
	33, // 27: flyteidl2.workflow.AbortInfo.aborted_by:type_name -> flyteidl2.common.EnrichedIdentity
	37, // 28: flyteidl2.workflow.ActionDetails.id:type_name -> flyteidl2.common.ActionIdentifier
	12, // 29: flyteidl2.workflow.ActionDetails.metadata:type_name -> flyteidl2.workflow.ActionMetadata
	13, // 30: flyteidl2.workflow.ActionDetails.status:type_name -> flyteidl2.workflow.ActionStatus
	16, // 31: flyteidl2.workflow.ActionDetails.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	17, // 32: flyteidl2.workflow.ActionDetails.abort_info:type_name -> flyteidl2.workflow.AbortInfo
	38, // 33: flyteidl2.workflow.ActionDetails.task:type_name -> flyteidl2.task.TaskSpec
	39, // 34: flyteidl2.workflow.ActionDetails.trace:type_name -> flyteidl2.task.TraceSpec
	19, // 35: flyteidl2.workflow.ActionDetails.attempts:type_name -> flyteidl2.workflow.ActionAttempt
	0,  // 36: flyteidl2.workflow.ActionAttempt.phase:type_name -> flyteidl2.workflow.Phase
	35, // 37: flyteidl2.workflow.ActionAttempt.start_time:type_name -> google.protobuf.Timestamp
	35, // 38: flyteidl2.workflow.ActionAttempt.end_time:type_name -> google.protobuf.Timestamp
	16, // 39: flyteidl2.workflow.ActionAttempt.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	40, // 40: flyteidl2.workflow.ActionAttempt.log_info:type_name -> flyteidl2.core.TaskLog
	24, // 41: flyteidl2.workflow.ActionAttempt.outputs:type_name -> flyteidl2.workflow.OutputReferences
	36, // 42: flyteidl2.workflow.ActionAttempt.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	20, // 43: flyteidl2.workflow.ActionAttempt.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	21, // 44: flyteidl2.workflow.ActionAttempt.phase_transitions:type_name -> flyteidl2.workflow.PhaseTransition
	41, // 45: flyteidl2.workflow.ActionAttempt.log_context:type_name -> flyteidl2.core.LogContext
	35, // 46: flyteidl2.workflow.ClusterEvent.occurred_at:type_name -> google.protobuf.Timestamp
	0,  // 47: flyteidl2.workflow.PhaseTransition.phase:type_name -> flyteidl2.workflow.Phase
	35, // 48: flyteidl2.workflow.PhaseTransition.start_time:type_name -> google.protobuf.Timestamp
	35, // 49: flyteidl2.workflow.PhaseTransition.end_time:type_name -> google.protobuf.Timestamp
	37, // 50: flyteidl2.workflow.ActionEvent.id:type_name -> flyteidl2.common.ActionIdentifier
	0,  // 51: flyteidl2.workflow.ActionEvent.phase:type_name -> flyteidl2.workflow.Phase
	35, // 52: flyteidl2.workflow.ActionEvent.start_time:type_name -> google.protobuf.Timestamp
	35, // 53: flyteidl2.workflow.ActionEvent.updated_time:type_name -> google.protobuf.Timestamp
	35, // 54: flyteidl2.workflow.ActionEvent.end_time:type_name -> google.protobuf.Timestamp
	16, // 55: flyteidl2.workflow.ActionEvent.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	40, // 56: flyteidl2.workflow.ActionEvent.log_info:type_name -> flyteidl2.core.TaskLog
	41, // 57: flyteidl2.workflow.ActionEvent.log_context:type_name -> flyteidl2.core.LogContext
	24, // 58: flyteidl2.workflow.ActionEvent.outputs:type_name -> flyteidl2.workflow.OutputReferences
	36, // 59: flyteidl2.workflow.ActionEvent.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	20, // 60: flyteidl2.workflow.ActionEvent.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	35, // 61: flyteidl2.workflow.ActionEvent.reported_time:type_name -> google.protobuf.Timestamp
	42, // 62: flyteidl2.workflow.NamedLiteral.value:type_name -> flyteidl2.core.Literal
	23, // 63: flyteidl2.workflow.Inputs.literals:type_name -> flyteidl2.workflow.NamedLiteral
	30, // 64: flyteidl2.workflow.Inputs.context:type_name -> flyteidl2.core.KeyValuePair
	23, // 65: flyteidl2.workflow.Outputs.literals:type_name -> flyteidl2.workflow.NamedLiteral
