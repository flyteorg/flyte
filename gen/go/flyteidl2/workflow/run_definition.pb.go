...
var file_flyteidl2_workflow_run_definition_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x22, 0xc3, 0x01, 0x0a, 0x0a, 0x54, 0x61, 0x73, 0x6b, 0x41, 0x63, 0x74, 0x69, 0x6f,
	...
	0x09, 0x52, 0x05, 0x71, 0x75, 0x65, 0x75, 0x65, 0x22, 0xd6, 0x02, 0x0a, 0x0b, 0x54, 0x72, 0x61,
...
var file_flyteidl2_workflow_run_definition_proto_goTypes = []interface{}{
	...
	(core.CatalogCacheStatus)(0),       // 46: flyteidl2.core.CatalogCacheStatus
...
var file_flyteidl2_workflow_run_definition_proto_depIdxs = []int32{
	...
	36, // 27: flyteidl2.workflow.ActionStatus.phase:type_name -> flyteidl2.common.ActionPhase
	37, // 28: flyteidl2.workflow.ActionStatus.start_time:type_name -> google.protobuf.Timestamp
	37, // 29: flyteidl2.workflow.ActionStatus.end_time:type_name -> google.protobuf.Timestamp
	46, // 30: flyteidl2.workflow.ActionStatus.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	47, // 31: flyteidl2.workflow.Action.id:type_name -> flyteidl2.common.ActionIdentifier
	13, // 32: flyteidl2.workflow.Action.metadata:type_name -> flyteidl2.workflow.ActionMetadata
	14, // 33: flyteidl2.workflow.Action.status:type_name -> flyteidl2.workflow.ActionStatus
	15, // 34: flyteidl2.workflow.EnrichedAction.action:type_name -> flyteidl2.workflow.Action
	28, // 35: flyteidl2.workflow.EnrichedAction.children_phase_counts:type_name -> flyteidl2.workflow.EnrichedAction.ChildrenPhaseCountsEntry
	3,  // 36: flyteidl2.workflow.ErrorInfo.kind:type_name -> flyteidl2.workflow.ErrorInfo.Kind
	43, // 37: flyteidl2.workflow.AbortInfo.aborted_by:type_name -> flyteidl2.common.EnrichedIdentity
	43, // 38: flyteidl2.workflow.SignalInfo.signalled_by:type_name -> flyteidl2.common.EnrichedIdentity
	48, // 39: flyteidl2.workflow.SignalInfo.output:type_name -> flyteidl2.core.Literal
	47, // 40: flyteidl2.workflow.ActionDetails.id:type_name -> flyteidl2.common.ActionIdentifier
	13, // 41: flyteidl2.workflow.ActionDetails.metadata:type_name -> flyteidl2.workflow.ActionMetadata
	14, // 42: flyteidl2.workflow.ActionDetails.status:type_name -> flyteidl2.workflow.ActionStatus
	17, // 43: flyteidl2.workflow.ActionDetails.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	18, // 44: flyteidl2.workflow.ActionDetails.abort_info:type_name -> flyteidl2.workflow.AbortInfo
	19, // 45: flyteidl2.workflow.ActionDetails.signal_info:type_name -> flyteidl2.workflow.SignalInfo
	34, // 46: flyteidl2.workflow.ActionDetails.task:type_name -> flyteidl2.task.TaskSpec
	39, // 47: flyteidl2.workflow.ActionDetails.trace:type_name -> flyteidl2.task.TraceSpec
	8,  // 48: flyteidl2.workflow.ActionDetails.condition:type_name -> flyteidl2.workflow.ConditionAction
	21, // 49: flyteidl2.workflow.ActionDetails.attempts:type_name -> flyteidl2.workflow.ActionAttempt
	36, // 50: flyteidl2.workflow.ActionAttempt.phase:type_name -> flyteidl2.common.ActionPhase
	37, // 51: flyteidl2.workflow.ActionAttempt.start_time:type_name -> google.protobuf.Timestamp
	37, // 52: flyteidl2.workflow.ActionAttempt.end_time:type_name -> google.protobuf.Timestamp
	17, // 53: flyteidl2.workflow.ActionAttempt.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	49, // 54: flyteidl2.workflow.ActionAttempt.log_info:type_name -> flyteidl2.core.TaskLog
	38, // 55: flyteidl2.workflow.ActionAttempt.outputs:type_name -> flyteidl2.task.OutputReferences
	46, // 56: flyteidl2.workflow.ActionAttempt.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	22, // 57: flyteidl2.workflow.ActionAttempt.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	23, // 58: flyteidl2.workflow.ActionAttempt.phase_transitions:type_name -> flyteidl2.workflow.PhaseTransition
	50, // 59: flyteidl2.workflow.ActionAttempt.log_context:type_name -> flyteidl2.core.LogContext
	37, // 60: flyteidl2.workflow.ClusterEvent.occurred_at:type_name -> google.protobuf.Timestamp
	36, // 61: flyteidl2.workflow.PhaseTransition.phase:type_name -> flyteidl2.common.ActionPhase
	37, // 62: flyteidl2.workflow.PhaseTransition.start_time:type_name -> google.protobuf.Timestamp
	37, // 63: flyteidl2.workflow.PhaseTransition.end_time:type_name -> google.protobuf.Timestamp
	47, // 64: flyteidl2.workflow.ActionEvent.id:type_name -> flyteidl2.common.ActionIdentifier
	36, // 65: flyteidl2.workflow.ActionEvent.phase:type_name -> flyteidl2.common.ActionPhase
	37, // 66: flyteidl2.workflow.ActionEvent.start_time:type_name -> google.protobuf.Timestamp
	37, // 67: flyteidl2.workflow.ActionEvent.updated_time:type_name -> google.protobuf.Timestamp
	37, // 68: flyteidl2.workflow.ActionEvent.end_time:type_name -> google.protobuf.Timestamp
	17, // 69: flyteidl2.workflow.ActionEvent.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	49, // 70: flyteidl2.workflow.ActionEvent.log_info:type_name -> flyteidl2.core.TaskLog
	50, // 71: flyteidl2.workflow.ActionEvent.log_context:type_name -> flyteidl2.core.LogContext
	38, // 72: flyteidl2.workflow.ActionEvent.outputs:type_name -> flyteidl2.task.OutputReferences
	46, // 73: flyteidl2.workflow.ActionEvent.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	22, // 74: flyteidl2.workflow.ActionEvent.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	37, // 75: flyteidl2.workflow.ActionEvent.reported_time:type_name -> google.protobuf.Timestamp
	47, // 76: flyteidl2.workflow.ActionSpec.action_id:type_name -> flyteidl2.common.ActionIdentifier
	32, // 77: flyteidl2.workflow.ActionSpec.run_spec:type_name -> flyteidl2.task.RunSpec
	6,  // 78: flyteidl2.workflow.ActionSpec.task:type_name -> flyteidl2.workflow.TaskAction
	8,  // 79: flyteidl2.workflow.ActionSpec.condition:type_name -> flyteidl2.workflow.ConditionAction
	7,  // 80: flyteidl2.workflow.ActionSpec.trace:type_name -> flyteidl2.workflow.TraceAction
	37, // 81: flyteidl2.workflow.TaskGroup.latest_run_time:type_name -> google.protobuf.Timestamp
	29, // 82: flyteidl2.workflow.TaskGroup.recent_statuses:type_name -> flyteidl2.workflow.TaskGroup.RecentStatus
	41, // 83: flyteidl2.workflow.TaskGroup.average_duration:type_name -> google.protobuf.Duration
	37, // 84: flyteidl2.workflow.TaskGroup.latest_finished_time:type_name -> google.protobuf.Timestamp
	43, // 85: flyteidl2.workflow.TaskGroup.created_by:type_name -> flyteidl2.common.EnrichedIdentity
	30, // 86: flyteidl2.workflow.TaskGroup.error_counts:type_name -> flyteidl2.workflow.TaskGroup.ErrorCounts
	31, // 87: flyteidl2.workflow.TaskGroup.phase_counts:type_name -> flyteidl2.workflow.TaskGroup.PhaseCounts
	41, // 88: flyteidl2.workflow.TaskGroup.average_time_to_running:type_name -> google.protobuf.Duration
	36, // 89: flyteidl2.workflow.TaskGroup.RecentStatus.phase:type_name -> flyteidl2.common.ActionPhase
	36, // 90: flyteidl2.workflow.TaskGroup.PhaseCounts.phase:type_name -> flyteidl2.common.ActionPhase
