...
type ActionStatus struct {
	...
	// Resource details resolved at execution time by the operator.
	ResourceDetails *ResourceDetails `protobuf:"bytes,7,opt,name=resource_details,json=resourceDetails,proto3" json:"resource_details,omitempty"`
}
...
func (x *ActionStatus) GetResourceDetails() *ResourceDetails {
	if x != nil {
...
func (x *ResourceDetails) GetGpuResourceName() string {
	if x != nil {
...
var file_flyteidl2_workflow_run_definition_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x22, 0xb9, 0x03, 0x0a, 0x0c, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61,
