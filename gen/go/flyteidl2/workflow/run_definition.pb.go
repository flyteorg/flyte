...
var file_flyteidl2_workflow_run_definition_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0xcb, 0x04, 0x0a, 0x09, 0x54, 0x61, 0x73, 0x6b, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12,
	...
	0x65, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x46, 0x0a, 0x0f, 0x72, 0x65,
	...
	0x73, 0x65, 0x52, 0x0e, 0x72, 0x65, 0x63, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x2a,
	...
	0x45, 0x52, 0x10, 0x03, 0x42, 0xcf, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x79,
...
var file_flyteidl2_workflow_run_definition_proto_depIdxs = []int32{
	...
	29, // 21: flyteidl2.workflow.ActionStatus.phase:type_name -> flyteidl2.common.ActionPhase
	30, // 22: flyteidl2.workflow.ActionStatus.start_time:type_name -> google.protobuf.Timestamp
	30, // 23: flyteidl2.workflow.ActionStatus.end_time:type_name -> google.protobuf.Timestamp
	37, // 24: flyteidl2.workflow.ActionStatus.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	38, // 25: flyteidl2.workflow.Action.id:type_name -> flyteidl2.common.ActionIdentifier
	...
	34, // 31: flyteidl2.workflow.AbortInfo.aborted_by:type_name -> flyteidl2.common.EnrichedIdentity
	38, // 32: flyteidl2.workflow.ActionDetails.id:type_name -> flyteidl2.common.ActionIdentifier
	...
	27, // 37: flyteidl2.workflow.ActionDetails.task:type_name -> flyteidl2.task.TaskSpec
	32, // 38: flyteidl2.workflow.ActionDetails.trace:type_name -> flyteidl2.task.TraceSpec
	18, // 39: flyteidl2.workflow.ActionDetails.attempts:type_name -> flyteidl2.workflow.ActionAttempt
	29, // 40: flyteidl2.workflow.ActionAttempt.phase:type_name -> flyteidl2.common.ActionPhase
	30, // 41: flyteidl2.workflow.ActionAttempt.start_time:type_name -> google.protobuf.Timestamp
	30, // 42: flyteidl2.workflow.ActionAttempt.end_time:type_name -> google.protobuf.Timestamp
	15, // 43: flyteidl2.workflow.ActionAttempt.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	39, // 44: flyteidl2.workflow.ActionAttempt.log_info:type_name -> flyteidl2.core.TaskLog
	31, // 45: flyteidl2.workflow.ActionAttempt.outputs:type_name -> flyteidl2.task.OutputReferences
	37, // 46: flyteidl2.workflow.ActionAttempt.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	...
	40, // 49: flyteidl2.workflow.ActionAttempt.log_context:type_name -> flyteidl2.core.LogContext
	30, // 50: flyteidl2.workflow.ClusterEvent.occurred_at:type_name -> google.protobuf.Timestamp
	29, // 51: flyteidl2.workflow.PhaseTransition.phase:type_name -> flyteidl2.common.ActionPhase
	30, // 52: flyteidl2.workflow.PhaseTransition.start_time:type_name -> google.protobuf.Timestamp
	30, // 53: flyteidl2.workflow.PhaseTransition.end_time:type_name -> google.protobuf.Timestamp
	38, // 54: flyteidl2.workflow.ActionEvent.id:type_name -> flyteidl2.common.ActionIdentifier
	29, // 55: flyteidl2.workflow.ActionEvent.phase:type_name -> flyteidl2.common.ActionPhase
	30, // 56: flyteidl2.workflow.ActionEvent.start_time:type_name -> google.protobuf.Timestamp
	30, // 57: flyteidl2.workflow.ActionEvent.updated_time:type_name -> google.protobuf.Timestamp
	30, // 58: flyteidl2.workflow.ActionEvent.end_time:type_name -> google.protobuf.Timestamp
	15, // 59: flyteidl2.workflow.ActionEvent.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	39, // 60: flyteidl2.workflow.ActionEvent.log_info:type_name -> flyteidl2.core.TaskLog
	40, // 61: flyteidl2.workflow.ActionEvent.log_context:type_name -> flyteidl2.core.LogContext
	31, // 62: flyteidl2.workflow.ActionEvent.outputs:type_name -> flyteidl2.task.OutputReferences
	37, // 63: flyteidl2.workflow.ActionEvent.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	19, // 64: flyteidl2.workflow.ActionEvent.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	30, // 65: flyteidl2.workflow.ActionEvent.reported_time:type_name -> google.protobuf.Timestamp
	38, // 66: flyteidl2.workflow.ActionSpec.action_id:type_name -> flyteidl2.common.ActionIdentifier
	25, // 67: flyteidl2.workflow.ActionSpec.run_spec:type_name -> flyteidl2.task.RunSpec
	...
	30, // 71: flyteidl2.workflow.TaskGroup.latest_run_time:type_name -> google.protobuf.Timestamp
	29, // 72: flyteidl2.workflow.TaskGroup.recent_statuses:type_name -> flyteidl2.common.ActionPhase
	41, // 73: flyteidl2.workflow.TaskGroup.average_duration:type_name -> google.protobuf.Duration
	30, // 74: flyteidl2.workflow.TaskGroup.latest_finished_time:type_name -> google.protobuf.Timestamp
	34, // 75: flyteidl2.workflow.TaskGroup.created_by:type_name -> flyteidl2.common.EnrichedIdentity
