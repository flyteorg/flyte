...
type ActionStatus struct {
	...
	// GPU resource name resolved by the operator (e.g. "nvidia.com/gpu").
	GpuResourceName string `protobuf:"bytes,7,opt,name=gpu_resource_name,json=gpuResourceName,proto3" json:"gpu_resource_name,omitempty"`
}
...
func (x *ActionStatus) GetGpuResourceName() string {
	if x != nil {
...
func (*TaskGroup_RecentStatus) Descriptor() ([]byte, []int) {
	return file_flyteidl2_workflow_run_definition_proto_rawDescGZIP(), []int{20, 0}
}
...
func (*TaskGroup_PhaseCounts) Descriptor() ([]byte, []int) {
	return file_flyteidl2_workflow_run_definition_proto_rawDescGZIP(), []int{20, 2}
}
...
var file_flyteidl2_workflow_run_definition_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x22, 0x95, 0x03, 0x0a, 0x0c, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61,
	...
	0x01, 0x12, 0x2a, 0x0a, 0x11, 0x67, 0x70, 0x75, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x67, 0x70,
	0x75, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0x0b, 0x0a,
	...
	0x79, 0x52, 0x09, 0x61, 0x62, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x42, 0x79, 0x22, 0xf1, 0x03, 0x0a,
	...
	0x00, 0x52, 0x09, 0x61, 0x62, 0x6f, 0x72, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x2e, 0x0a, 0x04,
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2a, 0x71,
...
var file_flyteidl2_workflow_run_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_flyteidl2_workflow_run_definition_proto_goTypes = []interface{}{
	...
	(*TaskGroup_RecentStatus)(nil),     // 25: flyteidl2.workflow.TaskGroup.RecentStatus
	(*TaskGroup_ErrorCounts)(nil),      // 26: flyteidl2.workflow.TaskGroup.ErrorCounts
	(*TaskGroup_PhaseCounts)(nil),      // 27: flyteidl2.workflow.TaskGroup.PhaseCounts
	(*task.RunSpec)(nil),               // 28: flyteidl2.task.RunSpec
	(*task.TaskIdentifier)(nil),        // 29: flyteidl2.task.TaskIdentifier
	(*task.TaskSpec)(nil),              // 30: flyteidl2.task.TaskSpec
	(*wrapperspb.StringValue)(nil),     // 31: google.protobuf.StringValue
	(common.ActionPhase)(0),            // 32: flyteidl2.common.ActionPhase
	(*timestamppb.Timestamp)(nil),      // 33: google.protobuf.Timestamp
	(*task.OutputReferences)(nil),      // 34: flyteidl2.task.OutputReferences
	(*task.TraceSpec)(nil),             // 35: flyteidl2.task.TraceSpec
	(*core.LiteralType)(nil),           // 36: flyteidl2.core.LiteralType
	(*common.EnrichedIdentity)(nil),    // 37: flyteidl2.common.EnrichedIdentity
	(*common.TriggerIdentifier)(nil),   // 38: flyteidl2.common.TriggerIdentifier
	(*task.TriggerAutomationSpec)(nil), // 39: flyteidl2.task.TriggerAutomationSpec
	(core.CatalogCacheStatus)(0),       // 40: flyteidl2.core.CatalogCacheStatus
	(*common.ActionIdentifier)(nil),    // 41: flyteidl2.common.ActionIdentifier
	(*core.TaskLog)(nil),               // 42: flyteidl2.core.TaskLog
	(*core.LogContext)(nil),            // 43: flyteidl2.core.LogContext
...
var file_flyteidl2_workflow_run_definition_proto_depIdxs = []int32{
	...
	28, // 1: flyteidl2.workflow.RunDetails.run_spec:type_name -> flyteidl2.task.RunSpec
	17, // 2: flyteidl2.workflow.RunDetails.action:type_name -> flyteidl2.workflow.ActionDetails
	29, // 3: flyteidl2.workflow.TaskAction.id:type_name -> flyteidl2.task.TaskIdentifier
	30, // 4: flyteidl2.workflow.TaskAction.spec:type_name -> flyteidl2.task.TaskSpec
	31, // 5: flyteidl2.workflow.TaskAction.cache_key:type_name -> google.protobuf.StringValue
	32, // 6: flyteidl2.workflow.TraceAction.phase:type_name -> flyteidl2.common.ActionPhase
	33, // 7: flyteidl2.workflow.TraceAction.start_time:type_name -> google.protobuf.Timestamp
	33, // 8: flyteidl2.workflow.TraceAction.end_time:type_name -> google.protobuf.Timestamp
	34, // 9: flyteidl2.workflow.TraceAction.outputs:type_name -> flyteidl2.task.OutputReferences
	35, // 10: flyteidl2.workflow.TraceAction.spec:type_name -> flyteidl2.task.TraceSpec
	36, // 11: flyteidl2.workflow.ConditionAction.type:type_name -> flyteidl2.core.LiteralType
	29, // 12: flyteidl2.workflow.TaskActionMetadata.id:type_name -> flyteidl2.task.TaskIdentifier
	37, // 13: flyteidl2.workflow.ActionMetadata.executed_by:type_name -> flyteidl2.common.EnrichedIdentity
	...
	38, // 18: flyteidl2.workflow.ActionMetadata.trigger_id:type_name -> flyteidl2.common.TriggerIdentifier
	39, // 19: flyteidl2.workflow.ActionMetadata.trigger_type:type_name -> flyteidl2.task.TriggerAutomationSpec
	1,  // 20: flyteidl2.workflow.ActionMetadata.source:type_name -> flyteidl2.workflow.RunSource
	32, // 21: flyteidl2.workflow.ActionStatus.phase:type_name -> flyteidl2.common.ActionPhase
	33, // 22: flyteidl2.workflow.ActionStatus.start_time:type_name -> google.protobuf.Timestamp
	33, // 23: flyteidl2.workflow.ActionStatus.end_time:type_name -> google.protobuf.Timestamp
	40, // 24: flyteidl2.workflow.ActionStatus.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	41, // 25: flyteidl2.workflow.Action.id:type_name -> flyteidl2.common.ActionIdentifier
	...
	37, // 31: flyteidl2.workflow.AbortInfo.aborted_by:type_name -> flyteidl2.common.EnrichedIdentity
	41, // 32: flyteidl2.workflow.ActionDetails.id:type_name -> flyteidl2.common.ActionIdentifier
	...
	30, // 37: flyteidl2.workflow.ActionDetails.task:type_name -> flyteidl2.task.TaskSpec
	35, // 38: flyteidl2.workflow.ActionDetails.trace:type_name -> flyteidl2.task.TraceSpec
	18, // 39: flyteidl2.workflow.ActionDetails.attempts:type_name -> flyteidl2.workflow.ActionAttempt
	32, // 40: flyteidl2.workflow.ActionAttempt.phase:type_name -> flyteidl2.common.ActionPhase
	33, // 41: flyteidl2.workflow.ActionAttempt.start_time:type_name -> google.protobuf.Timestamp
	33, // 42: flyteidl2.workflow.ActionAttempt.end_time:type_name -> google.protobuf.Timestamp
	15, // 43: flyteidl2.workflow.ActionAttempt.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	42, // 44: flyteidl2.workflow.ActionAttempt.log_info:type_name -> flyteidl2.core.TaskLog
	34, // 45: flyteidl2.workflow.ActionAttempt.outputs:type_name -> flyteidl2.task.OutputReferences
	40, // 46: flyteidl2.workflow.ActionAttempt.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	...
	43, // 49: flyteidl2.workflow.ActionAttempt.log_context:type_name -> flyteidl2.core.LogContext
	33, // 50: flyteidl2.workflow.ClusterEvent.occurred_at:type_name -> google.protobuf.Timestamp
	32, // 51: flyteidl2.workflow.PhaseTransition.phase:type_name -> flyteidl2.common.ActionPhase
	33, // 52: flyteidl2.workflow.PhaseTransition.start_time:type_name -> google.protobuf.Timestamp
	33, // 53: flyteidl2.workflow.PhaseTransition.end_time:type_name -> google.protobuf.Timestamp
	41, // 54: flyteidl2.workflow.ActionEvent.id:type_name -> flyteidl2.common.ActionIdentifier
	32, // 55: flyteidl2.workflow.ActionEvent.phase:type_name -> flyteidl2.common.ActionPhase
	33, // 56: flyteidl2.workflow.ActionEvent.start_time:type_name -> google.protobuf.Timestamp
	33, // 57: flyteidl2.workflow.ActionEvent.updated_time:type_name -> google.protobuf.Timestamp
	33, // 58: flyteidl2.workflow.ActionEvent.end_time:type_name -> google.protobuf.Timestamp
	15, // 59: flyteidl2.workflow.ActionEvent.error_info:type_name -> flyteidl2.workflow.ErrorInfo
	42, // 60: flyteidl2.workflow.ActionEvent.log_info:type_name -> flyteidl2.core.TaskLog
	43, // 61: flyteidl2.workflow.ActionEvent.log_context:type_name -> flyteidl2.core.LogContext
	34, // 62: flyteidl2.workflow.ActionEvent.outputs:type_name -> flyteidl2.task.OutputReferences
	40, // 63: flyteidl2.workflow.ActionEvent.cache_status:type_name -> flyteidl2.core.CatalogCacheStatus
	19, // 64: flyteidl2.workflow.ActionEvent.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	33, // 65: flyteidl2.workflow.ActionEvent.reported_time:type_name -> google.protobuf.Timestamp
	41, // 66: flyteidl2.workflow.ActionSpec.action_id:type_name -> flyteidl2.common.ActionIdentifier
	28, // 67: flyteidl2.workflow.ActionSpec.run_spec:type_name -> flyteidl2.task.RunSpec
	...
	33, // 71: flyteidl2.workflow.TaskGroup.latest_run_time:type_name -> google.protobuf.Timestamp
	25, // 72: flyteidl2.workflow.TaskGroup.recent_statuses:type_name -> flyteidl2.workflow.TaskGroup.RecentStatus
	44, // 73: flyteidl2.workflow.TaskGroup.average_duration:type_name -> google.protobuf.Duration
	33, // 74: flyteidl2.workflow.TaskGroup.latest_finished_time:type_name -> google.protobuf.Timestamp
	37, // 75: flyteidl2.workflow.TaskGroup.created_by:type_name -> flyteidl2.common.EnrichedIdentity
	26, // 76: flyteidl2.workflow.TaskGroup.error_counts:type_name -> flyteidl2.workflow.TaskGroup.ErrorCounts
	27, // 77: flyteidl2.workflow.TaskGroup.phase_counts:type_name -> flyteidl2.workflow.TaskGroup.PhaseCounts
	44, // 78: flyteidl2.workflow.TaskGroup.average_time_to_running:type_name -> google.protobuf.Duration
	32, // 79: flyteidl2.workflow.TaskGroup.RecentStatus.phase:type_name -> flyteidl2.common.ActionPhase
	32, // 80: flyteidl2.workflow.TaskGroup.PhaseCounts.phase:type_name -> flyteidl2.common.ActionPhase
