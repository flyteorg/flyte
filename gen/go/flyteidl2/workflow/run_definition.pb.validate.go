...
// Validate checks the field values on ConditionWebhook with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on ConditionWebhook with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ConditionWebhookMultiError, or nil if none found.
func (m *ConditionWebhook) ValidateAll() error {
	return m.validate(true)
}

func (m *ConditionWebhook) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ConditionWebhookValidationError{
					field:  "Payload",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return ConditionWebhookValidationError{
				field:  "Payload",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return ConditionWebhookMultiError(errors)
	}

	return nil
}

// ConditionWebhookMultiError is an error wrapping multiple validation errors
// returned by ConditionWebhook.ValidateAll() if the designated constraints
// aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m ConditionWebhookMultiError) AllErrors() []error { return m }

// ConditionWebhookValidationError is the validation error returned by
// ConditionWebhook.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e ConditionWebhookValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ConditionWebhookValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ConditionWebhookValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ConditionWebhookValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ConditionWebhookValidationError) ErrorName() string { return "ConditionWebhookValidationError" }
...
func (e ConditionWebhookValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sConditionWebhook.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ConditionWebhookValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ConditionWebhookValidationError{}
...
func (m *TaskGroup) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetLatestRunTime()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
	...
	} else if v, ok := interface{}(m.GetLatestRunTime()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
	...
	if all {
		switch v := interface{}(m.GetAverageDuration()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, TaskGroupValidationError{
	...
	} else if v, ok := interface{}(m.GetAverageDuration()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return TaskGroupValidationError{
				field:  "AverageDuration",
				reason: "embedded message failed validation",
	...
	if all {
		switch v := interface{}(m.GetLatestFinishedTime()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, TaskGroupValidationError{
					field:  "LatestFinishedTime",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetLatestFinishedTime()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return TaskGroupValidationError{
				field:  "LatestFinishedTime",
				reason: "embedded message failed validation",
	...
	if all {
		switch v := interface{}(m.GetErrorCounts()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, TaskGroupValidationError{
					field:  "ErrorCounts",
	...
	} else if v, ok := interface{}(m.GetErrorCounts()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return TaskGroupValidationError{
				field:  "ErrorCounts",
				reason: "embedded message failed validation",
...
// Validate checks the field values on CacheMetadata with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *CacheMetadata) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CacheMetadata with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in CacheMetadataMultiError, or
// nil if none found.
func (m *CacheMetadata) ValidateAll() error {
	return m.validate(true)
}

func (m *CacheMetadata) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		switch v := interface{}(m.GetSourceActionAttempt()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CacheMetadataValidationError{
					field:  "SourceActionAttempt",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetSourceActionAttempt()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return CacheMetadataValidationError{
				field:  "SourceActionAttempt",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return CacheMetadataMultiError(errors)
	}

	return nil
}

// CacheMetadataMultiError is an error wrapping multiple validation errors
// returned by CacheMetadata.ValidateAll() if the designated constraints
// aren't met.
type CacheMetadataMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CacheMetadataMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CacheMetadataMultiError) AllErrors() []error { return m }

// CacheMetadataValidationError is the validation error returned by
// CacheMetadata.Validate if the designated constraints aren't met.
type CacheMetadataValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CacheMetadataValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CacheMetadataValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CacheMetadataValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CacheMetadataValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CacheMetadataValidationError) ErrorName() string { return "CacheMetadataValidationError" }

// Error satisfies the builtin error interface
func (e CacheMetadataValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = CacheMetadataValidationError{}
...
// ValidateAll checks the field values on TaskGroup_ErrorCounts with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// TaskGroup_ErrorCountsMultiError, or nil if none found.
func (m *TaskGroup_ErrorCounts) ValidateAll() error {
	return m.validate(true)
}

func (m *TaskGroup_ErrorCounts) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for UserError

	// no validation rules for SystemError

	// no validation rules for UnspecifiedError

	if len(errors) > 0 {
		return TaskGroup_ErrorCountsMultiError(errors)
	}

	return nil
}

// TaskGroup_ErrorCountsMultiError is an error wrapping multiple validation
// errors returned by TaskGroup_ErrorCounts.ValidateAll() if the designated
// constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m TaskGroup_ErrorCountsMultiError) AllErrors() []error { return m }

// TaskGroup_ErrorCountsValidationError is the validation error returned by
// TaskGroup_ErrorCounts.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e TaskGroup_ErrorCountsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TaskGroup_ErrorCountsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TaskGroup_ErrorCountsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TaskGroup_ErrorCountsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TaskGroup_ErrorCountsValidationError) ErrorName() string {
	return "TaskGroup_ErrorCountsValidationError"
}
...
func (e TaskGroup_ErrorCountsValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sTaskGroup_ErrorCounts.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = TaskGroup_ErrorCountsValidationError{}
