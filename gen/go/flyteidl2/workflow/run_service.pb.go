...
type WatchGroupsRequest_KnownSortField struct {
	...
	//
	//	*WatchGroupsRequest_KnownSortField_LatestCreatedAt
...
func (x *WatchGroupsRequest_KnownSortField) GetLatestCreatedAt() common.Sort_Direction {
	if x, ok := x.GetSortBy().(*WatchGroupsRequest_KnownSortField_LatestCreatedAt); ok {
...
type WatchGroupsRequest_KnownSortField_LatestCreatedAt struct {
	LatestCreatedAt common.Sort_Direction `protobuf:"varint,1,opt,name=latest_created_at,json=latestCreatedAt,proto3,enum=flyteidl2.common.Sort_Direction,oneof"`
}

func (*WatchGroupsRequest_KnownSortField_LatestCreatedAt) isWatchGroupsRequest_KnownSortField_SortBy() {
}
...
var file_flyteidl2_workflow_run_service_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0xf0, 0x03, 0x0a, 0x12, 0x57, 0x61, 0x74, 0x63, 0x68, 0x47, 0x72, 0x6f, 0x75, 0x70,
	...
	0x65, 0x6c, 0x64, 0x73, 0x1a, 0x6b, 0x0a, 0x0e, 0x4b, 0x6e, 0x6f, 0x77, 0x6e, 0x53, 0x6f, 0x72,
	0x74, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x12, 0x4e, 0x0a, 0x11, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74,
	...
	0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x0f, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x43, 0x72, 0x65,
...
var file_flyteidl2_workflow_run_service_proto_depIdxs = []int32{
	...
	50, // 44: flyteidl2.workflow.WatchGroupsRequest.KnownSortField.latest_created_at:type_name -> flyteidl2.common.Sort.Direction
...
func file_flyteidl2_workflow_run_service_proto_init() {
	...
	file_flyteidl2_workflow_run_service_proto_msgTypes[28].OneofWrappers = []interface{}{
		(*WatchGroupsRequest_KnownSortField_LatestCreatedAt)(nil),
	}
	type x struct{}
