...
func (*WatchGroupsRequest_KnownSortField) Descriptor() ([]byte, []int) {
	return file_flyteidl2_workflow_run_service_proto_rawDescGZIP(), []int{30, 0}
}
...
var file_flyteidl2_workflow_run_service_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x22, 0x87, 0x01, 0x0a, 0x13, 0x57, 0x61, 0x74, 0x63, 0x68, 0x41, 0x63, 0x74, 0x69,
	...
	,
...
var file_flyteidl2_workflow_run_service_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_flyteidl2_workflow_run_service_proto_goTypes = []interface{}{
	...
	(*WatchGroupsRequest)(nil),                // 30: flyteidl2.workflow.WatchGroupsRequest
	(*WatchGroupsResponse)(nil),               // 31: flyteidl2.workflow.WatchGroupsResponse
	(*WatchGroupsRequest_KnownSortField)(nil), // 32: flyteidl2.workflow.WatchGroupsRequest.KnownSortField
	(*common.RunIdentifier)(nil),              // 33: flyteidl2.common.RunIdentifier
	(*common.ProjectIdentifier)(nil),          // 34: flyteidl2.common.ProjectIdentifier
	(*task.TaskIdentifier)(nil),               // 35: flyteidl2.task.TaskIdentifier
	(*task.TaskSpec)(nil),                     // 36: flyteidl2.task.TaskSpec
	(*common.TriggerName)(nil),                // 37: flyteidl2.common.TriggerName
	(*task.Inputs)(nil),                       // 38: flyteidl2.task.Inputs
	(*common.OffloadedInputData)(nil),         // 39: flyteidl2.common.OffloadedInputData
	(*task.RunSpec)(nil),                      // 40: flyteidl2.task.RunSpec
	(RunSource)(0),                            // 41: flyteidl2.workflow.RunSource
	(*Run)(nil),                               // 42: flyteidl2.workflow.Run
	(*RunDetails)(nil),                        // 43: flyteidl2.workflow.RunDetails
	(*common.ActionIdentifier)(nil),           // 44: flyteidl2.common.ActionIdentifier
	(*ActionDetails)(nil),                     // 45: flyteidl2.workflow.ActionDetails
	(*task.Outputs)(nil),                      // 46: flyteidl2.task.Outputs
	(*core.LogContext)(nil),                   // 47: flyteidl2.core.LogContext
	(*timestamppb.Timestamp)(nil),             // 48: google.protobuf.Timestamp
	(*common.ListRequest)(nil),                // 49: flyteidl2.common.ListRequest
	(*task.TaskName)(nil),                     // 50: flyteidl2.task.TaskName
	(*common.ClusterIdentifier)(nil),          // 51: flyteidl2.common.ClusterIdentifier
	(*Action)(nil),                            // 52: flyteidl2.workflow.Action
	(*common.Filter)(nil),                     // 53: flyteidl2.common.Filter
	(*EnrichedAction)(nil),                    // 54: flyteidl2.workflow.EnrichedAction
	(*ClusterEvent)(nil),                      // 55: flyteidl2.workflow.ClusterEvent
	(*TaskGroup)(nil),                         // 56: flyteidl2.workflow.TaskGroup
	(common.Sort_Direction)(0),                // 57: flyteidl2.common.Sort.Direction
}
var file_flyteidl2_workflow_run_service_proto_depIdxs = []int32{
	33, // 0: flyteidl2.workflow.CreateRunRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	34, // 1: flyteidl2.workflow.CreateRunRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	35, // 2: flyteidl2.workflow.CreateRunRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	36, // 3: flyteidl2.workflow.CreateRunRequest.task_spec:type_name -> flyteidl2.task.TaskSpec
	37, // 4: flyteidl2.workflow.CreateRunRequest.trigger_name:type_name -> flyteidl2.common.TriggerName
	38, // 5: flyteidl2.workflow.CreateRunRequest.inputs:type_name -> flyteidl2.task.Inputs
	39, // 6: flyteidl2.workflow.CreateRunRequest.offloaded_input_data:type_name -> flyteidl2.common.OffloadedInputData
	40, // 7: flyteidl2.workflow.CreateRunRequest.run_spec:type_name -> flyteidl2.task.RunSpec
	41, // 8: flyteidl2.workflow.CreateRunRequest.source:type_name -> flyteidl2.workflow.RunSource
	42, // 9: flyteidl2.workflow.CreateRunResponse.run:type_name -> flyteidl2.workflow.Run
	33, // 10: flyteidl2.workflow.AbortRunRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	33, // 11: flyteidl2.workflow.GetRunDetailsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	43, // 12: flyteidl2.workflow.GetRunDetailsResponse.details:type_name -> flyteidl2.workflow.RunDetails
	33, // 13: flyteidl2.workflow.WatchRunDetailsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	43, // 14: flyteidl2.workflow.WatchRunDetailsResponse.details:type_name -> flyteidl2.workflow.RunDetails
	44, // 15: flyteidl2.workflow.GetActionDetailsRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	45, // 16: flyteidl2.workflow.GetActionDetailsResponse.details:type_name -> flyteidl2.workflow.ActionDetails
	44, // 17: flyteidl2.workflow.WatchActionDetailsRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	45, // 18: flyteidl2.workflow.WatchActionDetailsResponse.details:type_name -> flyteidl2.workflow.ActionDetails
	44, // 19: flyteidl2.workflow.GetActionDataRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	38, // 20: flyteidl2.workflow.GetActionDataResponse.inputs:type_name -> flyteidl2.task.Inputs
	46, // 21: flyteidl2.workflow.GetActionDataResponse.outputs:type_name -> flyteidl2.task.Outputs
	44, // 22: flyteidl2.workflow.GetActionDataURIsRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	44, // 23: flyteidl2.workflow.GetActionLogContextRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	47, // 24: flyteidl2.workflow.GetActionLogContextResponse.log_context:type_name -> flyteidl2.core.LogContext
	48, // 25: flyteidl2.workflow.GetActionLogContextResponse.start_time:type_name -> google.protobuf.Timestamp
	48, // 26: flyteidl2.workflow.GetActionLogContextResponse.end_time:type_name -> google.protobuf.Timestamp
	49, // 27: flyteidl2.workflow.ListRunsRequest.request:type_name -> flyteidl2.common.ListRequest
	34, // 28: flyteidl2.workflow.ListRunsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	37, // 29: flyteidl2.workflow.ListRunsRequest.trigger_name:type_name -> flyteidl2.common.TriggerName
	50, // 30: flyteidl2.workflow.ListRunsRequest.task_name:type_name -> flyteidl2.task.TaskName
	35, // 31: flyteidl2.workflow.ListRunsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	42, // 32: flyteidl2.workflow.ListRunsResponse.runs:type_name -> flyteidl2.workflow.Run
	51, // 33: flyteidl2.workflow.WatchRunsRequest.cluster_id:type_name -> flyteidl2.common.ClusterIdentifier
	34, // 34: flyteidl2.workflow.WatchRunsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	35, // 35: flyteidl2.workflow.WatchRunsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	42, // 36: flyteidl2.workflow.WatchRunsResponse.runs:type_name -> flyteidl2.workflow.Run
	49, // 37: flyteidl2.workflow.ListActionsRequest.request:type_name -> flyteidl2.common.ListRequest
	33, // 38: flyteidl2.workflow.ListActionsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	52, // 39: flyteidl2.workflow.ListActionsResponse.actions:type_name -> flyteidl2.workflow.Action
	33, // 40: flyteidl2.workflow.WatchActionsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	53, // 41: flyteidl2.workflow.WatchActionsRequest.filter:type_name -> flyteidl2.common.Filter
	54, // 42: flyteidl2.workflow.WatchActionsResponse.enriched_actions:type_name -> flyteidl2.workflow.EnrichedAction
	44, // 43: flyteidl2.workflow.WatchClusterEventsRequest.id:type_name -> flyteidl2.common.ActionIdentifier
	55, // 44: flyteidl2.workflow.WatchClusterEventsResponse.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	44, // 45: flyteidl2.workflow.AbortActionRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	34, // 46: flyteidl2.workflow.WatchGroupsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	48, // 47: flyteidl2.workflow.WatchGroupsRequest.start_date:type_name -> google.protobuf.Timestamp
	48, // 48: flyteidl2.workflow.WatchGroupsRequest.end_date:type_name -> google.protobuf.Timestamp
	49, // 49: flyteidl2.workflow.WatchGroupsRequest.request:type_name -> flyteidl2.common.ListRequest
	32, // 50: flyteidl2.workflow.WatchGroupsRequest.known_sort_fields:type_name -> flyteidl2.workflow.WatchGroupsRequest.KnownSortField
	56, // 51: flyteidl2.workflow.WatchGroupsResponse.task_groups:type_name -> flyteidl2.workflow.TaskGroup
	57, // 52: flyteidl2.workflow.WatchGroupsRequest.KnownSortField.created_at:type_name -> flyteidl2.common.Sort.Direction
	0,  // 53: flyteidl2.workflow.RunService.CreateRun:input_type -> flyteidl2.workflow.CreateRunRequest
	2,  // 54: flyteidl2.workflow.RunService.AbortRun:input_type -> flyteidl2.workflow.AbortRunRequest
	4,  // 55: flyteidl2.workflow.RunService.GetRunDetails:input_type -> flyteidl2.workflow.GetRunDetailsRequest
	6,  // 56: flyteidl2.workflow.RunService.WatchRunDetails:input_type -> flyteidl2.workflow.WatchRunDetailsRequest
	8,  // 57: flyteidl2.workflow.RunService.GetActionDetails:input_type -> flyteidl2.workflow.GetActionDetailsRequest
	10, // 58: flyteidl2.workflow.RunService.WatchActionDetails:input_type -> flyteidl2.workflow.WatchActionDetailsRequest
	12, // 59: flyteidl2.workflow.RunService.GetActionData:input_type -> flyteidl2.workflow.GetActionDataRequest
	18, // 60: flyteidl2.workflow.RunService.ListRuns:input_type -> flyteidl2.workflow.ListRunsRequest
	20, // 61: flyteidl2.workflow.RunService.WatchRuns:input_type -> flyteidl2.workflow.WatchRunsRequest
	22, // 62: flyteidl2.workflow.RunService.ListActions:input_type -> flyteidl2.workflow.ListActionsRequest
	24, // 63: flyteidl2.workflow.RunService.WatchActions:input_type -> flyteidl2.workflow.WatchActionsRequest
	26, // 64: flyteidl2.workflow.RunService.WatchClusterEvents:input_type -> flyteidl2.workflow.WatchClusterEventsRequest
	28, // 65: flyteidl2.workflow.RunService.AbortAction:input_type -> flyteidl2.workflow.AbortActionRequest
	30, // 66: flyteidl2.workflow.RunService.WatchGroups:input_type -> flyteidl2.workflow.WatchGroupsRequest
	14, // 67: flyteidl2.workflow.RunService.GetActionDataURIs:input_type -> flyteidl2.workflow.GetActionDataURIsRequest
	16, // 68: flyteidl2.workflow.RunService.GetActionLogContext:input_type -> flyteidl2.workflow.GetActionLogContextRequest
	1,  // 69: flyteidl2.workflow.RunService.CreateRun:output_type -> flyteidl2.workflow.CreateRunResponse
	3,  // 70: flyteidl2.workflow.RunService.AbortRun:output_type -> flyteidl2.workflow.AbortRunResponse
	5,  // 71: flyteidl2.workflow.RunService.GetRunDetails:output_type -> flyteidl2.workflow.GetRunDetailsResponse
	7,  // 72: flyteidl2.workflow.RunService.WatchRunDetails:output_type -> flyteidl2.workflow.WatchRunDetailsResponse
	9,  // 73: flyteidl2.workflow.RunService.GetActionDetails:output_type -> flyteidl2.workflow.GetActionDetailsResponse
	11, // 74: flyteidl2.workflow.RunService.WatchActionDetails:output_type -> flyteidl2.workflow.WatchActionDetailsResponse
	13, // 75: flyteidl2.workflow.RunService.GetActionData:output_type -> flyteidl2.workflow.GetActionDataResponse
	19, // 76: flyteidl2.workflow.RunService.ListRuns:output_type -> flyteidl2.workflow.ListRunsResponse
	21, // 77: flyteidl2.workflow.RunService.WatchRuns:output_type -> flyteidl2.workflow.WatchRunsResponse
	23, // 78: flyteidl2.workflow.RunService.ListActions:output_type -> flyteidl2.workflow.ListActionsResponse
	25, // 79: flyteidl2.workflow.RunService.WatchActions:output_type -> flyteidl2.workflow.WatchActionsResponse
	27, // 80: flyteidl2.workflow.RunService.WatchClusterEvents:output_type -> flyteidl2.workflow.WatchClusterEventsResponse
	29, // 81: flyteidl2.workflow.RunService.AbortAction:output_type -> flyteidl2.workflow.AbortActionResponse
	31, // 82: flyteidl2.workflow.RunService.WatchGroups:output_type -> flyteidl2.workflow.WatchGroupsResponse
	15, // 83: flyteidl2.workflow.RunService.GetActionDataURIs:output_type -> flyteidl2.workflow.GetActionDataURIsResponse
	17, // 84: flyteidl2.workflow.RunService.GetActionLogContext:output_type -> flyteidl2.workflow.GetActionLogContextResponse
...
func file_flyteidl2_workflow_run_service_proto_init() {
	...
	file_flyteidl2_workflow_run_service_proto_msgTypes[32].OneofWrappers = []interface{}{
