...
var file_flyteidl2_workflow_run_service_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x73, 0x65, 0x6e, 0x74, 0x69, 0x6e, 0x65, 0x6c, 0x32, 0xb9, 0x0b, 0x0a, 0x0a, 0x52,
...
var file_flyteidl2_workflow_run_service_proto_goTypes = []interface{}{
	...
	(*TaskGroup)(nil),                         // 49: flyteidl2.workflow.TaskGroup
	(common.Sort_Direction)(0),                // 50: flyteidl2.common.Sort.Direction
}
var file_flyteidl2_workflow_run_service_proto_depIdxs = []int32{
	...
	37, // 24: flyteidl2.workflow.ListRunsResponse.runs:type_name -> flyteidl2.workflow.Run
	43, // 25: flyteidl2.workflow.WatchRunsRequest.cluster_id:type_name -> flyteidl2.common.ClusterIdentifier
	30, // 26: flyteidl2.workflow.WatchRunsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	31, // 27: flyteidl2.workflow.WatchRunsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	37, // 28: flyteidl2.workflow.WatchRunsResponse.runs:type_name -> flyteidl2.workflow.Run
	42, // 29: flyteidl2.workflow.ListActionsRequest.request:type_name -> flyteidl2.common.ListRequest
	29, // 30: flyteidl2.workflow.ListActionsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	44, // 31: flyteidl2.workflow.ListActionsResponse.actions:type_name -> flyteidl2.workflow.Action
	29, // 32: flyteidl2.workflow.WatchActionsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	45, // 33: flyteidl2.workflow.WatchActionsRequest.filter:type_name -> flyteidl2.common.Filter
	46, // 34: flyteidl2.workflow.WatchActionsResponse.enriched_actions:type_name -> flyteidl2.workflow.EnrichedAction
	39, // 35: flyteidl2.workflow.WatchClusterEventsRequest.id:type_name -> flyteidl2.common.ActionIdentifier
	47, // 36: flyteidl2.workflow.WatchClusterEventsResponse.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	39, // 37: flyteidl2.workflow.AbortActionRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	30, // 38: flyteidl2.workflow.WatchGroupsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	48, // 39: flyteidl2.workflow.WatchGroupsRequest.start_date:type_name -> google.protobuf.Timestamp
	48, // 40: flyteidl2.workflow.WatchGroupsRequest.end_date:type_name -> google.protobuf.Timestamp
	42, // 41: flyteidl2.workflow.WatchGroupsRequest.request:type_name -> flyteidl2.common.ListRequest
	28, // 42: flyteidl2.workflow.WatchGroupsRequest.known_sort_fields:type_name -> flyteidl2.workflow.WatchGroupsRequest.KnownSortField
	49, // 43: flyteidl2.workflow.WatchGroupsResponse.task_groups:type_name -> flyteidl2.workflow.TaskGroup
	50, // 44: flyteidl2.workflow.WatchGroupsRequest.KnownSortField.created_at:type_name -> flyteidl2.common.Sort.Direction
	0,  // 45: flyteidl2.workflow.RunService.CreateRun:input_type -> flyteidl2.workflow.CreateRunRequest
	2,  // 46: flyteidl2.workflow.RunService.AbortRun:input_type -> flyteidl2.workflow.AbortRunRequest
	4,  // 47: flyteidl2.workflow.RunService.GetRunDetails:input_type -> flyteidl2.workflow.GetRunDetailsRequest
	6,  // 48: flyteidl2.workflow.RunService.WatchRunDetails:input_type -> flyteidl2.workflow.WatchRunDetailsRequest
	8,  // 49: flyteidl2.workflow.RunService.GetActionDetails:input_type -> flyteidl2.workflow.GetActionDetailsRequest
	10, // 50: flyteidl2.workflow.RunService.WatchActionDetails:input_type -> flyteidl2.workflow.WatchActionDetailsRequest
	12, // 51: flyteidl2.workflow.RunService.GetActionData:input_type -> flyteidl2.workflow.GetActionDataRequest
	14, // 52: flyteidl2.workflow.RunService.ListRuns:input_type -> flyteidl2.workflow.ListRunsRequest
	16, // 53: flyteidl2.workflow.RunService.WatchRuns:input_type -> flyteidl2.workflow.WatchRunsRequest
	18, // 54: flyteidl2.workflow.RunService.ListActions:input_type -> flyteidl2.workflow.ListActionsRequest
	20, // 55: flyteidl2.workflow.RunService.WatchActions:input_type -> flyteidl2.workflow.WatchActionsRequest
	22, // 56: flyteidl2.workflow.RunService.WatchClusterEvents:input_type -> flyteidl2.workflow.WatchClusterEventsRequest
	24, // 57: flyteidl2.workflow.RunService.AbortAction:input_type -> flyteidl2.workflow.AbortActionRequest
	26, // 58: flyteidl2.workflow.RunService.WatchGroups:input_type -> flyteidl2.workflow.WatchGroupsRequest
	1,  // 59: flyteidl2.workflow.RunService.CreateRun:output_type -> flyteidl2.workflow.CreateRunResponse
	3,  // 60: flyteidl2.workflow.RunService.AbortRun:output_type -> flyteidl2.workflow.AbortRunResponse
	5,  // 61: flyteidl2.workflow.RunService.GetRunDetails:output_type -> flyteidl2.workflow.GetRunDetailsResponse
	7,  // 62: flyteidl2.workflow.RunService.WatchRunDetails:output_type -> flyteidl2.workflow.WatchRunDetailsResponse
	9,  // 63: flyteidl2.workflow.RunService.GetActionDetails:output_type -> flyteidl2.workflow.GetActionDetailsResponse
	11, // 64: flyteidl2.workflow.RunService.WatchActionDetails:output_type -> flyteidl2.workflow.WatchActionDetailsResponse
	13, // 65: flyteidl2.workflow.RunService.GetActionData:output_type -> flyteidl2.workflow.GetActionDataResponse
	15, // 66: flyteidl2.workflow.RunService.ListRuns:output_type -> flyteidl2.workflow.ListRunsResponse
	17, // 67: flyteidl2.workflow.RunService.WatchRuns:output_type -> flyteidl2.workflow.WatchRunsResponse
	19, // 68: flyteidl2.workflow.RunService.ListActions:output_type -> flyteidl2.workflow.ListActionsResponse
	21, // 69: flyteidl2.workflow.RunService.WatchActions:output_type -> flyteidl2.workflow.WatchActionsResponse
	23, // 70: flyteidl2.workflow.RunService.WatchClusterEvents:output_type -> flyteidl2.workflow.WatchClusterEventsResponse
	25, // 71: flyteidl2.workflow.RunService.AbortAction:output_type -> flyteidl2.workflow.AbortActionResponse
	27, // 72: flyteidl2.workflow.RunService.WatchGroups:output_type -> flyteidl2.workflow.WatchGroupsResponse
