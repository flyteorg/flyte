...
var file_flyteidl2_workflow_run_service_proto_rawDesc = []byte{
	...
	0x74, 0x70, 0x75, 0x74, 0x73, 0x22, 0x84, 0x03, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x75,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xd5, 0x0a, 0x0a, 0x0a, 0x52, 0x75, 0x6e, 0x53, 0x65, 0x72, 0x76,
...
var file_flyteidl2_workflow_run_service_proto_goTypes = []interface{}{
	...
	(*task.TaskName)(nil),              // 40: flyteidl2.task.TaskName
	(*common.ClusterIdentifier)(nil),   // 41: flyteidl2.common.ClusterIdentifier
	(*Action)(nil),                     // 42: flyteidl2.workflow.Action
	(*common.Filter)(nil),              // 43: flyteidl2.common.Filter
	(*EnrichedAction)(nil),             // 44: flyteidl2.workflow.EnrichedAction
	(*ClusterEvent)(nil),               // 45: flyteidl2.workflow.ClusterEvent
}
var file_flyteidl2_workflow_run_service_proto_depIdxs = []int32{
	...
	40, // 24: flyteidl2.workflow.ListRunsRequest.task_name:type_name -> flyteidl2.task.TaskName
	28, // 25: flyteidl2.workflow.ListRunsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	34, // 26: flyteidl2.workflow.ListRunsResponse.runs:type_name -> flyteidl2.workflow.Run
	41, // 27: flyteidl2.workflow.WatchRunsRequest.cluster_id:type_name -> flyteidl2.common.ClusterIdentifier
	27, // 28: flyteidl2.workflow.WatchRunsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	28, // 29: flyteidl2.workflow.WatchRunsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	34, // 30: flyteidl2.workflow.WatchRunsResponse.runs:type_name -> flyteidl2.workflow.Run
	39, // 31: flyteidl2.workflow.ListActionsRequest.request:type_name -> flyteidl2.common.ListRequest
	26, // 32: flyteidl2.workflow.ListActionsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	42, // 33: flyteidl2.workflow.ListActionsResponse.actions:type_name -> flyteidl2.workflow.Action
	26, // 34: flyteidl2.workflow.WatchActionsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	43, // 35: flyteidl2.workflow.WatchActionsRequest.filter:type_name -> flyteidl2.common.Filter
	44, // 36: flyteidl2.workflow.WatchActionsResponse.enriched_actions:type_name -> flyteidl2.workflow.EnrichedAction
	36, // 37: flyteidl2.workflow.WatchClusterEventsRequest.id:type_name -> flyteidl2.common.ActionIdentifier
	45, // 38: flyteidl2.workflow.WatchClusterEventsResponse.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	36, // 39: flyteidl2.workflow.AbortActionRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	0,  // 40: flyteidl2.workflow.RunService.CreateRun:input_type -> flyteidl2.workflow.CreateRunRequest
	2,  // 41: flyteidl2.workflow.RunService.AbortRun:input_type -> flyteidl2.workflow.AbortRunRequest
	4,  // 42: flyteidl2.workflow.RunService.GetRunDetails:input_type -> flyteidl2.workflow.GetRunDetailsRequest
	6,  // 43: flyteidl2.workflow.RunService.WatchRunDetails:input_type -> flyteidl2.workflow.WatchRunDetailsRequest
	8,  // 44: flyteidl2.workflow.RunService.GetActionDetails:input_type -> flyteidl2.workflow.GetActionDetailsRequest
	10, // 45: flyteidl2.workflow.RunService.WatchActionDetails:input_type -> flyteidl2.workflow.WatchActionDetailsRequest
	12, // 46: flyteidl2.workflow.RunService.GetActionData:input_type -> flyteidl2.workflow.GetActionDataRequest
	14, // 47: flyteidl2.workflow.RunService.ListRuns:input_type -> flyteidl2.workflow.ListRunsRequest
	16, // 48: flyteidl2.workflow.RunService.WatchRuns:input_type -> flyteidl2.workflow.WatchRunsRequest
	18, // 49: flyteidl2.workflow.RunService.ListActions:input_type -> flyteidl2.workflow.ListActionsRequest
	20, // 50: flyteidl2.workflow.RunService.WatchActions:input_type -> flyteidl2.workflow.WatchActionsRequest
	22, // 51: flyteidl2.workflow.RunService.WatchClusterEvents:input_type -> flyteidl2.workflow.WatchClusterEventsRequest
	24, // 52: flyteidl2.workflow.RunService.AbortAction:input_type -> flyteidl2.workflow.AbortActionRequest
	1,  // 53: flyteidl2.workflow.RunService.CreateRun:output_type -> flyteidl2.workflow.CreateRunResponse
	3,  // 54: flyteidl2.workflow.RunService.AbortRun:output_type -> flyteidl2.workflow.AbortRunResponse
	5,  // 55: flyteidl2.workflow.RunService.GetRunDetails:output_type -> flyteidl2.workflow.GetRunDetailsResponse
	7,  // 56: flyteidl2.workflow.RunService.WatchRunDetails:output_type -> flyteidl2.workflow.WatchRunDetailsResponse
	9,  // 57: flyteidl2.workflow.RunService.GetActionDetails:output_type -> flyteidl2.workflow.GetActionDetailsResponse
	11, // 58: flyteidl2.workflow.RunService.WatchActionDetails:output_type -> flyteidl2.workflow.WatchActionDetailsResponse
	13, // 59: flyteidl2.workflow.RunService.GetActionData:output_type -> flyteidl2.workflow.GetActionDataResponse
	15, // 60: flyteidl2.workflow.RunService.ListRuns:output_type -> flyteidl2.workflow.ListRunsResponse
	17, // 61: flyteidl2.workflow.RunService.WatchRuns:output_type -> flyteidl2.workflow.WatchRunsResponse
	19, // 62: flyteidl2.workflow.RunService.ListActions:output_type -> flyteidl2.workflow.ListActionsResponse
	21, // 63: flyteidl2.workflow.RunService.WatchActions:output_type -> flyteidl2.workflow.WatchActionsResponse
	23, // 64: flyteidl2.workflow.RunService.WatchClusterEvents:output_type -> flyteidl2.workflow.WatchClusterEventsResponse
	25, // 65: flyteidl2.workflow.RunService.AbortAction:output_type -> flyteidl2.workflow.AbortActionResponse
