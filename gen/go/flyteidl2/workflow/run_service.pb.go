...
var file_flyteidl2_workflow_run_service_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xee, 0x04, 0x0a, 0x10, 0x43,
	...
	0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x0b,
	...
	0x72, 0x69, 0x63, 0x68, 0x65, 0x64, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x7a, 0x0a,
...
var file_flyteidl2_workflow_run_service_proto_goTypes = []interface{}{
	...
	(*Run)(nil),                               // 45: flyteidl2.workflow.Run
	(*RunDetails)(nil),                        // 46: flyteidl2.workflow.RunDetails
	(*common.ActionIdentifier)(nil),           // 47: flyteidl2.common.ActionIdentifier
	(*ActionDetails)(nil),                     // 48: flyteidl2.workflow.ActionDetails
	(*task.Outputs)(nil),                      // 49: flyteidl2.task.Outputs
	(*core.LogContext)(nil),                   // 50: flyteidl2.core.LogContext
...
var file_flyteidl2_workflow_run_service_proto_depIdxs = []int32{
	...
	45, // 9: flyteidl2.workflow.CreateRunResponse.run:type_name -> flyteidl2.workflow.Run
	36, // 10: flyteidl2.workflow.AbortRunRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	36, // 11: flyteidl2.workflow.GetRunDetailsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	46, // 12: flyteidl2.workflow.GetRunDetailsResponse.details:type_name -> flyteidl2.workflow.RunDetails
	36, // 13: flyteidl2.workflow.WatchRunDetailsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	46, // 14: flyteidl2.workflow.WatchRunDetailsResponse.details:type_name -> flyteidl2.workflow.RunDetails
	47, // 15: flyteidl2.workflow.GetActionDetailsRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	48, // 16: flyteidl2.workflow.GetActionDetailsResponse.details:type_name -> flyteidl2.workflow.ActionDetails
	47, // 17: flyteidl2.workflow.WatchActionDetailsRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	48, // 18: flyteidl2.workflow.WatchActionDetailsResponse.details:type_name -> flyteidl2.workflow.ActionDetails
	47, // 19: flyteidl2.workflow.GetActionDataRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	41, // 20: flyteidl2.workflow.GetActionDataResponse.inputs:type_name -> flyteidl2.task.Inputs
	49, // 21: flyteidl2.workflow.GetActionDataResponse.outputs:type_name -> flyteidl2.task.Outputs
	47, // 22: flyteidl2.workflow.GetActionDataURIsRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	47, // 23: flyteidl2.workflow.GetActionLogContextRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	50, // 24: flyteidl2.workflow.GetActionLogContextResponse.log_context:type_name -> flyteidl2.core.LogContext
	51, // 25: flyteidl2.workflow.GetActionLogContextResponse.start_time:type_name -> google.protobuf.Timestamp
	51, // 26: flyteidl2.workflow.GetActionLogContextResponse.end_time:type_name -> google.protobuf.Timestamp
	52, // 27: flyteidl2.workflow.ListRunsRequest.request:type_name -> flyteidl2.common.ListRequest
	37, // 28: flyteidl2.workflow.ListRunsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	40, // 29: flyteidl2.workflow.ListRunsRequest.trigger_name:type_name -> flyteidl2.common.TriggerName
	53, // 30: flyteidl2.workflow.ListRunsRequest.task_name:type_name -> flyteidl2.task.TaskName
	38, // 31: flyteidl2.workflow.ListRunsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	45, // 32: flyteidl2.workflow.ListRunsResponse.runs:type_name -> flyteidl2.workflow.Run
	54, // 33: flyteidl2.workflow.WatchRunsRequest.cluster_id:type_name -> flyteidl2.common.ClusterIdentifier
	37, // 34: flyteidl2.workflow.WatchRunsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	38, // 35: flyteidl2.workflow.WatchRunsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	45, // 36: flyteidl2.workflow.WatchRunsResponse.runs:type_name -> flyteidl2.workflow.Run
	52, // 37: flyteidl2.workflow.ListActionsRequest.request:type_name -> flyteidl2.common.ListRequest
	36, // 38: flyteidl2.workflow.ListActionsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	55, // 39: flyteidl2.workflow.ListActionsResponse.actions:type_name -> flyteidl2.workflow.Action
	36, // 40: flyteidl2.workflow.WatchActionsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	56, // 41: flyteidl2.workflow.WatchActionsRequest.filter:type_name -> flyteidl2.common.Filter
	57, // 42: flyteidl2.workflow.WatchActionsResponse.enriched_actions:type_name -> flyteidl2.workflow.EnrichedAction
	47, // 43: flyteidl2.workflow.WatchClusterEventsRequest.id:type_name -> flyteidl2.common.ActionIdentifier
	58, // 44: flyteidl2.workflow.WatchClusterEventsResponse.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	47, // 45: flyteidl2.workflow.AbortActionRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	47, // 46: flyteidl2.workflow.SignalEventRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	30, // 47: flyteidl2.workflow.SignalEventRequest.payload:type_name -> flyteidl2.workflow.EventPayload
	37, // 48: flyteidl2.workflow.WatchGroupsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	51, // 49: flyteidl2.workflow.WatchGroupsRequest.start_date:type_name -> google.protobuf.Timestamp
	51, // 50: flyteidl2.workflow.WatchGroupsRequest.end_date:type_name -> google.protobuf.Timestamp
	52, // 51: flyteidl2.workflow.WatchGroupsRequest.request:type_name -> flyteidl2.common.ListRequest
	35, // 52: flyteidl2.workflow.WatchGroupsRequest.known_sort_fields:type_name -> flyteidl2.workflow.WatchGroupsRequest.KnownSortField
	59, // 53: flyteidl2.workflow.WatchGroupsResponse.task_groups:type_name -> flyteidl2.workflow.TaskGroup
	60, // 54: flyteidl2.workflow.WatchGroupsRequest.KnownSortField.created_at:type_name -> flyteidl2.common.Sort.Direction
	0,  // 55: flyteidl2.workflow.RunService.CreateRun:input_type -> flyteidl2.workflow.CreateRunRequest
	2,  // 56: flyteidl2.workflow.RunService.AbortRun:input_type -> flyteidl2.workflow.AbortRunRequest
	4,  // 57: flyteidl2.workflow.RunService.GetRunDetails:input_type -> flyteidl2.workflow.GetRunDetailsRequest
	6,  // 58: flyteidl2.workflow.RunService.WatchRunDetails:input_type -> flyteidl2.workflow.WatchRunDetailsRequest
	8,  // 59: flyteidl2.workflow.RunService.GetActionDetails:input_type -> flyteidl2.workflow.GetActionDetailsRequest
	10, // 60: flyteidl2.workflow.RunService.WatchActionDetails:input_type -> flyteidl2.workflow.WatchActionDetailsRequest
	12, // 61: flyteidl2.workflow.RunService.GetActionData:input_type -> flyteidl2.workflow.GetActionDataRequest
	18, // 62: flyteidl2.workflow.RunService.ListRuns:input_type -> flyteidl2.workflow.ListRunsRequest
	20, // 63: flyteidl2.workflow.RunService.WatchRuns:input_type -> flyteidl2.workflow.WatchRunsRequest
	22, // 64: flyteidl2.workflow.RunService.ListActions:input_type -> flyteidl2.workflow.ListActionsRequest
	24, // 65: flyteidl2.workflow.RunService.WatchActions:input_type -> flyteidl2.workflow.WatchActionsRequest
	26, // 66: flyteidl2.workflow.RunService.WatchClusterEvents:input_type -> flyteidl2.workflow.WatchClusterEventsRequest
	28, // 67: flyteidl2.workflow.RunService.AbortAction:input_type -> flyteidl2.workflow.AbortActionRequest
	31, // 68: flyteidl2.workflow.RunService.SignalEvent:input_type -> flyteidl2.workflow.SignalEventRequest
	33, // 69: flyteidl2.workflow.RunService.WatchGroups:input_type -> flyteidl2.workflow.WatchGroupsRequest
	14, // 70: flyteidl2.workflow.RunService.GetActionDataURIs:input_type -> flyteidl2.workflow.GetActionDataURIsRequest
	16, // 71: flyteidl2.workflow.RunService.GetActionLogContext:input_type -> flyteidl2.workflow.GetActionLogContextRequest
	1,  // 72: flyteidl2.workflow.RunService.CreateRun:output_type -> flyteidl2.workflow.CreateRunResponse
	3,  // 73: flyteidl2.workflow.RunService.AbortRun:output_type -> flyteidl2.workflow.AbortRunResponse
	5,  // 74: flyteidl2.workflow.RunService.GetRunDetails:output_type -> flyteidl2.workflow.GetRunDetailsResponse
	7,  // 75: flyteidl2.workflow.RunService.WatchRunDetails:output_type -> flyteidl2.workflow.WatchRunDetailsResponse
	9,  // 76: flyteidl2.workflow.RunService.GetActionDetails:output_type -> flyteidl2.workflow.GetActionDetailsResponse
	11, // 77: flyteidl2.workflow.RunService.WatchActionDetails:output_type -> flyteidl2.workflow.WatchActionDetailsResponse
	13, // 78: flyteidl2.workflow.RunService.GetActionData:output_type -> flyteidl2.workflow.GetActionDataResponse
	19, // 79: flyteidl2.workflow.RunService.ListRuns:output_type -> flyteidl2.workflow.ListRunsResponse
	21, // 80: flyteidl2.workflow.RunService.WatchRuns:output_type -> flyteidl2.workflow.WatchRunsResponse
	23, // 81: flyteidl2.workflow.RunService.ListActions:output_type -> flyteidl2.workflow.ListActionsResponse
	25, // 82: flyteidl2.workflow.RunService.WatchActions:output_type -> flyteidl2.workflow.WatchActionsResponse
	27, // 83: flyteidl2.workflow.RunService.WatchClusterEvents:output_type -> flyteidl2.workflow.WatchClusterEventsResponse
	29, // 84: flyteidl2.workflow.RunService.AbortAction:output_type -> flyteidl2.workflow.AbortActionResponse
	32, // 85: flyteidl2.workflow.RunService.SignalEvent:output_type -> flyteidl2.workflow.SignalEventResponse
	34, // 86: flyteidl2.workflow.RunService.WatchGroups:output_type -> flyteidl2.workflow.WatchGroupsResponse
	15, // 87: flyteidl2.workflow.RunService.GetActionDataURIs:output_type -> flyteidl2.workflow.GetActionDataURIsResponse
	17, // 88: flyteidl2.workflow.RunService.GetActionLogContext:output_type -> flyteidl2.workflow.GetActionLogContextResponse
