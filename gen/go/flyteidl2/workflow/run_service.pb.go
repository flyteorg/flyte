...
func (x *CreateRunRequest) GetInputUri() string {
	if x, ok := x.GetInputWrapper().(*CreateRunRequest_InputUri); ok {
		return x.InputUri
	}
	return ""
}
...
type CreateRunRequest_InputUri struct {
	InputUri string `protobuf:"bytes,9,opt,name=input_uri,json=inputUri,proto3,oneof"`
}

func (*CreateRunRequest_Inputs) isCreateRunRequest_InputWrapper() {}

func (*CreateRunRequest_InputUri) isCreateRunRequest_InputWrapper() {}
...
var file_flyteidl2_workflow_run_service_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x30, 0x0a, 0x06, 0x69,
	...
	,
	...
	0x73, 0x22, 0x84, 0x03, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x73, 0x52, 0x65,
	...
	0x08, 0x73, 0x65, 0x6e, 0x74, 0x69, 0x6e, 0x65, 0x6c, 0x32, 0xb9, 0x0b, 0x0a, 0x0a, 0x52, 0x75,
	...
	0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0xcc, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c,
	0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77,
	0x42, 0x0f, 0x52, 0x75, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74,
...
var file_flyteidl2_workflow_run_service_proto_goTypes = []interface{}{
	...
	(*task.RunSpec)(nil),                      // 35: flyteidl2.task.RunSpec
	(RunSource)(0),                            // 36: flyteidl2.workflow.RunSource
	(*Run)(nil),                               // 37: flyteidl2.workflow.Run
	(*RunDetails)(nil),                        // 38: flyteidl2.workflow.RunDetails
	(*common.ActionIdentifier)(nil),           // 39: flyteidl2.common.ActionIdentifier
	(*ActionDetails)(nil),                     // 40: flyteidl2.workflow.ActionDetails
	(*task.Outputs)(nil),                      // 41: flyteidl2.task.Outputs
	(*common.ListRequest)(nil),                // 42: flyteidl2.common.ListRequest
	(*task.TaskName)(nil),                     // 43: flyteidl2.task.TaskName
	(*common.ClusterIdentifier)(nil),          // 44: flyteidl2.common.ClusterIdentifier
	(*Action)(nil),                            // 45: flyteidl2.workflow.Action
	(*common.Filter)(nil),                     // 46: flyteidl2.common.Filter
	(*EnrichedAction)(nil),                    // 47: flyteidl2.workflow.EnrichedAction
	(*ClusterEvent)(nil),                      // 48: flyteidl2.workflow.ClusterEvent
	(*timestamppb.Timestamp)(nil),             // 49: google.protobuf.Timestamp
	(*TaskGroup)(nil),                         // 50: flyteidl2.workflow.TaskGroup
	(common.Sort_Direction)(0),                // 51: flyteidl2.common.Sort.Direction
}
var file_flyteidl2_workflow_run_service_proto_depIdxs = []int32{
	...
	35, // 6: flyteidl2.workflow.CreateRunRequest.run_spec:type_name -> flyteidl2.task.RunSpec
	36, // 7: flyteidl2.workflow.CreateRunRequest.source:type_name -> flyteidl2.workflow.RunSource
	37, // 8: flyteidl2.workflow.CreateRunResponse.run:type_name -> flyteidl2.workflow.Run
	29, // 9: flyteidl2.workflow.AbortRunRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	29, // 10: flyteidl2.workflow.GetRunDetailsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	38, // 11: flyteidl2.workflow.GetRunDetailsResponse.details:type_name -> flyteidl2.workflow.RunDetails
	29, // 12: flyteidl2.workflow.WatchRunDetailsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	38, // 13: flyteidl2.workflow.WatchRunDetailsResponse.details:type_name -> flyteidl2.workflow.RunDetails
	39, // 14: flyteidl2.workflow.GetActionDetailsRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	40, // 15: flyteidl2.workflow.GetActionDetailsResponse.details:type_name -> flyteidl2.workflow.ActionDetails
	39, // 16: flyteidl2.workflow.WatchActionDetailsRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	40, // 17: flyteidl2.workflow.WatchActionDetailsResponse.details:type_name -> flyteidl2.workflow.ActionDetails
	39, // 18: flyteidl2.workflow.GetActionDataRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	34, // 19: flyteidl2.workflow.GetActionDataResponse.inputs:type_name -> flyteidl2.task.Inputs
	41, // 20: flyteidl2.workflow.GetActionDataResponse.outputs:type_name -> flyteidl2.task.Outputs
	42, // 21: flyteidl2.workflow.ListRunsRequest.request:type_name -> flyteidl2.common.ListRequest
	30, // 22: flyteidl2.workflow.ListRunsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	33, // 23: flyteidl2.workflow.ListRunsRequest.trigger_name:type_name -> flyteidl2.common.TriggerName
	43, // 24: flyteidl2.workflow.ListRunsRequest.task_name:type_name -> flyteidl2.task.TaskName
	31, // 25: flyteidl2.workflow.ListRunsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	37, // 26: flyteidl2.workflow.ListRunsResponse.runs:type_name -> flyteidl2.workflow.Run
	44, // 27: flyteidl2.workflow.WatchRunsRequest.cluster_id:type_name -> flyteidl2.common.ClusterIdentifier
	30, // 28: flyteidl2.workflow.WatchRunsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	31, // 29: flyteidl2.workflow.WatchRunsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	37, // 30: flyteidl2.workflow.WatchRunsResponse.runs:type_name -> flyteidl2.workflow.Run
	42, // 31: flyteidl2.workflow.ListActionsRequest.request:type_name -> flyteidl2.common.ListRequest
	29, // 32: flyteidl2.workflow.ListActionsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	45, // 33: flyteidl2.workflow.ListActionsResponse.actions:type_name -> flyteidl2.workflow.Action
	29, // 34: flyteidl2.workflow.WatchActionsRequest.run_id:type_name -> flyteidl2.common.RunIdentifier
	46, // 35: flyteidl2.workflow.WatchActionsRequest.filter:type_name -> flyteidl2.common.Filter
	47, // 36: flyteidl2.workflow.WatchActionsResponse.enriched_actions:type_name -> flyteidl2.workflow.EnrichedAction
	39, // 37: flyteidl2.workflow.WatchClusterEventsRequest.id:type_name -> flyteidl2.common.ActionIdentifier
	48, // 38: flyteidl2.workflow.WatchClusterEventsResponse.cluster_events:type_name -> flyteidl2.workflow.ClusterEvent
	39, // 39: flyteidl2.workflow.AbortActionRequest.action_id:type_name -> flyteidl2.common.ActionIdentifier
	30, // 40: flyteidl2.workflow.WatchGroupsRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	49, // 41: flyteidl2.workflow.WatchGroupsRequest.start_date:type_name -> google.protobuf.Timestamp
	49, // 42: flyteidl2.workflow.WatchGroupsRequest.end_date:type_name -> google.protobuf.Timestamp
	42, // 43: flyteidl2.workflow.WatchGroupsRequest.request:type_name -> flyteidl2.common.ListRequest
	...
	50, // 45: flyteidl2.workflow.WatchGroupsResponse.task_groups:type_name -> flyteidl2.workflow.TaskGroup
	51, // 46: flyteidl2.workflow.WatchGroupsRequest.KnownSortField.created_at:type_name -> flyteidl2.common.Sort.Direction
	0,  // 47: flyteidl2.workflow.RunService.CreateRun:input_type -> flyteidl2.workflow.CreateRunRequest
	2,  // 48: flyteidl2.workflow.RunService.AbortRun:input_type -> flyteidl2.workflow.AbortRunRequest
	4,  // 49: flyteidl2.workflow.RunService.GetRunDetails:input_type -> flyteidl2.workflow.GetRunDetailsRequest
	6,  // 50: flyteidl2.workflow.RunService.WatchRunDetails:input_type -> flyteidl2.workflow.WatchRunDetailsRequest
	8,  // 51: flyteidl2.workflow.RunService.GetActionDetails:input_type -> flyteidl2.workflow.GetActionDetailsRequest
	10, // 52: flyteidl2.workflow.RunService.WatchActionDetails:input_type -> flyteidl2.workflow.WatchActionDetailsRequest
	12, // 53: flyteidl2.workflow.RunService.GetActionData:input_type -> flyteidl2.workflow.GetActionDataRequest
	14, // 54: flyteidl2.workflow.RunService.ListRuns:input_type -> flyteidl2.workflow.ListRunsRequest
	16, // 55: flyteidl2.workflow.RunService.WatchRuns:input_type -> flyteidl2.workflow.WatchRunsRequest
	18, // 56: flyteidl2.workflow.RunService.ListActions:input_type -> flyteidl2.workflow.ListActionsRequest
	20, // 57: flyteidl2.workflow.RunService.WatchActions:input_type -> flyteidl2.workflow.WatchActionsRequest
	22, // 58: flyteidl2.workflow.RunService.WatchClusterEvents:input_type -> flyteidl2.workflow.WatchClusterEventsRequest
	24, // 59: flyteidl2.workflow.RunService.AbortAction:input_type -> flyteidl2.workflow.AbortActionRequest
	26, // 60: flyteidl2.workflow.RunService.WatchGroups:input_type -> flyteidl2.workflow.WatchGroupsRequest
	1,  // 61: flyteidl2.workflow.RunService.CreateRun:output_type -> flyteidl2.workflow.CreateRunResponse
	3,  // 62: flyteidl2.workflow.RunService.AbortRun:output_type -> flyteidl2.workflow.AbortRunResponse
	5,  // 63: flyteidl2.workflow.RunService.GetRunDetails:output_type -> flyteidl2.workflow.GetRunDetailsResponse
	7,  // 64: flyteidl2.workflow.RunService.WatchRunDetails:output_type -> flyteidl2.workflow.WatchRunDetailsResponse
	9,  // 65: flyteidl2.workflow.RunService.GetActionDetails:output_type -> flyteidl2.workflow.GetActionDetailsResponse
	11, // 66: flyteidl2.workflow.RunService.WatchActionDetails:output_type -> flyteidl2.workflow.WatchActionDetailsResponse
	13, // 67: flyteidl2.workflow.RunService.GetActionData:output_type -> flyteidl2.workflow.GetActionDataResponse
	15, // 68: flyteidl2.workflow.RunService.ListRuns:output_type -> flyteidl2.workflow.ListRunsResponse
	17, // 69: flyteidl2.workflow.RunService.WatchRuns:output_type -> flyteidl2.workflow.WatchRunsResponse
	19, // 70: flyteidl2.workflow.RunService.ListActions:output_type -> flyteidl2.workflow.ListActionsResponse
	21, // 71: flyteidl2.workflow.RunService.WatchActions:output_type -> flyteidl2.workflow.WatchActionsResponse
	23, // 72: flyteidl2.workflow.RunService.WatchClusterEvents:output_type -> flyteidl2.workflow.WatchClusterEventsResponse
	25, // 73: flyteidl2.workflow.RunService.AbortAction:output_type -> flyteidl2.workflow.AbortActionResponse
	27, // 74: flyteidl2.workflow.RunService.WatchGroups:output_type -> flyteidl2.workflow.WatchGroupsResponse
