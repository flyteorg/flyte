...
// Validate checks the field values on AutoscalerOptions with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *AutoscalerOptions) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AutoscalerOptions with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AutoscalerOptionsMultiError, or nil if none found.
func (m *AutoscalerOptions) ValidateAll() error {
	return m.validate(true)
}

func (m *AutoscalerOptions) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for UpscalingMode

	// no validation rules for IdleTimeoutSeconds
	...
	for idx, item := range m.GetEnv() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, AutoscalerOptionsValidationError{
			...
			if err := v.Validate(); err != nil {
				return AutoscalerOptionsValidationError{
					field:  fmt.Sprintf("Env[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return AutoscalerOptionsMultiError(errors)
	}

	return nil
}

// AutoscalerOptionsMultiError is an error wrapping multiple validation errors
// returned by AutoscalerOptions.ValidateAll() if the designated constraints
// aren't met.
type AutoscalerOptionsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AutoscalerOptionsMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AutoscalerOptionsMultiError) AllErrors() []error { return m }

// AutoscalerOptionsValidationError is the validation error returned by
// AutoscalerOptions.Validate if the designated constraints aren't met.
type AutoscalerOptionsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AutoscalerOptionsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AutoscalerOptionsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AutoscalerOptionsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AutoscalerOptionsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AutoscalerOptionsValidationError) ErrorName() string {
	return "AutoscalerOptionsValidationError"
}

// Error satisfies the builtin error interface
func (e AutoscalerOptionsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAutoscalerOptions.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AutoscalerOptionsValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AutoscalerOptionsValidationError{}
...
func (m *RayCluster) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetAutoscalerOptions()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, RayClusterValidationError{
					field:  "AutoscalerOptions",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetAutoscalerOptions()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return RayClusterValidationError{
				field:  "AutoscalerOptions",
				reason: "embedded message failed validation",
