...
var file_flyteidl2_task_task_service_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8a, 0x01, 0x0a, 0x11, 0x44, 0x65, 0x70, 0x6c, 0x6f,
	...
	0x70, 0x65, 0x63, 0x22, 0x14, 0x0a, 0x12, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x54, 0x61, 0x73,
	...
	0x61, 0x69, 0x6c, 0x73, 0x22, 0xdb, 0x02, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x61, 0x73,
	...
	0x4c, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20,
...
var file_flyteidl2_task_task_service_proto_goTypes = []interface{}{
	...
	(*Task)(nil),                         // 12: flyteidl2.task.Task
}
var file_flyteidl2_task_task_service_proto_depIdxs = []int32{
	...
	7,  // 2: flyteidl2.task.GetTaskDetailsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	9,  // 3: flyteidl2.task.GetTaskDetailsResponse.details:type_name -> flyteidl2.task.TaskDetails
	10, // 4: flyteidl2.task.ListTasksRequest.request:type_name -> flyteidl2.common.ListRequest
	11, // 5: flyteidl2.task.ListTasksRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	6,  // 6: flyteidl2.task.ListTasksRequest.known_filters:type_name -> flyteidl2.task.ListTasksRequest.KnownFilter
	12, // 7: flyteidl2.task.ListTasksResponse.tasks:type_name -> flyteidl2.task.Task
	0,  // 8: flyteidl2.task.TaskService.DeployTask:input_type -> flyteidl2.task.DeployTaskRequest
	2,  // 9: flyteidl2.task.TaskService.GetTaskDetails:input_type -> flyteidl2.task.GetTaskDetailsRequest
	4,  // 10: flyteidl2.task.TaskService.ListTasks:input_type -> flyteidl2.task.ListTasksRequest
	1,  // 11: flyteidl2.task.TaskService.DeployTask:output_type -> flyteidl2.task.DeployTaskResponse
	3,  // 12: flyteidl2.task.TaskService.GetTaskDetails:output_type -> flyteidl2.task.GetTaskDetailsResponse
	5,  // 13: flyteidl2.task.TaskService.ListTasks:output_type -> flyteidl2.task.ListTasksResponse
