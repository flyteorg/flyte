...
var file_flyteidl2_task_task_service_proto_rawDesc = []byte{
	...
	0x0d, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x65, 0x64, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xa1,
...
var file_flyteidl2_task_task_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_flyteidl2_task_task_service_proto_goTypes = []interface{}{
	...
	(*ListTasksResponse_ListTasksMetadata)(nil), // 7: flyteidl2.task.ListTasksResponse.ListTasksMetadata
	(*TaskIdentifier)(nil),                      // 8: flyteidl2.task.TaskIdentifier
	(*TaskSpec)(nil),                            // 9: flyteidl2.task.TaskSpec
	(*TaskTrigger)(nil),                         // 10: flyteidl2.task.TaskTrigger
	(*TaskDetails)(nil),                         // 11: flyteidl2.task.TaskDetails
	(*common.ListRequest)(nil),                  // 12: flyteidl2.common.ListRequest
	(*common.ProjectIdentifier)(nil),            // 13: flyteidl2.common.ProjectIdentifier
	(*Task)(nil),                                // 14: flyteidl2.task.Task
}
var file_flyteidl2_task_task_service_proto_depIdxs = []int32{
	8,  // 0: flyteidl2.task.DeployTaskRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	9,  // 1: flyteidl2.task.DeployTaskRequest.spec:type_name -> flyteidl2.task.TaskSpec
	10, // 2: flyteidl2.task.DeployTaskRequest.triggers:type_name -> flyteidl2.task.TaskTrigger
	8,  // 3: flyteidl2.task.GetTaskDetailsRequest.task_id:type_name -> flyteidl2.task.TaskIdentifier
	11, // 4: flyteidl2.task.GetTaskDetailsResponse.details:type_name -> flyteidl2.task.TaskDetails
	12, // 5: flyteidl2.task.ListTasksRequest.request:type_name -> flyteidl2.common.ListRequest
	13, // 6: flyteidl2.task.ListTasksRequest.project_id:type_name -> flyteidl2.common.ProjectIdentifier
	6,  // 7: flyteidl2.task.ListTasksRequest.known_filters:type_name -> flyteidl2.task.ListTasksRequest.KnownFilter
	14, // 8: flyteidl2.task.ListTasksResponse.tasks:type_name -> flyteidl2.task.Task
	7,  // 9: flyteidl2.task.ListTasksResponse.metadata:type_name -> flyteidl2.task.ListTasksResponse.ListTasksMetadata
	0,  // 10: flyteidl2.task.TaskService.DeployTask:input_type -> flyteidl2.task.DeployTaskRequest
	2,  // 11: flyteidl2.task.TaskService.GetTaskDetails:input_type -> flyteidl2.task.GetTaskDetailsRequest
	4,  // 12: flyteidl2.task.TaskService.ListTasks:input_type -> flyteidl2.task.ListTasksRequest
	1,  // 13: flyteidl2.task.TaskService.DeployTask:output_type -> flyteidl2.task.DeployTaskResponse
	3,  // 14: flyteidl2.task.TaskService.GetTaskDetails:output_type -> flyteidl2.task.GetTaskDetailsResponse
	5,  // 15: flyteidl2.task.TaskService.ListTasks:output_type -> flyteidl2.task.ListTasksResponse
