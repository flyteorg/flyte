...
var file_flyteidl2_task_task_definition_proto_rawDesc = []byte{
	...
	0x8d, 0x01, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x41, 0x0a, 0x07, 0x74, 0x61, 0x73, 0x6b,
	...
	0x02, 0x10, 0x01, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x64, 0x12, 0x42, 0x0a, 0x08, 0x6d,
	...
	0x85, 0x02, 0x0a, 0x08, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x70, 0x65, 0x63, 0x12, 0x4b, 0x0a, 0x0d,
	...
	0x65, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x0c, 0x74, 0x61, 0x73,
	...
	0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x18, 0x3f, 0x52, 0x09, 0x73,
	...
	0x63, 0x65, 0x22, 0xcc, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x44, 0x65, 0x74, 0x61, 0x69,
	0x6c, 0x73, 0x12, 0x41, 0x0a, 0x07, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x61, 0x73, 0x6b, 0x49, 0x64, 0x12, 0x42, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	...
	0x63, 0x42, 0xb8, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69,
...
var file_flyteidl2_task_task_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_flyteidl2_task_task_definition_proto_goTypes = []interface{}{
	...
	(*TaskMetadata)(nil),            // 2: flyteidl2.task.TaskMetadata
	(*Task)(nil),                    // 3: flyteidl2.task.Task
	(*TaskSpec)(nil),                // 4: flyteidl2.task.TaskSpec
	(*TraceSpec)(nil),               // 5: flyteidl2.task.TraceSpec
	(*TaskDetails)(nil),             // 6: flyteidl2.task.TaskDetails
	...
	(*NamedParameter)(nil),          // 10: flyteidl2.task.NamedParameter
	(*Environment)(nil),             // 11: flyteidl2.task.Environment
	(*core.TypedInterface)(nil),     // 12: flyteidl2.core.TypedInterface
}
var file_flyteidl2_task_task_definition_proto_depIdxs = []int32{
	7,  // 0: flyteidl2.task.TaskMetadata.deployed_by:type_name -> flyteidl2.common.EnrichedIdentity
	8,  // 1: flyteidl2.task.TaskMetadata.deployed_at:type_name -> google.protobuf.Timestamp
	1,  // 2: flyteidl2.task.Task.task_id:type_name -> flyteidl2.task.TaskIdentifier
	2,  // 3: flyteidl2.task.Task.metadata:type_name -> flyteidl2.task.TaskMetadata
	9,  // 4: flyteidl2.task.TaskSpec.task_template:type_name -> flyteidl2.core.TaskTemplate
	10, // 5: flyteidl2.task.TaskSpec.default_inputs:type_name -> flyteidl2.task.NamedParameter
	11, // 6: flyteidl2.task.TaskSpec.environment:type_name -> flyteidl2.task.Environment
	12, // 7: flyteidl2.task.TraceSpec.interface:type_name -> flyteidl2.core.TypedInterface
	1,  // 8: flyteidl2.task.TaskDetails.task_id:type_name -> flyteidl2.task.TaskIdentifier
	2,  // 9: flyteidl2.task.TaskDetails.metadata:type_name -> flyteidl2.task.TaskMetadata
	4,  // 10: flyteidl2.task.TaskDetails.spec:type_name -> flyteidl2.task.TaskSpec
