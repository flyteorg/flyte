...
type SourceCode struct {
	...
	IsGitTreeClean bool `protobuf:"varint,4,opt,name=is_git_tree_clean,json=isGitTreeClean,proto3" json:"is_git_tree_clean,omitempty"`
...
func (x *SourceCode) GetRemoteUrl() string {
	if x != nil {
		return x.RemoteUrl
	}
	return ""
...
func (x *SourceCode) GetFilePath() string {
	if x != nil {
		return x.FilePath
	}
	return ""
...
func (x *SourceCode) GetLineNumber() int32 {
	if x != nil {
		return x.LineNumber
	}
	return 0
...
func (x *SourceCode) GetIsGitTreeClean() bool {
	if x != nil {
		return x.IsGitTreeClean
	}
	return false
}

func (x *SourceCode) GetCommitSha() string {
	if x != nil {
		return x.CommitSha
	}
	return ""
