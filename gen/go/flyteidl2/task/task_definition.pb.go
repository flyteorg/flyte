...
func (x *LatestRunSummary) GetRunId() string {
	if x != nil {
		return x.RunId
	}
	return ""
...
func (x *LatestRunSummary) GetPhase() string {
	if x != nil {
		return x.Phase
	}
	return ""
...
type Task struct {
	...
	LatestRun *LatestRunSummary `protobuf:"bytes,3,opt,name=latest_run,json=latestRun,proto3,oneof" json:"latest_run,omitempty"`
}
...
func (x *Task) GetLatestRun() *LatestRunSummary {
	if x != nil {
		return x.LatestRun
	}
	return nil
...
var file_flyteidl2_task_task_definition_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x22, 0x9c, 0x01, 0x0a,
	...
	0x09, 0x52, 0x05, 0x72, 0x75, 0x6e, 0x49, 0x64, 0x12, 0x35, 0x0a, 0x08, 0x72, 0x75, 0x6e, 0x5f,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xde, 0x01, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x3f,
	...
	0x61, 0x12, 0x44, 0x0a, 0x0a, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x72, 0x75, 0x6e, 0x18,
	...
	0x73, 0x74, 0x5f, 0x72, 0x75, 0x6e, 0x22, 0x20, 0x0a, 0x0a, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
...
var file_flyteidl2_task_task_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_flyteidl2_task_task_definition_proto_goTypes = []interface{}{
	...
	(*Task)(nil),                               // 5: flyteidl2.task.Task
	(*SourceCode)(nil),                         // 6: flyteidl2.task.SourceCode
	(*DocumentationEntity)(nil),                // 7: flyteidl2.task.DocumentationEntity
	(*TaskSpec)(nil),                           // 8: flyteidl2.task.TaskSpec
	(*TraceSpec)(nil),                          // 9: flyteidl2.task.TraceSpec
	(*TaskDetails)(nil),                        // 10: flyteidl2.task.TaskDetails
	(*TaskTrigger)(nil),                        // 11: flyteidl2.task.TaskTrigger
	(*TaskTriggerSpec)(nil),                    // 12: flyteidl2.task.TaskTriggerSpec
	(*TaskTriggersSummary_TriggerDetails)(nil), // 13: flyteidl2.task.TaskTriggersSummary.TriggerDetails
	(*TaskTriggersSummary_TriggerStats)(nil),   // 14: flyteidl2.task.TaskTriggersSummary.TriggerStats
	(*timestamppb.Timestamp)(nil),              // 15: google.protobuf.Timestamp
	(*common.EnrichedIdentity)(nil),            // 16: flyteidl2.common.EnrichedIdentity
	(*core.TaskTemplate)(nil),                  // 17: flyteidl2.core.TaskTemplate
	(*NamedParameter)(nil),                     // 18: flyteidl2.task.NamedParameter
	(*Environment)(nil),                        // 19: flyteidl2.task.Environment
	(*core.TypedInterface)(nil),                // 20: flyteidl2.core.TypedInterface
	(*TriggerAutomationSpec)(nil),              // 21: flyteidl2.task.TriggerAutomationSpec
	(*Inputs)(nil),                             // 22: flyteidl2.task.Inputs
	(*RunSpec)(nil),                            // 23: flyteidl2.task.RunSpec
}
var file_flyteidl2_task_task_definition_proto_depIdxs = []int32{
	13, // 0: flyteidl2.task.TaskTriggersSummary.details:type_name -> flyteidl2.task.TaskTriggersSummary.TriggerDetails
	14, // 1: flyteidl2.task.TaskTriggersSummary.stats:type_name -> flyteidl2.task.TaskTriggersSummary.TriggerStats
	15, // 2: flyteidl2.task.LatestRunSummary.run_time:type_name -> google.protobuf.Timestamp
	16, // 3: flyteidl2.task.TaskMetadata.deployed_by:type_name -> flyteidl2.common.EnrichedIdentity
	15, // 4: flyteidl2.task.TaskMetadata.deployed_at:type_name -> google.protobuf.Timestamp
	2,  // 5: flyteidl2.task.TaskMetadata.triggers_summary:type_name -> flyteidl2.task.TaskTriggersSummary
	1,  // 6: flyteidl2.task.Task.task_id:type_name -> flyteidl2.task.TaskIdentifier
	4,  // 7: flyteidl2.task.Task.metadata:type_name -> flyteidl2.task.TaskMetadata
	3,  // 8: flyteidl2.task.Task.latest_run:type_name -> flyteidl2.task.LatestRunSummary
	6,  // 9: flyteidl2.task.DocumentationEntity.source_code:type_name -> flyteidl2.task.SourceCode
	17, // 10: flyteidl2.task.TaskSpec.task_template:type_name -> flyteidl2.core.TaskTemplate
	18, // 11: flyteidl2.task.TaskSpec.default_inputs:type_name -> flyteidl2.task.NamedParameter
	19, // 12: flyteidl2.task.TaskSpec.environment:type_name -> flyteidl2.task.Environment
	7,  // 13: flyteidl2.task.TaskSpec.documentation:type_name -> flyteidl2.task.DocumentationEntity
	20, // 14: flyteidl2.task.TraceSpec.interface:type_name -> flyteidl2.core.TypedInterface
	1,  // 15: flyteidl2.task.TaskDetails.task_id:type_name -> flyteidl2.task.TaskIdentifier
	4,  // 16: flyteidl2.task.TaskDetails.metadata:type_name -> flyteidl2.task.TaskMetadata
	8,  // 17: flyteidl2.task.TaskDetails.spec:type_name -> flyteidl2.task.TaskSpec
	12, // 18: flyteidl2.task.TaskTrigger.spec:type_name -> flyteidl2.task.TaskTriggerSpec
	21, // 19: flyteidl2.task.TaskTrigger.automation_spec:type_name -> flyteidl2.task.TriggerAutomationSpec
	22, // 20: flyteidl2.task.TaskTriggerSpec.inputs:type_name -> flyteidl2.task.Inputs
	23, // 21: flyteidl2.task.TaskTriggerSpec.run_spec:type_name -> flyteidl2.task.RunSpec
	21, // 22: flyteidl2.task.TaskTriggersSummary.TriggerDetails.automation_spec:type_name -> flyteidl2.task.TriggerAutomationSpec
