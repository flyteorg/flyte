...
var file_flyteidl2_task_run_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	...
	0x6c, 0x75, 0x65, 0x73, 0x22, 0xa7, 0x02, 0x0a, 0x07, 0x52, 0x75, 0x6e, 0x53, 0x70, 0x65, 0x63,
	...
	0x74, 0x65, 0x72, 0x72, 0x75, 0x70, 0x74, 0x69, 0x62, 0x6c, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x6f,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x42, 0xad,
...
var file_flyteidl2_task_run_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_flyteidl2_task_run_proto_goTypes = []interface{}{
	...
	(*RunSpec)(nil),              // 3: flyteidl2.task.RunSpec
	nil,                          // 4: flyteidl2.task.Labels.ValuesEntry
	nil,                          // 5: flyteidl2.task.Annotations.ValuesEntry
	(*core.KeyValuePair)(nil),    // 6: flyteidl2.core.KeyValuePair
	(*wrapperspb.BoolValue)(nil), // 7: google.protobuf.BoolValue
}
var file_flyteidl2_task_run_proto_depIdxs = []int32{
	4, // 0: flyteidl2.task.Labels.values:type_name -> flyteidl2.task.Labels.ValuesEntry
	5, // 1: flyteidl2.task.Annotations.values:type_name -> flyteidl2.task.Annotations.ValuesEntry
	6, // 2: flyteidl2.task.Envs.values:type_name -> flyteidl2.core.KeyValuePair
	...
	7, // 6: flyteidl2.task.RunSpec.interruptible:type_name -> google.protobuf.BoolValue
