...
type TaskResourceDefaults struct {
	...
	// device it runs on.
	DefaultAccelerator *core.GPUAccelerator `protobuf:"bytes,3,opt,name=default_accelerator,json=defaultAccelerator,proto3" json:"default_accelerator,omitempty"`
}
...
func (x *TaskResourceDefaults) GetDefaultAccelerator() *core.GPUAccelerator {
	if x != nil {
		return x.DefaultAccelerator
	}
	return nil
}
...
var file_flyteidl2_task_run_proto_rawDesc = []byte{
	...
	0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x22, 0xe7, 0x01, 0x0a, 0x14, 0x54, 0x61, 0x73,
	...
	0x78, 0x12, 0x4f, 0x0a, 0x13, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x61, 0x63, 0x63,
	0x65, 0x6c, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e,
	0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e,
	0x47, 0x50, 0x55, 0x41, 0x63, 0x63, 0x65, 0x6c, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x12,
	0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x41, 0x63, 0x63, 0x65, 0x6c, 0x65, 0x72, 0x61, 0x74,
	0x6f, 0x72, 0x22, 0x4c, 0x0a, 0x0e, 0x49, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x75, 0x6c, 0x65,
	...
	0x02, 0x42, 0xad, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69,
...
var file_flyteidl2_task_run_proto_depIdxs = []int32{
	...
	22, // 21: flyteidl2.task.TaskResourceDefaults.default_accelerator:type_name -> flyteidl2.core.GPUAccelerator
