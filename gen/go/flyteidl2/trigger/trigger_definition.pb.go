...
type TriggerSpec struct {
	...
	// Inline inputs for the triggered task. Set by older SDKs that do not offload inputs at
	// registration. Mutually exclusive with offloaded_input_data.
	...
	// Offloaded inputs for the triggered task. Set when the SDK offloads inputs via UploadInputs at
	// registration time (SDK >= 2.3.6) and passes the resulting URI here instead of inline inputs.
	// Mutually exclusive with `inputs`. When present, launches pass this directly as the run's
	// OffloadedInputData and rely on run_start_time rather than merging a kickoff-time input literal.
	OffloadedInputData *common.OffloadedInputData `protobuf:"bytes,7,opt,name=offloaded_input_data,json=offloadedInputData,proto3" json:"offloaded_input_data,omitempty"`
}
...
var file_flyteidl2_trigger_trigger_definition_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa9, 0x01, 0x0a, 0x0f, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72,
	...
	0x79, 0x65, 0x64, 0x42, 0x79, 0x12, 0x49, 0x0a, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64,
	0x5f, 0x62, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x66, 0x6c, 0x79, 0x74,
	...
	0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x42, 0x79,
	0x22, 0xb7, 0x02, 0x0a, 0x0b, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63,
	...
	,
	...
	0x44, 0x61, 0x74, 0x61, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x22, 0x91, 0x02, 0x0a, 0x0d, 0x54,
	0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x43, 0x0a, 0x0b,
	0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x65, 0x64, 0x41, 0x74, 0x12, 0x3d, 0x0a, 0x0c, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x65,
	...
	0x02, 0x0a, 0x0f, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x52, 0x65, 0x76, 0x69, 0x73, 0x69,
	0x6f, 0x6e, 0x12, 0x33, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23,
	0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66,
	0x69, 0x65, 0x72, 0x52, 0x02, 0x69, 0x64, 0x12, 0x3e, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x66, 0x6c, 0x79, 0x74,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x38, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	...
	0x73, 0x12, 0x40, 0x0a, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x28, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x2e, 0x74, 0x72,
	0x69, 0x67, 0x67, 0x65, 0x72, 0x2e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x52, 0x65, 0x76,
	0x69, 0x73, 0x69, 0x6f, 0x6e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x61, 0x63, 0x74,
	...
	0x03, 0x0a, 0x0e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c,
	...
	0x65, 0x72, 0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x02, 0x69, 0x64, 0x12, 0x3e,
	...
	0x67, 0x67, 0x65, 0x72, 0x2e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x3a,
	0x0a, 0x04, 0x73, 0x70, 0x65, 0x63, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x66,
	...
	0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x66, 0x6c, 0x79,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x4e, 0x0a, 0x0f, 0x61, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e,
	...
	,
	...
	0x67, 0x67, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x08, 0x6d, 0x65,
	...
	,
	...
	0x67, 0x6f, 0x2f, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x2f, 0x74, 0x72, 0x69,
	0x67, 0x67, 0x65, 0x72, 0xa2, 0x02, 0x03, 0x46, 0x54, 0x58, 0xaa, 0x02, 0x11, 0x46, 0x6c, 0x79,
	0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x2e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0xca, 0x02,
	0x11, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x5c, 0x54, 0x72, 0x69, 0x67, 0x67,
	0x65, 0x72, 0xe2, 0x02, 0x1d, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x5c, 0x54,
	0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0xea, 0x02, 0x12, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x3a, 0x3a,
	0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_flyteidl2_trigger_trigger_definition_proto_goTypes = []interface{}{
	...
	(*common.TriggerIdentifier)(nil),   // 12: flyteidl2.common.TriggerIdentifier
	(*task.TriggerAutomationSpec)(nil), // 13: flyteidl2.task.TriggerAutomationSpec
}
var file_flyteidl2_trigger_trigger_definition_proto_depIdxs = []int32{
	...
	10, // 4: flyteidl2.trigger.TriggerSpec.offloaded_input_data:type_name -> flyteidl2.common.OffloadedInputData
	11, // 5: flyteidl2.trigger.TriggerStatus.deployed_at:type_name -> google.protobuf.Timestamp
	11, // 6: flyteidl2.trigger.TriggerStatus.updated_at:type_name -> google.protobuf.Timestamp
	11, // 7: flyteidl2.trigger.TriggerStatus.triggered_at:type_name -> google.protobuf.Timestamp
	11, // 8: flyteidl2.trigger.TriggerStatus.deleted_at:type_name -> google.protobuf.Timestamp
	12, // 9: flyteidl2.trigger.TriggerRevision.id:type_name -> flyteidl2.common.TriggerIdentifier
	1,  // 10: flyteidl2.trigger.TriggerRevision.metadata:type_name -> flyteidl2.trigger.TriggerMetadata
	3,  // 11: flyteidl2.trigger.TriggerRevision.status:type_name -> flyteidl2.trigger.TriggerStatus
	0,  // 12: flyteidl2.trigger.TriggerRevision.action:type_name -> flyteidl2.trigger.TriggerRevisionAction
	11, // 13: flyteidl2.trigger.TriggerRevision.created_at:type_name -> google.protobuf.Timestamp
	12, // 14: flyteidl2.trigger.TriggerDetails.id:type_name -> flyteidl2.common.TriggerIdentifier
	1,  // 15: flyteidl2.trigger.TriggerDetails.metadata:type_name -> flyteidl2.trigger.TriggerMetadata
	2,  // 16: flyteidl2.trigger.TriggerDetails.spec:type_name -> flyteidl2.trigger.TriggerSpec
	3,  // 17: flyteidl2.trigger.TriggerDetails.status:type_name -> flyteidl2.trigger.TriggerStatus
	13, // 18: flyteidl2.trigger.TriggerDetails.automation_spec:type_name -> flyteidl2.task.TriggerAutomationSpec
	12, // 19: flyteidl2.trigger.Trigger.id:type_name -> flyteidl2.common.TriggerIdentifier
	1,  // 20: flyteidl2.trigger.Trigger.metadata:type_name -> flyteidl2.trigger.TriggerMetadata
	3,  // 21: flyteidl2.trigger.Trigger.status:type_name -> flyteidl2.trigger.TriggerStatus
	13, // 22: flyteidl2.trigger.Trigger.automation_spec:type_name -> flyteidl2.task.TriggerAutomationSpec
