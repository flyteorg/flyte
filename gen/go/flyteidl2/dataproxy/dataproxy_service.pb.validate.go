...
// Validate checks the field values on UploadMetadataRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UploadMetadataRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UploadMetadataRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UploadMetadataRequestMultiError, or nil if none found.
func (m *UploadMetadataRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UploadMetadataRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, UploadMetadataRequestValidationError{
					field:  "ExpiresIn",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return UploadMetadataRequestValidationError{
				field:  "ExpiresIn",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	case *UploadMetadataRequest_ActionId:
		if v == nil {
			err := UploadMetadataRequestValidationError{
				field:  "Target",
				reason: "oneof value cannot be a typed-nil",
			}
			if !all {
	...
	case *UploadMetadataRequest_ActionAttemptId:
		if v == nil {
			err := UploadMetadataRequestValidationError{
				field:  "Target",
				reason: "oneof value cannot be a typed-nil",
	...
	if len(errors) > 0 {
		return UploadMetadataRequestMultiError(errors)
	}

	return nil
}

// UploadMetadataRequestMultiError is an error wrapping multiple validation
// errors returned by UploadMetadataRequest.ValidateAll() if the designated
// constraints aren't met.
type UploadMetadataRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UploadMetadataRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UploadMetadataRequestMultiError) AllErrors() []error { return m }

// UploadMetadataRequestValidationError is the validation error returned by
// UploadMetadataRequest.Validate if the designated constraints aren't met.
type UploadMetadataRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UploadMetadataRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UploadMetadataRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UploadMetadataRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UploadMetadataRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UploadMetadataRequestValidationError) ErrorName() string {
	return "UploadMetadataRequestValidationError"
}

// Error satisfies the builtin error interface
func (e UploadMetadataRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUploadMetadataRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UploadMetadataRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UploadMetadataRequestValidationError{}

// Validate checks the field values on CreateLocalDownloadLinkRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CreateLocalDownloadLinkRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CreateLocalDownloadLinkRequest with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// CreateLocalDownloadLinkRequestMultiError, or nil if none found.
func (m *CreateLocalDownloadLinkRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateLocalDownloadLinkRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CreateLocalDownloadLinkRequestValidationError{
					field:  "ActionAttemptId",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return CreateLocalDownloadLinkRequestValidationError{
				field:  "ActionAttemptId",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return CreateLocalDownloadLinkRequestMultiError(errors)
	}

	return nil
}

// CreateLocalDownloadLinkRequestMultiError is an error wrapping multiple
// validation errors returned by CreateLocalDownloadLinkRequest.ValidateAll()
// if the designated constraints aren't met.
type CreateLocalDownloadLinkRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateLocalDownloadLinkRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CreateLocalDownloadLinkRequestMultiError) AllErrors() []error { return m }

// CreateLocalDownloadLinkRequestValidationError is the validation error
// returned by CreateLocalDownloadLinkRequest.Validate if the designated
// constraints aren't met.
type CreateLocalDownloadLinkRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CreateLocalDownloadLinkRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateLocalDownloadLinkRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateLocalDownloadLinkRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateLocalDownloadLinkRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateLocalDownloadLinkRequestValidationError) ErrorName() string {
	return "CreateLocalDownloadLinkRequestValidationError"
}

// Error satisfies the builtin error interface
func (e CreateLocalDownloadLinkRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCreateLocalDownloadLinkRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateLocalDownloadLinkRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateLocalDownloadLinkRequestValidationError{}
