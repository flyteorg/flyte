...
import (
	...
	v2 "github.com/flyteorg/flyte/v2/gen/go/flyteidl2/cacheservice/v2"
	http "net/http"
	strings "strings"
)
...
var (
	cacheServiceServiceDescriptor                      = v2.File_flyteidl2_cacheservice_v2_cacheservice_proto.Services().ByName("CacheService")
...
type CacheServiceClient interface {
	...
	Put(context.Context, *connect.Request[v2.PutCacheRequest]) (*connect.Response[cacheservice.PutCacheResponse], error)
	// Deletes cached data by key.
	Delete(context.Context, *connect.Request[v2.DeleteCacheRequest]) (*connect.Response[cacheservice.DeleteCacheResponse], error)
	// Get or extend a reservation for a cache key
	GetOrExtendReservation(context.Context, *connect.Request[v2.GetOrExtendReservationRequest]) (*connect.Response[cacheservice.GetOrExtendReservationResponse], error)
...
func NewCacheServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CacheServiceClient {
	...
	return &cacheServiceClient{
		get: connect.NewClient[v2.GetCacheRequest, cacheservice.GetCacheResponse](
			httpClient,
			baseURL+CacheServiceGetProcedure,
			connect.WithSchema(cacheServiceGetMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		put: connect.NewClient[v2.PutCacheRequest, cacheservice.PutCacheResponse](
			httpClient,
			baseURL+CacheServicePutProcedure,
			connect.WithSchema(cacheServicePutMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		delete: connect.NewClient[v2.DeleteCacheRequest, cacheservice.DeleteCacheResponse](
			httpClient,
			baseURL+CacheServiceDeleteProcedure,
			connect.WithSchema(cacheServiceDeleteMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		getOrExtendReservation: connect.NewClient[v2.GetOrExtendReservationRequest, cacheservice.GetOrExtendReservationResponse](
			httpClient,
			baseURL+CacheServiceGetOrExtendReservationProcedure,
			connect.WithSchema(cacheServiceGetOrExtendReservationMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		releaseReservation: connect.NewClient[v2.ReleaseReservationRequest, cacheservice.ReleaseReservationResponse](
			httpClient,
...
type cacheServiceClient struct {
	get                    *connect.Client[v2.GetCacheRequest, cacheservice.GetCacheResponse]
	put                    *connect.Client[v2.PutCacheRequest, cacheservice.PutCacheResponse]
	delete                 *connect.Client[v2.DeleteCacheRequest, cacheservice.DeleteCacheResponse]
	getOrExtendReservation *connect.Client[v2.GetOrExtendReservationRequest, cacheservice.GetOrExtendReservationResponse]
