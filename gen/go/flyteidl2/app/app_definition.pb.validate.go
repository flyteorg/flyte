...
// Validate checks the field values on FailureInfo with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *FailureInfo) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on FailureInfo with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in FailureInfoMultiError, or
// nil if none found.
func (m *FailureInfo) ValidateAll() error {
	return m.validate(true)
}

func (m *FailureInfo) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for FailureMode

	// no validation rules for Summary

	// no validation rules for Image

	// no validation rules for ImagePullError
	...
	if len(errors) > 0 {
		return FailureInfoMultiError(errors)
	}

	return nil
}

// FailureInfoMultiError is an error wrapping multiple validation errors
// returned by FailureInfo.ValidateAll() if the designated constraints aren't met.
type FailureInfoMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m FailureInfoMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m FailureInfoMultiError) AllErrors() []error { return m }

// FailureInfoValidationError is the validation error returned by
// FailureInfo.Validate if the designated constraints aren't met.
type FailureInfoValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e FailureInfoValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e FailureInfoValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e FailureInfoValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e FailureInfoValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e FailureInfoValidationError) ErrorName() string { return "FailureInfoValidationError" }

// Error satisfies the builtin error interface
func (e FailureInfoValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = FailureInfoValidationError{}
