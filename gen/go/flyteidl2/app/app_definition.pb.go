...
type FailureInfo_Action int32

const (
	FailureInfo_NONE         FailureInfo_Action = 0
	FailureInfo_REDEPLOY     FailureInfo_Action = 1
	FailureInfo_OPEN_SECRETS FailureInfo_Action = 2
)

// Enum value maps for FailureInfo_Action.
var (
	FailureInfo_Action_name = map[int32]string{
		0: "NONE",
		1: "REDEPLOY",
		2: "OPEN_SECRETS",
	}
	FailureInfo_Action_value = map[string]int32{
		"NONE":         0,
		"REDEPLOY":     1,
		"OPEN_SECRETS": 2,
	}
...
func (x FailureInfo_Action) Enum() *FailureInfo_Action {
	p := new(FailureInfo_Action)
	*p = x
	return p
}

func (x FailureInfo_Action) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FailureInfo_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl2_app_app_definition_proto_enumTypes[0].Descriptor()
}

func (FailureInfo_Action) Type() protoreflect.EnumType {
	return &file_flyteidl2_app_app_definition_proto_enumTypes[0]
}

func (x FailureInfo_Action) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FailureInfo_Action.Descriptor instead.
func (FailureInfo_Action) EnumDescriptor() ([]byte, []int) {
...
func (Status_DeploymentStatus) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl2_app_app_definition_proto_rawDescGZIP(), []int{6, 0}
}

// Finer-grained substate that qualifies a DeploymentStatus, surfaced on a Condition.
type Status_Substate int32
...
const (
	...
	Status_SECRET_MOUNT_ERROR Status_Substate = 5
	// The container is repeatedly crashing on startup.
	Status_CRASH_LOOP Status_Substate = 6
	// The container was killed for exceeding its memory limit.
	Status_OOM_KILLED Status_Substate = 7
)

// Enum value maps for Status_Substate.
var (
	Status_Substate_name = map[int32]string{
	...
	Status_Substate_value = map[string]int32{
...
func (x Status_Substate) Enum() *Status_Substate {
	p := new(Status_Substate)
	*p = x
	return p
}

func (x Status_Substate) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Status_Substate) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl2_app_app_definition_proto_enumTypes[2].Descriptor()
}

func (Status_Substate) Type() protoreflect.EnumType {
	return &file_flyteidl2_app_app_definition_proto_enumTypes[2]
}

func (x Status_Substate) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Status_Substate.Descriptor instead.
func (Status_Substate) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl2_app_app_definition_proto_rawDescGZIP(), []int{6, 1}
}
...
func (Spec_DesiredState) Descriptor() protoreflect.EnumDescriptor {
	return file_flyteidl2_app_app_definition_proto_enumTypes[3].Descriptor()
}

func (Spec_DesiredState) Type() protoreflect.EnumType {
	return &file_flyteidl2_app_app_definition_proto_enumTypes[3]
}
...
func (Spec_DesiredState) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl2_app_app_definition_proto_rawDescGZIP(), []int{9, 0}
}
...
type Meta struct {
	...
	CodeBundleUri string `protobuf:"bytes,4,opt,name=code_bundle_uri,json=codeBundleUri,proto3" json:"code_bundle_uri,omitempty"`
	// Link to the source code used to define this app.
	SourceCode *task.SourceCode `protobuf:"bytes,5,opt,name=source_code,json=sourceCode,proto3" json:"source_code,omitempty"`
}
...
func (x *Meta) GetCodeBundleUri() string {
	if x != nil {
...
func (x *Meta) GetSourceCode() *task.SourceCode {
	if x != nil {
		return x.SourceCode
	}
	return nil
...
type Condition struct {
	...
	Substate Status_Substate `protobuf:"varint,6,opt,name=substate,proto3,enum=flyteidl2.app.Status_Substate" json:"substate,omitempty"`
...
func (x *Condition) GetSubstate() Status_Substate {
	if x != nil {
		return x.Substate
	}
	return Status_SUBSTATE_UNSPECIFIED
}

func (x *Condition) GetFailureInfo() *FailureInfo {
	if x != nil {
...
type FailureInfo struct {
	...
	FailureMode Status_Substate `protobuf:"varint,1,opt,name=failure_mode,json=failureMode,proto3,enum=flyteidl2.app.Status_Substate" json:"failure_mode,omitempty"`
	// One-line banner summary.
	Summary string `protobuf:"bytes,2,opt,name=summary,proto3" json:"summary,omitempty"`
	// Image-pull failures.
	Image          string `protobuf:"bytes,3,opt,name=image,proto3" json:"image,omitempty"`
	ImagePullError string `protobuf:"bytes,4,opt,name=image_pull_error,json=imagePullError,proto3" json:"image_pull_error,omitempty"`
	...
	RecentLogLines []string           `protobuf:"bytes,11,rep,name=recent_log_lines,json=recentLogLines,proto3" json:"recent_log_lines,omitempty"`
	Action         FailureInfo_Action `protobuf:"varint,12,opt,name=action,proto3,enum=flyteidl2.app.FailureInfo_Action" json:"action,omitempty"`
}
...
func (x *FailureInfo) GetFailureMode() Status_Substate {
	if x != nil {
...
func (x *FailureInfo) GetSummary() string {
	if x != nil {
		return x.Summary
	}
	return ""
...
func (x *FailureInfo) GetImage() string {
	if x != nil {
		return x.Image
	}
	return ""
...
func (x *FailureInfo) GetImagePullError() string {
	if x != nil {
		return x.ImagePullError
	}
	return ""
}

func (x *FailureInfo) GetSecretName() string {
	if x != nil {
		return x.SecretName
	}
	return ""
...
func (x *FailureInfo) GetMountPath() string {
	if x != nil {
		return x.MountPath
	}
	return ""
...
func (x *FailureInfo) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
func (x *FailureInfo) GetRestartCount() int32 {
	if x != nil {
...
func (x *FailureInfo) GetContainerName() string {
	if x != nil {
...
func (x *FailureInfo) GetMemoryLimit() string {
	if x != nil {
...
func (x *FailureInfo) GetRecentLogLines() []string {
	if x != nil {
...
func (x *FailureInfo) GetAction() FailureInfo_Action {
	if x != nil {
		return x.Action
	}
	return FailureInfo_NONE
}
...
func (x *TimeoutConfig) Reset() {
	*x = TimeoutConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl2_app_app_definition_proto_msgTypes[25]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TimeoutConfig) Descriptor() ([]byte, []int) {
	return file_flyteidl2_app_app_definition_proto_rawDescGZIP(), []int{25}
}
...
var file_flyteidl2_app_app_definition_proto_rawDesc = []byte{
	...
	0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1e, 0x67, 0x6f,
	...
	0x0a, 0x0a, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03,
	0x6f, 0x72, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6f, 0x72, 0x67, 0x12, 0x21,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x0a, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x06,
	0x61, 0x70, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x66,
	...
	,
	...
	,
	...
	0x72, 0x6c, 0x22, 0xa9, 0x01, 0x0a, 0x0f, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x43,
	...
	,
	...
	,
	...
	0x65, 0x69, 0x64, 0x6c, 0x32, 0x2f, 0x61, 0x70, 0x70, 0xa2, 0x02, 0x03, 0x46, 0x41, 0x58, 0xaa,
	0x02, 0x0d, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x2e, 0x41, 0x70, 0x70, 0xca,
	0x02, 0x0d, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x5c, 0x41, 0x70, 0x70, 0xe2,
	0x02, 0x19, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x5c, 0x41, 0x70, 0x70, 0x5c,
	0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0e, 0x46, 0x6c,
	0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x3a, 0x3a, 0x41, 0x70, 0x70, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_flyteidl2_app_app_definition_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_flyteidl2_app_app_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_flyteidl2_app_app_definition_proto_goTypes = []interface{}{
	(FailureInfo_Action)(0),         // 0: flyteidl2.app.FailureInfo.Action
	(Status_DeploymentStatus)(0),    // 1: flyteidl2.app.Status.DeploymentStatus
	(Status_Substate)(0),            // 2: flyteidl2.app.Status.Substate
	(Spec_DesiredState)(0),          // 3: flyteidl2.app.Spec.DesiredState
	(*Identifier)(nil),              // 4: flyteidl2.app.Identifier
	(*Meta)(nil),                    // 5: flyteidl2.app.Meta
	(*AppWrapper)(nil),              // 6: flyteidl2.app.AppWrapper
	(*App)(nil),                     // 7: flyteidl2.app.App
	(*Condition)(nil),               // 8: flyteidl2.app.Condition
	(*FailureInfo)(nil),             // 9: flyteidl2.app.FailureInfo
	(*Status)(nil),                  // 10: flyteidl2.app.Status
	(*K8SMetadata)(nil),             // 11: flyteidl2.app.K8sMetadata
	(*Ingress)(nil),                 // 12: flyteidl2.app.Ingress
	(*Spec)(nil),                    // 13: flyteidl2.app.Spec
	(*Link)(nil),                    // 14: flyteidl2.app.Link
	(*Input)(nil),                   // 15: flyteidl2.app.Input
	(*MaterializedInputs)(nil),      // 16: flyteidl2.app.MaterializedInputs
	(*MaterializedInput)(nil),       // 17: flyteidl2.app.MaterializedInput
	(*InputList)(nil),               // 18: flyteidl2.app.InputList
	(*Profile)(nil),                 // 19: flyteidl2.app.Profile
	(*SecurityContext)(nil),         // 20: flyteidl2.app.SecurityContext
	(*ImageSpec)(nil),               // 21: flyteidl2.app.ImageSpec
	(*ImageSpecSet)(nil),            // 22: flyteidl2.app.ImageSpecSet
	(*IngressConfig)(nil),           // 23: flyteidl2.app.IngressConfig
	(*AutoscalingConfig)(nil),       // 24: flyteidl2.app.AutoscalingConfig
	(*ScalingMetric)(nil),           // 25: flyteidl2.app.ScalingMetric
	(*Concurrency)(nil),             // 26: flyteidl2.app.Concurrency
	(*RequestRate)(nil),             // 27: flyteidl2.app.RequestRate
	(*Replicas)(nil),                // 28: flyteidl2.app.Replicas
	(*TimeoutConfig)(nil),           // 29: flyteidl2.app.TimeoutConfig
	nil,                             // 30: flyteidl2.app.Meta.LabelsEntry
	(*task.SourceCode)(nil),         // 31: flyteidl2.task.SourceCode
	(*timestamppb.Timestamp)(nil),   // 32: google.protobuf.Timestamp
	(*common.EnrichedIdentity)(nil), // 33: flyteidl2.common.EnrichedIdentity
	(*core.Container)(nil),          // 34: flyteidl2.core.Container
	(*core.K8SPod)(nil),             // 35: flyteidl2.core.K8sPod
	(*core.ExtendedResources)(nil),  // 36: flyteidl2.core.ExtendedResources
	(*common.RuntimeMetadata)(nil),  // 37: flyteidl2.common.RuntimeMetadata
	(*core.ArtifactQuery)(nil),      // 38: flyteidl2.core.ArtifactQuery
	(*core.ArtifactID)(nil),         // 39: flyteidl2.core.ArtifactID
	(*core.Identity)(nil),           // 40: flyteidl2.core.Identity
	(*core.Secret)(nil),             // 41: flyteidl2.core.Secret
	(*durationpb.Duration)(nil),     // 42: google.protobuf.Duration
}
var file_flyteidl2_app_app_definition_proto_depIdxs = []int32{
	4,  // 0: flyteidl2.app.Meta.id:type_name -> flyteidl2.app.Identifier
	30, // 1: flyteidl2.app.Meta.labels:type_name -> flyteidl2.app.Meta.LabelsEntry
	31, // 2: flyteidl2.app.Meta.source_code:type_name -> flyteidl2.task.SourceCode
	7,  // 3: flyteidl2.app.AppWrapper.app:type_name -> flyteidl2.app.App
	4,  // 4: flyteidl2.app.AppWrapper.app_id:type_name -> flyteidl2.app.Identifier
	5,  // 5: flyteidl2.app.App.metadata:type_name -> flyteidl2.app.Meta
	13, // 6: flyteidl2.app.App.spec:type_name -> flyteidl2.app.Spec
	10, // 7: flyteidl2.app.App.status:type_name -> flyteidl2.app.Status
	32, // 8: flyteidl2.app.Condition.last_transition_time:type_name -> google.protobuf.Timestamp
	1,  // 9: flyteidl2.app.Condition.deployment_status:type_name -> flyteidl2.app.Status.DeploymentStatus
	33, // 10: flyteidl2.app.Condition.actor:type_name -> flyteidl2.common.EnrichedIdentity
	2,  // 11: flyteidl2.app.Condition.substate:type_name -> flyteidl2.app.Status.Substate
	9,  // 12: flyteidl2.app.Condition.failure_info:type_name -> flyteidl2.app.FailureInfo
	2,  // 13: flyteidl2.app.FailureInfo.failure_mode:type_name -> flyteidl2.app.Status.Substate
	0,  // 14: flyteidl2.app.FailureInfo.action:type_name -> flyteidl2.app.FailureInfo.Action
	12, // 15: flyteidl2.app.Status.ingress:type_name -> flyteidl2.app.Ingress
	32, // 16: flyteidl2.app.Status.created_at:type_name -> google.protobuf.Timestamp
	32, // 17: flyteidl2.app.Status.last_updated_at:type_name -> google.protobuf.Timestamp
	8,  // 18: flyteidl2.app.Status.conditions:type_name -> flyteidl2.app.Condition
	32, // 19: flyteidl2.app.Status.lease_expiration:type_name -> google.protobuf.Timestamp
	11, // 20: flyteidl2.app.Status.k8s_metadata:type_name -> flyteidl2.app.K8sMetadata
	16, // 21: flyteidl2.app.Status.materialized_inputs:type_name -> flyteidl2.app.MaterializedInputs
	34, // 22: flyteidl2.app.Spec.container:type_name -> flyteidl2.core.Container
	35, // 23: flyteidl2.app.Spec.pod:type_name -> flyteidl2.core.K8sPod
	24, // 24: flyteidl2.app.Spec.autoscaling:type_name -> flyteidl2.app.AutoscalingConfig
	23, // 25: flyteidl2.app.Spec.ingress:type_name -> flyteidl2.app.IngressConfig
	3,  // 26: flyteidl2.app.Spec.desired_state:type_name -> flyteidl2.app.Spec.DesiredState
	22, // 27: flyteidl2.app.Spec.images:type_name -> flyteidl2.app.ImageSpecSet
	20, // 28: flyteidl2.app.Spec.security_context:type_name -> flyteidl2.app.SecurityContext
	36, // 29: flyteidl2.app.Spec.extended_resources:type_name -> flyteidl2.core.ExtendedResources
	37, // 30: flyteidl2.app.Spec.runtime_metadata:type_name -> flyteidl2.common.RuntimeMetadata
	19, // 31: flyteidl2.app.Spec.profile:type_name -> flyteidl2.app.Profile
	33, // 32: flyteidl2.app.Spec.creator:type_name -> flyteidl2.common.EnrichedIdentity
	18, // 33: flyteidl2.app.Spec.inputs:type_name -> flyteidl2.app.InputList
	14, // 34: flyteidl2.app.Spec.links:type_name -> flyteidl2.app.Link
	29, // 35: flyteidl2.app.Spec.timeouts:type_name -> flyteidl2.app.TimeoutConfig
	38, // 36: flyteidl2.app.Input.artifact_query:type_name -> flyteidl2.core.ArtifactQuery
	39, // 37: flyteidl2.app.Input.artifact_id:type_name -> flyteidl2.core.ArtifactID
	4,  // 38: flyteidl2.app.Input.app_id:type_name -> flyteidl2.app.Identifier
	17, // 39: flyteidl2.app.MaterializedInputs.items:type_name -> flyteidl2.app.MaterializedInput
	39, // 40: flyteidl2.app.MaterializedInput.artifact_id:type_name -> flyteidl2.core.ArtifactID
	15, // 41: flyteidl2.app.InputList.items:type_name -> flyteidl2.app.Input
	40, // 42: flyteidl2.app.SecurityContext.run_as:type_name -> flyteidl2.core.Identity
	41, // 43: flyteidl2.app.SecurityContext.secrets:type_name -> flyteidl2.core.Secret
	21, // 44: flyteidl2.app.ImageSpecSet.images:type_name -> flyteidl2.app.ImageSpec
	28, // 45: flyteidl2.app.AutoscalingConfig.replicas:type_name -> flyteidl2.app.Replicas
	42, // 46: flyteidl2.app.AutoscalingConfig.scaledown_period:type_name -> google.protobuf.Duration
	25, // 47: flyteidl2.app.AutoscalingConfig.scaling_metric:type_name -> flyteidl2.app.ScalingMetric
	27, // 48: flyteidl2.app.ScalingMetric.request_rate:type_name -> flyteidl2.app.RequestRate
	26, // 49: flyteidl2.app.ScalingMetric.concurrency:type_name -> flyteidl2.app.Concurrency
	42, // 50: flyteidl2.app.TimeoutConfig.request_timeout:type_name -> google.protobuf.Duration
...
func file_flyteidl2_app_app_definition_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_flyteidl2_app_app_definition_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
	...
	file_flyteidl2_app_app_definition_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*Spec_Container)(nil),
		(*Spec_Pod)(nil),
	}
	file_flyteidl2_app_app_definition_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*Input_StringValue)(nil),
		(*Input_ArtifactQuery)(nil),
		(*Input_ArtifactId)(nil),
		(*Input_AppId)(nil),
	}
	file_flyteidl2_app_app_definition_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*MaterializedInput_ArtifactId)(nil),
	}
	file_flyteidl2_app_app_definition_proto_msgTypes[21].OneofWrappers = []interface{}{
