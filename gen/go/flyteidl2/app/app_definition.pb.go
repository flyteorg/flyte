...
type SecurityContext struct {
	...
	// List of URL path prefixes that are publicly accessible without authentication.
	// Each prefix must start with "/". Matching is path-segment-aware:
	...
	// is public and these prefixes have no additional effect.
	// Catastrophic prefix "/" makes the whole app public — equivalent to
	// allow_anonymous=true. This is intentional.
	PublicPathPrefixes []string `protobuf:"bytes,6,rep,name=public_path_prefixes,json=publicPathPrefixes,proto3" json:"public_path_prefixes,omitempty"`
}
...
func (x *SecurityContext) GetPublicPathPrefixes() []string {
	if x != nil {
		return x.PublicPathPrefixes
	}
	return nil
}
...
var file_flyteidl2_app_app_definition_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x69, 0x63, 0x6f, 0x6e, 0x55, 0x72, 0x6c, 0x22, 0xf1, 0x01,
	...
	0x6c, 0x6c, 0x6f, 0x77, 0x41, 0x6e, 0x6f, 0x6e, 0x79, 0x6d, 0x6f, 0x75, 0x73, 0x12, 0x46, 0x0a,
	0x14, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x5f, 0x70, 0x72, 0x65,
	0x66, 0x69, 0x78, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x42, 0x14, 0xba, 0x48, 0x11,
	0x92, 0x01, 0x0e, 0x10, 0x32, 0x22, 0x0a, 0x72, 0x08, 0x10, 0x01, 0x32, 0x04, 0x5e, 0x2f, 0x2e,
	0x2a, 0x52, 0x12, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x50, 0x61, 0x74, 0x68, 0x50, 0x72, 0x65,
	0x66, 0x69, 0x78, 0x65, 0x73, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x04, 0x10,
