...
type Image struct {
	...
	// Identifier of the remote build run that produced this image.
	// Unset for images that were not built by the image builder service or
	// that were built before this field was introduced.
	BuildRun *common.RunIdentifier `protobuf:"bytes,3,opt,name=build_run,json=buildRun,proto3" json:"build_run,omitempty"`
}
...
func (x *Image) GetBuildRun() *common.RunIdentifier {
	if x != nil {
		return x.BuildRun
	}
	return nil
...
type PythonWheels struct {
	...
	Options      *PipOptions    `protobuf:"bytes,2,opt,name=options,proto3" json:"options,omitempty"`
	SecretMounts []*core.Secret `protobuf:"bytes,3,rep,name=secret_mounts,json=secretMounts,proto3" json:"secret_mounts,omitempty"`
	// Name of the package to install from the wheel directory. When set, the server
	// installs with `--find-links <dir> --no-index <package_name>` so pip selects the
	// wheel matching the target platform. When empty, falls back to legacy `<dir>/*`
	// glob behavior for backward compatibility with older clients.
...
func (x *PythonWheels) GetPackageName() string {
	if x != nil {
...
type UVProject struct {
	...
	// The path to the folder containing the pyproject.toml and uvlock files.
	Pyproject string `protobuf:"bytes,1,opt,name=pyproject,proto3" json:"pyproject,omitempty"`
	// The path to the uvlock file.
...
func (x *UVProject) GetSourceDir() string {
	if x != nil {
		return x.SourceDir
	}
	return ""
...
type PoetryProject struct {
	...
	Pyproject  string `protobuf:"bytes,1,opt,name=pyproject,proto3" json:"pyproject,omitempty"`
	PoetryLock string `protobuf:"bytes,2,opt,name=poetry_lock,json=poetryLock,proto3" json:"poetry_lock,omitempty"`
	// Optional extra arguments for poetry install command
	ExtraArgs    string         `protobuf:"bytes,3,opt,name=extra_args,json=extraArgs,proto3" json:"extra_args,omitempty"`
	SecretMounts []*core.Secret `protobuf:"bytes,4,rep,name=secret_mounts,json=secretMounts,proto3" json:"secret_mounts,omitempty"`
}

func (x *PoetryProject) Reset() {
	*x = PoetryProject{}
	if protoimpl.UnsafeEnabled {
...
func (x *PoetryProject) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PoetryProject) ProtoMessage() {}

func (x *PoetryProject) ProtoReflect() protoreflect.Message {
	mi := &file_flyteidl2_imagebuilder_definition_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PoetryProject.ProtoReflect.Descriptor instead.
func (*PoetryProject) Descriptor() ([]byte, []int) {
	return file_flyteidl2_imagebuilder_definition_proto_rawDescGZIP(), []int{12}
}

func (x *PoetryProject) GetPyproject() string {
	if x != nil {
		return x.Pyproject
	}
	return ""
...
func (x *PoetryProject) GetPoetryLock() string {
	if x != nil {
		return x.PoetryLock
	}
	return ""
...
func (x *PoetryProject) GetExtraArgs() string {
	if x != nil {
		return x.ExtraArgs
	}
	return ""
...
func (x *PoetryProject) GetSecretMounts() []*core.Secret {
	if x != nil {
		return x.SecretMounts
	}
	return nil
...
func (x *Layer) GetPoetryProject() *PoetryProject {
	if x, ok := x.GetLayer().(*Layer_PoetryProject); ok {
		return x.PoetryProject
	}
	return nil
}
...
type Layer_PoetryProject struct {
	// Poetry project configuration
	PoetryProject *PoetryProject `protobuf:"bytes,10,opt,name=poetry_project,json=poetryProject,proto3,oneof"`
}
...
func (*Layer_PoetryProject) isLayer_Layer() {}
...
func (x *ImageSpec) Reset() {
	*x = ImageSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_flyteidl2_imagebuilder_definition_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ImageSpec) Descriptor() ([]byte, []int) {
	return file_flyteidl2_imagebuilder_definition_proto_rawDescGZIP(), []int{14}
}
...
var file_flyteidl2_imagebuilder_definition_proto_rawDesc = []byte{
	...
	0x22, 0x92, 0x01, 0x0a, 0x05, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x37, 0x0a, 0x02, 0x69, 0x64,
	...
	,
	...
	,
	...
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c,
	0x32, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x52, 0x0c, 0x73,
	0x65, 0x63, 0x72, 0x65, 0x74, 0x4d, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x22, 0x9d, 0x01, 0x0a, 0x0c,
	...
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c,
	0x32, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x52, 0x0c, 0x73,
	0x65, 0x63, 0x72, 0x65, 0x74, 0x4d, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x22, 0xbe, 0x01, 0x0a, 0x0c,
	0x50, 0x79, 0x74, 0x68, 0x6f, 0x6e, 0x57, 0x68, 0x65, 0x65, 0x6c, 0x73, 0x12, 0x10, 0x0a, 0x03,
	0x64, 0x69, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x69, 0x72, 0x12, 0x3c,
	...
	,
	...
	,
	...
	0x4d, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x22, 0xc6, 0x05, 0x0a, 0x05, 0x4c, 0x61, 0x79, 0x65, 0x72,
	0x12, 0x48, 0x0a, 0x0c, 0x61, 0x70, 0x74, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x73,
	...
	0x70, 0x74, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x73, 0x12, 0x48, 0x0a, 0x0c, 0x70, 0x69,
	0x70, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x23, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x2e, 0x69, 0x6d, 0x61,
	0x67, 0x65, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x2e, 0x50, 0x69, 0x70, 0x50, 0x61, 0x63,
	0x6b, 0x61, 0x67, 0x65, 0x73, 0x48, 0x00, 0x52, 0x0b, 0x70, 0x69, 0x70, 0x50, 0x61, 0x63, 0x6b,
	0x61, 0x67, 0x65, 0x73, 0x12, 0x3e, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x73,
	...
	,
	...
	,
	...
	0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0xa2, 0x02, 0x03, 0x46, 0x49, 0x58, 0xaa, 0x02, 0x16, 0x46,
	0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x2e, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x62, 0x75,
	0x69, 0x6c, 0x64, 0x65, 0x72, 0xca, 0x02, 0x16, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c,
	0x32, 0x5c, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0xe2, 0x02,
	0x22, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x5c, 0x49, 0x6d, 0x61, 0x67, 0x65,
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0xea, 0x02, 0x17, 0x46, 0x6c, 0x79, 0x74, 0x65, 0x69, 0x64, 0x6c, 0x32, 0x3a,
...
var file_flyteidl2_imagebuilder_definition_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_flyteidl2_imagebuilder_definition_proto_goTypes = []interface{}{
	...
	(*PoetryProject)(nil),        // 12: flyteidl2.imagebuilder.PoetryProject
	(*Layer)(nil),                // 13: flyteidl2.imagebuilder.Layer
	(*ImageSpec)(nil),            // 14: flyteidl2.imagebuilder.ImageSpec
	nil,                          // 15: flyteidl2.imagebuilder.Env.EnvVariablesEntry
	(*common.RunIdentifier)(nil), // 16: flyteidl2.common.RunIdentifier
	(*core.Secret)(nil),          // 17: flyteidl2.core.Secret
}
var file_flyteidl2_imagebuilder_definition_proto_depIdxs = []int32{
	...
	16, // 1: flyteidl2.imagebuilder.Image.build_run:type_name -> flyteidl2.common.RunIdentifier
	17, // 2: flyteidl2.imagebuilder.AptPackages.secret_mounts:type_name -> flyteidl2.core.Secret
	3,  // 3: flyteidl2.imagebuilder.PipPackages.options:type_name -> flyteidl2.imagebuilder.PipOptions
	17, // 4: flyteidl2.imagebuilder.PipPackages.secret_mounts:type_name -> flyteidl2.core.Secret
	3,  // 5: flyteidl2.imagebuilder.Requirements.options:type_name -> flyteidl2.imagebuilder.PipOptions
	17, // 6: flyteidl2.imagebuilder.Requirements.secret_mounts:type_name -> flyteidl2.core.Secret
	3,  // 7: flyteidl2.imagebuilder.PythonWheels.options:type_name -> flyteidl2.imagebuilder.PipOptions
	17, // 8: flyteidl2.imagebuilder.PythonWheels.secret_mounts:type_name -> flyteidl2.core.Secret
	3,  // 9: flyteidl2.imagebuilder.UVProject.options:type_name -> flyteidl2.imagebuilder.PipOptions
	17, // 10: flyteidl2.imagebuilder.UVProject.secret_mounts:type_name -> flyteidl2.core.Secret
	17, // 11: flyteidl2.imagebuilder.Commands.secret_mounts:type_name -> flyteidl2.core.Secret
	15, // 12: flyteidl2.imagebuilder.Env.env_variables:type_name -> flyteidl2.imagebuilder.Env.EnvVariablesEntry
	17, // 13: flyteidl2.imagebuilder.PoetryProject.secret_mounts:type_name -> flyteidl2.core.Secret
	2,  // 14: flyteidl2.imagebuilder.Layer.apt_packages:type_name -> flyteidl2.imagebuilder.AptPackages
	4,  // 15: flyteidl2.imagebuilder.Layer.pip_packages:type_name -> flyteidl2.imagebuilder.PipPackages
	8,  // 16: flyteidl2.imagebuilder.Layer.commands:type_name -> flyteidl2.imagebuilder.Commands
	5,  // 17: flyteidl2.imagebuilder.Layer.requirements:type_name -> flyteidl2.imagebuilder.Requirements
	6,  // 18: flyteidl2.imagebuilder.Layer.python_wheels:type_name -> flyteidl2.imagebuilder.PythonWheels
	9,  // 19: flyteidl2.imagebuilder.Layer.workdir:type_name -> flyteidl2.imagebuilder.WorkDir
	10, // 20: flyteidl2.imagebuilder.Layer.copy_config:type_name -> flyteidl2.imagebuilder.CopyConfig
	7,  // 21: flyteidl2.imagebuilder.Layer.uv_project:type_name -> flyteidl2.imagebuilder.UVProject
	11, // 22: flyteidl2.imagebuilder.Layer.env:type_name -> flyteidl2.imagebuilder.Env
	12, // 23: flyteidl2.imagebuilder.Layer.poetry_project:type_name -> flyteidl2.imagebuilder.PoetryProject
	13, // 24: flyteidl2.imagebuilder.ImageSpec.layers:type_name -> flyteidl2.imagebuilder.Layer
...
func file_flyteidl2_imagebuilder_definition_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_flyteidl2_imagebuilder_definition_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
	...
	file_flyteidl2_imagebuilder_definition_proto_msgTypes[13].OneofWrappers = []interface{}{
