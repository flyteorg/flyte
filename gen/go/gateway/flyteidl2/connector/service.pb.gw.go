...
import (
	...
	extConnector "github.com/flyteorg/flyte/v2/gen/go/flyteidl2/connector"
...
func request_AsyncConnectorService_CreateTask_0(ctx context.Context, marshaler runtime.Marshaler, client extConnector.AsyncConnectorServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_AsyncConnectorService_CreateTask_0(ctx context.Context, marshaler runtime.Marshaler, server extConnector.AsyncConnectorServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extConnector.CreateTaskRequest
	var metadata runtime.ServerMetadata
...
func request_AsyncConnectorService_GetTask_0(ctx context.Context, marshaler runtime.Marshaler, client extConnector.AsyncConnectorServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_AsyncConnectorService_GetTask_0(ctx context.Context, marshaler runtime.Marshaler, server extConnector.AsyncConnectorServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extConnector.GetTaskRequest
	var metadata runtime.ServerMetadata
...
func request_AsyncConnectorService_DeleteTask_0(ctx context.Context, marshaler runtime.Marshaler, client extConnector.AsyncConnectorServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_AsyncConnectorService_DeleteTask_0(ctx context.Context, marshaler runtime.Marshaler, server extConnector.AsyncConnectorServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extConnector.DeleteTaskRequest
	var metadata runtime.ServerMetadata
...
func request_AsyncConnectorService_GetTaskMetrics_0(ctx context.Context, marshaler runtime.Marshaler, client extConnector.AsyncConnectorServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_AsyncConnectorService_GetTaskMetrics_0(ctx context.Context, marshaler runtime.Marshaler, server extConnector.AsyncConnectorServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extConnector.GetTaskMetricsRequest
	var metadata runtime.ServerMetadata
...
func request_AsyncConnectorService_GetTaskLogs_0(ctx context.Context, marshaler runtime.Marshaler, client extConnector.AsyncConnectorServiceClient, req *http.Request, pathParams map[string]string) (extConnector.AsyncConnectorService_GetTaskLogsClient, runtime.ServerMetadata, error) {
...
func request_ConnectorMetadataService_GetConnector_0(ctx context.Context, marshaler runtime.Marshaler, client extConnector.ConnectorMetadataServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ConnectorMetadataService_GetConnector_0(ctx context.Context, marshaler runtime.Marshaler, server extConnector.ConnectorMetadataServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extConnector.GetConnectorRequest
	var metadata runtime.ServerMetadata
...
func request_ConnectorMetadataService_ListConnectors_0(ctx context.Context, marshaler runtime.Marshaler, client extConnector.ConnectorMetadataServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ConnectorMetadataService_ListConnectors_0(ctx context.Context, marshaler runtime.Marshaler, server extConnector.ConnectorMetadataServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extConnector.ListConnectorsRequest
	var metadata runtime.ServerMetadata
...
func RegisterAsyncConnectorServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extConnector.AsyncConnectorServiceServer) error {
	...
	mux.Handle("POST", pattern_AsyncConnectorService_CreateTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl2.connector.AsyncConnectorService/CreateTask", runtime.WithHTTPPathPattern("/api/v1/connector/task"))
		if err != nil {
	...
	mux.Handle("GET", pattern_AsyncConnectorService_GetTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl2.connector.AsyncConnectorService/GetTask", runtime.WithHTTPPathPattern("/api/v1/connector/task/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_AsyncConnectorService_DeleteTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl2.connector.AsyncConnectorService/DeleteTask", runtime.WithHTTPPathPattern("/api/v1/connector/task_executions/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AsyncConnectorService_GetTaskMetrics_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl2.connector.AsyncConnectorService/GetTaskMetrics", runtime.WithHTTPPathPattern("/api/v1/connector/task/metrics/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterConnectorMetadataServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extConnector.ConnectorMetadataServiceServer) error {
	...
	mux.Handle("GET", pattern_ConnectorMetadataService_GetConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl2.connector.ConnectorMetadataService/GetConnector", runtime.WithHTTPPathPattern("/api/v1/connector/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorMetadataService_ListConnectors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/flyteidl2.connector.ConnectorMetadataService/ListConnectors", runtime.WithHTTPPathPattern("/api/v1/connectors"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterAsyncConnectorServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterAsyncConnectorServiceHandlerClient(ctx, mux, extConnector.NewAsyncConnectorServiceClient(conn))
}

// RegisterAsyncConnectorServiceHandlerClient registers the http handlers for service AsyncConnectorService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "extConnector.AsyncConnectorServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "extConnector.AsyncConnectorServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "extConnector.AsyncConnectorServiceClient" to call the correct interceptors.
func RegisterAsyncConnectorServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extConnector.AsyncConnectorServiceClient) error {
	...
	mux.Handle("POST", pattern_AsyncConnectorService_CreateTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl2.connector.AsyncConnectorService/CreateTask", runtime.WithHTTPPathPattern("/api/v1/connector/task"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AsyncConnectorService_GetTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl2.connector.AsyncConnectorService/GetTask", runtime.WithHTTPPathPattern("/api/v1/connector/task/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_AsyncConnectorService_DeleteTask_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl2.connector.AsyncConnectorService/DeleteTask", runtime.WithHTTPPathPattern("/api/v1/connector/task_executions/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AsyncConnectorService_GetTaskMetrics_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl2.connector.AsyncConnectorService/GetTaskMetrics", runtime.WithHTTPPathPattern("/api/v1/connector/task/metrics/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AsyncConnectorService_GetTaskLogs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl2.connector.AsyncConnectorService/GetTaskLogs", runtime.WithHTTPPathPattern("/api/v1/connector/task/logs/{task_category.name}/{task_category.version}/{resource_meta}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterConnectorMetadataServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterConnectorMetadataServiceHandlerClient(ctx, mux, extConnector.NewConnectorMetadataServiceClient(conn))
}

// RegisterConnectorMetadataServiceHandlerClient registers the http handlers for service ConnectorMetadataService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "extConnector.ConnectorMetadataServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "extConnector.ConnectorMetadataServiceClient"
// doesn't go through the normal gRPC flow (creating a gRPC client etc.) then it will be up to the passed in
// "extConnector.ConnectorMetadataServiceClient" to call the correct interceptors.
func RegisterConnectorMetadataServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extConnector.ConnectorMetadataServiceClient) error {
	...
	mux.Handle("GET", pattern_ConnectorMetadataService_GetConnector_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl2.connector.ConnectorMetadataService/GetConnector", runtime.WithHTTPPathPattern("/api/v1/connector/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ConnectorMetadataService_ListConnectors_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/flyteidl2.connector.ConnectorMetadataService/ListConnectors", runtime.WithHTTPPathPattern("/api/v1/connectors"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
