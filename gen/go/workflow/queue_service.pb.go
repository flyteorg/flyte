...
var file_workflow_queue_service_proto_rawDesc = []byte{
	...
	0x22, 0x58, 0x0a, 0x15, 0x41, 0x62, 0x6f, 0x72, 0x74, 0x51, 0x75, 0x65, 0x75, 0x65, 0x64, 0x52,
	0x75, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3f, 0x0a, 0x06, 0x72, 0x75, 0x6e,
	...
	,
	...
	0x73, 0x65, 0x22, 0x00, 0x42, 0xbc, 0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x79,
...
var file_workflow_queue_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_workflow_queue_service_proto_goTypes = []interface{}{
	...
	(*RunSpec)(nil),                 // 9: flyteidl.workflow.RunSpec
	(*TaskIdentifier)(nil),          // 10: flyteidl.workflow.TaskIdentifier
	(*TaskSpec)(nil),                // 11: flyteidl.workflow.TaskSpec
	(*wrapperspb.StringValue)(nil),  // 12: google.protobuf.StringValue
	(Phase)(0),                      // 13: flyteidl.workflow.Phase
	(*timestamppb.Timestamp)(nil),   // 14: google.protobuf.Timestamp
	(*OutputReferences)(nil),        // 15: flyteidl.workflow.OutputReferences
	(*core.LiteralType)(nil),        // 16: flyteidl.core.LiteralType
	(*common.RunIdentifier)(nil),    // 17: flyteidl.common.RunIdentifier
}
var file_workflow_queue_service_proto_depIdxs = []int32{
	8,  // 0: flyteidl.workflow.EnqueueActionRequest.action_id:type_name -> flyteidl.common.ActionIdentifier
	9,  // 1: flyteidl.workflow.EnqueueActionRequest.run_spec:type_name -> flyteidl.workflow.RunSpec
	...
	10, // 5: flyteidl.workflow.TaskAction.id:type_name -> flyteidl.workflow.TaskIdentifier
	11, // 6: flyteidl.workflow.TaskAction.spec:type_name -> flyteidl.workflow.TaskSpec
	12, // 7: flyteidl.workflow.TaskAction.cache_key:type_name -> google.protobuf.StringValue
	13, // 8: flyteidl.workflow.TraceAction.phase:type_name -> flyteidl.workflow.Phase
	14, // 9: flyteidl.workflow.TraceAction.start_time:type_name -> google.protobuf.Timestamp
	14, // 10: flyteidl.workflow.TraceAction.end_time:type_name -> google.protobuf.Timestamp
	15, // 11: flyteidl.workflow.TraceAction.outputs:type_name -> flyteidl.workflow.OutputReferences
	16, // 12: flyteidl.workflow.ConditionAction.type:type_name -> flyteidl.core.LiteralType
	17, // 13: flyteidl.workflow.AbortQueuedRunRequest.run_id:type_name -> flyteidl.common.RunIdentifier
	1,  // 14: flyteidl.workflow.QueueService.EnqueueAction:input_type -> flyteidl.workflow.EnqueueActionRequest
	6,  // 15: flyteidl.workflow.QueueService.AbortQueuedRun:input_type -> flyteidl.workflow.AbortQueuedRunRequest
	5,  // 16: flyteidl.workflow.QueueService.EnqueueAction:output_type -> flyteidl.workflow.EnqueueActionResponse
	7,  // 17: flyteidl.workflow.QueueService.AbortQueuedRun:output_type -> flyteidl.workflow.AbortQueuedRunResponse
