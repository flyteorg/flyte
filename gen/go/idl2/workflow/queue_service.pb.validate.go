...
// Validate checks the field values on WorkerIdentifier with the rules defined
...
// ValidateAll checks the field values on WorkerIdentifier with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// WorkerIdentifierMultiError, or nil if none found.
func (m *WorkerIdentifier) ValidateAll() error {
	return m.validate(true)
}

func (m *WorkerIdentifier) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetOrganization()) < 1 {
		err := WorkerIdentifierValidationError{
			field:  "Organization",
	...
	if len(errors) > 0 {
		return WorkerIdentifierMultiError(errors)
	}

	return nil
}

// WorkerIdentifierMultiError is an error wrapping multiple validation errors
// returned by WorkerIdentifier.ValidateAll() if the designated constraints
// aren't met.
type WorkerIdentifierMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m WorkerIdentifierMultiError) Error() string {
	var msgs []string
	for _, err := range m {
...
func (m WorkerIdentifierMultiError) AllErrors() []error { return m }

// WorkerIdentifierValidationError is the validation error returned by
// WorkerIdentifier.Validate if the designated constraints aren't met.
...
func (e WorkerIdentifierValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e WorkerIdentifierValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e WorkerIdentifierValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e WorkerIdentifierValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e WorkerIdentifierValidationError) ErrorName() string { return "WorkerIdentifierValidationError" }

// Error satisfies the builtin error interface
func (e WorkerIdentifierValidationError) Error() string {
	cause := ""
	if e.cause != nil {
	...
	return fmt.Sprintf(
		"invalid %sWorkerIdentifier.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = WorkerIdentifierValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = WorkerIdentifierValidationError{}
