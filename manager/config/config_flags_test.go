...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_executor.healthProbePort", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("executor.healthProbePort", testValue)
			if vInt, err := cmdFlags.GetInt("executor.healthProbePort"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vInt), &actual.Executor.HealthProbePort)
